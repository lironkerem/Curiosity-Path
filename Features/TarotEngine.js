...
class TarotEngine {
  ...
  flipCard(index) {
    ...
    front.innerHTML = `<picture><source srcset="${card.imageUrl}" type="image/webp"><img src="${card.imageUrl.replace('.webp', '.jpg')}" alt="${card.name}" class="tarot-card-image" loading="lazy" decoding="async" onerror="this.style.display='none'; this.parentElement.innerHTML='<div class=\'tarot-card-error\'>🃏</div>'"></picture>`;
    ...
    return `
      <div class="community-link-card" style="padding-top:0;">
        <div style="display:flex;flex-direction:column;align-items:center;gap:0;margin-bottom:0;">
          <picture><source srcset="/public/Tabs/CommunityHub.webp" type="image/webp"><img src="/public/Tabs/CommunityHub.png" alt="Community" loading="lazy" decoding="async" style="width:30rem;object-fit:contain;margin-top:1rem;margin-bottom:1rem;"></picture>
        ...
        <div class="tarot-card-flip-container" id="tarot-card-container-${index}" onclick="window.featuresManager.engines.tarot.flipCard(${index})">
          <div class="tarot-card-flip-inner">
            <div class="tarot-card-back">
              ...
              <picture><source srcset="${this.CARD_BACK_URL}" type="image/webp"><img src="${this.CARD_BACK_URL.replace('.webp', '.jpg')}" alt="Card Back" class="tarot-card-image" loading="lazy" decoding="async"></picture>
            </div>
