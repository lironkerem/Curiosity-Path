...
const UpcomingEvents = {
    ...
    classes: [
        {
            ...
            image:    '/CTA/Sessions/Sessions4.jpg',
        ...
        },
        {
            ...
            image:    '/CTA/Sessions/Sessions3.jpg',
            whatsapp: 'https://wa.me/+972524588767',
        },
    ],
    ...
    sessions: [
        {
            ...
            image:    '/CTA/Sessions/Sessions1.jpg',
            whatsapp: 'https://wa.me/+972524588767',
        },
        {
            ...
            type:     '✨ In-Person or Online',
            datetime: 'Daily • Flexible Hours',
            image:    '/CTA/Sessions/Sessions2.jpg',
            whatsapp: 'https://wa.me/+972524588767',
        },
    ],
    ...
    _getContentHTML(data, contentId, ctaText) {
        ...
        <div class="event-content" id="${contentId}" style="padding:20px;">
            ...
            <button type="button" class="btn btn-primary" style="display:inline-flex;align-items:center;justify-content:center;gap:0.5rem;width:100%;" onclick="UpcomingEvents.openWhatsApp('${this.escapeHtml(data.whatsapp)}')"
