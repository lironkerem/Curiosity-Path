      ...
      <div class="neuro-card flip-card" id="dashboard-quote-card">
        <div class="flip-card-inner">
          <div class="flip-card-front">
            ...
            <p class="text-2xl font-semibold text-center" style="color: var(--neuro-accent); line-height: 1.5; padding-top: 1.5rem; padding-bottom: 1rem;">
    ...
    <div class="card dashboard-achievements mb-8">
      <div style="display: flex; flex-direction: column; gap: 1.5rem;">
        ...
        <div style="text-align:center;">
          ...
          <div class="grid badges-grid gap-4" style="grid-template-columns: repeat(3, 1fr);">
