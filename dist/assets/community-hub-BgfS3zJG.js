var St=Object.defineProperty;var Mt=(t,e,o)=>e in t?St(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o;var Ze=(t,e,o)=>Mt(t,typeof e!="symbol"?e+"":e,o);import{ActiveMembersWidget as It}from"./active-members-DuQKpaap.js";import{_ as _e}from"./features-lazy-COJZCo6-.js";const gt=window.AppSupabase||null;window.CommunitySupabase=gt;const u={_sb:null,_uid:null,_subs:{},_heartbeatTimer:null,async init(){if(this._sb=window.AppSupabase||gt,!this._sb)return console.error("[CommunityDB] CommunitySupabase not ready — window.AppSupabase is null"),!1;const{data:{user:t},error:e}=await this._sb.auth.getUser();return e||!t?(console.error("[CommunityDB] No authenticated user:",e==null?void 0:e.message),!1):(this._uid=t.id,!0)},get userId(){return this._uid},get ready(){return!!(this._sb&&this._uid)},_err(t,e){console.error(`[CommunityDB] ${t}:`,(e==null?void 0:e.message)??e)},_profileSelect:"id, name, emoji, avatar_url",_ago(t){return new Date(Date.now()-t).toISOString()},_todayUTC(){const t=new Date;return t.setUTCHours(0,0,0,0),t.toISOString()},async getMyProfile(){if(!this.ready)return null;const{data:t,error:e}=await this._sb.from("profiles").select("*").eq("id",this._uid).single();return e?(this._err("getMyProfile",e),null):t},async getProfile(t){if(!this.ready)return null;const{data:e,error:o}=await this._sb.from("profiles").select("id, name, emoji, avatar_url, inspiration, community_status, community_role, total_sessions, total_minutes, gifts_given, birthday, country").eq("id",t).single();return o?(this._err("getProfile",o),null):e},_parseProgress(t){var o,i,n,r,a,s;const e=typeof t=="string"?JSON.parse(t):t;return{xp:e.xp??0,karma:e.karma??0,level:e.level??1,badges:e.badges??[],unlockedFeatures:e.unlockedFeatures??[],streak:((o=e.streaks)==null?void 0:o.current)??((i=e.streak)==null?void 0:i.current)??0,longestStreak:((n=e.streaks)==null?void 0:n.longest)??0,totalSessions:((r=e.stats)==null?void 0:r.totalSessions)??0,totalMeditations:((a=e.stats)==null?void 0:a.totalMeditations)??0,totalReadings:((s=e.stats)==null?void 0:s.totalReadings)??0,totalTarotSpreads:e.totalTarotSpreads??0,totalJournalEntries:e.totalJournalEntries??0,totalWellnessRuns:e.totalWellnessRuns??0,totalHappinessViews:e.totalHappinessViews??0}},async getUserProgress(t){if(!this.ready)return null;try{const{data:e,error:o}=await this._sb.from("user_progress").select("payload").eq("user_id",t).single();return o||!e?null:this._parseProgress(e.payload)}catch(e){return this._err("getUserProgress",e),null}},getOwnGamificationState(){var e;const t=(e=window.app)==null?void 0:e.gamification;return t?this._parseProgress(t.state??t):null},async uploadAvatar(t){if(!this.ready)return null;try{const e=t.name.split(".").pop().toLowerCase()||"jpg",o=`avatars/${this._uid}.${e}`,{error:i}=await this._sb.storage.from("community-avatars").upload(o,t,{upsert:!0,contentType:t.type});if(i)return this._err("uploadAvatar upload",i),null;const{data:n}=this._sb.storage.from("community-avatars").getPublicUrl(o),r=n==null?void 0:n.publicUrl;if(!r)return null;const a=`${r}?t=${Date.now()}`;return await this.updateProfile({avatar_url:a})?a:null}catch(e){return this._err("uploadAvatar",e),null}},async updateProfile(t){if(!this.ready)return!1;const{error:e}=await this._sb.from("profiles").update({...t,updated_at:new Date().toISOString()}).eq("id",this._uid);return e?(this._err("updateProfile",e),!1):!0},async setPresence(t="online",e="✨ Available",o=null){if(!this.ready)return!1;const i=new Date().toISOString(),{error:n}=await this._sb.from("community_presence").upsert({user_id:this._uid,status:t,activity:e,room_id:o,last_seen:i,updated_at:i},{onConflict:"user_id"});return n&&this._err("setPresence",n),!n},async setOffline(){return this.setPresence("offline","💤 Offline",null)},async getActiveMembers(){if(!this.ready)return[];const{data:t,error:e}=await this._sb.from("community_presence").select(`user_id, status, activity, room_id, is_phantom, last_seen, profiles ( ${this._profileSelect} )`).neq("status","offline").gte("last_seen",this._ago(5*6e4)).order("is_phantom",{ascending:!1}).order("last_seen",{ascending:!1});return e?(this._err("getActiveMembers",e),[]):t||[]},async getRoomParticipants(t){if(!this.ready)return[];const{data:e,error:o}=await this._sb.from("community_presence").select(`user_id, status, activity, room_id, is_phantom, last_seen, profiles ( ${this._profileSelect} )`).or(`room_id.eq.${t},is_phantom.eq.true`).neq("status","offline").gte("last_seen",this._ago(5*6e4)).order("is_phantom",{ascending:!1}).order("last_seen",{ascending:!0});return o?(this._err("getRoomParticipants",o),[]):e||[]},subscribeToPresence(t){return this._subs.presence&&this._subs.presence.unsubscribe(),this._subs.presence=this._sb.channel("community-presence").on("postgres_changes",{event:"*",schema:"public",table:"community_presence"},async()=>t(await this.getActiveMembers())).subscribe(),this._subs.presence},startHeartbeat(t=6e4){this.stopHeartbeat(),this._heartbeatTimer=setInterval(async()=>{var o,i,n;if(!this.ready)return;const e=(o=typeof Core<"u"?Core:window.Core)==null?void 0:o.state;await this.setPresence(((i=e==null?void 0:e.currentUser)==null?void 0:i.status)||"online",((n=e==null?void 0:e.currentUser)==null?void 0:n.activity)||"✨ Available",(e==null?void 0:e.currentRoom)||null)},t),window.addEventListener("beforeunload",()=>this._cleanup())},stopHeartbeat(){this._heartbeatTimer&&(clearInterval(this._heartbeatTimer),this._heartbeatTimer=null)},_reflectionSelect:"id, content, appreciation_count, created_at, profiles ( id, name, emoji, avatar_url )",async getReflections(t=30){if(!this.ready)return[];const{data:e,error:o}=await this._sb.from("reflections").select(this._reflectionSelect).order("created_at",{ascending:!1}).limit(t);return o?(this._err("getReflections",o),[]):e||[]},async postReflection(t){if(!this.ready)return null;const{data:e,error:o}=await this._sb.from("reflections").insert({user_id:this._uid,content:t}).select(this._reflectionSelect).single();return o?(this._err("postReflection",o),null):e},async deleteReflection(t){if(!this.ready)return!1;const{error:e}=await this._sb.from("reflections").delete().eq("id",t);return e?(this._err("deleteReflection",e),!1):!0},async updateReflection(t,e){if(!this.ready)return!1;const{error:o}=await this._sb.from("reflections").update({content:e}).eq("id",t).eq("user_id",this._uid);return o?(this._err("updateReflection",o),!1):!0},subscribeToReflections(t){return this._subs.reflections&&this._subs.reflections.unsubscribe(),this._subs.reflections=this._sb.channel("community-reflections").on("postgres_changes",{event:"INSERT",schema:"public",table:"reflections"},async({new:e})=>{const{data:o}=await this._sb.from("reflections").select(this._reflectionSelect).eq("id",e.id).single();o&&t(o)}).subscribe(),this._subs.reflections},async getMyAppreciations(){if(!this.ready)return new Set;const{data:t,error:e}=await this._sb.from("appreciations").select("reflection_id").eq("user_id",this._uid);return e?(this._err("getMyAppreciations",e),new Set):new Set(t.map(o=>o.reflection_id))},async toggleAppreciation(t,e){if(!this.ready)return null;if(e){const{error:o}=await this._sb.from("appreciations").delete().eq("user_id",this._uid).eq("reflection_id",t);return o?(this._err("removeAppreciation",o),null):{appreciated:!1}}else{const{error:o}=await this._sb.from("appreciations").insert({user_id:this._uid,reflection_id:t});return o?(this._err("addAppreciation",o),null):{appreciated:!0}}},async getReflectionCount(t){if(!this.ready)return null;const{data:e,error:o}=await this._sb.from("reflections").select("appreciation_count").eq("id",t).single();return o?(this._err("getReflectionCount",o),null):(e==null?void 0:e.appreciation_count)??null},async getMyUserAppreciations(){if(!this.ready)return new Set;const{data:t,error:e}=await this._sb.from("user_appreciations").select("appreciated_user_id").eq("user_id",this._uid);return e?(this._err("getMyUserAppreciations",e),new Set):new Set(t.map(o=>o.appreciated_user_id))},async toggleUserAppreciation(t,e){if(!this.ready)return null;if(e){const{error:o}=await this._sb.from("user_appreciations").delete().eq("user_id",this._uid).eq("appreciated_user_id",t);return o?(this._err("removeUserAppreciation",o),null):{appreciated:!1}}else{const{error:o}=await this._sb.from("user_appreciations").insert({user_id:this._uid,appreciated_user_id:t});return o?(this._err("addUserAppreciation",o),null):{appreciated:!0}}},async getUserAppreciationCount(t){if(!this.ready)return 0;const{count:e,error:o}=await this._sb.from("user_appreciations").select("*",{count:"exact",head:!0}).eq("appreciated_user_id",t);return o?(this._err("getUserAppreciationCount",o),0):e||0},_roomMsgSelect:"id, message, created_at, profiles ( id, name, emoji, avatar_url )",async getRoomMessages(t,e=50){if(!this.ready)return[];const{data:o,error:i}=await this._sb.from("room_messages").select(this._roomMsgSelect).eq("room_id",t).order("created_at",{ascending:!0}).limit(e);return i?(this._err("getRoomMessages",i),[]):o||[]},async sendRoomMessage(t,e){if(!this.ready)return null;const{data:o,error:i}=await this._sb.from("room_messages").insert({user_id:this._uid,room_id:t,message:e}).select(this._roomMsgSelect).single();return i?(this._err("sendRoomMessage",i),null):o},subscribeToRoomChat(t,e){const o=`room-${t}`;return this._subs[o]&&this._subs[o].unsubscribe(),this._subs[o]=this._sb.channel(`room-chat-${t}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"room_messages",filter:`room_id=eq.${t}`},async({new:i})=>{const{data:n}=await this._sb.from("room_messages").select(this._roomMsgSelect).eq("id",i.id).single();n&&e(n)}).subscribe(),this._subs[o]},unsubscribeFromRoomChat(t){this._unsub(`room-${t}`)},async sendWhisper(t,e){if(!this.ready)return null;const{data:o,error:i}=await this._sb.from("whispers").insert({sender_id:this._uid,recipient_id:t,message:e}).select().single();return i?(this._err("sendWhisper",i),null):o},async getWhispers(t){if(!this.ready)return[];const{data:e,error:o}=await this._sb.from("whispers").select(`
            ...
            `).or(`and(sender_id.eq.${this._uid},recipient_id.eq.${t}),and(sender_id.eq.${t},recipient_id.eq.${this._uid})`).order("created_at",{ascending:!0});return o?(this._err("getWhispers",o),[]):e||[]},async markWhisperRead(t){this.ready&&await this._sb.from("whispers").update({read:!0}).eq("id",t)},async markConversationRead(t){if(!this.ready)return;const{error:e}=await this._sb.from("whispers").update({read:!0}).eq("recipient_id",this._uid).eq("sender_id",t).eq("read",!1);e&&this._err("markConversationRead",e)},async getWhisperInbox(){if(!this.ready)return[];try{const{data:t,error:e}=await this._sb.from("whispers").select(`
                ...
                `).or(`sender_id.eq.${this._uid},recipient_id.eq.${this._uid}`).order("created_at",{ascending:!1}).limit(200);if(e)return this._err("getWhisperInbox",e),[];const o={};for(const i of t||[]){const n=i.sender_id===this._uid?i.recipient_id:i.sender_id,r=i.sender_id===this._uid?i.recipient:i.sender;o[n]||(o[n]={partnerId:n,partner:r,lastMessage:i.message,lastAt:i.created_at,unread:0}),i.recipient_id===this._uid&&!i.read&&o[n].unread++}return Object.values(o).sort((i,n)=>new Date(n.lastAt)-new Date(i.lastAt))}catch(t){return this._err("getWhisperInbox",t),[]}},async getUnreadWhisperCount(){if(!this.ready)return 0;const{count:t,error:e}=await this._sb.from("whispers").select("id",{count:"exact",head:!0}).eq("recipient_id",this._uid).eq("read",!1);return e?0:t||0},subscribeToWhispers(t){return this._subs.whispersFg&&this._subs.whispersFg.unsubscribe(),this._subs.whispersFg=this._sb.channel("my-whispers-fg").on("postgres_changes",{event:"INSERT",schema:"public",table:"whispers",filter:`recipient_id=eq.${this._uid}`},async({new:e})=>{const{data:o}=await this._sb.from("whispers").select(`
                        id, message, read, created_at, sender_id,
                        sender:profiles!whispers_sender_id_fkey ( id, name, emoji, avatar_url )
                    `).eq("id",e.id).single();o&&t(o)}).subscribe(),this._subs.whispersFg},subscribeToWhispersBackground(t){return this._subs.whispersBg&&this._subs.whispersBg.unsubscribe(),this._subs.whispersBg=this._sb.channel("my-whispers-bg").on("postgres_changes",{event:"INSERT",schema:"public",table:"whispers",filter:`recipient_id=eq.${this._uid}`},async({new:e})=>{const{data:o}=await this._sb.from("whispers").select(`
                        id, message, read, created_at, sender_id,
                        sender:profiles!whispers_sender_id_fkey ( id, name, emoji, avatar_url )
                    `).eq("id",e.id).single();o&&t(o)}).subscribe(),this._subs.whispersBg},async submitReport(t,e,o=""){if(!this.ready)return!1;const{error:i}=await this._sb.from("reports").insert({reporter_id:this._uid,reported_user_id:t,reason:e,details:o});return i?(this._err("submitReport",i),!1):!0},async blockUser(t){if(!this.ready)return!1;const{error:e}=await this._sb.from("blocked_users").insert({user_id:this._uid,blocked_user_id:t});return e?(this._err("blockUser",e),!1):!0},async getBlockedUsers(){if(!this.ready)return new Set;const{data:t,error:e}=await this._sb.from("blocked_users").select("blocked_user_id").eq("user_id",this._uid);return e?new Set:new Set(t.map(o=>o.blocked_user_id))},async getUserByName(t){if(!this.ready)return null;const{data:e,error:o}=await this._sb.from("profiles").select("id, name").ilike("name",t).single();return o?(this._err("getUserByName",o),null):e},async getOwnFullProgress(){if(!this.ready)return null;try{const{data:t,error:e}=await this._sb.from("user_progress").select("payload").eq("user_id",this._uid).single();if(e||!t)return null;const o=typeof t.payload=="string"?JSON.parse(t.payload):t.payload;return{journalEntries:o.journalEntries||[],energyEntries:o.energyEntries||[],gratitudeEntries:o.gratitudeEntries||[],flipEntries:o.flipEntries||[],tarotReadings:o.tarotReadings||[],meditationEntries:o.meditationEntries||[]}}catch(t){return this._err("getOwnFullProgress",t),null}},async getRoomBlessings(t){if(!this.ready)return[];const{data:e,error:o}=await this._sb.from("room_blessings").select("user_id, created_at, profiles ( name, avatar_url, emoji )").eq("room_id",t).order("created_at",{ascending:!1});return o?(this._err("getRoomBlessings",o),[]):e||[]},async blessRoom(t){if(!this.ready)return{status:"error"};const{data:e,error:o}=await this._sb.rpc("bless_room_with_cooldown",{p_room_id:t,p_cooldown_seconds:60});if(o)return this._err("blessRoom rpc",o),{status:"error"};if(e==="cooldown")return{status:"cooldown"};if(e!=="ok")return{status:"error"};const{data:i,error:n}=await this._sb.from("room_blessings").select("user_id, created_at, profiles ( name, avatar_url, emoji )").eq("room_id",t).eq("user_id",this._uid).single();return n?(this._err("blessRoom fetch",n),{status:"ok",data:null}):{status:"ok",data:i}},subscribeToBlessings(t,e){const o=`bless-${t}`;this._subs[o]&&this._subs[o].unsubscribe();const i=async({new:n})=>{if(!(n!=null&&n.user_id))return;const{data:r}=await this._sb.from("profiles").select("name, avatar_url, emoji").eq("id",n.user_id).single();e({roomId:t,userId:n.user_id,name:(r==null?void 0:r.name)||"A member",avatarUrl:(r==null?void 0:r.avatar_url)||"",emoji:(r==null?void 0:r.emoji)||""})};return this._subs[o]=this._sb.channel(o).on("postgres_changes",{event:"INSERT",schema:"public",table:"room_blessings",filter:`room_id=eq.${t}`},i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"room_blessings",filter:`room_id=eq.${t}`},i).subscribe(),this._subs[o]},unsubscribeFromBlessings(t){this._unsub(`bless-${t}`)},async getAppSettings(t){if(!this.ready)return null;const{data:e,error:o}=await this._sb.from("app_settings").select("value").eq("key",t).single();return o?(this._err("getAppSettings",o),null):(e==null?void 0:e.value)??null},async saveAppSettings(t,e){if(!this.ready)return!1;const{error:o}=await this._sb.from("app_settings").upsert({key:t,value:e,updated_at:new Date().toISOString()},{onConflict:"key"});return o?(this._err("saveAppSettings",o),!1):!0},async logRoomEntry(t){if(!this.ready)return null;const{data:e,error:o}=await this._sb.from("room_entries").insert({user_id:this._uid,room_id:t}).select("id").single();return o?(this._err("logRoomEntry",o),null):(e==null?void 0:e.id)||null},async logRoomExit(t){if(!t||!this.ready)return;const{data:e}=await this._sb.from("room_entries").select("entered_at").eq("id",t).single();if(!e)return;const o=Math.round((Date.now()-new Date(e.entered_at).getTime())/1e3);await this._sb.from("room_entries").update({left_at:new Date().toISOString(),duration_seconds:o}).eq("id",t)},async broadcastMessage(t,e){if(!this.ready||!(t!=null&&t.length))return{sent:0,failed:0};const o=t.map(r=>({sender_id:this._uid,recipient_id:r,message:e})),{data:i,error:n}=await this._sb.from("whispers").insert(o).select("id");return n?(this._err("broadcastMessage",n),{sent:0,failed:t.length}):{sent:(i==null?void 0:i.length)||0,failed:t.length-((i==null?void 0:i.length)||0)}},async getAdminNotifications(t=50){if(!this.ready)return[];const{data:e,error:o}=await this._sb.from("admin_notifications").select("*").order("created_at",{ascending:!1}).limit(t);return o?(this._err("getAdminNotifications",o),[]):e||[]},async markNotificationRead(t){if(!this.ready)return!1;const{error:e}=await this._sb.from("admin_notifications").update({read:!0}).eq("id",t);return e?(this._err("markNotificationRead",e),!1):!0},async markAllNotificationsRead(){if(!this.ready)return!1;const{error:t}=await this._sb.from("admin_notifications").update({read:!0}).eq("read",!1);return t?(this._err("markAllNotificationsRead",t),!1):!0},async getUnreadNotificationCount(){if(!this.ready)return 0;const{count:t,error:e}=await this._sb.from("admin_notifications").select("*",{count:"exact",head:!0}).eq("read",!1);return e?(this._err("getUnreadNotificationCount",e),0):t||0},async getAdminMemberStats(){if(!this.ready)return{};const[t,e,o]=await Promise.all([this._sb.from("profiles").select("*",{count:"exact",head:!0}),this._sb.from("profiles").select("*",{count:"exact",head:!0}).gte("updated_at",this._ago(10080*6e4)),this._sb.from("community_presence").select("*",{count:"exact",head:!0}).neq("status","offline").gte("last_seen",this._ago(5*6e4))]);return{total:t.count||0,newThisWeek:e.count||0,onlineNow:o.count||0}},async getAdminEngagementStats(){if(!this.ready)return{};const t=this._todayUTC(),[e,o,i,n]=await Promise.all([this._sb.from("reflections").select("*",{count:"exact",head:!0}).gte("created_at",t),this._sb.from("reflections").select("*",{count:"exact",head:!0}),this._sb.from("whispers").select("*",{count:"exact",head:!0}).gte("created_at",t),this._sb.from("appreciations").select("*",{count:"exact",head:!0}).gte("created_at",t)]);return{reflectionsToday:e.count||0,reflectionsTotal:o.count||0,whispersToday:i.count||0,appreciationsToday:n.count||0}},async getLeaderboard(){if(!this.ready)return{xp:[],karma:[]};const{data:t,error:e}=await this._sb.from("user_progress").select("user_id, payload->xp, payload->karma, payload->level").limit(50);if(e)return this._err("getLeaderboard",e),{xp:[],karma:[]};const o=(t||[]).map(s=>s.user_id);if(!o.length)return{xp:[],karma:[]};const{data:i}=await this._sb.from("profiles").select("id, name, emoji, avatar_url").in("id",o),n=Object.fromEntries((i||[]).map(s=>[s.id,s])),r=(t||[]).filter(s=>n[s.user_id]).map(s=>({user_id:s.user_id,profiles:n[s.user_id],payload:{xp:s.xp??0,karma:s.karma??0,level:s.level??1}})),a=s=>[...r].sort((l,d)=>{var c,p;return(((c=d.payload)==null?void 0:c[s])||0)-(((p=l.payload)==null?void 0:p[s])||0)}).slice(0,3);return{xp:a("xp"),karma:a("karma")}},async getRoomUsageToday(){if(!this.ready)return[];const{data:t,error:e}=await this._sb.from("room_entries").select("room_id, duration_seconds").gte("entered_at",this._todayUTC());if(e)return this._err("getRoomUsageToday",e),[];const o={};for(const i of t||[])o[i.room_id]||(o[i.room_id]={room_id:i.room_id,entries:0,totalSeconds:0}),o[i.room_id].entries++,o[i.room_id].totalSeconds+=i.duration_seconds||0;return Object.values(o).sort((i,n)=>n.entries-i.entries)},async getPushSubscriptionCount(){if(!this.ready)return 0;const{count:t,error:e}=await this._sb.from("push_subscriptions").select("*",{count:"exact",head:!0});return e?(this._err("getPushSubscriptionCount",e),0):t||0},async getRetentionSignals(){if(!this.ready)return{quietMembers:[],streakMembers:[]};const[t,e,o]=await Promise.all([this._sb.from("community_presence").select("user_id, profiles(name, emoji)").gte("last_seen",this._ago(10080*6e4)).neq("status","offline"),this._sb.from("community_presence").select("user_id").gte("last_seen",this._ago(336*60*6e4)).lt("last_seen",this._ago(10080*6e4)),this._sb.from("community_presence").select("user_id, profiles(name, emoji)").gte("last_seen",this._ago(4320*6e4))]),i=new Set((t.data||[]).map(s=>s.user_id)),r=[...new Set((e.data||[]).map(s=>s.user_id))].filter(s=>!i.has(s)).slice(0,5),a=(o.data||[]).filter(s=>s.profiles).slice(0,5).map(s=>{var l,d;return{user_id:s.user_id,name:(l=s.profiles)==null?void 0:l.name,emoji:(d=s.profiles)==null?void 0:d.emoji}});return{quietMembers:r,streakMembers:a}},async getSafetyStats(){if(!this.ready)return{};const[t,e,o]=await Promise.all([this._sb.from("admin_notifications").select("*",{count:"exact",head:!0}).eq("type","report").gte("created_at",this._ago(10080*6e4)),this._sb.from("blocked_users").select("*",{count:"exact",head:!0}),this._sb.from("admin_notifications").select("*",{count:"exact",head:!0}).eq("read",!1)]);return{reportsThisWeek:t.count||0,blockedTotal:e.count||0,unreadNotifs:o.count||0}},async getRecentReflectionsAdmin(t=5){if(!this.ready)return[];const{data:e,error:o}=await this._sb.from("reflections").select("id, content, created_at, user_id, profiles!reflections_user_id_fkey(id, name, emoji, avatar_url)").order("created_at",{ascending:!1}).limit(t);if(o){this._err("getRecentReflectionsAdmin",o);const{data:i}=await this._sb.from("reflections").select("id, content, created_at, author_id").order("created_at",{ascending:!1}).limit(t);return i||[]}return e||[]},async adminUpdateGamification(t,{xpDelta:e=0,karmaDelta:o=0,unlockFeature:i=null,badgeId:n=null,badgeName:r=null,badgeIcon:a="🏅",badgeRarity:s="common",badgeXp:l=0,badgeDesc:d=""}={}){if(!this.ready)return!1;try{const{error:c}=await this._sb.rpc("update_user_gamification",{target_user_id:t,xp_delta:e,karma_delta:o,unlock_feature:i,badge_id:n,badge_name:r,badge_icon:a,badge_rarity:s,badge_xp:l,badge_desc:d});if(c)throw new Error(c.message);return!0}catch(c){return this._err("adminUpdateGamification",c),!1}},_unsub(t){this._subs[t]&&(this._subs[t].unsubscribe(),delete this._subs[t])},unsubscribeAll(){for(const t of Object.values(this._subs))try{t.unsubscribe()}catch{}this._subs={}},async _cleanup(){this.stopHeartbeat(),await this.setOffline(),this.unsubscribeAll()}};window.addEventListener("pagehide",()=>u._cleanup());window.CommunityDB=u;function Tt(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var Ne={exports:{}},Qe;function Et(){return Qe||(Qe=1,(function(t,e){(function(){var o=Math.PI,i=Math.sin,n=Math.cos,r=Math.tan,a=Math.asin,s=Math.atan2,l=Math.acos,d=o/180,c=1e3*60*60*24,p=2440588,h=2451545;function m(y){return y.valueOf()/c-.5+p}function g(y){return new Date((y+.5-p)*c)}function f(y){return m(y)-h}var v=d*23.4397;function S(y,b){return s(i(y)*n(v)-r(b)*i(v),n(y))}function L(y,b){return a(i(b)*n(v)+n(b)*i(v)*i(y))}function _(y,b,w){return s(i(y),n(y)*i(b)-r(w)*n(b))}function k(y,b,w){return a(i(b)*i(w)+n(b)*n(w)*n(y))}function R(y,b){return d*(280.16+360.9856235*y)-b}function O(y){return y<0&&(y=0),2967e-7/Math.tan(y+.00312536/(y+.08901179))}function T(y){return d*(357.5291+.98560028*y)}function z(y){var b=d*(1.9148*i(y)+.02*i(2*y)+3e-4*i(3*y)),w=d*102.9372;return y+b+w+o}function Y(y){var b=T(y),w=z(b);return{dec:L(w,0),ra:S(w,0)}}var B={};B.getPosition=function(y,b,w){var A=d*-w,I=d*b,j=f(y),P=Y(j),H=R(j,A)-P.ra;return{azimuth:_(H,I,P.dec),altitude:k(H,I,P.dec)}};var X=B.times=[[-.833,"sunrise","sunset"],[-.3,"sunriseEnd","sunsetStart"],[-6,"dawn","dusk"],[-12,"nauticalDawn","nauticalDusk"],[-18,"nightEnd","night"],[6,"goldenHourEnd","goldenHour"]];B.addTime=function(y,b,w){X.push([y,b,w])};var G=9e-4;function Q(y,b){return Math.round(y-G-b/(2*o))}function E(y,b,w){return G+(y+b)/(2*o)+w}function M(y,b,w){return h+y+.0053*i(b)-.0069*i(2*w)}function K(y,b,w){return l((i(y)-i(b)*i(w))/(n(b)*n(w)))}function J(y){return-2.076*Math.sqrt(y)/60}function de(y,b,w,A,I,j,P){var H=K(y,w,A),Z=E(H,b,I);return M(Z,j,P)}B.getTimes=function(y,b,w,A){A=A||0;var I=d*-w,j=d*b,P=J(A),H=f(y),Z=Q(H,I),ae=E(0,I,Z),pe=T(ae),fe=z(pe),Ce=L(fe,0),me=M(ae,pe,fe),ve,Se,he,se,be,Me,re={solarNoon:g(me),nadir:g(me-.5)};for(ve=0,Se=X.length;ve<Se;ve+=1)he=X[ve],se=(he[0]+P)*d,be=de(se,I,j,Ce,Z,pe,fe),Me=me-(be-me),re[he[1]]=g(Me),re[he[2]]=g(be);return re};function ce(y){var b=d*(218.316+13.176396*y),w=d*(134.963+13.064993*y),A=d*(93.272+13.22935*y),I=b+d*6.289*i(w),j=d*5.128*i(A),P=385001-20905*n(w);return{ra:S(I,j),dec:L(I,j),dist:P}}B.getMoonPosition=function(y,b,w){var A=d*-w,I=d*b,j=f(y),P=ce(j),H=R(j,A)-P.ra,Z=k(H,I,P.dec),ae=s(i(H),r(I)*n(P.dec)-i(P.dec)*n(H));return Z=Z+O(Z),{azimuth:_(H,I,P.dec),altitude:Z,distance:P.dist,parallacticAngle:ae}},B.getMoonIllumination=function(y){var b=f(y||new Date),w=Y(b),A=ce(b),I=149598e3,j=l(i(w.dec)*i(A.dec)+n(w.dec)*n(A.dec)*n(w.ra-A.ra)),P=s(I*i(j),A.dist-I*n(j)),H=s(n(w.dec)*i(w.ra-A.ra),i(w.dec)*n(A.dec)-n(w.dec)*i(A.dec)*n(w.ra-A.ra));return{fraction:(1+n(P))/2,phase:.5+.5*P*(H<0?-1:1)/Math.PI,angle:H}};function ue(y,b){return new Date(y.valueOf()+b*c/24)}B.getMoonTimes=function(y,b,w,A){var I=new Date(y);A?I.setUTCHours(0,0,0,0):I.setHours(0,0,0,0);for(var j=.133*d,P=B.getMoonPosition(I,b,w).altitude-j,H,Z,ae,pe,fe,Ce,me,ve,Se,he,se,be,Me,re=1;re<=24&&(H=B.getMoonPosition(ue(I,re),b,w).altitude-j,Z=B.getMoonPosition(ue(I,re+1),b,w).altitude-j,fe=(P+Z)/2-H,Ce=(Z-P)/2,me=-Ce/(2*fe),ve=(fe*me+Ce)*me+H,Se=Ce*Ce-4*fe*H,he=0,Se>=0&&(Me=Math.sqrt(Se)/(Math.abs(fe)*2),se=me-Me,be=me+Me,Math.abs(se)<=1&&he++,Math.abs(be)<=1&&he++,se<-1&&(se=be)),he===1?P<0?ae=re+se:pe=re+se:he===2&&(ae=re+(ve<0?be:se),pe=re+(ve<0?se:be)),!(ae&&pe));re+=2)P=Z;var Le={};return ae&&(Le.rise=ue(I,ae)),pe&&(Le.set=ue(I,pe)),!ae&&!pe&&(Le[ve>0?"alwaysUp":"alwaysDown"]=!0),Le},t.exports=B})()})(Ne)),Ne.exports}var $t=Et();const Re=Tt($t),x={state:{currentUser:{id:null,name:"Loading...",avatar:"?",emoji:"",avatar_url:null,bio:"",status:"online",role:"Member",karma:0,xp:0,badges:[],minutes:0,circles:0,offered:0,birthday:null,country:null,email:"",is_admin:!1},currentRoom:null,currentActivity:"✨ Available",presenceCount:0,presenceInterval:null,pulseSent:!1,timerRunning:!1,timeLeft:1200,currentView:"hubView",initialized:!1},config:{ROOM_MODULES:["SilentRoom","CampfireRoom","GuidedRoom","BreathworkRoom","OshoRoom","DeepWorkRoom","TarotRoom","ReikiRoom"],STATUS_RINGS:{silent:"#60a5fa",available:"#34d399",guiding:"#fbbf24",deep:"#a78bfa",resonant:"#f472b6",offline:"#d1d5db"},AVATAR_GRADIENTS:["linear-gradient(135deg, #667eea 0%, #764ba2 100%)","linear-gradient(135deg, #f093fb 0%, #f5576c 100%)","linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)","linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)","linear-gradient(135deg, #fa709a 0%, #fee140 100%)"],ADMIN_MODULES:["CollectiveField","LunarEngine","SolarEngine","UpcomingEvents","AdminDashboard"],RENDER_DELAY:100,CELESTIAL_INIT_DELAY:500,CELESTIAL_POLL_MAX:25,PRESENCE_INTERVAL:3e4,HEARTBEAT_INTERVAL:6e4,PULSE_COOLDOWN:6e4},async init(){var t,e;if(this.state.initialized){console.warn("[Core] Already initialized");return}try{if(!await u.init())throw new Error("Database not ready - is the user logged in?");if(await this.loadCurrentUser(),!this.state.currentUser.avatar_url){const i=(e=(t=window.app)==null?void 0:t.state)==null?void 0:e.currentUser,n=(i==null?void 0:i.avatarUrl)||(i==null?void 0:i.avatar_url)||null;n&&(this.state.currentUser.avatar_url=n)}if(await u.setPresence(this.state.currentUser.status||"online",this.state.currentUser.activity||"✨ Available",null),u.startHeartbeat(this.config.HEARTBEAT_INTERVAL),window.addEventListener("pagehide",()=>{u.setOffline(),u.unsubscribeAll()}),this.setupEventListeners(),this.initializeSafetyModals(),this.initializeModules(),this.initializePracticeRooms(),this.scheduleRoomRendering(),this.scheduleCelestialInit(),this.updatePresenceCount(),setTimeout(()=>this._injectAdminUIAll(),1e3),this.state.initialized=!0,window._pendingHubScrollTarget){const i=window._pendingHubScrollTarget;window._pendingHubScrollTarget=null,(()=>{let a=0,s=0,l=0;const d=setInterval(()=>{if(a++,document.body.classList.contains("ritual-active")){s=0,l=0;return}const c=document.getElementById(i),p=c?c.offsetHeight:0;if(p>10&&(p===s?l++:l=0,s=p),(l>=3||a>=60)&&p>0){clearInterval(d);const m=document.getElementById("mobile-bottom-bar"),g=m?m.offsetHeight+16:16;requestAnimationFrame(()=>{const f=c.getBoundingClientRect().top+window.scrollY-g;window.scrollTo({top:f,behavior:"smooth"})})}else a>=60&&clearInterval(d)},100)})()}}catch(o){console.error("❌ [Core] Initialization failed:",o),this.handleInitializationError(o)}},async loadCurrentUser(){var t,e,o,i,n,r,a,s,l;try{const d=await u.getMyProfile();if(!d){console.warn("[Core] No profile found for current user");return}const p=new Set(["online","available","away","guiding","silent","deep","offline"]).has(d.community_status)?d.community_status:"online";this.state.currentUser={id:d.id,name:d.name||"Anonymous",avatar:(d.name||"A").charAt(0).toUpperCase(),emoji:d.emoji||"",avatar_url:d.avatar_url||null,bio:d.inspiration||"Here to practice with intention.",status:p,community_status:p,role:d.is_admin?"Admin":d.community_role||"Member",community_role:d.community_role||"Member",minutes:d.total_minutes||0,circles:d.total_sessions||0,offered:d.gifts_given||0,birthday:d.birthday||null,country:d.country||null,email:d.email||"",is_admin:!!d.is_admin,karma:((o=(e=(t=window.app)==null?void 0:t.gamification)==null?void 0:e.state)==null?void 0:o.karma)??0,xp:((r=(n=(i=window.app)==null?void 0:i.gamification)==null?void 0:n.state)==null?void 0:r.xp)??0,badges:((l=(s=(a=window.app)==null?void 0:a.gamification)==null?void 0:s.state)==null?void 0:l.badges)??[]}}catch(d){console.error("[Core] loadCurrentUser failed:",d)}},initializeModules(){var e;const t=[{name:"Rituals",instance:window.Rituals},{name:"ProfileModule",instance:window.ProfileModule},{name:"CommunityModule",instance:window.CommunityModule}];for(const{name:o,instance:i}of t)if(i!=null&&i.init)try{i.init()}catch(n){console.error(`✗ [Core] ${o} init failed:`,n)}else console.warn(`⚠ [Core] ${o} not found or missing init()`);(e=window.ActiveMembers)!=null&&e.render?window.ActiveMembers.render().catch(o=>console.error("✗ [Core] ActiveMembers.render() failed:",o)):console.warn("⚠ [Core] ActiveMembers not found")},_injectAdminUIAll(){for(const t of this.config.ADMIN_MODULES){const e=window[t];if(e!=null&&e.injectAdminUI)try{e.injectAdminUI()}catch(o){console.warn(`[Core] injectAdminUI failed on ${t}:`,o)}}},handleInitializationError(t){this.showToast("Failed to initialize. Please refresh the page."),console.error("[Core] Init error details:",{message:t.message,stack:t.stack,state:this.state})},initializePracticeRooms(){const t=[];for(const e of this.config.ROOM_MODULES){const o=window[e];if(!o){console.warn(`⚠ [Core] ${e} not found on window`);continue}if(!o.init){console.warn(`⚠ [Core] ${e} missing init()`);continue}try{o.init(),t.push(o)}catch(i){console.error(`✗ [Core] ${e} init failed:`,i)}}window.PracticeRoom&&t.length&&PracticeRoom.startHubPresence(t)},scheduleRoomRendering(){setTimeout(()=>{try{this.renderRooms()}catch(t){console.error("[Core] Room rendering failed:",t)}},this.config.RENDER_DELAY)},renderRooms(){const t=document.getElementById("roomsGrid");if(!t){console.warn("[Core] #roomsGrid not found - skipping render");return}const e=this.config.ROOM_MODULES.reduce((o,i)=>{const n=window[i];if(!(n!=null&&n.getRoomCardHTML))return console.warn(`⚠ [Core] ${i} missing getRoomCardHTML()`),o;try{const r=n.getRoomCardHTML();r&&o.push(r)}catch(r){console.error(`✗ [Core] getRoomCardHTML failed for ${i}:`,r)}return o},[]);e.length?t.innerHTML=e.join(""):console.warn("[Core] No room cards to render")},scheduleCelestialInit(){setTimeout(()=>{try{this.initializeCelestialSystems()}catch(t){console.error("[Core] Celestial init failed:",t)}},this.config.CELESTIAL_INIT_DELAY)},initializeCelestialSystems(){for(const[t,e]of[["LunarEngine",window.LunarEngine],["SolarEngine",window.SolarEngine]])if(e!=null&&e.init)try{e.init()}catch(o){console.error(`✗ [Core] ${t} init failed:`,o)}else console.warn(`⚠ [Core] ${t} not found`)},navigateTo(t){var e,o;try{const i=document.getElementById("communityHubFullscreenContainer"),n=document.getElementById("community-hub-tab");t==="hubView"?(i&&(i.style.display="none"),n&&(n.style.display="block"),document.body.style.overflow="",document.querySelectorAll("#hubView").forEach(r=>r.classList.add("active")),this.state.currentView="hubView"):t==="practiceRoomView"?(i&&(i.style.display="flex",(e=i.querySelector("#openingOverlay"))==null||e.classList.remove("active"),(o=i.querySelector("#closingOverlay"))==null||o.classList.remove("active")),n?n.style.display="none":console.error("[Core] Hub tab element not found"),document.body.style.overflow="hidden",this.state.currentView="practiceRoomView"):console.warn(`[Core] Unknown viewId: "${t}"`)}catch(i){console.error("[Core] Navigation error:",i)}},setupEventListeners(){document.addEventListener("click",t=>{t.target.classList.contains("modal-overlay")&&t.target.classList.remove("active")}),document.addEventListener("keydown",t=>{var e;t.key==="Escape"&&((e=document.querySelector(".modal-overlay.active"))==null||e.classList.remove("active"))})},async updatePresenceCount(){this.state.presenceInterval&&clearInterval(this.state.presenceInterval);const t=async()=>{try{if(!u.ready)return;const e=await u.getActiveMembers();this.state.presenceCount=e.length;const o=document.getElementById("presenceCount");o&&(o.textContent=e.length)}catch(e){console.error("[Core] updatePresenceCount error:",e)}};await t(),this.state.presenceInterval=setInterval(t,this.config.PRESENCE_INTERVAL)},sendPulse(){if(this.state.pulseSent){this.showToast("Please wait before sending another pulse");return}this.state.pulseSent=!0,this.showToast("Pulse sent to the community"),setTimeout(()=>{this.state.pulseSent=!1},this.config.PULSE_COOLDOWN)},showToast(t,e=3e3){const o=document.getElementById("toast");if(!o){console.warn("[Core] #toast element not found");return}o.textContent=t,o.classList.add("show"),setTimeout(()=>o.classList.remove("show"),e)},initializeSafetyModals(){document.getElementById("reportModal")||document.body.insertAdjacentHTML("beforeend",`
            <!-- Report Modal -->
        ...
        `)},formatTime(t){if(typeof t!="number"||t<0)return"0:00";const e=Math.floor(t/60),o=Math.floor(t%60);return`${e}:${o.toString().padStart(2,"0")}`},getAvatarGradient(t){(!t||typeof t!="string")&&(t="default");const e=t.split("").reduce((o,i)=>o+i.charCodeAt(0),0);return this.config.AVATAR_GRADIENTS[Math.abs(e)%this.config.AVATAR_GRADIENTS.length]}};window.Core=x;const Oe={user:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',aries:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20V10c0-3.31-2.69-6-6-6"/><path d="M12 20V10c0-3.31 2.69-6 6-6"/><circle cx="6" cy="4" r="2"/><circle cx="18" cy="4" r="2"/></svg>',taurus:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="14" r="7"/><path d="M5 9C5 6 7 3 12 3s7 3 7 6"/><path d="M9 9H4"/><path d="M20 9h-5"/></svg>',gemini:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="4" x2="8" y2="20"/><line x1="16" y1="4" x2="16" y2="20"/><line x1="8" y1="4" x2="16" y2="4"/><line x1="8" y1="20" x2="16" y2="20"/><line x1="8" y1="12" x2="16" y2="12"/></svg>',cancer:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="12" r="4"/><circle cx="16" cy="12" r="4"/><path d="M4 8c0-2 1-4 4-4"/><path d="M20 16c0 2-1 4-4 4"/></svg>',leo:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="4"/><path d="M12 8h4a4 4 0 0 1 0 8h-1"/><path d="M15 16v4"/></svg>',virgo:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="4" x2="6" y2="16"/><line x1="12" y1="4" x2="12" y2="16"/><path d="M6 12c0 2.5 2 4 6 4s6-1.5 6-4V8a6 6 0 0 0-12 0"/><path d="M15 16v4"/><path d="M17 16l1.5 4"/></svg>',libra:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="20" x2="21" y2="20"/><line x1="12" y1="4" x2="12" y2="16"/><path d="M6 16a6 6 0 0 0 12 0"/></svg>',scorpio:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="4" x2="6" y2="16"/><line x1="12" y1="4" x2="12" y2="16"/><line x1="18" y1="4" x2="18" y2="12"/><path d="M6 12c0 2.5 2 4 6 4s6-1.5 6-4"/><polyline points="15 9 18 12 21 9"/></svg>',sagittarius:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="19" x2="19" y2="5"/><polyline points="12 5 19 5 19 12"/><line x1="5" y1="19" x2="12" y2="12"/></svg>',capricorn:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 20V8a4 4 0 0 1 8 0v4a4 4 0 0 0 4 4h0"/><path d="M18 16l2 2-2 2"/></svg>',aquarius:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 10c2-2 4 0 6 0s4-2 6 0 4 0 6 0"/><path d="M3 16c2-2 4 0 6 0s4-2 6 0 4 0 6 0"/></svg>',pisces:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="4" x2="12" y2="20"/><path d="M4 8c2 2 4 4 8 4s6-2 8-4"/><path d="M4 16c2-2 4-4 8-4s6 2 8 4"/></svg>',meditation:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="5" r="2"/><path d="M12 7v5l-3 3"/><path d="M12 12l3 3"/><path d="M6 17c0-2 2-4 6-4s6 2 6 4"/></svg>',moon:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>',sun:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>',star:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',crystal:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8l4 4-4 4-4-4z"/></svg>',butterfly:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22V12"/><path d="M12 12C12 12 8 9 4 10c-3 1-3 5 0 6 2 1 5 0 8-4z"/><path d="M12 12C12 12 16 9 20 10c3 1 3 5 0 6-2 1-5 0-8-4z"/><circle cx="12" cy="5" r="2"/></svg>',leaf:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 22c1.25-1.25 2.5-2.5 3.75-3.75"/><path d="M22 2C11 2 2 11 2 22c5.5 0 11-2.5 14.5-6S22 7.5 22 2z"/></svg>',flower:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 2a4 4 0 0 1 0 8 4 4 0 0 1 0-8z"/><path d="M12 14a4 4 0 0 1 0 8 4 4 0 0 1 0-8z"/><path d="M2 12a4 4 0 0 1 8 0 4 4 0 0 1-8 0z"/><path d="M14 12a4 4 0 0 1 8 0 4 4 0 0 1-8 0z"/></svg>',om:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 12a4 4 0 0 0 8 0"/><circle cx="12" cy="8" r="1"/></svg>',clover:'<svg xmlns="http://www.w3.org/2000/svg" class="lucide-avatar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 12c-2-2.5-4-3-6-2s-3 4-1 6 5 2 7-4z"/><path d="M12 12c2-2.5 4-3 6-2s3 4 1 6-5 2-7-4z"/><path d="M12 12c-2.5-2-3-4-2-6s4-3 6-1-2 5-4 7z"/><path d="M12 12c2.5-2 3-4 2-6s-4-3-6-1 2 5 4 7z"/><line x1="12" y1="12" x2="12" y2="22"/></svg>'},et={"👤":"user","♈️":"aries","♉️":"taurus","♊️":"gemini","♋️":"cancer","♌️":"leo","♍️":"virgo","♎️":"libra","♏️":"scorpio","♐️":"sagittarius","♑️":"capricorn","♒️":"aquarius","♓️":"pisces","🧘‍♀️":"meditation","🌙":"moon","☀️":"sun","🌟":"star","🔮":"crystal","🦋":"butterfly","🌿":"leaf","🌸":"flower","🕉️":"om","🍀":"clover"};function At(t){return Oe[t]||Oe[t in et?et[t]:"user"]||Oe.user}const Rt=["🏅","🎖️","🌟","👑","🧪","🕉️","🦸","🌱","🎪","🌙","☀️","⚡","🌊","💜","🔱","🔥","💎","🦋","🌸","🍀","🌈","⭐","🎯","🏆","🎗️","🌀","🔮","💫","🧘","🦅","🐉","🌺","🎵","💡","🌿","🦁","🐬","🌍","🎭","🛡️","⚔️","🗝️","🧬","🌠","🎋"],Bt={state:{isOpen:!1,currentUserId:null,isAppreciated:!1,appreciationCount:0},_LEVEL_TITLES:{1:"Seeker",2:"Practitioner",3:"Adept",4:"Healer",5:"Master",6:"Sage",7:"Enlightened",8:"Buddha",9:"Light",10:"Emptiness"},_STATUS_RINGS:{online:{c:"var(--ring-available,#6b9b37)",s:"rgba(107,155,55,0.2)"},available:{c:"var(--ring-available,#6b9b37)",s:"rgba(107,155,55,0.2)"},away:{c:"var(--ring-guiding,#e53e3e)",s:"rgba(229,62,62,0.2)"},silent:{c:"var(--ring-silent,#7c3aed)",s:"rgba(124,58,237,0.2)"},deep:{c:"var(--ring-deep,#1e40af)",s:"rgba(30,64,175,0.2)"},offline:{c:"var(--ring-offline,#9ca3af)",s:"rgba(156,163,175,0.2)"}},_RARITY_COLORS:{common:"#9ca3af",uncommon:"#10b981",rare:"#3b82f6",epic:"#a855f7",legendary:"#f59e0b"},_RARITY_LABELS:{common:"Common",uncommon:"Uncommon",rare:"Rare",epic:"Epic",legendary:"Legendary"},_COUNTRY_CODES:{israel:"IL","united states":"US",usa:"US",us:"US","united kingdom":"GB",uk:"GB",canada:"CA",australia:"AU",germany:"DE",france:"FR",spain:"ES",italy:"IT",netherlands:"NL",belgium:"BE",switzerland:"CH",sweden:"SE",norway:"NO",denmark:"DK",finland:"FI",poland:"PL",portugal:"PT",austria:"AT",india:"IN",china:"CN",japan:"JP","south korea":"KR",brazil:"BR",mexico:"MX",argentina:"AR","south africa":"ZA",russia:"RU",ukraine:"UA",greece:"GR",turkey:"TR",egypt:"EG","new zealand":"NZ",ireland:"IE",singapore:"SG",thailand:"TH",indonesia:"ID",malaysia:"MY",philippines:"PH"},_ADMIN_SUB_IDS:["adminSubRole","adminSubXp","adminSubKarma","adminSubBadge","adminSubPremium","adminSubMessage","adminSubCustomBadge"],_buildEmojiPicker(t,e){return`
            <div id="${e}" style="display:none;margin-top:6px;padding:8px;border-radius:10px;
                ...
                ${Rt.map(o=>`<button type="button" onclick="MemberProfileModal._pickEmoji('${t}','${e}','${o}')"
                             ...
                             onmouseout="this.style.background='none'">${o}</button>`).join("")}
            </div>`},_pickEmoji(t,e,o){const i=document.getElementById(t);i&&(i.value=o);const n=document.getElementById(e);n&&(n.style.display="none")},_toggleEmojiPicker(t){const e=document.getElementById(t);e&&(e.style.display=e.style.display==="none"?"flex":"none")},init(){if(document.getElementById("memberProfileModal"))return;window.addEventListener("statusChanged",i=>{var l;const{status:n}=i.detail||{};if(!n||!this.state.isOpen||!(this.state.currentUserId===((l=window.Core.state.currentUser)==null?void 0:l.id)))return;const a=document.getElementById("memberModalStatusRing");if(!a)return;const s=this._STATUS_RINGS[n]||this._STATUS_RINGS.offline;a.style.borderColor=s.c,a.style.boxShadow=`0 0 0 3px ${s.s}`}),window.addEventListener("avatarChanged",i=>{const{userId:n,emoji:r,avatarUrl:a}=i.detail||{};if(!n||!this.state.isOpen||this.state.currentUserId!==n)return;const s=document.getElementById("memberModalAvatar");s&&(a?(s.style.background="transparent",s.innerHTML=`<img src="${a}" loading="lazy" decoding="async" width="80" height="80"
                    style="width:100%;height:100%;object-fit:cover;border-radius:50%;" alt="avatar">`):r&&(s.style.background="",s.innerHTML=`<span>${At(r)}</span>`))});const e=(window.BADGE_REGISTRY||[]).map(i=>`<option value="${i.id}" data-icon="${i.icon}" data-rarity="${i.rarity}" data-xp="${i.xp}" data-desc="${i.desc}">${i.icon} ${i.name}</option>`).join(""),o=document.createElement("div");o.innerHTML=`
                        ...
                        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-bottom:1rem;">
                            ${[["memberModalKarma",'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M6 3h12l4 6-10 13L2 9Z"/><path d="M11 3 8 9l4 13 4-13-3-6"/><path d="M2 9h20"/></svg>',"Karma"],["memberModalBlessings",'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M12 3L13.5 8.5L19 10L13.5 11.5L12 17L10.5 11.5L5 10L10.5 8.5Z"/><path d="M5 3L5.75 5.25L8 6L5.75 6.75L5 9L4.25 6.75L2 6L4.25 5.25Z"/><path d="M19 14L19.75 16.25L22 17L19.75 17.75L19 20L18.25 17.75L16 17L18.25 16.25Z"/></svg>',"Blessings"],["memberModalFavRoom",'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',"Fav Room"],["memberModalBadgeCount",'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>',"Badges"]].map(([i,n,r])=>`
                                <div style="background:var(--neuro-bg,#f0f0f3);border-radius:14px;
                                    ...
                                    <div id="${i}" style="font-size:1rem;font-weight:800;
                        ...
                        <div id="memberModalAdminSection" style="display:none;margin-top:1rem;">
                            ...
                            <div id="memberModalAdminBody" style="display:none;margin-top:10px;">
                                <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px;">
                                    ${[["role","👤 Change Role"],["xp","⭐ Send XP"],["karma","🌀 Send Karma"],["badge","🎖️ Send Badge"],["customBadge","✨ Custom Badge"],["premium","🔓 Unlock Premium"],["message","📩 Send Message"]].map(([i,n])=>`<button onclick="MemberProfileModal._openAdminSub('${i}')"
                                ...
                                <div id="adminSubPremium" style="display:none;" class="admin-sub-panel">
                                    <div style="display:flex;flex-direction:column;gap:6px;margin-bottom:10px;
                                        ...
                                        ${[["advance_tarot_spreads","Advanced Tarot Spreads"],["tarot_vision_ai","Tarot Vision AI"],["shadow_alchemy_lab","Shadow Alchemy Lab"],["advanced_meditations","Advanced Meditations"],["luxury_blush_champagne_skin","Blush Champagne Skin"],["luxury_champagne_gold_skin","Champagne Gold Skin"],["luxury_marble_bronze_skin","Marble Bronze Skin"],["royal_indigo_skin","Royal Indigo Skin"],["earth_luxury_skin","Earth Luxury Skin"]].map(([i,n])=>`<label style="display:flex;align-items:center;gap:8px;font-size:0.83rem;cursor:pointer;">
                                                <input type="checkbox" value="${i}"> ${n}
                                            </label>`).join("")}
                                    </div>
            ...
            </div><!-- /modal -->`,document.body.appendChild(o.firstElementChild),document.getElementById("memberProfileModal").addEventListener("click",i=>{i.target.id==="memberProfileModal"&&this.close()}),document.addEventListener("keydown",i=>{i.key==="Escape"&&this.state.isOpen&&this.close()})},_adminSubFooter(t,e){return`<div style="display:flex;gap:8px;">
            ...
            <button onclick="MemberProfileModal._closeAdminSubs()"
                    style="padding:8px 14px;border-radius:10px;border:none;cursor:pointer;
                           font-size:0.88rem;background:var(--neuro-shadow-light,rgba(0,0,0,0.06));
                           color:var(--neuro-text);">Cancel</button>
        </div>`},async open(t){var a,s;if(this.init(),!t)return;const e=t===((a=window.Core.state.currentUser)==null?void 0:a.id);this.state.currentUserId=t,this.state.isOpen=!0;const o=document.getElementById("memberProfileModal"),i=document.getElementById("memberProfileModalInner"),n=document.getElementById("memberModalLoading"),r=document.getElementById("memberModalContent");this._hideActionPanels(),n.style.display="block",r.style.display="none",o.style.display="flex",requestAnimationFrame(()=>{o.style.opacity="1",i.style.transform="translateY(0)"}),document.body.style.overflow="hidden";try{const l=await u.getProfile(t);if(!l){window.Core.showToast("Could not load member profile"),this.close();return}if(this._populate(l),!e){const m=u.subscribeToPresence(g=>{const f=g.find(L=>L.user_id===t);if(!f||!this.state.isOpen)return;const v=document.getElementById("memberModalStatusRing");if(!v)return;const S=this._STATUS_RINGS[f.status]||this._STATUS_RINGS.offline;v.style.borderColor=S.c,v.style.boxShadow=`0 0 0 3px ${S.s}`});this._presenceUnsub=()=>{try{m==null||m.unsubscribe()}catch{}}}const d=document.getElementById("memberModalActions"),c=document.getElementById("memberModalAppreciateBtn");d&&(d.style.display=e?"none":"flex"),c&&(c.style.display=e?"none":"block");const p=document.getElementById("memberModalAdminSection"),h=(s=window.Core.state.currentUser)==null?void 0:s.is_admin;if(p){if(p.style.display=h?"block":"none",h&&l.community_role){const v=document.getElementById("adminRoleSelect");v&&(v.value=l.community_role)}const m=document.getElementById("memberModalAdminBody"),g=document.getElementById("memberModalAdminToggle");m&&(m.style.display="none"),g&&(g.textContent="▶"),this._closeAdminSubs();const f=document.querySelector(`button[onclick*="_openAdminSub('role')"]`);f&&(f.style.display=e?"none":"inline-block")}e||(this.state.isAppreciated=!1,this.state.appreciationCount=0,this._updateAppreciateBtn(),Promise.all([u.getMyUserAppreciations(),u.getUserAppreciationCount(t)]).then(([m,g])=>{this.state.isAppreciated=m.has(t),this.state.appreciationCount=g,this._updateAppreciateBtn()}).catch(()=>{})),u.getUserProgress(t).then(m=>{m&&this._populateGamification(m)}).catch(()=>{}),this._loadMemberCommunityStats(t).catch(()=>{}),n.style.display="none",r.style.display="block"}catch(l){console.error("[MemberProfileModal] open error:",l),window.Core.showToast("Could not load member profile"),this.close()}},close(){const t=document.getElementById("memberProfileModal"),e=document.getElementById("memberProfileModalInner");t&&(t.style.opacity="0",e.style.transform="translateY(16px)",setTimeout(()=>{t.style.display="none",this.state.isOpen=!1,this.state.currentUserId=null,document.body.style.overflow="",this._hideActionPanels(),this._presenceUnsub&&(this._presenceUnsub(),this._presenceUnsub=null)},250))},_populate(t){const e=document.getElementById("memberModalAvatar");e&&(t.avatar_url?(e.style.background="transparent",e.innerHTML=`<img src="${t.avatar_url}" loading="lazy" decoding="async" width="80" height="80"
                    style="width:100%;height:100%;object-fit:cover;border-radius:50%;"
                    alt="${this._esc(t.name)}">`):(e.style.background=window.Core.getAvatarGradient(t.id),e.innerHTML=`<span>${this._esc(t.emoji||(t.name||"?").charAt(0).toUpperCase())}</span>`));const o=document.getElementById("memberModalStatusRing");if(o){const r=this._STATUS_RINGS[t.community_status]||this._STATUS_RINGS.offline;o.style.borderColor=r.c,o.style.boxShadow=`0 0 0 3px ${r.s}`}this._setText("memberModalName",t.name||"Member"),this._setHTML("memberModalRole",`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> ${t.community_role||"Member"}`),this._setText("memberModalInspiration",t.inspiration?`"${t.inspiration}"`:"");const i=document.getElementById("memberModalLocation"),n=document.getElementById("memberModalMetaSep");if(i){const r=[];if(t.birthday)try{const a=new Date(t.birthday+"T00:00:00");r.push(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M20 21v-8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8"/><path d="M4 16s.5-1 2-1 2.5 2 4 2 2.5-2 4-2 2 1 2 1"/><path d="M2 21h20"/><path d="M7 8v3"/><path d="M12 8v3"/><path d="M17 8v3"/><path d="M7 4h.01"/><path d="M12 4h.01"/><path d="M17 4h.01"/></svg> ${a.toLocaleDateString(void 0,{month:"long",day:"numeric"})}`)}catch{r.push(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M20 21v-8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8"/><path d="M4 16s.5-1 2-1 2.5 2 4 2 2.5-2 4-2 2 1 2 1"/><path d="M2 21h20"/><path d="M7 8v3"/><path d="M12 8v3"/><path d="M17 8v3"/><path d="M7 4h.01"/><path d="M12 4h.01"/><path d="M17 4h.01"/></svg> ${t.birthday}`)}t.country&&r.push(`${this._countryFlag(t.country)} ${t.country}`),r.length?(i.innerHTML=r.map((a,s)=>`${s>0?'<span style="width:1px;height:16px;background:rgba(0,0,0,0.1);flex-shrink:0;display:inline-block;"></span>':""}
                     <span style="font-size:0.76rem;font-weight:600;color:var(--text-muted);padding:5px 12px;white-space:nowrap;">${a}</span>`).join(""),n&&(n.style.display="")):(i.innerHTML="",n&&(n.style.display="none"))}},_populateGamification(t){const e=this._LEVEL_TITLES[t.level]||"Seeker",o=e.match(/^[aeiou]/i)?"An":"A",i=document.getElementById("memberModalLevel");i&&(i.textContent=`${o} ${e} - Level ${t.level}`);const n=document.getElementById("memberModalXpBar");if(n){const r=[0,800,2e3,4200,7e3,12e3,3e4,6e4,18e4,45e4],a=r[t.level-1]||0,s=r[t.level]||r[r.length-1],l=s>a?Math.min(100,Math.round((t.xp-a)/(s-a)*100)):100;requestAnimationFrame(()=>{n.style.width=l+"%"})}this._setText("memberModalXP",(t.xp??0).toLocaleString()),this._setText("memberModalKarma",(t.karma??0).toLocaleString()),this._setText("memberModalBadgeCount",(t.badges||[]).length)},async _loadMemberCommunityStats(t){if(!u.ready)return;const e=u._sb;try{const[o,i]=await Promise.all([e.from("room_blessings").select("*",{count:"exact",head:!0}).eq("user_id",t),e.from("room_entries").select("room_id").eq("user_id",t)]);this._setText("memberModalBlessings",!o.error&&o.count!=null?o.count.toLocaleString():"0");const n=i.data;if(!i.error&&(n!=null&&n.length)){const r={};for(const s of n)r[s.room_id]=(r[s.room_id]||0)+1;const a=Object.entries(r).sort((s,l)=>l[1]-s[1])[0][0];this._setText("memberModalFavRoom",a.replace(/-/g," ").replace(/\b\w/g,s=>s.toUpperCase()))}else this._setText("memberModalFavRoom","-")}catch(o){console.warn("[MemberProfileModal] _loadMemberCommunityStats:",o)}},async toggleAppreciate(){const t=document.getElementById("memberModalAppreciateBtn");if(!(!t||!this.state.currentUserId)){t.disabled=!0;try{const e=await u.toggleUserAppreciation(this.state.currentUserId,this.state.isAppreciated);if(!e){window.Core.showToast("Could not update - please try again");return}this.state.isAppreciated=e.appreciated,this.state.appreciationCount=await u.getUserAppreciationCount(this.state.currentUserId),this._updateAppreciateBtn(),window.Core.showToast(e.appreciated?"Appreciation sent":"Appreciation removed")}catch(e){console.error("[MemberProfileModal] toggleAppreciate error:",e),window.Core.showToast("Could not update - please try again")}finally{t.disabled=!1}}},_updateAppreciateBtn(){const t=document.getElementById("memberModalAppreciateBtn");if(!t)return;const e=this.state.appreciationCount??"",o=e!==""?` (${e})`:"";this.state.isAppreciated?(t.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M12 3L13.5 8.5L19 10L13.5 11.5L12 17L10.5 11.5L5 10L10.5 8.5Z"/><path d="M5 3L5.75 5.25L8 6L5.75 6.75L5 9L4.25 6.75L2 6L4.25 5.25Z"/><path d="M19 14L19.75 16.25L22 17L19.75 17.75L19 20L18.25 17.75L16 17L18.25 16.25Z"/></svg> Appreciated${o}`,t.style.background="var(--primary,#667eea)",t.style.color="#fff",t.style.boxShadow="inset 2px 2px 5px rgba(0,0,0,0.15)"):(t.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M12 3L13.5 8.5L19 10L13.5 11.5L12 17L10.5 11.5L5 10L10.5 8.5Z"/><path d="M5 3L5.75 5.25L8 6L5.75 6.75L5 9L4.25 6.75L2 6L4.25 5.25Z"/><path d="M19 14L19.75 16.25L22 17L19.75 17.75L19 20L18.25 17.75L16 17L18.25 16.25Z"/></svg> Appreciate${o}`,t.style.background="var(--neuro-bg,#f0f0f3)",t.style.color="var(--neuro-text)",t.style.boxShadow="3px 3px 8px rgba(0,0,0,0.1),-2px -2px 6px rgba(255,255,255,0.7)")},startWhisper(){var e;this._hideActionPanels();const t=document.getElementById("memberModalWhisperPanel");t&&(t.style.display="block",(e=document.getElementById("memberModalWhisperText"))==null||e.focus())},cancelWhisper(){const t=document.getElementById("memberModalWhisperPanel");if(!t)return;t.style.display="none";const e=document.getElementById("memberModalWhisperText");e&&(e.value="")},async sendWhisper(){const t=document.getElementById("memberModalWhisperText"),e=t==null?void 0:t.value.trim();if(!e){window.Core.showToast("Please write a message first");return}await this._withBtnState("#memberModalWhisperPanel button","Sending...","Send",async()=>{await u.sendWhisper(this.state.currentUserId,e)?(window.Core.showToast("Whisper sent"),this.cancelWhisper()):window.Core.showToast("Could not send - please try again")})},startReport(){this._hideActionPanels();const t=document.getElementById("memberModalReportPanel");t&&(t.style.display="block")},cancelReport(){const t=document.getElementById("memberModalReportPanel");if(!t)return;t.style.display="none";const e=document.getElementById("memberModalReportReason"),o=document.getElementById("memberModalReportDetails");e&&(e.value=""),o&&(o.value="")},async submitReport(){var o,i;const t=(o=document.getElementById("memberModalReportReason"))==null?void 0:o.value,e=((i=document.getElementById("memberModalReportDetails"))==null?void 0:i.value.trim())||"";if(!t){window.Core.showToast("Please select a reason");return}await this._withBtnState("#memberModalReportPanel button","Submitting...","Submit Report",async()=>{await u.submitReport(this.state.currentUserId,t,e)?(window.Core.showToast("Report submitted - thank you"),this.cancelReport()):window.Core.showToast("Could not submit - please try again")})},async startBlock(){var e,o;const t=((e=document.getElementById("memberModalName"))==null?void 0:e.textContent)||"this member";if(confirm(`Block ${t}? Their content will be hidden from you.`))try{await u.blockUser(this.state.currentUserId)?(window.Core.showToast(`${t} blocked`),this.close(),(o=window.ActiveMembers)==null||o.refresh()):window.Core.showToast("Could not block - please try again")}catch(i){console.error("[MemberProfileModal] blockUser error:",i),window.Core.showToast("Could not block - please try again")}},_toggleAdminPanel(){const t=document.getElementById("memberModalAdminBody"),e=document.getElementById("memberModalAdminToggle");if(!t)return;const o=t.style.display!=="none";t.style.display=o?"none":"block",e.textContent=o?"▶":"▼",o&&this._closeAdminSubs()},_openAdminSub(t){this._closeAdminSubs();const e=t.charAt(0).toUpperCase()+t.slice(1),o=document.getElementById(`adminSub${e}`);o&&(o.style.display="block")},_closeAdminSubs(){for(const t of this._ADMIN_SUB_IDS){const e=document.getElementById(t);e&&(e.style.display="none")}},async _adminChangeRole(){var e;const t=(e=document.getElementById("adminRoleSelect"))==null?void 0:e.value;!t||!this.state.currentUserId||await this._withBtnState("#adminSubRole button","Saving...","Save Role",async()=>{const o={community_role:t};o.is_vip=t==="VIP",o.is_admin=t==="Admin";const{error:i}=await u._sb.rpc("admin_update_profile",{target_user_id:this.state.currentUserId,new_role:o.community_role,new_is_vip:o.is_vip,new_is_admin:o.is_admin});if(i)throw i;this._setHTML("memberModalRole",`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> ${t}`),await this._adminPushNotify(this.state.currentUserId,"👤 Role Updated",`Your community role has been changed to ${t}.`),window.Core.showToast(`Role changed to ${t}`),this._closeAdminSubs(),await this._safeRefresh(this.state.currentUserId)})},async _adminSendXP(){var e;const t=parseInt((e=document.getElementById("adminXpAmount"))==null?void 0:e.value,10);if(!t||t<1){window.Core.showToast("Enter a valid XP amount");return}await this._withBtnState("#adminSubXp button","Sending...","Send XP",async()=>{if(!await u.adminUpdateGamification(this.state.currentUserId,{xpDelta:t}))throw new Error("Save failed");await this._adminPushNotify(this.state.currentUserId,"🎁 Gift from Aanandoham!",`You received +${t} XP!`),window.Core.showToast(`Sent ${t} XP`),this._closeAdminSubs(),await this._safeRefresh(this.state.currentUserId)})},async _adminSendKarma(){var e;const t=parseInt((e=document.getElementById("adminKarmaAmount"))==null?void 0:e.value,10);if(!t||t<1){window.Core.showToast("Enter a valid Karma amount");return}await this._withBtnState("#adminSubKarma button","Sending...","Send Karma",async()=>{if(!await u.adminUpdateGamification(this.state.currentUserId,{karmaDelta:t}))throw new Error("Save failed");await this._adminPushNotify(this.state.currentUserId,"🎁 Gift from Aanandoham!",`You received +${t} Karma!`),window.Core.showToast(`Sent ${t} Karma`),this._closeAdminSubs(),await this._safeRefresh(this.state.currentUserId)})},async _adminSendBadge(){const t=document.getElementById("adminBadgeSelect"),e=t==null?void 0:t.selectedOptions[0];if(!e)return;const i=(window.BADGE_REGISTRY||[]).find(r=>r.id===e.value)||{},n={id:e.value,name:i.name||e.textContent.replace(/^.+? /,"").trim(),icon:i.icon||e.dataset.icon||"🏅",rarity:i.rarity||e.dataset.rarity||"common",xp:i.xp??parseInt(e.dataset.xp,10)??0,description:i.desc||e.dataset.desc||""};await this._withBtnState("#adminSubBadge button","Awarding...","Award Badge",async()=>{if(!await u.adminUpdateGamification(this.state.currentUserId,{badgeId:n.id,badgeName:n.name,badgeIcon:n.icon,badgeRarity:n.rarity,badgeXp:n.xp,badgeDesc:n.description}))throw new Error("Save failed");await this._adminPushNotify(this.state.currentUserId,"🎖️ New Badge Earned!",`You received the ${n.name} badge!`),window.Core.showToast(`Awarded ${n.icon} ${n.name}`),this._closeAdminSubs(),await this._safeRefresh(this.state.currentUserId)})},async _adminSendCustomBadge(){var s,l,d,c,p,h;const t=((s=document.getElementById("adminCustomBadgeIcon"))==null?void 0:s.value.trim())||"🏅",e=(l=document.getElementById("adminCustomBadgeName"))==null?void 0:l.value.trim(),o=((d=document.getElementById("adminCustomBadgeDesc"))==null?void 0:d.value.trim())||"",i=((c=document.getElementById("adminCustomBadgeRarity"))==null?void 0:c.value)||"epic",n=parseInt((p=document.getElementById("adminCustomBadgeXp"))==null?void 0:p.value,10)||0,r=parseInt((h=document.getElementById("adminCustomBadgeKarma"))==null?void 0:h.value,10)||0;if(!e){window.Core.showToast("Please enter a badge name");return}const a="custom_"+e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,"")+"_"+Date.now();await this._withBtnState("#adminSubCustomBadge button","Awarding...","Award Custom Badge",async()=>{if(!await u.adminUpdateGamification(this.state.currentUserId,{badgeId:a,badgeName:e,badgeIcon:t,badgeRarity:i,badgeXp:n,badgeDesc:o}))throw new Error("Save failed");r>0&&await u.adminUpdateGamification(this.state.currentUserId,{karmaDelta:r}),await this._adminPushNotify(this.state.currentUserId,"🎖️ Special Badge Earned!",`You received the ${e} badge!`),window.Core.showToast(`Awarded custom badge: ${t} ${e}`),this._closeAdminSubs(),await this._safeRefresh(this.state.currentUserId)})},async _adminUnlockPremium(){const t=[...document.querySelectorAll("#adminSubPremium input[type=checkbox]:checked")].map(e=>e.value);if(!t.length){window.Core.showToast("Select at least one feature");return}await this._withBtnState("#adminSubPremium button","Unlocking...","Unlock Selected",async()=>{let e=0;const o=[];for(const n of t)await u.adminUpdateGamification(this.state.currentUserId,{unlockFeature:n})?e++:o.push(n);if(o.length&&console.warn("[AdminPanel] Failed to unlock:",o),!e)throw new Error("All unlocks failed");const i=t.map(n=>n.replace(/_/g," ").replace(/\b\w/g,r=>r.toUpperCase())).join(", ");await this._adminPushNotify(this.state.currentUserId,"🔓 New Features Unlocked!",`Admin unlocked: ${i}`),window.Core.showToast(`Unlocked ${e}/${t.length} feature(s)${o.length?` (${o.length} failed)`:""}`),this._closeAdminSubs(),await this._safeRefresh(this.state.currentUserId)})},async _adminSendMessage(){var o,i;const t=(o=document.getElementById("adminMessageTitle"))==null?void 0:o.value.trim(),e=(i=document.getElementById("adminMessageContent"))==null?void 0:i.value.trim();if(!t){window.Core.showToast("Please enter a message title");return}if(!e){window.Core.showToast("Please enter a message");return}await this._withBtnState("#adminSubMessage button","Sending...","Send Message",async()=>{const{data:n}=await u._sb.from("user_progress").select("payload").eq("user_id",this.state.currentUserId).single(),r=(n==null?void 0:n.payload)||{},a=r.adminMessages||[];a.push({id:Date.now()+Math.random(),title:t,content:e,date:new Date().toISOString(),read:!1});const{error:s}=await u._sb.from("user_progress").update({payload:{...r,adminMessages:a},updated_at:new Date().toISOString()}).eq("user_id",this.state.currentUserId);if(s)throw s;const l=e.length>80?e.slice(0,80)+"...":e;await this._adminPushNotify(this.state.currentUserId,`💬 ${t}`,l),window.Core.showToast("Message sent"),this._closeAdminSubs(),document.getElementById("adminMessageTitle").value="",document.getElementById("adminMessageContent").value=""})},async _safeRefresh(t){var i,n,r,a,s,l,d,c,p;const e=(i=window.Core.state.currentUser)==null?void 0:i.id;if(t===e){const h=(n=window.app)==null?void 0:n.gamification;h!=null&&h.saveTimeout&&(clearTimeout(h.saveTimeout),h.saveTimeout=null),(a=(r=window.DB)==null?void 0:r.clearCache)==null||a.call(r),(d=(l=(s=window.app)==null?void 0:s.state)==null?void 0:l.clearCache)==null||d.call(l);try{const m=await u.getUserProgress(t);m&&(h!=null&&h.state)&&(m.xp!==void 0&&(h.state.xp=m.xp),m.karma!==void 0&&(h.state.karma=m.karma),m.level!==void 0&&(h.state.level=m.level),Array.isArray(m.badges)&&(h.state.badges=m.badges),Array.isArray(m.unlockedFeatures)&&(h.state.unlockedFeatures=m.unlockedFeatures)),m&&((p=(c=window.app)==null?void 0:c.state)!=null&&p.data)&&(m.xp!==void 0&&(window.app.state.data.xp=m.xp),m.karma!==void 0&&(window.app.state.data.karma=m.karma),m.level!==void 0&&(window.app.state.data.level=m.level),Array.isArray(m.badges)&&(window.app.state.data.badges=m.badges),Array.isArray(m.unlockedFeatures)&&(window.app.state.data.unlockedFeatures=m.unlockedFeatures))}catch(m){console.warn("[_safeRefresh] pre-patch failed:",m)}}await this._refreshMainProfileStats(t)},async _refreshMainProfileStats(t){var e,o,i,n,r,a;try{const s=(e=window.Core.state.currentUser)==null?void 0:e.id;if(!s)return;const l=t||s,d=await u.getUserProgress(l);if(!d)return;if(l===s){d.xp!==void 0&&(window.Core.state.currentUser.xp=d.xp),d.karma!==void 0&&(window.Core.state.currentUser.karma=d.karma),d.level!==void 0&&(window.Core.state.currentUser.level=d.level),await((n=(i=(o=window.app)==null?void 0:o.gamification)==null?void 0:i.reloadFromDatabase)==null?void 0:n.call(i));const c=document.getElementById("profileGamificationXP");c&&d.xp!==void 0&&(c.textContent=d.xp.toLocaleString()),(a=(r=window.ProfileModule)==null?void 0:r.refreshGamification)==null||a.call(r)}this._populateGamification(d)}catch(s){console.warn("[AdminPanel] _refreshMainProfileStats:",s)}},async _adminPushNotify(t,e,o){try{const i=await fetch("/api/send",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({userId:t,payload:{title:e,body:o,icon:"/icons/icon-192x192.png",data:{url:"/"}}})});i.ok||console.warn(`[MemberProfileModal] push notify non-200: ${i.status}`)}catch(i){console.warn("[MemberProfileModal] push notify unavailable:",i.message)}},_hideActionPanels(){["memberModalWhisperPanel","memberModalReportPanel"].forEach(i=>{const n=document.getElementById(i);n&&(n.style.display="none")});const t=document.getElementById("memberModalWhisperText");t&&(t.value="");const e=document.getElementById("memberModalReportReason"),o=document.getElementById("memberModalReportDetails");e&&(e.value=""),o&&(o.value=""),this._closeAdminSubs()},_setText(t,e){const o=document.getElementById(t);o&&(o.textContent=e)},_setHTML(t,e){const o=document.getElementById(t);o&&(o.innerHTML=e)},async _withBtnState(t,e,o,i){const n=document.querySelector(t);n&&(n.disabled=!0,n.textContent=e);try{await i()}catch(r){console.error(`[AdminPanel] ${o} error:`,r),window.Core.showToast(`Could not complete: ${o}`)}finally{n&&(n.disabled=!1,n.textContent=o)}},_countryFlag(t){const e=this._COUNTRY_CODES[t.toLowerCase().trim()];return e?[...e].map(o=>String.fromCodePoint(127462+o.charCodeAt(0)-65)).join(""):"🌍"},_esc(t){if(!t||typeof t!="string")return"";const e=document.createElement("div");return e.textContent=t,e.innerHTML}};window.MemberProfileModal=Bt;const Lt={state:{isOpen:!1,view:"inbox",threadPartnerId:null,threadPartnerName:null,realtimeSub:null,bgSub:null},init(){if(document.getElementById("whisperModal"))return;const t=document.createElement("div");t.innerHTML=`
            <div id="whisperModal"
            ...
            </div>`,document.body.appendChild(t.firstElementChild),document.getElementById("whisperModal").addEventListener("click",o=>{o.target.id==="whisperModal"&&this.close()}),document.addEventListener("keydown",o=>{o.key==="Escape"&&this.state.isOpen&&this.close()});const e=()=>{u!=null&&u.ready?this.startBackgroundListener():setTimeout(e,500)};e()},async open(){this._openShared(),await this._showInbox()},async openThread(t,e,o,i){this._openShared(),await this._showThread(t,e,o,i)},_openShared(){this.init(),this._animateIn(),this.state.isOpen=!0,document.body.style.overflow="hidden",this._subscribeRealtime()},close(){const t=document.getElementById("whisperModal"),e=document.getElementById("whisperModalInner");t&&(t.style.opacity="0",e.style.transform="translateY(20px)",setTimeout(()=>{var o,i;t.style.display="none",this.state.isOpen=!1,this.state.view="inbox",this.state.threadPartnerId=null,document.body.style.overflow="",(i=(o=this.state.realtimeSub)==null?void 0:o.unsubscribe)==null||i.call(o),this.state.realtimeSub=null},250))},_animateIn(){const t=document.getElementById("whisperModal"),e=document.getElementById("whisperModalInner");t.style.display="flex",requestAnimationFrame(()=>{t.style.opacity="1",e.style.transform="translateY(0)"})},_setView(t){const e=t==="inbox";document.getElementById("whisperInboxView").style.display=e?"block":"none",document.getElementById("whisperThreadView").style.display=e?"none":"flex",document.getElementById("whisperReplyBar").style.display=e?"none":"block",document.getElementById("whisperBackBtn").style.display=e?"none":"inline-flex";const o=document.getElementById("whisperModalSubtitle");e&&(document.getElementById("whisperModalTitle").textContent="Whispers",o.style.display="none")},async _showInbox(){this.state.view="inbox",this.state.threadPartnerId=null,this._setView("inbox");const t=document.getElementById("whisperInboxLoading"),e=document.getElementById("whisperInboxEmpty"),o=document.getElementById("whisperInboxList");t.style.display="block",e.style.display="none",o.innerHTML="";const i=await u.getWhisperInbox();if(t.style.display="none",!i.length){e.style.display="block";return}o.innerHTML=i.map(n=>this._conversationRowHTML(n)).join(""),this._setBadge(i.reduce((n,r)=>n+r.unread,0))},_conversationRowHTML(t){const e=t.partner||{},o=this._escape(e.name||"Member"),i=this._avatarHTML(e,44),n=this._escape(t.lastMessage||""),r=this._relativeTime(t.lastAt),a=this._escape(e.id||""),s=this._escape(e.emoji||""),l=this._escape(e.avatar_url||""),d=t.unread>0;return`
            <div data-partner-id="${a}"
                 onclick="WhisperModal._showThread('${a}','${o}','${s}','${l}')"
            ...
            </div>`},async _showThread(t,e,o,i){var d;this.state.view="thread",this.state.threadPartnerId=t,this.state.threadPartnerName=e,this._setView("thread"),document.getElementById("whisperModalTitle").textContent=e;const n=document.getElementById("whisperModalSubtitle");n.textContent="Private whisper thread",n.style.display="block";const r=document.getElementById("whisperThreadLoading"),a=document.getElementById("whisperThreadMessages"),s=document.getElementById("whisperThreadView");r.style.display="block",a.innerHTML="";const[l]=await Promise.all([u.getWhispers(t),u.markConversationRead(t)]);r.style.display="none",this._renderThreadMessages(l),setTimeout(()=>{s.scrollTop=s.scrollHeight},50),(d=document.getElementById("whisperReplyText"))==null||d.focus(),await this.refreshUnreadBadge()},_renderThreadMessages(t){const e=document.getElementById("whisperThreadMessages");if(!e)return;if(!t.length){e.innerHTML=`
                <div style="text-align:center;padding:3rem;
                            color:var(--text-muted);font-size:0.85rem;">
                    No messages yet — say something ✨
                </div>`;return}const o=u._uid;e.innerHTML=t.map(i=>{var r;const n=i.sender_id===o||((r=i.sender)==null?void 0:r.id)===o;return this._messageBubbleHTML(n,this._escape(i.message),this._relativeTime(i.created_at))}).join("")},_appendMessage(t){var n,r;const e=document.getElementById("whisperThreadMessages");if(!e)return;(n=e.querySelector("[data-empty]"))==null||n.remove();const o=t.sender_id===u._uid,i=document.createElement("div");i.innerHTML=this._messageBubbleHTML(o,this._escape(t.message),this._relativeTime(t.created_at)),e.appendChild(i.firstElementChild),(r=document.getElementById("whisperThreadView"))==null||r.scrollTo({top:999999})},_messageBubbleHTML(t,e,o){return`
                    ...
                    <div class="profile-avatar-section">
                        ...
                        <div style="position:relative;">
                            ...
                            <div id="statusPickerDropdown"
                                ...
                                ${t.map(i=>`
                                <button onclick="ProfileModule.setStatus('${i.status}','${i.label}','${i.color}')"
                    ...
                    <div class="profile-info">
                        ...
                        <div class="private-details" id="privateDetails">
                            <div id="myActivityGrid"
                                ...
                                ${e.map(i=>`
                                <div class="activity-card" onclick="ProfileModule.openActivityModal('${i.type}')" style="${o}">
                                    <div style="font-size:1.6rem;margin-bottom:6px;">${i.icon}</div>
                                    <div style="font-weight:700;font-size:0.88rem;color:var(--neuro-text);">${i.label}</div>
                                    <div id="activityCount_${i.type}"
                                         style="font-size:0.75rem;color:var(--text-muted);margin-top:2px;">- ${i.count}</div>
                                </div>`).join("")}
                            </div>
                        </div>
        ...
        <div class="profile-gamification-section"
            ...
            <div style="text-align:center;margin-bottom:0.75rem;">
                <div style="font-size:1.25rem;font-weight:700;color:var(--neuro-text);margin-bottom:0.5rem;">
                    <strong style="color:var(--neuro-accent);">${i.charAt(0).toUpperCase()+i.slice(1)} ${o.title}</strong>
                    - Level ${o.level}
                </div>
                <!-- XP progress bar -->
                ...
                <div style="font-size:0.82rem;color:var(--text-muted);">
                    ...
                    <span id="profileGamificationXPNext">${o.pointsToNext}</span> to next level
                </div>
            </div>
        ...
        <style>
            @keyframes profile-xp-shimmer {
                ...
                100% { transform: translateX(200%); }
        ...
        </style>`},animateGamificationBar(){requestAnimationFrame(()=>{const t=document.getElementById("profileGamificationXpBar");t&&(t.style.width=(t.dataset.width||0)+"%")})},refreshGamification(){const t=document.querySelector(".profile-gamification-section");if(!t)return;const e=document.createElement("div");e.innerHTML=this._getGamificationHTML(),t.replaceWith(e.firstElementChild),this.animateGamificationBar()},renderHTML(){const t=document.getElementById("profileHeroContainer");if(!t){console.warn("profileHeroContainer not found - skipping profile render");return}t.innerHTML=this.getHTML()},populateData(){const t=this._user();if(!t){console.warn("window.Core.state.currentUser not available");return}try{this.updateAvatar(t),this.updateName(t),this.updateKarma(t),this.updateBio(t),this.updateStatusRing(t.status),this.updateRole(t),this.updateBadges(),this.updateBirthday(t),this.updateCountry(t),this.updateProfileLocationRow(t),this.animateGamificationBar(),this.loadActivityData().catch(()=>{}),this.loadCommunityStats().catch(()=>{})}catch(e){console.error("Profile data population error:",e)}},updateAvatar(t){var r;const e=document.getElementById("profileAvatar"),o=document.getElementById("profileAvatarImg"),i=document.getElementById("profileAvatarFallback");if(!e)return;const n=t.avatar_url||t.avatarUrl;if(n&&o){o.src=n,o.style.display="block",i&&(i.style.display="none"),e.style.background="transparent";return}i&&(i.textContent=t.emoji||t.avatar||"?",i.style.display="block",o&&(o.style.display="none")),(r=window.Core)!=null&&r.getAvatarGradient&&(e.style.background=window.Core.getAvatarGradient(t.id||t.name||"default"))},updateName(t){const e=document.getElementById("profileName");e&&(e.textContent=t.name||t.displayName||"Member")},updateKarma(t){var d,c;const e=(c=(d=U())==null?void 0:d.getOwnGamificationState)==null?void 0:c.call(d),o=(e==null?void 0:e.karma)??t.karma??0,i=(e==null?void 0:e.xp)??t.xp??0,n=(e==null?void 0:e.level)??t.level??1,r=document.getElementById("profileGamificationXP"),a=document.getElementById("profileGamificationXPNext"),s=document.getElementById("profileGamificationXpBar");if(r&&(r.textContent=i.toLocaleString()),s){const p=[0,800,2e3,4200,7e3,12e3,3e4,6e4,18e4,45e4],h=p[n-1]||0,m=p[n]||p[p.length-1],g=m>h?Math.min(100,Math.round((i-h)/(m-h)*100)):100;s.dataset.width=g,s.style.width=g+"%",a&&(a.textContent=Math.max(0,m-i).toLocaleString())}const l=document.getElementById("statKarma");l&&(l.textContent=o.toLocaleString())},async loadCommunityStats(){var e,o,i,n;if(!((e=U())!=null&&e.ready))return;const t=(o=this._user())==null?void 0:o.id;if(t)try{const[{data:r,error:a},{data:s,error:l}]=await Promise.all([(i=U())==null?void 0:i._sb.from("profiles").select("gifts_given").eq("id",t).single(),(n=U())==null?void 0:n._sb.from("room_entries").select("room_id").eq("user_id",t)]),d=document.getElementById("statBlessings");if(d){const p=!a&&(r==null?void 0:r.gifts_given)!=null?r.gifts_given:0;d.textContent=p.toLocaleString()}const c=document.getElementById("statFavRoom");if(c)if(!l&&(s==null?void 0:s.length)>0){const p={};s.forEach(m=>{p[m.room_id]=(p[m.room_id]||0)+1});const h=Object.entries(p).sort((m,g)=>g[1]-m[1])[0][0];c.textContent=h.replace(/-/g," ").replace(/\b\w/g,m=>m.toUpperCase())}else c.textContent="-"}catch(r){console.warn("[ProfileModule] loadCommunityStats error:",r)}},updateBio(t){const e=document.getElementById("profileInspiration"),o=t.bio||t.inspiration;e&&o&&(e.textContent=`"${o}"`)},updateRole(t){const e=t.community_role||t.role||"Member",o=t.status||"available",i=document.getElementById("profileRoleBadge");i&&(i.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> ${e}`);const n=document.getElementById("privateRole");n&&(n.textContent=e);const r=document.getElementById("privateStatus");r&&(r.textContent=o.charAt(0).toUpperCase()+o.slice(1))},updateBirthday(t){const e=document.getElementById("privateBirthday");if(e)if(t.birthday)try{e.textContent=new Date(t.birthday+"T00:00:00").toLocaleDateString(void 0,{month:"long",day:"numeric",year:"numeric"})}catch{e.textContent=t.birthday}else e.textContent="-"},updateCountry(t){const e=document.getElementById("privateCountry");e&&(e.textContent=t.country||"-")},async updateProfileLocationRow(t){var s,l;let{birthday:e,country:o}=t;if(!e&&!o&&((s=U())!=null&&s.ready))try{const d=await((l=U())==null?void 0:l.getMyProfile());if(d){e=d.birthday,o=d.country;const c=this._user();c&&(c.birthday=e,c.country=o)}}catch{}const i=document.getElementById("profileBirthdayDisplay");if(i)if(e)try{const d=new Date(e+"T00:00:00").toLocaleDateString(void 0,{month:"long",day:"numeric"});i.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M20 21v-8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8"/><path d="M4 16s.5-1 2-1 2.5 2 4 2 2.5-2 4-2 2 1 2 1"/><path d="M2 21h20"/><path d="M7 8v3"/><path d="M12 8v3"/><path d="M17 8v3"/><path d="M7 4h.01"/><path d="M12 4h.01"/><path d="M17 4h.01"/></svg> ${d}`}catch{i.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M20 21v-8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8"/><path d="M4 16s.5-1 2-1 2.5 2 4 2 2.5-2 4-2 2 1 2 1"/><path d="M2 21h20"/><path d="M7 8v3"/><path d="M12 8v3"/><path d="M17 8v3"/><path d="M7 4h.01"/><path d="M12 4h.01"/><path d="M17 4h.01"/></svg> ${e}`}else i.textContent="";const n=document.getElementById("profileCountryDisplay");n&&(n.textContent=o?`${this._countryFlag(o)} ${o}`:"");const r=document.getElementById("profileCountrySep");r&&(r.style.display=o?"":"none");const a=document.querySelector("#profileMetaRow .profile-meta-sep");a&&(a.style.display=e||o?"":"none")},async loadActivityData(){var n,r,a,s,l,d,c,p,h,m,g,f,v,S,L,_,k,R,O,T,z,Y,B,X,G,Q,E,M,K,J,de,ce,ue;const t=(n=window.app)==null?void 0:n.gamification,e=((r=t==null?void 0:t.getStatusSummary)==null?void 0:r.call(t))??null,o=((l=(s=(a=window.app)==null?void 0:a.state)==null?void 0:s.getStats)==null?void 0:l.call(s))??null;if(e&&o){this._setActivityCount("journal",e.totalJournalEntries??0,"entries"),this._setActivityCount("gratitude",o.totalGratitudes??0,"entries"),this._setActivityCount("energy",o.totalEnergyEntries??((h=(p=(c=(d=window.app)==null?void 0:d.state)==null?void 0:c.data)==null?void 0:p.energyEntries)==null?void 0:h.length)??0,"check-ins"),this._setActivityCount("flip",o.totalFlipEntries??((v=(f=(g=(m=window.app)==null?void 0:m.state)==null?void 0:g.data)==null?void 0:f.flipEntries)==null?void 0:v.length)??0,"entries"),this._setActivityCount("tarot",e.totalTarotSpreads??0,"readings"),this._setActivityCount("meditation",e.totalMeditations??o.weeklyMeditations??((k=(_=(L=(S=window.app)==null?void 0:S.state)==null?void 0:L.data)==null?void 0:_.meditationEntries)==null?void 0:k.length)??0,"sessions"),this._activityData={_fromGamification:!0};return}if((O=(R=window.app)==null?void 0:R.state)!=null&&O.ready)try{await window.app.state.ready}catch{}const i=(z=(T=window.app)==null?void 0:T.state)==null?void 0:z.data;if(i){const y=(i.gratitudeEntries||[]).reduce((b,w)=>{var A;return b+(((A=w.entries)==null?void 0:A.length)||0)},0);this._setActivityCount("journal",((Y=i.journalEntries)==null?void 0:Y.length)??0,"entries"),this._setActivityCount("gratitude",y,"entries"),this._setActivityCount("energy",((B=i.energyEntries)==null?void 0:B.length)??0,"check-ins"),this._setActivityCount("flip",((X=i.flipEntries)==null?void 0:X.length)??0,"entries"),this._setActivityCount("tarot",((G=i.tarotReadings)==null?void 0:G.length)??0,"readings"),this._setActivityCount("meditation",((Q=i.meditationEntries)==null?void 0:Q.length)??0,"sessions"),this._activityData=i;return}try{if((E=U())!=null&&E.ready){const y=await((M=U())==null?void 0:M.getOwnFullProgress());if(y){const b=(y.gratitudeEntries||[]).reduce((w,A)=>{var I;return w+(((I=A.entries)==null?void 0:I.length)||0)},0);this._setActivityCount("journal",((K=y.journalEntries)==null?void 0:K.length)??0,"entries"),this._setActivityCount("gratitude",b,"entries"),this._setActivityCount("energy",((J=y.energyEntries)==null?void 0:J.length)??0,"check-ins"),this._setActivityCount("flip",((de=y.flipEntries)==null?void 0:de.length)??0,"entries"),this._setActivityCount("tarot",((ce=y.tarotReadings)==null?void 0:ce.length)??0,"readings"),this._setActivityCount("meditation",((ue=y.meditationEntries)==null?void 0:ue.length)??0,"sessions"),this._activityData=y}}}catch(y){console.warn("[ProfileModule] loadActivityData fallback failed:",y)}},_setActivityCount(t,e,o){const i=document.getElementById(`activityCount_${t}`);i&&(i.textContent=e>0?`${e} ${o}`:`No ${o} yet`)},async openActivityModal(t){var l;this._activityData||await this.loadActivityData();const o={journal:{title:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg> Journal Entries'},gratitude:{title:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="m12 13-1-1 2-2-3-3-2 2-1-1"/></svg> Gratitude Entries'},energy:{title:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/></svg> Energy Check-ins'},flip:{title:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg> Flip the Script'},tarot:{title:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><rect x="2" y="5" width="11" height="14" rx="2"/><path d="M15.5 5.5 18 3l4 4-5.5 5.5"/><path d="m13 13 4.5 4.5"/><path d="m17.5 17.5 1 1"/></svg> Tarot Spreads'},meditation:{title:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4"/><path d="M17.599 6.5a3 3 0 0 0 .399-1.375"/><path d="M6.003 5.125A3 3 0 0 0 6.401 6.5"/><path d="M3.477 10.896a4 4 0 0 1 .585-.396"/><path d="M19.938 10.5a4 4 0 0 1 .585.396"/><path d="M6 18a4 4 0 0 1-1.967-.516"/><path d="M19.967 17.484A4 4 0 0 1 18 18"/></svg> Meditation Sessions'}}[t],i=((l=this._activityData)==null?void 0:l[`${t}Entries`])||[],n=document.getElementById("activityModalTitle"),r=document.getElementById("activityModalBody");n&&(n.innerHTML=o.title),r&&(r.innerHTML=i.length?i.map(d=>this._renderActivityEntry(t,d)).join(""):'<div style="text-align:center;color:var(--text-muted);padding:2rem;">No entries yet</div>');const a=document.getElementById("activityModal"),s=document.getElementById("activityModalInner");a&&(a.style.display="flex",requestAnimationFrame(()=>{a.style.opacity="1",s.style.transform="translateY(0)"}),a.onclick=d=>{d.target===a&&this.closeActivityModal()},this._activityEscHandler=d=>{d.key==="Escape"&&this.closeActivityModal()},document.addEventListener("keydown",this._activityEscHandler))},closeActivityModal(){const t=document.getElementById("activityModal"),e=document.getElementById("activityModalInner");t&&(t.style.opacity="0",e.style.transform="translateY(16px)",setTimeout(()=>{t.style.display="none"},250),this._activityEscHandler&&(document.removeEventListener("keydown",this._activityEscHandler),this._activityEscHandler=null))},_renderActivityEntry(t,e){var n;const o=this._formatEntryDate(e.timestamp||e.date),i=`border-radius:12px;padding:12px 14px;margin-bottom:10px;
                      background:var(--surface,rgba(0,0,0,0.03));
                      border-left:3px solid var(--neuro-accent);
                      font-size:0.86rem;line-height:1.6;`;switch(t){case"journal":{const r=e.situation||e.feelings||"",a=e.mood?`<span style="margin-left:6px;opacity:0.7;">${e.mood}</span>`:"";return`<div style="${i}">
                    <div style="font-size:0.75rem;color:var(--text-muted);margin-bottom:4px;">${o}${a}</div>
                    <div style="color:var(--neuro-text);">${this._esc(r)}</div>
                </div>`}case"gratitude":{const r=e.entries||[];return`<div style="${i}">
                    <div style="font-size:0.75rem;color:var(--text-muted);margin-bottom:6px;">${o}</div>
                    ${r.map(a=>`<div style="margin-bottom:3px;display:flex;align-items:center;gap:0.3rem;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="m12 13-1-1 2-2-3-3-2 2-1-1"/></svg> ${this._esc(a)}</div>`).join("")}
                       ...
                       </div>`:"";return`<div style="${i}">
                    <div style="font-size:0.75rem;color:var(--text-muted);margin-bottom:4px;">${o}</div>
                    ...
                    ${s}${a}
                </div>`}case"flip":{const r=e.original||e.flipped_from||e.situation||e.text||e.content||"",a=e.flipped||e.reframe||"";return`<div style="${i}">
                    <div style="font-size:0.75rem;color:var(--text-muted);margin-bottom:4px;">${o}</div>
                ...
                </div>`}case"tarot":{const r=e.spreadType||e.spreadKey||"Spread",a=(e.cards||[]).slice(0,3);return`<div style="${i}">
                    <div style="font-size:0.75rem;color:var(--text-muted);margin-bottom:4px;">${o}</div>
                ...
                </div>`}case"meditation":{const r=e.title||e.category||"Session",a=e.duration?`${e.duration} min`:"",s=e.chakra?`· ${e.chakra} chakra`:"";return`<div style="${i}">
                    <div style="font-size:0.75rem;color:var(--text-muted);margin-bottom:4px;">${o}</div>
                ...
                </div>`}default:return""}},updateBadges(){var o,i,n;const t=((n=(i=(o=window.app)==null?void 0:o.gamification)==null?void 0:i.state)==null?void 0:n.badges)??[],e=document.getElementById("statBadges");e&&(e.textContent=t.length)},updateStatusRing(t){const e=this.config.STATUS_RING[t]||this.config.STATUS_RING.offline,o=document.getElementById("statusRing");o&&(o.style.borderColor=e.color,o.style.boxShadow=`0 0 0 4px ${e.color}33`);const i=document.getElementById("statusPickerDot"),n=document.getElementById("statusPickerLabel");i&&(i.style.background=e.color),n&&(n.textContent=e.label)},toggleStatusPicker(){const t=document.getElementById("statusPickerDropdown");if(!t)return;const e=t.style.display!=="none";if(t.style.display=e?"none":"block",!e){const o=i=>{var n;!((n=document.getElementById("statusPickerBtn"))!=null&&n.contains(i.target))&&!t.contains(i.target)&&(t.style.display="none",document.removeEventListener("click",o))};setTimeout(()=>document.addEventListener("click",o),0)}},async setStatus(t,e,o){var d,c,p,h,m;const i=document.getElementById("statusPickerDropdown");i&&(i.style.display="none");const n=(d=this._user())==null?void 0:d.id;n&&window.ActiveMembers&&window.ActiveMembers.updateMemberStatus(n,t);const r=this.config.STATUS_ACTIVITIES[t]||"✨ Available";this.updateStatusRing(t);const a=document.getElementById("statusPickerDot"),s=document.getElementById("statusPickerLabel");a&&(a.style.background=o),s&&(s.textContent=e);const l=this._user();l&&(l.status=t,l.community_status=t);try{const g=((p=(c=window.Core)==null?void 0:c.state)==null?void 0:p.currentRoom)||null;await Promise.all([(h=U())==null?void 0:h.setPresence(t,r,g),(m=U())==null?void 0:m.updateProfile({community_status:t})]),window.Core.showToast(`Status set to ${e}`)}catch(g){console.error("[ProfileModule] setStatus error:",g),window.Core.showToast("Could not update status - please try again")}window.dispatchEvent(new CustomEvent("statusChanged",{detail:{status:t}}))},updatePresenceCount(){var t,e;(e=(t=window.Core)==null?void 0:t.updatePresenceCount)==null||e.call(t)},toggleProfileView(t){var e;t!=="public"&&t!=="private"||(document.querySelectorAll(".v-btn").forEach(o=>{const i=o.textContent.trim()==="Public View",n=t==="public"&&i||t==="private"&&!i;o.classList.toggle("active",n),o.setAttribute("aria-pressed",String(n))}),(e=document.getElementById("privateDetails"))==null||e.classList.toggle("visible",t==="private"),this.state.currentView=t)},async sendPulse(){var o;const t=(o=window.Core)==null?void 0:o.state;if(!t){console.error("Core not available");return}if(t.pulseSent){window.Core.showToast("Already offered");return}const e=document.getElementById("pulseBtn");if(e)try{e.classList.add("sending"),setTimeout(async()=>{var r;e.classList.remove("sending"),e.classList.add("sent"),e.innerHTML='✓<span class="pulse-ripple"></span>',t.pulseSent=!0;const i=document.getElementById("pulseFill");i&&(i.style.width="50%"),window.Core.showToast("Calm offered to the community"),await((r=U())==null?void 0:r.setPresence("online","💗 Offering calm",t.currentRoom||null));const n=this._user();n&&(n.activity="💗 Offering calm")},this.config.PULSE_ANIMATION_DURATION)}catch(i){console.error("Error sending pulse:",i)}},editProfile(){let t=document.getElementById("_avatarFileInput");t||(t=document.createElement("input"),t.id="_avatarFileInput",t.type="file",t.accept="image/jpeg,image/png,image/webp,image/gif",t.style.display="none",document.body.appendChild(t),t.addEventListener("change",()=>{var o;const e=(o=t.files)==null?void 0:o[0];e&&this._uploadAvatar(e),t.value=""})),t.click()},async _uploadAvatar(t){var i;if(t.size>5*1024*1024){window.Core.showToast("Image too large - max 5MB");return}const e=new FileReader;e.onload=n=>{const r=document.getElementById("profileAvatarImg"),a=document.getElementById("profileAvatarFallback"),s=document.getElementById("profileAvatar");r&&(r.src=n.target.result,r.style.display="block"),a&&(a.style.display="none"),s&&(s.style.background="transparent")},e.readAsDataURL(t),window.Core.showToast("Uploading photo...");const o=await((i=U())==null?void 0:i.uploadAvatar(t));if(o){const n=this._user();n&&(n.avatar_url=o),window.Core.showToast("Profile photo updated")}else window.Core.showToast("Upload failed - please try again"),this.updateAvatar(this._user())},async editRole(){var r,a;const t=((r=this._user())==null?void 0:r.role)||"",e=prompt("Enter your community role (e.g. Meditator, Healer, Teacher):",t);if(e===null)return;const o=e.trim().substring(0,60);if(!await((a=U())==null?void 0:a.updateProfile({community_role:o||null}))){window.Core.showToast("Could not save - please try again");return}const n=this._user();n&&(n.community_role=o||"Member",n.role=o||"Member"),this.updateRole(this._user()),window.Core.showToast("Role updated")},async editInspiration(){var a;const t=document.getElementById("profileInspiration");if(!t)return;const e=t.textContent.replace(/"/g,"").trim(),o=prompt("Edit your inspiration message:",e);if(!(o!=null&&o.trim()))return;const i=o.trim().substring(0,this.config.MAX_INSPIRATION_LENGTH).replace(/<[^>]*>/g,"");if(!i)return;if(!await((a=U())==null?void 0:a.updateProfile({inspiration:i}))){window.Core.showToast("Could not save - please try again");return}t.textContent=`"${i}"`;const r=this._user();r&&(r.inspiration=i),window.Core.showToast("Inspiration updated")},async _createInlineEditor({fieldId:t,dbKey:e,currentValue:o,inputType:i,placeholder:n,maxLength:r,successToast:a,validate:s,onSave:l}){const d=document.getElementById(t),c=d==null?void 0:d.closest(".detail-row");if(!c||c.querySelector("input"))return;const p=c.querySelector(".edit-inline-btn");d&&(d.style.display="none"),p&&(p.style.display="none");const h=`flex:1;padding:4px 8px;border-radius:8px;
            ...
            background:rgba(0,0,0,0.06);color:var(--neuro-text);`,f=document.createElement("input");f.type=i,f.value=o,f.maxLength=r,f.placeholder=n,f.style.cssText=h;const v=document.createElement("button");v.textContent="✓",v.style.cssText=m;const S=document.createElement("button");S.textContent="✕",S.style.cssText=g;const L=()=>{f.remove(),v.remove(),S.remove(),d&&(d.style.display=""),p&&(p.style.display="")},_=async()=>{var O;const k=f.value.trim().substring(0,r);if(s){const T=s(k);if(T){window.Core.showToast(T);return}}if(v.disabled=!0,v.textContent="...",!await((O=U())==null?void 0:O.updateProfile({[e]:k||null}))){window.Core.showToast("Could not save - please try again"),v.disabled=!1,v.textContent="✓";return}L(),l(k||null),window.Core.showToast(a)};v.onclick=_,S.onclick=L,f.addEventListener("keydown",k=>{k.key==="Enter"&&_(),k.key==="Escape"&&L()}),c.appendChild(f),c.appendChild(v),c.appendChild(S),f.focus()},editBirthday(){var n;const t=document.getElementById("profileBirthdayDisplay");if(!t)return;const e=((n=this._user())==null?void 0:n.birthday)||"",o=document.createElement("input");o.type="date",o.value=e,o.style.cssText=`padding:3px 8px;border-radius:8px;border:1px solid rgba(0,0,0,0.15);
            font-size:0.8rem;background:var(--neuro-bg);color:var(--neuro-text);`;const i=async()=>{var l;const r=o.value.trim();if(r&&!/^\d{4}-\d{2}-\d{2}$/.test(r)){window.Core.showToast("Invalid date");return}if(!await((l=U())==null?void 0:l.updateProfile({birthday:r||null}))){window.Core.showToast("Could not save - please try again");return}const s=this._user();s&&(s.birthday=r),o.replaceWith(t),t.style.display="",this.updateBirthday(this._user()),this.updateProfileLocationRow(this._user()),window.Core.showToast("Birthday updated")};o.addEventListener("keydown",r=>{r.key==="Enter"&&i(),r.key==="Escape"&&(o.replaceWith(t),t.style.display="")}),o.addEventListener("blur",i),t.style.display="none",t.parentNode.insertBefore(o,t.nextSibling),o.focus()},editCountry(){var n;const t=document.getElementById("profileCountryDisplay");if(!t)return;const e=((n=this._user())==null?void 0:n.country)||"",o=document.createElement("input");o.type="text",o.value=e,o.placeholder="Your country",o.maxLength=60,o.style.cssText=`padding:3px 8px;border-radius:8px;border:1px solid rgba(0,0,0,0.15);
            font-size:0.8rem;background:var(--neuro-bg);color:var(--neuro-text);width:90px;`;const i=async()=>{var l;const r=o.value.trim();if(!await((l=U())==null?void 0:l.updateProfile({country:r||null}))){window.Core.showToast("Could not save - please try again");return}const s=this._user();s&&(s.country=r),o.replaceWith(t),t.style.display="",this.updateCountry(this._user()),this.updateProfileLocationRow(this._user()),window.Core.showToast("Country updated")};o.addEventListener("keydown",r=>{r.key==="Enter"&&i(),r.key==="Escape"&&(o.replaceWith(t),t.style.display="")}),o.addEventListener("blur",i),t.style.display="none",t.parentNode.insertBefore(o,t.nextSibling),o.focus()},setupCharCounter(){const t=document.getElementById("reflectionInput"),e=document.getElementById("charCount");t&&e&&t.addEventListener("input",()=>{e.textContent=t.value.length})},refresh(){this.populateData()}};window.ProfileModule=Dt;const zt={state:{isInitialized:!1,appreciatedReflections:new Set,reportingUserId:null},config:{MIN_REFLECTION_LENGTH:1,MAX_REFLECTION_LENGTH:500,MIN_REPORT_LENGTH:10,MIN_MODERATOR_MESSAGE_LENGTH:10,MIN_TECHNICAL_DESCRIPTION_LENGTH:10},async init(){if(!this.state.isInitialized)try{this.state.appreciatedReflections=await u.getMyAppreciations(),this.renderReflectionsHTML(),await this.renderReflections(),this.subscribeToNewReflections(),this._initWhisperBadge(),this.state.isInitialized=!0}catch(t){console.error("[CommunityModule] init failed:",t)}},_initWhisperBadge(){const t=()=>{var e;return(e=window.WhisperModal)==null?void 0:e.refreshUnreadBadge()};if(u!=null&&u.ready)t();else{const e=setInterval(()=>{u!=null&&u.ready&&(clearInterval(e),t())},300)}},renderReflectionsHTML(){const t=document.getElementById("communityReflectionsContainer");if(!t){console.warn("[CommunityModule] #communityReflectionsContainer not found");return}t.innerHTML=this._buildReflectionsShell(),this._setupCharCounter("reflectionInput","charCount")},_buildReflectionsShell(){var a,s;const t=((s=(a=window.Core)==null?void 0:a.state)==null?void 0:s.currentUser)||{},e=t.name||"You",o=t.avatar_url||"",i=window.Core.getAvatarGradient(t.id||"me"),n=o?`<img src="${o}" alt="${e}" width="40" height="40" style="width:100%;height:100%;object-fit:cover;border-radius:50%;" loading="lazy" decoding="async">`:t.emoji||e.charAt(0).toUpperCase();return`
        <section class="section">
            ...
            <div class="reflection" style="margin-bottom:16px;">
                <div class="ref-header">
                    <div class="ref-avatar" style="${o?"background:transparent;":`background:${i};`}cursor:pointer;"
        ...
        </section>`},async renderReflections(){const t=document.getElementById("reflectionsContainer");if(t){t.innerHTML='<div style="color:var(--text-muted);font-size:13px;padding:16px;text-align:center">Loading reflections...</div>';try{const[e,o]=await Promise.all([u.getReflections(20),u.getBlockedUsers()]),i=e.filter(n=>{var r;return!o.has((r=n.profiles)==null?void 0:r.id)});t.innerHTML=i.length?i.map(n=>this._buildReflectionHTML(n)).join(""):'<div style="color:var(--text-muted);font-size:13px;padding:16px;text-align:center">Be the first to share a reflection ✨</div>'}catch(e){console.error("[CommunityModule] renderReflections error:",e)}}},_buildReflectionHTML(t){var h,m,g,f,v,S;const e=t.profiles||{},o=e.name||"Community Member",i=e.avatar_url||"",n=window.Core.getAvatarGradient(e.id||t.id),r=this._timeAgo(t.created_at),a=e.id===((g=(m=(h=window.Core)==null?void 0:h.state)==null?void 0:m.currentUser)==null?void 0:g.id),s=(S=(v=(f=window.Core)==null?void 0:f.state)==null?void 0:v.currentUser)==null?void 0:S.is_admin,l=this.state.appreciatedReflections.has(t.id),d=i?`<img src="${i}" alt="${this._esc(o)}" width="40" height="40" loading="lazy" decoding="async">`:this._esc(e.emoji||o.charAt(0).toUpperCase()),c=i?"background:transparent;":`background:${n};`,p=a?`
            ...
            </div>`},subscribeToNewReflections(){if(!(u!=null&&u.ready)){const e=setInterval(()=>{u!=null&&u.ready&&(clearInterval(e),this.subscribeToNewReflections())},300);return}if(!u.subscribeToReflections(async e=>{var i,n,r,a,s;((i=e.profiles)==null?void 0:i.id)===((a=(r=(n=window.Core)==null?void 0:n.state)==null?void 0:r.currentUser)==null?void 0:a.id)||(await u.getBlockedUsers()).has((s=e.profiles)==null?void 0:s.id)||this._prependReflection(e)})){const e=setInterval(()=>{u!=null&&u.ready&&(clearInterval(e),this.subscribeToNewReflections())},300)}},_prependReflection(t){const e=document.getElementById("reflectionsContainer");if(!e)return;const o=document.createElement("div");o.innerHTML=this._buildReflectionHTML(t);const i=o.firstElementChild;i&&e.insertBefore(i,e.firstChild)},async shareReflection(){const t=document.getElementById("reflectionInput");if(!t)return;const e=t.value.trim();if(e.length<this.config.MIN_REFLECTION_LENGTH){window.Core.showToast("Please write something first");return}if(e.length>this.config.MAX_REFLECTION_LENGTH){window.Core.showToast(`Reflection too long (max ${this.config.MAX_REFLECTION_LENGTH} characters)`);return}try{const o=await u.postReflection(e);if(!o){window.Core.showToast("Could not share reflection - please try again");return}t.value="";const i=document.getElementById("charCount");i&&(i.textContent="0"),this._prependReflection(o),window.Core.showToast("Reflection shared with the community")}catch(o){console.error("[CommunityModule] shareReflection error:",o)}},async deleteReflection(t){var o;if(!confirm("Remove this reflection?"))return;await u.deleteReflection(t)?((o=document.querySelector(`[data-reflection-id="${t}"]`))==null||o.remove(),window.Core.showToast("Reflection removed")):window.Core.showToast("Could not remove reflection")},editReflection(t){const e=document.querySelector(`[data-reflection-id="${t}"]`),o=e==null?void 0:e.querySelector(".ref-content");if(!o)return;const i=o.textContent.trim();o.innerHTML=`
            ...
            >${this._esc(i)}</textarea>
            <div style="display:flex;justify-content:space-between;align-items:center;margin-top:6px;">
                <span style="font-size:11px;color:var(--text-muted)">
                    <span id="editCharCount_${t}">${i.length}</span>/500
                </span>
            ...
            </div>`;const n=document.getElementById(`editReflectionInput_${t}`);n&&(this._setupCharCounter(`editReflectionInput_${t}`,`editCharCount_${t}`),n.focus(),n.setSelectionRange(n.value.length,n.value.length))},cancelEditReflection(t){const e=document.querySelector(`[data-reflection-id="${t}"]`),o=e==null?void 0:e.querySelector(".ref-content");o&&u.getReflections(20).then(i=>{const n=i.find(r=>r.id===t);n&&(o.textContent=n.content)}).catch(()=>{})},async saveEditReflection(t){const e=document.getElementById(`editReflectionInput_${t}`);if(!e)return;const o=e.value.trim();if(!o){window.Core.showToast("Reflection cannot be empty");return}if(o.length>500){window.Core.showToast("Too long (max 500 characters)");return}if(e.disabled=!0,await u.updateReflection(t,o)){const n=document.querySelector(`[data-reflection-id="${t}"] .ref-content`);n&&(n.textContent=o),window.Core.showToast("Reflection updated")}else e.disabled=!1,window.Core.showToast("Could not update - please try again")},async appreciate(t,e){if(!(!t||!e))try{const o=this.state.appreciatedReflections.has(e),i=await u.toggleAppreciation(e,o);if(!i)return;this.state.appreciatedReflections[i.appreciated?"add":"delete"](e),t.classList.toggle("appreciated",i.appreciated);const n=await u.getReflectionCount(e),r=t.querySelector(".appreciation-count");r&&n!==null&&(r.textContent=`Appreciate (${n})`)}catch(o){console.error("[CommunityModule] appreciate error:",o)}},async whisper(t){if(t)try{const e=await u.getProfile(t);WhisperModal.openThread(t,(e==null?void 0:e.name)||"Member",(e==null?void 0:e.emoji)||"",(e==null?void 0:e.avatar_url)||"")}catch{WhisperModal.openThread(t,"Member","","")}},renderMembers(){},viewMember(t){t&&(window.MemberProfileModal?MemberProfileModal.open(t):window.Core.showToast("Member profiles loading..."))},renderWaves(){const t=document.getElementById("wavesContainer");if(!t)return;const e=[{id:1,title:"Evening Wind Down",time:"Tonight at 8:00 PM",participants:42,progress:67},{id:2,title:"Sunday Morning Stillness",time:"Tomorrow at 7:00 AM",participants:28,progress:45}];t.innerHTML=e.map(o=>`
            <div class="wave-card" data-wave-id="${o.id}">
                <div class="wave-header">
                    <div>
                        <div class="wave-title">${this._esc(o.title)}</div>
                        <div class="wave-meta">${this._esc(o.time)} • ${o.participants} joined</div>
                    </div>
                </div>
                <div class="prog-bar">
                    <div class="prog-fill" style="width:${Math.min(100,Math.max(0,o.progress))}%"></div>
                </div>
                <button type="button" class="contrib-btn" onclick="CommunityModule.contributeWave(${o.id})">
                    Contribute 20 Minutes
                </button>
            </div>`).join("")},contributeWave(){window.Core.showToast("Contribution recorded! Start your practice.")},showCrisisModal(){this.openModal("crisisModal")},closeCrisisModal(){this.closeModal("crisisModal")},showReportModal(t=null){this.state.reportingUserId=t,this.openModal("reportModal")},closeReportModal(){this.closeModal("reportModal"),this._clearFields(["reportReason","reportDetails"]),this.state.reportingUserId=null},async submitReport(){var i,n,r;const t=(i=document.getElementById("reportReason"))==null?void 0:i.value,e=((r=(n=document.getElementById("reportDetails"))==null?void 0:n.value)==null?void 0:r.trim())||"";if(!t){window.Core.showToast("Please select a reason");return}await u.submitReport(this.state.reportingUserId,t,e)?(window.Core.showToast("Report submitted. Thank you for keeping the space safe."),this.closeReportModal()):window.Core.showToast("Could not submit report - please try again")},showBlockModal(){this.openModal("blockModal")},closeBlockModal(){this.closeModal("blockModal"),this._clearFields(["blockUsername"])},async confirmBlock(){var i,n;const t=(n=(i=document.getElementById("blockUsername"))==null?void 0:i.value)==null?void 0:n.trim();if(!t){window.Core.showToast("Please enter a username");return}const e=await u.getUserByName(t);if(!e){window.Core.showToast("User not found");return}await u.blockUser(e.id)?(window.Core.showToast(`${e.name} has been blocked`),this.closeBlockModal(),await this.renderReflections()):window.Core.showToast("Could not block user - please try again")},hideMessagesFromUser(t){document.querySelectorAll(".chat-msg").forEach(e=>{var o;(o=e.querySelector("div"))!=null&&o.textContent.includes(t)&&(e.style.display="none")})},showHelpModal(){this.openModal("helpModal")},closeHelpModal(){this.closeModal("helpModal")},needHelp(){this.showHelpModal()},showModeratorModal(){this.closeHelpModal(),this.openModal("moderatorModal")},closeModeratorModal(){this.closeModal("moderatorModal"),this._clearFields(["moderatorMessage"]);const t=document.getElementById("moderatorUrgency");t&&(t.value="low")},contactModerator(){this.showModeratorModal()},submitModeratorRequest(){var e,o;const t=(o=(e=document.getElementById("moderatorMessage"))==null?void 0:e.value)==null?void 0:o.trim();if(!t||t.length<this.config.MIN_MODERATOR_MESSAGE_LENGTH){window.Core.showToast(`Please describe your situation (at least ${this.config.MIN_MODERATOR_MESSAGE_LENGTH} characters)`);return}window.Core.showToast("Request sent. A moderator will reach out shortly."),this.closeModeratorModal()},showTechnicalModal(){this.closeHelpModal(),this.openModal("technicalModal")},closeTechnicalModal(){this.closeModal("technicalModal"),this._clearFields(["technicalType","technicalDescription","technicalDevice"])},reportTechnicalIssue(){this.showTechnicalModal()},submitTechnicalIssue(){var o,i,n;const t=(o=document.getElementById("technicalType"))==null?void 0:o.value,e=(n=(i=document.getElementById("technicalDescription"))==null?void 0:i.value)==null?void 0:n.trim();if(!t){window.Core.showToast("Please select an issue type");return}if(!e||e.length<this.config.MIN_TECHNICAL_DESCRIPTION_LENGTH){window.Core.showToast(`Please provide more details (at least ${this.config.MIN_TECHNICAL_DESCRIPTION_LENGTH} characters)`);return}window.Core.showToast("Issue reported. Our tech team will investigate."),this.closeTechnicalModal()},showGuidelinesModal(){this.closeHelpModal(),this.openModal("guidelinesModal")},closeGuidelinesModal(){this.closeModal("guidelinesModal")},viewGuidelines(){this.showGuidelinesModal()},muteChat(){var o;const t=document.getElementById("psSidebar");if(!t)return;const e=t.classList.contains("muted");t.classList.toggle("muted"),window.Core.showToast(e?"Chat unmuted":"Chat muted"),!e&&t.classList.contains("open")&&(t.classList.remove("open"),(o=document.getElementById("fabChat"))==null||o.classList.remove("hidden"))},registerEvent(){window.Core.showToast("Registration confirmed! Check your email.")},openModal(t){const e=document.getElementById(t);e?e.classList.add("active"):console.warn(`[CommunityModule] Modal not found: ${t}`)},closeModal(t){var e;(e=document.getElementById(t))==null||e.classList.remove("active")},_setupCharCounter(t,e){const o=document.getElementById(t),i=document.getElementById(e);o&&i&&o.addEventListener("input",()=>{i.textContent=o.value.length})},_clearFields(t){t.forEach(e=>{const o=document.getElementById(e);o&&(o.value="")})},_timeAgo(t){if(!t)return"";const e=Date.now()-new Date(t).getTime(),o=Math.floor(e/6e4),i=Math.floor(e/36e5),n=Math.floor(e/864e5);return o<1?"Just now":o<60?`${o}m ago`:i<24?`${i}h ago`:`${n}d ago`},_esc(t){if(!t||typeof t!="string")return"";const e=document.createElement("div");return e.textContent=t,e.innerHTML}};window.CommunityModule=zt;const V={state:{modalsInjected:!1},init(){},injectModals(){const t=!!document.getElementById("reportModal");if(this.state.modalsInjected&&!t&&(this.state.modalsInjected=!1),!(this.state.modalsInjected||t))try{document.body.insertAdjacentHTML("beforeend",this.getAllModalsHTML()),this.state.modalsInjected=!0}catch(e){console.error("Failed to inject SafetyBar modals:",e)}},getAllModalsHTML(){return`
    ...
    <div class="modal-overlay" id="guidelinesModal" onclick="SafetyBar.handleOverlayClick(event,'guidelines')">
    ...
    </div>`},handleOverlayClick(t,e){t.target===t.currentTarget&&this.closeModal(e)},openModal(t){this.injectModals();const e=document.getElementById(`${t}Modal`);e?e.classList.add("active"):console.warn(`[SafetyBar] openModal: #${t}Modal not found`)},closeModal(t){var e;(e=document.getElementById(`${t}Modal`))==null||e.classList.remove("active")},_switchModal(t,e){this.closeModal(t),this.openModal(e)},async submitReport(){var o,i,n,r,a;const t=(o=document.getElementById("reportReason"))==null?void 0:o.value,e=(n=(i=document.getElementById("reportDetails"))==null?void 0:i.value)==null?void 0:n.trim();if(!t){window.Core.showToast("Please select a reason");return}(a=(r=window.Community)==null?void 0:r.submitReport)==null||a.call(r);try{await this._writeAdminNotification("report",{reason:t,details:e,room:this._getCurrentRoom()}),await this._pushAdmins("⚠️ New Report",`${this._senderName()} reported: ${t}${e?" - "+e.substring(0,60):""}`)}catch(s){console.error("submitReport admin notify error:",s)}},confirmBlock(){var t;typeof((t=window.Community)==null?void 0:t.confirmBlock)=="function"?window.Community.confirmBlock():console.error("Community.confirmBlock not available")},toggleHelpMePanel(){const t=document.getElementById("helpMePanel");t&&(t.style.display=t.style.display==="none"?"block":"none")},async submitHelpMe(){var o,i;const t=(i=(o=document.getElementById("helpMeText"))==null?void 0:o.value)==null?void 0:i.trim();if(!t){window.Core.showToast("Please write a short message");return}const e=document.querySelector("#helpMePanel button");e&&(e.disabled=!0,e.textContent="Sending...");try{await this._writeAdminNotification("help",{message:t,room:this._getCurrentRoom()}),await this._pushAdmins("🆘 Help Request",`${this._senderName()} needs help: "${t.substring(0,80)}"`),window.Core.showToast("Your message was sent to the admin"),document.getElementById("helpMeText").value="",document.getElementById("helpMePanel").style.display="none",this.closeModal("help")}catch(n){console.error("submitHelpMe error:",n),window.Core.showToast("Could not send - please try again")}finally{e&&(e.disabled=!1,e.textContent="Send to Admin")}},async submitModeratorRequest(){var o,i,n;const t=(o=document.getElementById("moderatorUrgency"))==null?void 0:o.value,e=(n=(i=document.getElementById("moderatorMessage"))==null?void 0:i.value)==null?void 0:n.trim();try{await this._writeAdminNotification("moderator",{urgency:t,message:e,room:this._getCurrentRoom()}),await this._pushAdmins("👥 Moderator Request",`${this._senderName()} [${t}]: ${e?e.substring(0,80):"-"}`),window.Core.showToast("Moderator contacted"),this.closeModal("moderator")}catch(r){console.error("submitModeratorRequest error:",r),window.Core.showToast("Could not send - please try again")}},async submitTechnicalIssue(){var i,n,r,a,s,l,d;const t=(i=document.getElementById("technicalType"))==null?void 0:i.value,e=(r=(n=document.getElementById("technicalDescription"))==null?void 0:n.value)==null?void 0:r.trim(),o=(s=(a=document.getElementById("technicalDevice"))==null?void 0:a.value)==null?void 0:s.trim();(d=(l=window.Community)==null?void 0:l.submitTechnicalIssue)==null||d.call(l);try{await this._writeAdminNotification("technical",{issueType:t,description:e,device:o,room:this._getCurrentRoom()}),await this._pushAdmins("🔧 Technical Issue",`${this._senderName()}: ${t||"issue"}${e?" - "+e.substring(0,60):""}`)}catch(c){console.error("submitTechnicalIssue admin notify error:",c)}},async _writeAdminNotification(t,e){if(!(u!=null&&u.ready))return;const{error:o}=await u._sb.from("admin_notifications").insert({type:t,from_user_id:u.userId||null,payload:{...e,sender_name:this._senderName(),timestamp:new Date().toISOString()}});o&&console.error("[SafetyBar] _writeAdminNotification:",o.message)},async _pushAdmins(t,e){if(u!=null&&u.ready)try{const[{data:o}]=await Promise.all([u._sb.from("profiles").select("id").eq("is_admin",!0)]);if(!(o!=null&&o.length))return;const{data:i}=await u._sb.from("push_subscriptions").select("subscription").in("user_id",o.map(n=>n.id));if(!(i!=null&&i.length))return;await Promise.allSettled(i.map(n=>fetch("/api/send",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sub:n.subscription,payload:{title:t,body:e,icon:"/icons/icon-192x192.png",data:{url:"/"}}})}).catch(()=>{})))}catch(o){console.error("[SafetyBar] _pushAdmins error:",o)}},_getCurrentRoom(){var t,e;return((e=(t=document.querySelector(".room-title, .room-name-inline, #roomTitle"))==null?void 0:t.textContent)==null?void 0:e.trim())||"Community Hub"},_senderName(){var t,e,o;return((o=(e=(t=window.Core)==null?void 0:t.state)==null?void 0:e.currentUser)==null?void 0:o.name)||"A member"}};(function(){const t={showReportModal:()=>V.openModal("report"),showBlockModal:()=>V.openModal("block"),showHelpModal:()=>V.openModal("help"),showCrisisModal:()=>V.openModal("crisis"),showModeratorModal:()=>V.openModal("moderator"),showTechnicalModal:()=>V.openModal("technical"),showGuidelinesModal:()=>V.openModal("guidelines"),muteChat:()=>{var e,o;return(o=(e=window.Core)==null?void 0:e.showToast)==null?void 0:o.call(e,"Chat muted")},closeReportModal:()=>V.closeModal("report"),closeBlockModal:()=>V.closeModal("block"),closeHelpModal:()=>V.closeModal("help"),closeCrisisModal:()=>V.closeModal("crisis"),closeModeratorModal:()=>V.closeModal("moderator"),closeTechnicalModal:()=>V.closeModal("technical"),closeGuidelinesModal:()=>V.closeModal("guidelines")};window.CommunityModule?Object.keys(t).forEach(e=>{typeof window.CommunityModule[e]!="function"&&(window.CommunityModule[e]=t[e])}):window.CommunityModule=t})();window.SafetyBar=V;const qe=[{id:"early_supporter",icon:"🌟",name:"Early Supporter",rarity:"epic",xp:100,desc:"Joined during early access"},{id:"vip_member",icon:"👑",name:"VIP Member",rarity:"legendary",xp:150,desc:"VIP community member"},{id:"beta_tester",icon:"🧪",name:"Beta Tester",rarity:"rare",xp:100,desc:"Helped test new features"},{id:"spiritual_guide",icon:"🕉️",name:"Spiritual Guide",rarity:"epic",xp:150,desc:"Community mentor and guide"},{id:"community_hero",icon:"🦸",name:"Community Hero",rarity:"legendary",xp:200,desc:"Outstanding community contribution"},{id:"first_step",icon:"🌱",name:"First Step",rarity:"common",xp:25,desc:"Took their first step in the community"},{id:"triple_threat",icon:"🎪",name:"Triple Threat",rarity:"uncommon",xp:50,desc:"Active in three different rooms"},{id:"moon_walker",icon:"🌙",name:"Moon Walker",rarity:"rare",xp:75,desc:"Night-time community explorer"},{id:"sun_keeper",icon:"☀️",name:"Sun Keeper",rarity:"uncommon",xp:50,desc:"Consistent morning presence"},{id:"energy_master",icon:"⚡",name:"Energy Master",rarity:"epic",xp:125,desc:"Master of community energy"},{id:"wave_rider",icon:"🌊",name:"Wave Rider",rarity:"rare",xp:75,desc:"Goes with the flow"},{id:"community_heart",icon:"💜",name:"Community Heart",rarity:"uncommon",xp:50,desc:"Heart of the community"},{id:"deep_diver",icon:"🔱",name:"Deep Diver",rarity:"epic",xp:125,desc:"Explores the depths of every topic"}];window.BADGE_REGISTRY=qe;const jt=["🏅","🎖️","🌟","👑","🧪","🕉️","🦸","🌱","🎪","🌙","☀️","⚡","🌊","💜","🔱","🔥","💎","🦋","🌸","🍀","🌈","⭐","🎯","🏆","🎗️","🌀","🔮","💫","🧘","🦅","🐉","🌺","🎵","💡","🌿","🦁","🐬","🌍","🎭","🛡️","⚔️","🗝️","🧬","🌠","🎋"];function W(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}const Ht={_open:!1,_pollInterval:null,_bulkMembers:[],_bulkSelected:new Set,_bulkRendered:new Set,_filterTimer:null,_SECTIONS:["notifications","members","engagement","safety","leaderboard","rooms","retention","bulk"],_BULK_TABS:[["xp","🎁 XP"],["karma","🌀 Karma"],["badge","🏅 Badge"],["customBadge","✨ Custom Badge"],["unlock","🔓 Unlock"],["message","💬 Message"]],_UNLOCKS:[["tarot_vision_ai","Tarot Vision AI"],["shadow_alchemy_lab","Shadow Alchemy Lab"],["advanced_meditations","Advanced Meditations"],["luxury_blush_champagne_skin","Blush Champagne Skin"],["luxury_champagne_gold_skin","Champagne Gold Skin"],["luxury_marble_bronze_skin","Marble Bronze Skin"],["royal_indigo_skin","Royal Indigo Skin"],["earth_luxury_skin","Earth Luxury Skin"]],_NOTIF_ICONS:{report:"⚠️",help:"🆘",technical:"🔧"},_buildEmojiPicker(t,e){return`
            <div id="${e}"
                ...
                ${jt.map(o=>`<button type="button"
                             onclick="AdminDashboard._pickEmoji('${t}','${e}','${o}')"
                             style="font-size:1.25rem;background:none;border:none;cursor:pointer;
                                    padding:3px 5px;border-radius:6px;line-height:1;transition:background 0.1s;"
                             onmouseover="this.style.background='rgba(0,0,0,0.07)'"
                             onmouseout="this.style.background='none'">${o}</button>`).join("")}
            </div>`},_pickEmoji(t,e,o){const i=document.getElementById(t);i&&(i.value=o);const n=document.getElementById(e);n&&(n.style.display="none")},_toggleEmojiPicker(t){const e=document.getElementById(t);e&&(e.style.display=e.style.display==="none"?"flex":"none")},async _pushNotify(t,e,o){try{await fetch("/api/send",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({userId:t,payload:{title:e,body:o,icon:"/icons/icon-192x192.png",data:{url:"/"}}})})}catch(i){console.error("[AdminDashboard] push notify error:",i)}},_injectStyles(){if(document.getElementById("adminDashStyles"))return;const t=document.createElement("style");t.id="adminDashStyles",t.textContent=`
        ...
        `,document.head.appendChild(t)},injectAdminUI(){var t,e,o;(o=(e=(t=window.Core)==null?void 0:t.state)==null?void 0:e.currentUser)!=null&&o.is_admin&&this.injectBadge()},injectBadge(){var i,n,r;if(document.getElementById("adminDashBadge")||!((r=(n=(i=window.Core)==null?void 0:i.state)==null?void 0:n.currentUser)!=null&&r.is_admin))return;this._injectStyles();const t=document.createElement("div");t.id="adminDashBadge",t.style.cssText="padding:0 0 32px;",t.innerHTML=`
            <section class="section">
                <div class="section-header">
        ...
        <div style="margin-bottom:12px;">
            <div class="admin-section-header" onclick="AdminDashboard.toggleSection('${t}')">
                ...
                <span id="adminSecToggle_${t}" style="font-size:0.8rem;color:var(--neuro-accent);">${o?"▼":"▶"}</span>
            </div>
            <div id="adminSec_${t}" class="admin-section-body" style="display:${o?"block":"none"};">
                <div id="adminSecContent_${t}" style="color:var(--text-muted,#888);font-size:0.83rem;padding:8px;">Loading...</div>
            </div>
        </div>`},toggleSection(t){const e=document.getElementById(`adminSec_${t}`),o=document.getElementById(`adminSecToggle_${t}`);if(!e)return;const i=e.style.display!=="none";e.style.display=i?"none":"block",o.textContent=i?"▶":"▼",i||this._loadSection(t)},refreshAll(){const t=document.getElementById("adminDashSubtitle");t&&(t.textContent=`Last updated: ${new Date().toLocaleTimeString()}`);for(const e of this._SECTIONS){const o=document.getElementById(`adminSec_${e}`);o&&(o.style.display!=="none"||e==="notifications")&&this._loadSection(e)}},async _loadSection(t){const e=document.getElementById(`adminSecContent_${t}`);if(e){e.innerHTML='<div style="color:var(--text-muted,#888);font-size:0.83rem;padding:8px;">Loading...</div>';try{await this[`_render${t.charAt(0).toUpperCase()+t.slice(1)}`](e)}catch(o){e.innerHTML=`<div style="color:#ef4444;font-size:0.83rem;padding:8px;">Failed to load: ${W(o.message)}</div>`}}},async _renderNotifications(t){const e=await CommunityDB.getAdminNotifications(30);if(!e.length){t.innerHTML='<div style="color:var(--text-muted,#888);padding:8px;font-size:0.83rem;">No notifications yet.</div>';return}const o=e.filter(i=>!i.read).length;t.innerHTML=`
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
                <span style="font-size:0.82rem;color:var(--text-muted,#888);">${o} unread of ${e.length}</span>
            ...
            ${e.map(i=>{var n,r,a,s,l,d,c;return`
                <div class="admin-notif-row ${i.read?"":"unread"}" id="adminNotif_${i.id}">
                    <span style="font-size:1.2rem;flex-shrink:0;">${this._NOTIF_ICONS[i.type]||"📋"}</span>
                    <div style="flex:1;min-width:0;">
                        <div style="display:flex;justify-content:space-between;margin-bottom:2px;">
                            <span style="font-size:0.82rem;font-weight:600;text-transform:capitalize;">${i.type}</span>
                            <span style="font-size:0.72rem;color:var(--text-muted,#888);">${this._timeAgo(i.created_at)}</span>
                        </div>
                        <div style="font-size:0.82rem;color:var(--text-muted,#888);">
                            From: <strong>${W(((n=i.payload)==null?void 0:n.sender_name)||"Unknown")}</strong>
                            ${(r=i.payload)!=null&&r.room?`· ${W(i.payload.room)}`:""}
                        </div>
                        ${(a=i.payload)!=null&&a.message?`<div style="font-size:0.82rem;margin-top:4px;font-style:italic;">"${W(i.payload.message)}"</div>`:""}
                        ${(s=i.payload)!=null&&s.reason?`<div style="font-size:0.82rem;margin-top:4px;">Reason: ${W(i.payload.reason)}</div>`:""}
                        ${(l=i.payload)!=null&&l.details?`<div style="font-size:0.82rem;color:var(--text-muted,#888);">${W(i.payload.details)}</div>`:""}
                        ${(d=i.payload)!=null&&d.issueType?`<div style="font-size:0.82rem;margin-top:4px;">Type: ${W(i.payload.issueType)}</div>`:""}
                        ${(c=i.payload)!=null&&c.description?`<div style="font-size:0.82rem;color:var(--text-muted,#888);">${W(i.payload.description)}</div>`:""}
                    </div>
                    ${i.read?"":`
                    <button onclick="AdminDashboard._markRead(${i.id})"
                ...
                </div>`}).join("")}`},async _renderMembers(t){const[e,o,{data:i=[]}]=await Promise.all([CommunityDB.getAdminMemberStats(),CommunityDB.getActiveMembers(),CommunityDB._sb.from("profiles").select("id, name, emoji, avatar_url, community_status").order("name")]),n=Object.fromEntries(o.map(l=>[l.user_id,l])),r=new Set(o.map(l=>l.user_id)),a=i.filter(l=>!r.has(l.id)),s=(l,d)=>{const c=(d==null?void 0:d.status)||"offline",p=(d==null?void 0:d.activity)||"💤 Offline",h=c==="online"?"#22c55e":c==="away"?"#f59e0b":"#aaa",m=l.avatar_url?`<img src="${W(l.avatar_url)}" alt="Member avatar" width="40" height="40" style="width:100%;height:100%;object-fit:cover;" loading="lazy" decoding="async">`:W(l.emoji||(l.name||"?").charAt(0));return`
                <div style="display:flex;align-items:center;gap:10px;padding:8px 10px;border-radius:10px;
                    ...
                    <div style="flex:1;min-width:0;">
                        <div style="font-size:0.85rem;font-weight:600;">${W(l.name||"Member")}</div>
                        <div style="font-size:0.75rem;color:var(--text-muted,#888);">${W(p)}</div>
                    </div>
            ...
            ${o.length?o.map(l=>s(l.profiles||{id:l.user_id,name:"Member"},l)).join(""):'<div style="color:var(--text-muted,#888);font-size:0.83rem;margin-bottom:12px;">No members online.</div>'}
            <div style="font-size:0.78rem;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;
            ...
            </div>`},async _renderSafety(t){const[e,o]=await Promise.all([CommunityDB.getSafetyStats(),CommunityDB.getPushSubscriptionCount()]);t.innerHTML=`
            <div class="admin-stat-grid">
                ...
                ${this._statCard(o||0,"Push Subscriptions")}
            </div>`},async _renderLeaderboard(t){const e=await CommunityDB.getLeaderboard(),o=(i,n)=>i.length?i.map((r,a)=>{var s,l,d;return`
                <div style="display:flex;align-items:center;gap:8px;padding:7px 10px;border-radius:8px;
                    ...
                    <span style="flex:1;font-size:0.85rem;font-weight:600;">${W(((l=r.profiles)==null?void 0:l.name)||"Member")}</span>
            ...
            <table class="admin-table">
                ...
                <tbody>
                    ${e.map(o=>{const i=o.entries>0?Math.round(o.totalSeconds/o.entries):0;return`<tr>
                            <td style="font-weight:600;">${this._formatRoomId(o.room_id)}</td>
                            <td>${o.entries}</td>
                            <td>${this._formatDuration(i)}</td>
                        </tr>`}).join("")}
                </tbody>
            </table>`},async _renderRetention(t){var o,i;const e=await CommunityDB.getRetentionSignals();t.innerHTML=`
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div>
                    <div style="font-size:0.78rem;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;
                    ...
                    ${(o=e.quietMembers)!=null&&o.length?e.quietMembers.map(n=>`
                ...
                <div>
                    ...
                    ${(i=e.streakMembers)!=null&&i.length?e.streakMembers.map(n=>`
                            <div style="display:flex;align-items:center;gap:8px;padding:6px 10px;border-radius:8px;
                                ...
                                <span>${n.emoji||"🧘"}</span>
                                <span style="font-size:0.83rem;font-weight:600;">${W(n.name||"Member")}</span>
                            </div>`).join(""):'<div style="color:var(--text-muted,#888);font-size:0.83rem;">No data yet.</div>'}
                </div>
            </div>`},async _renderBulk(t){const{data:e=[]}=await CommunityDB._sb.from("profiles").select("id, name, emoji, avatar_url, community_role").order("name");this._bulkMembers=e,this._bulkSelected=new Set,this._bulkRendered.clear();const o=e.map(i=>`
            <label id="bulkRow_${i.id}"
                ...
                <input type="checkbox" value="${i.id}"
                       onchange="AdminDashboard._bulkToggle('${i.id}',this.checked)"
                       style="width:16px;height:16px;cursor:pointer;accent-color:var(--neuro-accent);">
                <span style="font-size:1.1rem;">${i.emoji||"👤"}</span>
                <span style="font-size:0.85rem;font-weight:600;color:var(--neuro-text);">${W(i.name||"Member")}</span>
                <span style="font-size:0.75rem;color:var(--text-muted,#888);margin-left:auto;">${W(i.community_role||"Member")}</span>
            ...
            <div style="margin-bottom:16px;">
                ...
                <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:14px;" id="bulkTabBar">
                    ${this._BULK_TABS.map(([i,n],r)=>`
                        <button onclick="AdminDashboard._bulkShowTab('${i}')" id="bulkTab_${i}"
            ...
            </div>`,this._bulkRenderTabContent("xp")},_bulkRenderTabContent(t){if(this._bulkRendered.has(t))return;const e="width:100%;padding:8px 12px;border-radius:10px;margin-bottom:10px;border:1px solid rgba(0,0,0,0.1);background:var(--surface,#fff);color:var(--neuro-text);font-size:0.88rem;",o="width:100%;padding:8px 18px;border-radius:10px;border:none;cursor:pointer;font-size:0.88rem;font-weight:700;background:var(--neuro-accent-a20);color:var(--neuro-accent);",i="flex:1;padding:8px 12px;border-radius:10px;border:1px solid rgba(0,0,0,0.1);background:var(--surface,#fff);color:var(--neuro-text);font-size:0.88rem;",n="width:100%;padding:8px 12px;border-radius:10px;border:1px solid rgba(0,0,0,0.1);background:var(--surface,#fff);color:var(--neuro-text);font-size:0.88rem;box-sizing:border-box;margin-bottom:8px;",r="font-size:0.82rem;color:var(--text-muted,#888);margin-bottom:8px;",a={xp:`
                <div style="${r}">Send XP to all selected members</div>
                <div style="display:flex;gap:8px;align-items:center;">
                    <input id="bulkXpAmount" type="number" min="1" value="100" placeholder="XP amount" style="${i}">
                ...
                <div style="display:flex;gap:8px;align-items:center;">
                    <input id="bulkKarmaAmount" type="number" min="1" value="10" placeholder="Karma amount" style="${i}">
                ...
                <select id="bulkBadgeSelect" style="${e}">
                    ${qe.map(l=>`<option value="${l.id}" data-icon="${l.icon}" data-rarity="${l.rarity}" data-xp="${l.xp}" data-desc="${l.desc}">${l.icon} ${l.name}</option>`).join("")}
                </select>
                <button onclick="AdminDashboard._bulkSendBadge()" style="${o}">Send Badge</button>`,customBadge:`
                ...
                <select id="bulkCustomRarity" style="${e}">
                    <option value="common">Common</option>
                    <option value="uncommon">Uncommon</option>
                    <option value="rare">Rare</option>
                    <option value="epic" selected>Epic</option>
                ...
                <button onclick="AdminDashboard._bulkSendCustomBadge()" style="${o}">Send Custom Badge</button>`,unlock:`
                <div style="${r}">Unlock a feature for all selected members</div>
                <select id="bulkUnlockSelect" style="${e}">
                    ${this._UNLOCKS.map(([l,d])=>`<option value="${l}">${d}</option>`).join("")}
                </select>
                <button onclick="AdminDashboard._bulkSendUnlock()" style="${o}">Unlock Feature</button>`,message:`
                ...
                <button onclick="AdminDashboard._bulkSendMessage()" style="${o}">Send Message</button>`},s=document.getElementById("bulkActivePanel");s&&a[t]&&(s.innerHTML=a[t],this._bulkRendered.add(t))},_bulkToggle(t,e){this._bulkSelected[e?"add":"delete"](t),this._bulkUpdateCount()},_bulkSelectAll(){for(const t of this._bulkMembers){this._bulkSelected.add(t.id);const e=document.querySelector(`#bulkRow_${t.id} input[type=checkbox]`);e&&(e.checked=!0)}this._bulkUpdateCount()},_bulkSelectNone(){this._bulkSelected.clear(),document.querySelectorAll("#bulkMemberList input[type=checkbox]").forEach(t=>t.checked=!1),this._bulkUpdateCount()},_bulkUpdateCount(){const t=this._bulkSelected.size,e=document.getElementById("bulkSelectedCount");e&&(e.textContent=`${t} member${t!==1?"s":""} selected`)},_bulkFilterMembers(t){clearTimeout(this._filterTimer),this._filterTimer=setTimeout(()=>{const e=t.toLowerCase(),o=document.querySelectorAll("#bulkMemberList label"),i=[];o.forEach(n=>{var a,s;const r=((s=(a=n.querySelector("span:nth-child(3)"))==null?void 0:a.textContent)==null?void 0:s.toLowerCase())||"";i.push({row:n,show:r.includes(e)})}),i.forEach(({row:n,show:r})=>{n.style.display=r?"":"none"})},120)},_bulkShowTab(t){for(const[e]of this._BULK_TABS){const o=document.getElementById(`bulkTab_${e}`);if(!o)continue;const i=e===t;o.style.background=i?"var(--neuro-accent-a20)":"rgba(0,0,0,0.05)",o.style.color=i?"var(--neuro-accent)":"var(--text-muted,#888)"}this._bulkRendered.delete(t),this._bulkRenderTabContent(t)},_bulkGuard(){return this._bulkSelected.size===0?(window.Core.showToast("Select at least one member first"),!1):!0},async _bulkSendGamification({inputId:t,label:e,xpDelta:o=0,karmaDelta:i=0,notifTitle:n,notifBody:r}){var d;if(!this._bulkGuard())return;const a=parseInt((d=document.getElementById(t))==null?void 0:d.value,10);if(!a||a<1){window.Core.showToast(`Enter a valid ${e} amount`);return}const s=[...this._bulkSelected];window.Core.showToast(`Sending ${a} ${e} to ${s.length} members...`);let l=0;for(const c of s)try{await CommunityDB.adminUpdateGamification(c,{xpDelta:o==="amount"?a:o,karmaDelta:i==="amount"?a:i})?(l++,await this._pushNotify(c,n,r(a))):console.warn("[AdminDashboard] _bulkSendGamification: no success for",c)}catch(p){console.error("[AdminDashboard] _bulkSendGamification error for",c,p)}window.Core.showToast(`Sent ${a} ${e} to ${l}/${s.length} members`)},async _bulkSendXP(){await this._bulkSendGamification({inputId:"bulkXpAmount",label:"XP",xpDelta:"amount",notifTitle:"🎁 Gift from Aanandoham!",notifBody:t=>`You received +${t} XP!`})},async _bulkSendKarma(){await this._bulkSendGamification({inputId:"bulkKarmaAmount",label:"Karma",karmaDelta:"amount",notifTitle:"🎁 Gift from Aanandoham!",notifBody:t=>`You received +${t} Karma!`})},async _bulkSendBadge(){if(!this._bulkGuard())return;const t=document.getElementById("bulkBadgeSelect"),e=t==null?void 0:t.value;if(!e){window.Core.showToast("Select a badge");return}const o=qe.find(c=>c.id===e)||{},i=o.name||e,n=o.icon||"🏅",r=o.rarity||"common",a=o.xp??0,s=o.desc||"",l=[...this._bulkSelected];window.Core.showToast(`Sending badge to ${l.length} members...`);let d=0;for(const c of l)try{await CommunityDB.adminUpdateGamification(c,{badgeId:e,badgeName:i,badgeIcon:n,badgeRarity:r,badgeXp:a,badgeDesc:s})?(d++,await this._pushNotify(c,"🏅 New Badge!",`You earned the ${n} ${i} badge!`)):console.warn("[AdminDashboard] _bulkSendBadge: no success for",c)}catch(p){console.error("[AdminDashboard] _bulkSendBadge error for",c,p)}window.Core.showToast(`Sent badge to ${d}/${l.length} members`)},async _bulkSendCustomBadge(){var d,c,p,h,m,g;if(!this._bulkGuard())return;const t=((d=document.getElementById("bulkCustomIcon"))==null?void 0:d.value.trim())||"🏅",e=(c=document.getElementById("bulkCustomName"))==null?void 0:c.value.trim(),o=((p=document.getElementById("bulkCustomDesc"))==null?void 0:p.value.trim())||"",i=((h=document.getElementById("bulkCustomRarity"))==null?void 0:h.value)||"epic",n=parseInt((m=document.getElementById("bulkCustomXp"))==null?void 0:m.value,10)||0,r=parseInt((g=document.getElementById("bulkCustomKarma"))==null?void 0:g.value,10)||0;if(!e){window.Core.showToast("Please enter a badge name");return}const a="custom_"+e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,"")+"_"+Date.now(),s=[...this._bulkSelected];window.Core.showToast(`Sending custom badge to ${s.length} members...`);let l=0;for(const f of s)try{await CommunityDB.adminUpdateGamification(f,{badgeId:a,badgeName:e,badgeIcon:t,badgeRarity:i,badgeXp:n,badgeDesc:o})?(r>0&&await CommunityDB.adminUpdateGamification(f,{karmaDelta:r}),l++,await this._pushNotify(f,"🎖️ Special Badge!",`You received the ${t} ${e} badge!`)):console.warn("[AdminDashboard] _bulkSendCustomBadge: no success for",f)}catch(v){console.error("[AdminDashboard] _bulkSendCustomBadge error for",f,v)}window.Core.showToast(`Sent custom badge to ${l}/${s.length} members`)},async _bulkSendUnlock(){var r;if(!this._bulkGuard())return;const t=document.getElementById("bulkUnlockSelect"),e=t==null?void 0:t.value,o=((r=t==null?void 0:t.options[t.selectedIndex])==null?void 0:r.text)||e;if(!e){window.Core.showToast("Select a feature");return}const i=[...this._bulkSelected];window.Core.showToast(`Unlocking ${o} for ${i.length} members...`);let n=0;for(const a of i)try{await CommunityDB.adminUpdateGamification(a,{unlockFeature:e})?(n++,await this._pushNotify(a,"🔓 Feature Unlocked!",`${o} has been unlocked for you!`)):console.warn("[AdminDashboard] _bulkSendUnlock: no success for",a)}catch(s){console.error("[AdminDashboard] _bulkSendUnlock error for",a,s)}window.Core.showToast(`Unlocked ${o} for ${n}/${i.length} members`)},async _bulkSendMessage(){var i,n;if(!this._bulkGuard())return;const t=(n=(i=document.getElementById("bulkMessageText"))==null?void 0:i.value)==null?void 0:n.trim();if(!t){window.Core.showToast("Write a message first");return}const e=[...this._bulkSelected];window.Core.showToast(`Broadcasting to ${e.length} members...`);let o={sent:0};try{o=await CommunityDB.broadcastMessage(e,t)}catch(r){console.error("[AdminDashboard] _bulkSendMessage error:",r),window.Core.showToast("Failed to send messages");return}if(o.sent>0){for(const r of e)await this._pushNotify(r,"💬 Message from Aanandoham",t.substring(0,80));document.getElementById("bulkMessageText").value="",window.Core.showToast(`Message sent to ${o.sent}/${e.length} members`)}else window.Core.showToast("Failed to send messages")},async _markRead(t){var o;await CommunityDB.markNotificationRead(t);const e=document.getElementById(`adminNotif_${t}`);e&&(e.classList.remove("unread"),(o=e.querySelector("button"))==null||o.remove()),this._updateBadge()},async _markAllRead(){await CommunityDB.markAllNotificationsRead(),this._loadSection("notifications"),this._updateBadge()},async _deleteReflection(t,e){var i;if(!confirm("Delete this reflection?"))return;e.disabled=!0,await CommunityDB.deleteReflection(t)?((i=e.closest(".admin-refl-row"))==null||i.remove(),window.Core.showToast("Reflection deleted")):(window.Core.showToast("Could not delete"),e.disabled=!1)},_statCard(t,e){return`
            <div class="admin-stat-card">
                <div class="admin-stat-value">${t}</div>
                <div class="admin-stat-label">${e}</div>
            </div>`},_timeAgo(t){if(!t)return"";const e=Date.now()-new Date(t).getTime(),o=Math.floor(e/6e4),i=Math.floor(e/36e5),n=Math.floor(e/864e5);return o<1?"just now":o<60?`${o}m ago`:i<24?`${i}h ago`:`${n}d ago`},_formatDuration(t){return t?t<60?`${t}s`:t<3600?`${Math.round(t/60)}m`:`${(t/3600).toFixed(1)}h`:"-"},_formatRoomId(t){return(t||"").replace(/-/g," ").replace(/\b\w/g,e=>e.toUpperCase())},_esc:W};window.AdminDashboard=Ht;const le=()=>window.CollectiveField,Fe=()=>{var t,e,o,i;return((t=window.CommunityDB)==null?void 0:t.userId)||((i=(o=(e=window.Core)==null?void 0:e.state)==null?void 0:o.currentUser)==null?void 0:i.id)||null},Ie={_realtimeChannels:{},_pollInterval:null,POLL_INTERVAL_MS:3e4,async init(){try{await this._ensureTodayRow(),await this.loadAll(),this._subscribeRealtime(),this._startPolling()}catch(t){console.error("[CollectiveFieldDB] init error:",t)}},async loadAll(){await Promise.all([this.loadFieldState(),this.loadRecentSenders(),this.loadWaveTotal(),this.loadWaveParticipants(),this.loadUserContribution()])},get _sb(){return window.AppSupabase||window.CommunitySupabase||null},_todayUTC(){return new Date().toISOString().slice(0,10)},_err(t,e){console.error(`[CollectiveFieldDB] ${t}:`,e)},async _ensureTodayRow(){const t=this._todayUTC(),{data:e,error:o}=await this._sb.from("collective_field").select("id").eq("date",t).maybeSingle();if(o)throw o;if(!e){const{error:i}=await this._sb.from("collective_field").insert({date:t,energy_level:0,pulse_count_today:0});if(i)throw i}},async loadFieldState(){const{data:t,error:e}=await this._sb.from("collective_field").select("energy_level, pulse_count_today").eq("date",this._todayUTC()).single();if(e){this._err("loadFieldState",e);return}le().updateEnergyLevel(t.energy_level),le().updateCommunityPulseCount(t.pulse_count_today)},async loadRecentSenders(){const{data:t,error:e}=await this._sb.from("collective_pulses").select("user_id, profiles(emoji, avatar_url)").eq("date",this._todayUTC()).order("created_at",{ascending:!1}).limit(5);if(e){this._err("loadRecentSenders",e);return}le().updateRecentSenders((t||[]).map(o=>{var i,n;return{emoji:((i=o.profiles)==null?void 0:i.emoji)||"🧘",avatarUrl:((n=o.profiles)==null?void 0:n.avatar_url)||null}}))},async recordPulse(){const t=Fe();if(!t){this._err("recordPulse","no userId");return}const e=this._todayUTC(),{error:o}=await this._sb.rpc("increment_field_pulse",{p_date:e,p_energy_add:5});if(o){this._err("recordPulse RPC",o);return}const{error:i}=await this._sb.from("collective_pulses").insert({user_id:t,date:e});i&&this._err("recordPulse insert",i)},async loadWaveTotal(){const{data:t,error:e}=await this._sb.from("wave_contributions").select("minutes").eq("date",this._todayUTC());if(e){this._err("loadWaveTotal",e);return}le().updateWaveTotalMinutes((t||[]).reduce((o,i)=>o+(i.minutes||0),0))},async loadWaveParticipants(){const{data:t,error:e}=await this._sb.from("wave_contributions").select("user_id").eq("date",this._todayUTC());if(e){this._err("loadWaveParticipants",e);return}le().updateWaveParticipants(new Set((t||[]).map(o=>o.user_id)).size)},async loadUserContribution(){const t=Fe();if(!t)return;const e=this._todayUTC(),[{data:o,error:i},{data:n,error:r}]=await Promise.all([this._sb.from("wave_contributions").select("minutes").eq("user_id",t).eq("date",e),this._sb.from("wave_contributions").select("minutes").eq("user_id",t)]);if(i){this._err("loadUserContribution today",i);return}if(r){this._err("loadUserContribution allTime",r);return}const a=s=>(s||[]).reduce((l,d)=>l+(d.minutes||0),0);le().updateUserContribution(a(o),a(n))},async logWaveContribution(t,e){const o=Fe();if(!o){this._err("logWaveContribution","no userId");return}if(t<1)return;const{error:i}=await this._sb.from("wave_contributions").insert({user_id:o,date:this._todayUTC(),minutes:t,completed:e});if(i){this._err("logWaveContribution",i);return}await Promise.all([this.loadWaveTotal(),this.loadWaveParticipants()])},_subscribeRealtime(){const t=this._todayUTC();this._realtimeChannels.field=this._sb.channel("collective_field_changes").on("postgres_changes",{event:"UPDATE",schema:"public",table:"collective_field",filter:`date=eq.${t}`},({new:e})=>{le().updateEnergyLevel(e.energy_level),le().updateCommunityPulseCount(e.pulse_count_today)}).subscribe(),this._realtimeChannels.pulses=this._sb.channel("collective_pulses_inserts").on("postgres_changes",{event:"INSERT",schema:"public",table:"collective_pulses",filter:`date=eq.${t}`},async({new:e})=>{le().receiveExternalPulse({userId:e.user_id,intensity:.7}),await this.loadRecentSenders()}).subscribe(),this._realtimeChannels.wave=this._sb.channel("wave_contributions_inserts").on("postgres_changes",{event:"INSERT",schema:"public",table:"wave_contributions",filter:`date=eq.${t}`},async({new:e})=>{if(typeof(e==null?void 0:e.minutes)=="number"&&e.minutes>0){const o=le().state.waveTotalMinutes||0;le().updateWaveTotalMinutes(o+e.minutes)}await this.loadWaveParticipants()}).subscribe()},_startPolling(){this._pollInterval&&clearInterval(this._pollInterval),this._pollInterval=setInterval(async()=>{try{await this.loadAll()}catch(t){this._err("poll",t)}},this.POLL_INTERVAL_MS)},destroy(){for(const t of Object.values(this._realtimeChannels))try{t.unsubscribe()}catch{}this._realtimeChannels={},this._pollInterval&&(clearInterval(this._pollInterval),this._pollInterval=null)}};window.addEventListener("pagehide",()=>Ie.destroy());window.CollectiveFieldDB=Ie;const ye={state:{isRendered:!1,calmsSentCount:0,lastCalmSentAt:null,isHolding:!1,holdProgress:0,holdInterval:null,HOLD_DURATION_MS:3e3,COOLDOWN_MS:3e4,energyLevel:42,ENERGY_PER_PULSE:5,isContributing:!1,contributeStartedAt:null,timerInterval:null,countedAsParticipant:!1,waveTotalMinutes:967,WAVE_GOAL_MINUTES:1440,userTodayMinutes:0,userAllTimeMinutes:0,communityPulseCount:47,recentSenders:[]},config:{DEFAULT_PRESENCE_COUNT:127,DEFAULT_WAVE_PARTICIPANTS:0},_FIELD_LABELS:[{min:80,text:"The field is radiant",svg:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><circle cx="12" cy="12" r="4"/><line x1="12" y1="2" x2="12" y2="5"/><line x1="12" y1="19" x2="12" y2="22"/><line x1="2" y1="12" x2="5" y2="12"/><line x1="19" y1="12" x2="22" y2="12"/><line x1="4.22" y1="4.22" x2="6.34" y2="6.34"/><line x1="17.66" y1="17.66" x2="19.78" y2="19.78"/><line x1="19.78" y1="4.22" x2="17.66" y2="6.34"/><line x1="6.34" y1="17.66" x2="4.22" y2="19.78"/></svg>'},{min:60,text:"The field is strong",svg:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/><path d="M8 12h8M12 8v8"/></svg>'},{min:40,text:"The field is growing",svg:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M12 22V12"/><path d="M12 12C12 7 7 4 3 6"/><path d="M12 12C12 7 17 4 21 6"/></svg>'},{min:20,text:"The field is flickering",svg:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M12 2L8 10h4l-2 10 8-12h-4l2-6z"/></svg>'},{min:0,text:"The field needs energy",svg:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>'}],render(){const t=document.getElementById("collectiveFieldContainer");if(!t){console.warn("[CollectiveField] #collectiveFieldContainer not found");return}this._cleanup();try{t.innerHTML=this._buildHTML(),this.state.isRendered=!0,["pulseBtn","waveBtn"].forEach(e=>{const o=document.getElementById(e);o&&(o.addEventListener("contextmenu",i=>i.preventDefault()),o.addEventListener("touchstart",i=>{i.preventDefault(),ye.handleHoldStart()},{passive:!1}))}),this._lastSentRefreshInterval=setInterval(()=>{const e=document.getElementById("lastSentLabel");e&&(e.textContent=this._getLastSentLabel())},6e4),this.state.isContributing&&this._resumeWaveTick()}catch(e){console.error("[CollectiveField] render error:",e)}},_buildHTML(){return`
            <div class="section-header">
            ...
            </div>`},_buildEnergyFieldHTML(){const{energyLevel:t,communityPulseCount:e}=this.state,o=this._getFieldLabel(t),i=this._getLastSentLabel(),n=this._buildRecentSendersHTML();return`
            <div class="collective-card energy-card">
                ...
                <div style="margin:10px 0;">
                    ...
                    <div id="lastSentLabel" style="font-size:11px;color:var(--text-muted);margin-top:5px;">${i}</div>
                </div>
            ...
            </div>`},_buildCalmWaveHTML(){const{waveTotalMinutes:t,WAVE_GOAL_MINUTES:e,userTodayMinutes:o,userAllTimeMinutes:i}=this.state,n=this.config.DEFAULT_WAVE_PARTICIPANTS,r=Math.min(Math.round(t/e*100),100),a=Math.max(e-t,0),s=Math.floor(a/60),l=a%60,d=s>0?`${s}h ${l}m`:`${l}m`;return`
                ...
                <div class="wave-time-block" style="position:relative;">
                    ...
                    <div id="waveContribBlock" style="margin-top:8px;padding-top:8px;border-top:1px solid var(--border-subtle,rgba(0,0,0,0.08));transition:opacity 0.4s ease;">
                        ...
                        <div style="display:flex;gap:12px;align-items:baseline;">
                            <span>
                                <span id="userTodayDisplay"   style="font-size:16px;font-weight:600;color:var(--text-primary);">${o}m</span>
                                <span style="font-size:10px;color:var(--text-muted);margin-left:2px;">today</span>
                            </span>
                            <span>
                                <span id="userAllTimeDisplay" style="font-size:16px;font-weight:600;color:var(--text-primary);">${i}m</span>
            ...
            </svg>`},_cleanup(){const t=this.state,e=["holdInterval","timerInterval"];for(const o of e)t[o]&&(clearInterval(t[o]),t[o]=null);this._lastSentRefreshInterval&&(clearInterval(this._lastSentRefreshInterval),this._lastSentRefreshInterval=null),t.isHolding=!1},handleHoldStart(){var o;const t=this.state;if(t.lastCalmSentAt&&Date.now()-t.lastCalmSentAt<t.COOLDOWN_MS){const i=Math.ceil((t.COOLDOWN_MS-(Date.now()-t.lastCalmSentAt))/1e3);this._toast(`Wait ${i}s before sending again`);return}if(t.isHolding)return;t.isHolding=!0,t.holdProgress=0,(o=document.getElementById("pulseBtn"))==null||o.classList.add("holding");const e=Date.now();t.holdInterval=setInterval(()=>{const i=Date.now()-e;t.holdProgress=Math.min(i/t.HOLD_DURATION_MS*100,100);const n=document.getElementById("holdRing");n&&(n.style.strokeDashoffset=100.5-t.holdProgress/100*100.5),t.holdProgress>=100&&(clearInterval(t.holdInterval),t.holdInterval=null,t.isHolding=!1,this._firePulse())},50)},handleHoldEnd(){this.state.isHolding&&this._cancelHold()},handleHoldCancel(){this.state.isHolding&&this._cancelHold()},_cancelHold(){var o;const t=this.state;t.holdInterval&&(clearInterval(t.holdInterval),t.holdInterval=null),t.isHolding=!1,t.holdProgress=0,(o=document.getElementById("pulseBtn"))==null||o.classList.remove("holding");const e=document.getElementById("holdRing");e&&(e.style.strokeDashoffset="100.5")},_firePulse(){const t=this.state;t.lastCalmSentAt=Date.now(),t.calmsSentCount++;const e=document.getElementById("pulseBtn");e&&(e.classList.remove("holding"),e.classList.add("fired"),setTimeout(()=>e.classList.remove("fired"),1e3));const o=document.getElementById("holdRing");o&&(o.style.strokeDashoffset="100.5"),this._addEnergy(t.ENERGY_PER_PULSE),this._triggerFieldRipple(t.calmsSentCount),this._triggerAppWideRipple(),this._broadcastPulse(t.calmsSentCount),t.communityPulseCount++,this._addSelfToRecentSenders(),this._refreshEnergyCardMeta(),this._toast("Energy sent")},_addEnergy(t){const e=this.state;e.energyLevel=Math.min(e.energyLevel+t,100),this._updateEnergyBar(e.energyLevel)},_updateEnergyBar(t){var n,r,a;const e=document.getElementById("pulseFill"),o=document.getElementById("energyValue");e&&(e.style.width=`${t}%`,e.setAttribute("aria-valuenow",t)),o&&(o.textContent=`${t}%`);const i=document.getElementById("adminEnergyBtn");i&&(i.style.display=(a=(r=(n=window.Core)==null?void 0:n.state)==null?void 0:r.currentUser)!=null&&a.is_admin?"inline":"none")},handleContributeWave(){this.state.isContributing?this._endWave().catch(t=>console.error("[CollectiveField] _endWave error:",t)):this._startWave()},_startWave(){var o;const t=this.state;t.isContributing=!0,t.contributeStartedAt=Date.now(),t.countedAsParticipant=!1,(o=document.getElementById("waveBtn"))==null||o.classList.add("in-progress");const e=document.getElementById("waveBtnLabel");e&&(e.textContent="End Session"),this._updateWaveStatusLine(),this._toast("Silence started"),t.timerInterval=setInterval(()=>this._waveTick(),1e3)},_resumeWaveTick(){var o;const t=this.state;(o=document.getElementById("waveBtn"))==null||o.classList.add("in-progress");const e=document.getElementById("waveBtnLabel");e&&(e.textContent="End Session"),this._updateWaveStatusLine(),t.timerInterval=setInterval(()=>this._waveTick(),1e3)},_waveTick(){const t=this.state;if(!t.isContributing)return;const e=Date.now()-t.contributeStartedAt;!t.countedAsParticipant&&e>=300*1e3&&(t.countedAsParticipant=!0,this._incrementParticipantCount(),this._triggerAvatarRipple(),this._toast("You're in the wave")),this._updateWaveStatusLine(e)},async _endWave(){var s;const t=this.state;clearInterval(t.timerInterval),t.timerInterval=null,t.isContributing=!1;const e=Date.now()-t.contributeStartedAt,o=Math.floor(e/6e4);t.countedAsParticipant&&(this._decrementParticipantCount(),t.countedAsParticipant=!1),(s=document.getElementById("waveBtn"))==null||s.classList.remove("in-progress");const i=document.getElementById("waveBtnLabel");if(i&&(i.textContent="Start Silence"),o<1){this._toast("Sit a little longer"),this._updateWaveStatusLine();return}const n=t.waveTotalMinutes,r=t.userTodayMinutes,a=t.userAllTimeMinutes;t.waveTotalMinutes=Math.min(t.waveTotalMinutes+o,t.WAVE_GOAL_MINUTES),t.userTodayMinutes+=o,t.userAllTimeMinutes+=o,this._updateWaveProgress(),this._updateWaveStatusLine(),this._toast(`${o}min contributed to the wave`),t.waveTotalMinutes>=t.WAVE_GOAL_MINUTES&&this._onWaveComplete();try{await Ie.logWaveContribution(o,!0)}catch(l){console.error("[CollectiveField] logWaveContribution failed — rolling back:",l),t.waveTotalMinutes=n,t.userTodayMinutes=r,t.userAllTimeMinutes=a,this._updateWaveProgress(),this._updateWaveStatusLine(),this._toast("Could not save session — please try again")}},_onWaveComplete(){this._toast("The wave is complete! A new one begins tomorrow.")},_updateWaveProgress(){var r,a,s;const t=this.state,e=Math.min(Math.round(t.waveTotalMinutes/t.WAVE_GOAL_MINUTES*100),100),o=document.getElementById("waveFill"),i=document.getElementById("waveProgressValue");o&&(o.style.width=`${e}%`,o.setAttribute("aria-valuenow",e)),i&&(i.textContent=`${e}%`);const n=document.getElementById("adminWaveBtn");n&&(n.style.display=(s=(a=(r=window.Core)==null?void 0:r.state)==null?void 0:a.currentUser)!=null&&s.is_admin?"inline":"none")},_updateWaveStatusLine(t){const e=this.state,o=document.getElementById("waveSessionClock"),i=document.getElementById("waveCountUp"),n=document.getElementById("waveCollectiveTime"),r=document.getElementById("waveClockDisplay"),a=document.getElementById("waveContribBlock");if(!r)return;const s=Math.max(e.WAVE_GOAL_MINUTES-e.waveTotalMinutes,0),l=Math.floor(s/60),d=s%60;if(r.textContent=l>0?`${l}h ${d}m`:`${d}m`,t!==void 0&&e.isContributing){const c=Math.floor(t/6e4),p=Math.floor(t%6e4/1e3);i&&(i.textContent=`${String(c).padStart(2,"0")}:${String(p).padStart(2,"0")}`),o&&(o.style.maxHeight="60px",o.style.opacity="1",o.style.marginBottom="8px"),n&&(n.style.fontSize="13px",n.style.opacity="0.45",n.style.marginTop="2px"),a&&(a.style.opacity="0.5")}else{o&&(o.style.maxHeight="0",o.style.opacity="0",o.style.marginBottom="0"),n&&(n.style.fontSize="",n.style.opacity="1",n.style.marginTop=""),a&&(a.style.opacity="1");const c=document.getElementById("userTodayDisplay"),p=document.getElementById("userAllTimeDisplay");c&&(c.textContent=`${e.userTodayMinutes}m`),p&&(p.textContent=`${e.userAllTimeMinutes}m`)}},_triggerFieldRipple(t){const e=document.querySelector(".energy-card svg");if(!e)return;const o=Math.max(1-(t-1)*.2,.2),i=document.createElementNS("http://www.w3.org/2000/svg","circle");Object.entries({cx:"50",cy:"50",r:"10",fill:"none",stroke:"currentColor","stroke-width":"2"}).forEach(([n,r])=>i.setAttribute(n,r)),i.style.cssText=`opacity:${o};transition:r 1s ease-out,opacity 1s ease-out;`,e.appendChild(i),requestAnimationFrame(()=>requestAnimationFrame(()=>{i.style.opacity="0",i.setAttribute("r","48")})),setTimeout(()=>i.remove(),1100)},_triggerAppWideRipple(){if(!document.getElementById("appRippleStyles")){const a=document.createElement("style");a.id="appRippleStyles",a.textContent=`
            ...
            `,document.head.appendChild(a)}let t=document.getElementById("appRippleOverlay");t||(t=document.createElement("div"),t.id="appRippleOverlay",document.body.appendChild(t));const e=document.querySelector(".energy-card"),o=e?e.getBoundingClientRect():null,i=o?o.left+o.width/2:window.innerWidth/2,n=o?o.top+o.height/2:window.innerHeight/2,r=Math.hypot(window.innerWidth,window.innerHeight)*2.2;["ring-1","ring-2","ring-3"].forEach((a,s)=>{const l=document.createElement("div");l.className=`app-wide-ripple ${a}`,l.style.cssText=`--ripple-size:${r}px;left:${i}px;top:${n}px;`,t.appendChild(l),setTimeout(()=>l.remove(),3400+s*300)})},_triggerAvatarRipple(){var a,s;if(!document.getElementById("waveRippleStyles")){const l=document.createElement("style");l.id="waveRippleStyles",l.textContent=`
                @keyframes waveFloat {
            ...
            `,document.head.appendChild(l)}const t=document.getElementById("waveRippleStage");if(!t)return;const e=(s=(a=window.Core)==null?void 0:a.state)==null?void 0:s.currentUser,o=(e==null?void 0:e.avatar_url)||null,i=(e==null?void 0:e.emoji)||"🧘",n=Math.floor(Math.random()*((t.offsetWidth||80)-36))+2;let r;o?(r=Object.assign(document.createElement("img"),{src:o,alt:"You",className:"wave-avatar-ripple"}),r.onerror=()=>r.replaceWith(this._makeEmojiRipple(i,n))):r=this._makeEmojiRipple(i,n),r.style.left=`${n}px`,t.appendChild(r),setTimeout(()=>r.remove(),3e3)},_makeEmojiRipple(t,e){const o=document.createElement("span");return o.textContent=t,o.className="wave-avatar-ripple",o.style.cssText=`left:${e}px;line-height:28px;text-align:center;`,o},_incrementParticipantCount(){const t=document.getElementById("waveParticipants");t&&(t.textContent=parseInt(t.textContent||"0")+1)},_decrementParticipantCount(){const t=document.getElementById("waveParticipants");t&&(t.textContent=Math.max(parseInt(t.textContent||"0")-1,0))},_broadcastPulse(t){Ie==null||Ie.recordPulse().catch(e=>console.error("[CollectiveField] recordPulse failed:",e))},receiveExternalPulse(t){const e=Math.min(t.intensity||.6,.8);this._triggerFieldRipple(Math.round((1-e)/.2)+1)},_refreshEnergyCardMeta(){const t=this.state,e=document.getElementById("fieldStateLabel"),o=document.getElementById("lastSentLabel"),i=document.getElementById("communityPulseCount"),n=document.getElementById("recentSendersStrip");e&&(e.innerHTML=this._getFieldLabel(t.energyLevel)),o&&(o.textContent=this._getLastSentLabel()),i&&(i.textContent=t.communityPulseCount),n&&(n.innerHTML=this._buildRecentSendersHTML())},_addSelfToRecentSenders(){var e,o;const t=(o=(e=window.Core)==null?void 0:e.state)==null?void 0:o.currentUser;this.state.recentSenders=[{emoji:(t==null?void 0:t.emoji)||"🧘",avatarUrl:(t==null?void 0:t.avatar_url)||null},...this.state.recentSenders].slice(0,5)},_getFieldLabel(t){const{text:e,svg:o}=this._FIELD_LABELS.find(i=>t>=i.min)||this._FIELD_LABELS.at(-1);return`<span style="display:inline-flex;align-items:center;gap:5px;opacity:0.75;">${o}<span>${e}</span></span>`},_getLastSentLabel(){const t=this.state.lastCalmSentAt;if(!t)return"Not sent yet";const e=Math.floor((Date.now()-t)/1e3);if(e<60)return`Sent ${e}s ago`;const o=Math.floor(e/60);return o<60?`Sent ${o}m ago`:`Sent ${Math.floor(o/60)}h ago`},_buildRecentSendersHTML(){const t=this.state.recentSenders;return t.length?t.slice(0,5).map(e=>e.avatarUrl?`<img src="${e.avatarUrl}" alt="" width="26" height="26" loading="lazy" decoding="async"
                             style="width:26px;height:26px;border-radius:50%;object-fit:cover;border:1.5px solid var(--border-subtle,rgba(0,0,0,0.1));"
                             onerror="this.replaceWith(Object.assign(document.createElement('span'),{textContent:'${e.emoji||"🧘"}',style:'font-size:20px;line-height:26px;'}))">`:`<span style="font-size:20px;line-height:26px;" title="Recent sender">${e.emoji||"🧘"}</span>`).join(""):'<span style="font-size:11px;color:var(--text-muted);font-style:italic;">No one yet - be first</span>'},updatePresenceCount(t){if(typeof t!="number"||t<0)return;const e=document.getElementById("presenceCount");e&&(e.textContent=t)},updateEnergyLevel(t){typeof t!="number"||t<0||t>100||(this.state.energyLevel=t,this._updateEnergyBar(t))},updateCommunityPulseCount(t){this.state.communityPulseCount=t||0;const e=document.getElementById("communityPulseCount");e&&(e.textContent=this.state.communityPulseCount)},updateRecentSenders(t){this.state.recentSenders=t||[];const e=document.getElementById("recentSendersStrip");e&&(e.innerHTML=this._buildRecentSendersHTML())},updateUserContribution(t,e){this.state.userTodayMinutes=t||0,this.state.userAllTimeMinutes=e||0,this.state.isContributing||this._updateWaveStatusLine()},updateWaveParticipants(t){this.config.DEFAULT_WAVE_PARTICIPANTS=t||0;const e=document.getElementById("waveParticipants");e&&(e.textContent=t||0)},updateWaveTotalMinutes(t){typeof t!="number"||t<0||(this.state.waveTotalMinutes=Math.min(t,this.state.WAVE_GOAL_MINUTES),this._updateWaveProgress(),this.state.isContributing||this._updateWaveStatusLine())},refresh(){try{this.render()}catch(t){console.error("[CollectiveField] refresh error:",t)}},injectAdminUI(){var i,n,r;const t=(r=(n=(i=window.Core)==null?void 0:i.state)==null?void 0:n.currentUser)==null?void 0:r.is_admin,e=document.getElementById("adminEnergyBtn"),o=document.getElementById("adminWaveBtn");e&&(e.style.display=t?"inline":"none"),o&&(o.style.display=t?"inline":"none")},async adminAddEnergy(){var t,e,o;if((o=(e=(t=window.Core)==null?void 0:t.state)==null?void 0:e.currentUser)!=null&&o.is_admin)try{const i=window.AppSupabase||window.CommunitySupabase;if(!i)throw new TypeError("Supabase client unavailable");const{error:n}=await i.rpc("increment_field_pulse",{p_date:new Date().toISOString().slice(0,10),p_energy_add:10});if(n)throw n;await window.CollectiveFieldDB.loadFieldState(),this._toast("+10 Energy added")}catch(i){console.error("[CollectiveField] adminAddEnergy error:",i),this._toast("Could not add energy")}},async adminAddWaveMinutes(){var t,e,o;if((o=(e=(t=window.Core)==null?void 0:t.state)==null?void 0:e.currentUser)!=null&&o.is_admin)try{await window.CollectiveFieldDB.logWaveContribution(60,!1),this._toast("+60 min added to Wave")}catch(i){console.error("[CollectiveField] adminAddWaveMinutes error:",i),this._toast("Could not add wave minutes")}},_toast(t){var e;(e=window.Core)==null||e.showToast(t)}};window.addEventListener("beforeunload",()=>ye._cleanup());window.CollectiveField=ye;const Pe='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;opacity:0.8;"><path d="M12 3L13.5 8.5L19 10L13.5 11.5L12 17L10.5 11.5L5 10L10.5 8.5Z"/><path d="M5 3L5.75 5.25L8 6L5.75 6.75L5 9L4.25 6.75L2 6L4.25 5.25Z"/><path d="M19 14L19.75 16.25L22 17L19.75 17.75L19 20L18.25 17.75L16 17L18.25 16.25Z"/></svg>',tt='<span style="background:rgba(239,68,68,0.85);color:white;font-size:11px;font-weight:700;letter-spacing:0.08em;padding:4px 10px;border-radius:4px;text-transform:uppercase;">In Session</span>',De={MAX:5,fallbackGradient:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"};function ge(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}const we={bless:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;opacity:0.8;"><path d="M12 3L13.5 8.5L19 10L13.5 11.5L12 17L10.5 11.5L5 10L10.5 8.5Z"/><path d="M5 3L5.75 5.25L8 6L5.75 6.75L5 9L4.25 6.75L2 6L4.25 5.25Z"/><path d="M19 14L19.75 16.25L22 17L19.75 17.75L19 20L18.25 17.75L16 17L18.25 16.25Z"/></svg>',leave:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M13 4h3a2 2 0 0 1 2 2v14"/><path d="M2 20h3"/><path d="M13 20h9"/><path d="M10 12v.01"/><path d="M13 4l-6 2v14l6 2"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',book:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>',alert:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>',block:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><circle cx="12" cy="12" r="10"/><path d="m4.9 4.9 14.2 14.2"/></svg>',mute:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="23" y1="9" x2="17" y2="15"/><line x1="17" y1="9" x2="23" y2="15"/></svg>',help:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4"/><line x1="4.93" y1="4.93" x2="9.17" y2="9.17"/><line x1="14.83" y1="14.83" x2="19.07" y2="19.07"/><line x1="14.83" y1="9.17" x2="19.07" y2="4.93"/><line x1="4.93" y1="19.07" x2="9.17" y2="14.83"/></svg>'},Ue={data:null,fetchedAt:0,TTL_MS:12e4,async get(){const t=Date.now();if(this.data&&t-this.fetchedAt<this.TTL_MS)return this.data;try{this.data=await u.getBlockedUsers(),this.fetchedAt=t}catch{this.data=this.data??new Set}return this.data},invalidate(){this.data=null,this.fetchedAt=0}};let D=class $e{constructor(e){this.roomId=e.roomId,this.roomType=e.roomType,this.config={name:"Practice Room",icon:"🧘",description:"A space for practice",energy:"Peaceful",statusRingColor:"var(--neuro-accent)",imageUrl:"",...e},this.state={participants:e.participants||0,isActive:!0,...e.state},this.eventListeners=[],this._actionsCache=null}_dbReady(){return!!(u!=null&&u.ready)}init(){var e;this.updateRoomCard(),window[`${this.roomId}_blessRoom`]=()=>this._blessRoom(),window[`${this.roomId}_showScheduleModal`]=()=>{var o;return(o=this.showScheduleModal)==null?void 0:o.call(this)},window[`${this.roomId}_closeScheduleModal`]=()=>{var o;return(o=this.closeScheduleModal)==null?void 0:o.call(this)},this.mountHubModals(),this._loadBlessingCount(),(e=this.onInit)==null||e.call(this)}mountHubModals(){var n,r;const e=((n=this.buildHubModals)==null?void 0:n.call(this))||"";if(!e)return;let o=document.getElementById("roomHubModals");o||(o=Object.assign(document.createElement("div"),{id:"roomHubModals"}),o.style.cssText="position:relative;z-index:200000;",document.body.appendChild(o)),(r=document.getElementById(`${this.roomId}HubModalsSlot`))==null||r.remove();const i=Object.assign(document.createElement("div"),{id:`${this.roomId}HubModalsSlot`,innerHTML:e});o.appendChild(i)}buildHubModals(){return""}enterRoom(){var e;if(!this.canEnterRoom()){window.Core.showToast("Session in progress. Please wait for the next opening.");return}$e.stopHubPresence(),this._createPracticeViewDeferred(),window.Core.navigateTo("practiceRoomView"),window.Core.showToast(`${this.config.icon} Entered ${this.config.name}`),this._actionsCache=null,this.setupEventListeners(),(e=this.onEnter)==null||e.call(this),this._setRoomPresence(this.roomId),ye&&!ye.state.isContributing&&ye._startWave(),requestAnimationFrame(()=>{this._refreshParticipantSidebar(`${this.roomId}ParticipantListEl`,`${this.roomId}ParticipantCount`),requestAnimationFrame(()=>{this._refreshBlessingCounter(),this._subscribeToBlessings()})}),u.logRoomEntry(this.roomId).then(o=>{this._roomEntryId=o}).catch(()=>{})}_createPracticeViewDeferred(){var r;V.injectModals();const e=document.getElementById("dynamicRoomContent"),o=this.buildHeader(),i=[this.buildInstructionsModal(),((r=this.buildAdditionalModals)==null?void 0:r.call(this))??""].join(""),n=`<div class="ps-body" id="${this.roomId}BodyPlaceholder" style="flex:1;display:flex;align-items:center;justify-content:center;min-height:200px;"><div style="opacity:0.4;font-size:14px;">Loading…</div></div>`;if(e)e.innerHTML=o+n+i;else{if(document.getElementById(`${this.roomId}View`))return;const a=document.createElement("div");a.className="view practice-space",a.id=`${this.roomId}View`,a.innerHTML=o+n+i,document.body.appendChild(a)}requestAnimationFrame(()=>{const a=document.getElementById(`${this.roomId}BodyPlaceholder`),s=this.buildBody();if(a){const l=document.createElement("div");l.innerHTML=s,a.replaceWith(...Array.from(l.childNodes))}else e&&(e.innerHTML=o+s+i);this._onEnterDeferred()})}_onEnterDeferred(){var e;(e=this.onEnter)==null||e.call(this),requestAnimationFrame(()=>{this._refreshParticipantSidebar(`${this.roomId}ParticipantListEl`,`${this.roomId}ParticipantCount`),requestAnimationFrame(()=>{this._refreshBlessingCounter(),this._subscribeToBlessings()})})}createPracticeView(){this._createPracticeViewDeferred()}leaveRoom(){var e;this._exitCleanup(),window.Core.navigateTo("hubView"),window.Core.showToast(`Left ${this.config.name}`),(e=this.onLeave)==null||e.call(this),$e.startHubPresence()}gentlyLeave(){var e;this._exitCleanup(),(e=this.onLeave)==null||e.call(this),$e.startHubPresence(),window.Rituals?Rituals.showClosing():window.Core.navigateTo("hubView")}_exitCleanup(){this._teardownDelegatedListeners(),ye!=null&&ye.state.isContributing&&ye._endWave(),this._clearRoomPresence(),Ue.invalidate(),this._lastParticipantKey=null,this._participantFetchInFlight=!1,this._blessingRows=null,this._actionsCache=null,clearTimeout(this._blessingRefreshTimer),this._roomEntryId&&(u.logRoomExit(this._roomEntryId).catch(()=>{}),this._roomEntryId=null);for(const e of["_presenceSub","_sidebarPresenceSub"])if(this[e]){try{this[e].unsubscribe()}catch{}this[e]=null}u&&u.unsubscribeFromBlessings(this.roomId),this.cleanup()}canEnterRoom(){return!0}_isWithinOpenWindow(){return this.roomType!=="timed"?!0:typeof this._checkCycleWindow=="function"?this._checkCycleWindow():!0}cleanup(){var e;this.eventListeners.forEach(({element:o,event:i,handler:n})=>o.removeEventListener(i,n)),this.eventListeners=[],(e=this.onCleanup)==null||e.call(this)}_setRoomPresence(e){var o;if(this._dbReady())try{const i=$e.ROOM_ACTIVITIES[e]??`${this.config.icon} ${this.config.name}`;u.setPresence("online",i,e),(o=window.Core)!=null&&o.state&&(window.Core.state.currentRoom=e,window.Core.state.currentUser&&(window.Core.state.currentUser.activity=i))}catch(i){console.error("[PracticeRoom] _setRoomPresence error:",i)}}_clearRoomPresence(){var e;if(this._dbReady())try{u.setPresence("online","✨ Available",null),(e=window.Core)!=null&&e.state&&(window.Core.state.currentRoom=null,window.Core.state.currentUser&&(window.Core.state.currentUser.activity="✨ Available"))}catch(o){console.error("[PracticeRoom] _clearRoomPresence error:",o)}}async fetchRoomParticipants(){if(this._dbReady())try{const[e,o]=await Promise.all([u.getRoomParticipants(this.roomId),Ue.get()]),i=e.filter(n=>!o.has(n.user_id));this.state.participants=i.length,this._updateParticipantUI(i),this._updateRoomCardCount(i.length)}catch(e){console.error(`[${this.roomId}] fetchRoomParticipants error:`,e)}}_updateParticipantUI(e){const o=document.getElementById(`${this.roomId}ParticipantCount`);o&&(o.textContent=this.getParticipantText());const i=document.getElementById(`${this.roomId}ParticipantStack`);i&&(i.innerHTML=this._buildAvatarStack(e))}async _refreshParticipantSidebar(e,o=null){var n;if(!this._dbReady())return;const i=async()=>{if(this._participantFetchInFlight)return;this._participantFetchInFlight=!0;const[r,a]=await Promise.all([u.getRoomParticipants(this.roomId),Ue.get()]),s=r.filter(c=>!a.has(c.user_id));this._participantFetchInFlight=!1;const l=s.map(c=>c.user_id).sort().join(",");if(l===this._lastParticipantKey)return;this._lastParticipantKey=l,this.state.participants=s.length,this._updateParticipantUI(s);const d=document.getElementById(e);if(d&&this._renderParticipantList(d,s),o){const c=document.getElementById(o);c&&(c.textContent=`${s.length} present`)}this._updateRoomCardCount(s.length)};try{await i()}catch(r){this._participantFetchInFlight=!1,console.error(`[${this.roomId}] _refreshParticipantSidebar error:`,r);return}(n=this._sidebarPresenceSub)==null||n.unsubscribe(),this._sidebarPresenceSub=u.subscribeToPresence(async()=>{var r;document.getElementById(e)?await i():((r=this._sidebarPresenceSub)==null||r.unsubscribe(),this._sidebarPresenceSub=null)})}_updateRoomCardCount(e){this.state.participants=e;const o=document.querySelector(`[data-room-id="${this.roomId}"] .room-participants`);o&&(o.textContent=this.getParticipantText())}_buildAvatarStack(e,o=22,i=9){const{MAX:n,fallbackGradient:r}=De,a=e.slice(0,n),s=e.length-n,l=a.map(c=>{var _,k;const p=c.profiles||{},h=ge(p.name||"Member"),m=ge(p.avatar_url||""),f=ge(p.emoji||"")||h.charAt(0).toUpperCase(),v=((k=(_=window.Core)==null?void 0:_.getAvatarGradient)==null?void 0:k.call(_,c.user_id||h))??r,S=m?`<img src="${m}" width="40" height="40" style="width:100%;height:100%;object-fit:cover;border-radius:50%;" alt="${h}" loading="lazy" decoding="async">`:`<span style="color:white;font-size:${i}px;font-weight:700;">${f}</span>`;return`<div title="${h}" style="width:${o}px;height:${o}px;border-radius:50%;background:${m?"transparent":v};border:2px solid var(--surface);display:flex;align-items:center;justify-content:center;overflow:hidden;margin-left:-6px;flex-shrink:0;">${S}</div>`}).join(""),d=s>0?`<span style="font-size:10px;color:var(--text-muted);margin-left:4px;">+${s}</span>`:"";return l+d}_buildRealAvatars(e){const{MAX:o,fallbackGradient:i}=De,n=e.slice(0,o),r=e.length-o;return n.map(s=>{var R,O;const l=s.profiles||{},d=s.user_id||l.id||"",c=ge(l.name||"Member"),p=ge(l.avatar_url||""),h=ge(l.emoji||""),m=((O=(R=window.Core)==null?void 0:R.getAvatarGradient)==null?void 0:O.call(R,d||c))??i,g=p?`<img src="${p}" width="40" height="40" style="width:100%;height:100%;object-fit:cover;border-radius:50%;" alt="${c}" loading="lazy" decoding="async">`:`<span aria-hidden="true">${h||c.charAt(0).toUpperCase()}</span>`,f=p?"background:transparent;":`background:${m};`,v=d?`onclick="openMemberProfileAboveRoom('${d}')"`:"",S=d?"button":"img",L=d?'tabindex="0"':"",_=d?`onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();openMemberProfileAboveRoom('${d}');}"`:"",k=`aria-label="${c}"`;return`<div class="p-avatar" style="${f}" title="${c}" role="${S}" ${L} ${k} ${v} ${_}>${g}</div>`}).join("")+(r>0?`<div class="p-avatar" style="background:var(--surface);color:var(--text-muted);font-size:11px;">+${r}</div>`:"")}_renderParticipantList(e,o){if(!o.length){e.innerHTML='<div style="color:var(--text-muted);font-size:13px;padding:8px;">Just you here 🕯️</div>';return}const{fallbackGradient:i}=De;e.innerHTML=o.map(n=>{var v,S;const r=n.profiles||{},a=n.user_id||r.id||"",s=ge(r.name||"Member"),l=ge(r.avatar_url||""),d=ge(r.emoji||""),c=((S=(v=window.Core)==null?void 0:v.getAvatarGradient)==null?void 0:S.call(v,a||s))??i,p=l?`<img src="${l}" referrerpolicy="no-referrer" width="40" height="40" style="width:40px;height:40px;min-width:40px;min-height:40px;object-fit:cover;border-radius:50%;display:block;" alt="${s}" loading="lazy" decoding="async">`:`<span style="color:white;font-weight:600;font-size:13px;">${d||s.charAt(0).toUpperCase()}</span>`,h=l?"background:transparent;":`background:${c};`,m=a?`onclick="openMemberProfileAboveRoom('${a}')"`:"",g=a?`onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();openMemberProfileAboveRoom('${a}');}"`:"";return`
            <div class="campfire-participant" ${m} ${g} ${a?'role="button" tabindex="0"':""} style="${a?"cursor:pointer;":""}">
                ...
                <div class="campfire-participant-info">
                    ...
                    <div class="campfire-participant-country">${ge(n.activity||"✨ Available")}</div>
                </div>
            </div>`}).join("")}async _blessRoom(){var s;const e=document.getElementById(`${this.roomId}BlessBtn`);if(!this._dbReady()){window.Core.showToast("Blessing sent ✨"),this._showBlessingAnimation(null);return}const o=Date.now(),i=this._lastBlessedAt??0,n=6e4;if(o-i<n){const l=Math.ceil((n-(o-i))/1e3);window.Core.showToast(`✦ Room is holding your blessing — try again in ${l}s`);return}if(e){if(e.dataset.blessed)return;e.dataset.blessed="1",e.style.opacity="0.7",e.innerHTML=`${Pe} Blessed ✦`,setTimeout(()=>{delete e.dataset.blessed,e.style.opacity="1";const l='<div class="bless-dots"><div class="bless-dot"></div><div class="bless-dot"></div><div class="bless-dot"></div></div>';e.innerHTML=`${l} ${Pe} Bless this room ${l}`},3e3)}this._lastBlessedAt=o,this._showBlessingAnimation(null),window.Core.showToast("Blessing sent ✨");const r=await u.blessRoom(this.roomId);if(r.status==="cooldown"){window.Core.showToast("✦ This room is still holding your last blessing"),this._lastBlessedAt=o;return}if(r.status==="error")return;this._blessingRows=this._blessingRows??[];const a=u.userId;if(a&&!this._blessingRows.some(l=>(l.user_id||l.userId)===a)){const l=((s=r.data)==null?void 0:s.profiles)??null;this._blessingRows=[...this._blessingRows,{user_id:a,profiles:l}]}this._updateCardBlessingBadge(this._blessingRows.length),this._refreshBlessingCounter()}async _loadBlessingCount(){if(this._dbReady())try{const e=await u.getRoomBlessings(this.roomId);this._blessingRows=e,this._updateCardBlessingBadge(e.length)}catch{}}_updateCardBlessingBadge(e){const o=document.getElementById(`${this.roomId}BlessBtn`);if(!o)return;const i='<div class="bless-dots"><div class="bless-dot"></div><div class="bless-dot"></div><div class="bless-dot"></div></div>';o.style.color="#fff",o.innerHTML=`${i} ${Pe} Bless this room ${i}`}_subscribeToBlessings(){this._dbReady()&&u.subscribeToBlessings(this.roomId,e=>{this._showBlessingAnimation(e),this._optimisticBlessingBump(e),this._debouncedRefreshBlessingCounter()})}_optimisticBlessingBump(e){this._blessingRows=this._blessingRows??[];const o=(e==null?void 0:e.userId)||(e==null?void 0:e.user_id);o&&!this._blessingRows.some(i=>(i.user_id||i.userId)===o)&&(this._blessingRows=[...this._blessingRows,e]),this._renderBlessingCounter(this._blessingRows),this._updateCardBlessingBadge(this._blessingRows.length)}_debouncedRefreshBlessingCounter(){clearTimeout(this._blessingRefreshTimer),this._blessingRefreshTimer=setTimeout(()=>this._refreshBlessingCounter(),3e3)}async _refreshBlessingCounter(){if(this._dbReady())try{const e=await u.getRoomBlessings(this.roomId);this._blessingRows=e,this._renderBlessingCounter(e),this._updateCardBlessingBadge(e.length)}catch{}}_normaliseBlessingRow(e){return e.profiles?e:{user_id:e.userId||e.user_id,profiles:{name:e.name||"A member",avatar_url:e.avatarUrl||"",emoji:e.emoji||""}}}_renderBlessingCounter(e){const o=document.getElementById(`${this.roomId}BlessedCounter`);if(!o)return;if(!e.length){o.innerHTML='<span style="font-size:12px;color:var(--text-muted);opacity:0.6;">No blessings yet</span>';return}const i=e.map(s=>this._normaliseBlessingRow(s)),n=this._buildAvatarStack(i),r=Math.max(0,e.length-De.MAX),a=r>0?`<span style="font-size:10px;color:var(--text-muted);margin-left:4px;">+${r}</span>`:"";o.innerHTML=`
            <span style="font-size:11px;color:var(--text-muted);white-space:nowrap;margin-right:4px;display:inline-flex;align-items:center;gap:0.25rem;">${we.bless} Blessed by</span>
            <div style="display:flex;align-items:center;margin-left:6px;">${n}</div>
            ${a}`}_showBlessingAnimation(e){if(document.getElementById("blessingAnimationOverlay"))return;const o=3e3,i=window.innerWidth<768,n=window.innerWidth,r=window.innerHeight,a=n/2,s=r/2,l=document.createElement("div");l.id="blessingAnimationOverlay",l.style.cssText=["position:fixed;inset:0;pointer-events:none;z-index:999999;","backdrop-filter:blur(6px);-webkit-backdrop-filter:blur(6px);","background:rgba(0,0,0,0);","transition:background 0.2s ease;"].join(""),document.body.appendChild(l),requestAnimationFrame(()=>{l.style.background="rgba(0,0,0,0.25)"});const d=document.createElement("canvas");d.width=n,d.height=r,d.style.cssText="position:absolute;inset:0;width:100%;height:100%;background:transparent;",l.appendChild(d);const c=d.getContext("2d"),p=document.createElement("div");p.style.cssText=["position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) scale(0.6);","color:rgba(255,230,120,0.95);font-size:clamp(36px,8vw,72px);font-weight:300;","letter-spacing:0.25em;text-transform:uppercase;white-space:nowrap;","font-family:var(--serif,Georgia,serif);","text-shadow:0 0 40px rgba(255,200,60,0.8),0 0 80px rgba(255,180,40,0.4);","opacity:0;transition:opacity 0.35s ease,transform 0.5s cubic-bezier(0.34,1.56,0.64,1);","pointer-events:none;"].join(""),p.textContent="✦  Blessed  ✦",l.appendChild(p),setTimeout(()=>{p.style.opacity="1",p.style.transform="translate(-50%,-50%) scale(1)"},o*.42),setTimeout(()=>{p.style.opacity="0",p.style.transform="translate(-50%,-50%) scale(1.15)",p.style.transition="opacity 0.4s ease,transform 0.4s ease"},o-600);const h=(e==null?void 0:e.name)??null;if(h){const m=document.createElement("div");m.style.cssText=["position:absolute;bottom:18%;left:50%;transform:translateX(-50%);","color:rgba(255,230,160,0.9);font-size:15px;font-weight:400;","letter-spacing:0.18em;text-transform:uppercase;white-space:nowrap;","font-family:var(--serif,Georgia,serif);","opacity:0;transition:opacity 0.6s ease 0.6s;"].join(""),m.textContent=`✦  ${h} blesses this room  ✦`,l.appendChild(m),requestAnimationFrame(()=>{m.style.opacity="1"}),setTimeout(()=>{m.style.opacity="0",m.style.transition="opacity 0.4s ease"},o-500)}requestAnimationFrame(()=>{const m=i?120:260,g=[];for(let L=0;L<m;L++){const _=Math.random()*Math.PI*2,k=20+Math.random()*Math.max(n,r)*.55,R=Math.random()<.75,O=R?38+Math.random()*18:265+Math.random()*25,T=R?85+Math.random()*15:70+Math.random()*20,z=60+Math.random()*25;g.push({angle:_,radius:k,x:a+Math.cos(_)*k,y:s+Math.sin(_)*k,size:1+Math.random()*(i?2:3),hue:O,sat:T,lit:z,delay:Math.random()*.3,speed:.8+Math.random()})}const f=performance.now();let v;const S=L=>{const _=(L-f)/o,k=.42,R=.48,O=1;if(c.globalCompositeOperation="destination-out",c.globalAlpha=.18,c.fillStyle="rgba(0,0,0,1)",c.fillRect(0,0,n,r),c.globalCompositeOperation="source-over",c.globalAlpha=1,_>k*.6&&_<O*.85){const T=_<R?(_-k*.6)/(R-k*.6):1-(_-R)/(O-R),z=Math.max(0,Math.min(1,T)),Y=80+T*120,B=c.createRadialGradient(a,s,0,a,s,Y);B.addColorStop(0,`rgba(255,220,100,${.55*z})`),B.addColorStop(.5,`rgba(200,150, 60,${.25*z})`),B.addColorStop(1,"rgba(200,150, 60,0)"),c.globalAlpha=1,c.fillStyle=B,c.beginPath(),c.arc(a,s,Y,0,Math.PI*2),c.fill()}g.forEach(T=>{const z=Math.max(0,_-T.delay*.3);let Y,B,X;if(z<k){const G=z/k,Q=1-(1-G)*(1-G),E=T.radius*(1-Q*.97),M=Q*Math.PI*2.5*(T.radius>0?1:-1);Y=a+Math.cos(T.angle+M)*E,B=s+Math.sin(T.angle+M)*E,X=Math.min(1,Q*2.5)}else if(z<R)Y=a+(Math.random()-.5)*8,B=s+(Math.random()-.5)*8,X=1;else{const G=(z-R)/(O-R),Q=G*G,E=T.angle+Math.PI*(.7+Math.random()*.6),M=Q*Math.max(n,r)*.7*T.speed;Y=a+Math.cos(E)*M,B=s+Math.sin(E)*M,X=Math.max(0,1-G*1.15)}X<=0||(c.globalAlpha=X,c.fillStyle=`hsl(${T.hue},${T.sat}%,${T.lit}%)`,c.shadowBlur=i?4:8,c.shadowColor=`hsl(${T.hue},100%,70%)`,c.beginPath(),c.arc(Y,B,T.size,0,Math.PI*2),c.fill())}),c.globalAlpha=1,c.shadowBlur=0,_<1?v=requestAnimationFrame(S):(l.style.transition="opacity 0.3s ease",l.style.opacity="0",setTimeout(()=>l.remove(),350),cancelAnimationFrame(v))};v=requestAnimationFrame(S)})}buildHeader(){var e;return`
        <header class="ps-header" style="padding:12px 16px;display:flex;flex-direction:column;gap:12px;${this.getHeaderGradient()}">
            ...
            <div class="ps-header-btn-grid">
                ...
                <button type="button" class="ps-leave ps-header-btn" data-action="gentlyLeave">
                    ${we.leave} Gently Leave
                </button>
            </div>
        </header>`}buildSafetyDropdown(){const e=[["CommunityModule.showReportModal()",we.alert,"Report Issue"],["CommunityModule.showBlockModal()",we.block,"Block User"],["CommunityModule.muteChat()",we.mute,"Mute Chat"],["CommunityModule.showHelpModal()",we.help,"Get Help"]];return`
        <div style="position:relative;" id="${this.roomId}SafetyDropdownContainer">
            <button type="button" class="ps-leave" data-action="toggleSafety"
                ...
                ${we.shield} Safety <span style="font-size:12px;">▼</span>
            </button>
            <div id="${this.roomId}SafetyDropdown"
                ...
                <button type="button" data-action="showInstructions"
                    ...
                    <span aria-hidden="true">${we.book}</span> Instructions
                </button>
                ${e.map(([o,i,n],r,a)=>{const s=r<a.length-1?"border-bottom:1px solid var(--border);":"";return`<button type="button" onclick="${o}" style="width:100%;padding:12px 16px;text-align:left;background:none;border:none;${s}cursor:pointer;display:flex;align-items:center;gap:12px;color:var(--text);"><span aria-hidden="true">${i}</span> ${n}</button>`}).join("")}
            </div>
        </div>`}buildParticipantAvatars(){const[e,o]=this.config.name.split(" ").map(i=>i[0]);return`
        <div class="participant-stack" id="${this.roomId}ParticipantStack">
            ...
            <div class="p-avatar" style="background:linear-gradient(135deg,#4facfe,#00f2fe);" aria-hidden="true">${o||"R"}</div>
        ...
        <div class="modal-overlay" id="${this.roomId}InstructionsModal">
            ...
            </ul>`}buildParticipantSidebarHTML(e,o,i,n="400px"){return`
        <div style="border:1px solid var(--border);border-radius:var(--radius-md);padding:6px 8px;background:var(--background);">
            ...
            <div id="${o}" class="campfire-participants" style="height:${n};overflow-y:auto;">
                <div style="color:var(--text-muted);font-size:13px;padding:8px;">Loading...</div>
            </div>
        </div>`}updateRoomCard(){var i;const e=document.querySelector(`[data-room-id="${this.roomId}"]`);if(!e)return;const o=e.querySelector(".room-energy span");if(o&&(o.textContent=this.getParticipantText()),this.roomType==="timed"){const n=this.canEnterRoom(),r=this._isWithinOpenWindow();e.style.cursor=n?"pointer":"not-allowed",e.style.opacity=r?"1":"0.55",e.style.border=`3px solid ${r?"#22c55e":"#ef4444"}`,e.onclick=n?()=>this.enterRoom():null,e.classList.toggle("active",r),e.classList.toggle("in-session",!r);let a=e.querySelector(".in-session-label");!r&&!a?(a=document.createElement("div"),a.className="in-session-label",a.style.cssText="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;z-index:2;pointer-events:none;",a.innerHTML=tt,e.appendChild(a)):r&&a&&a.remove();const s=e.querySelector(".room-timer");s&&this.getTimerText&&(s.innerHTML=this.getTimerText())}else e.style.border="3px solid #22c55e",e.classList.add("active");(i=this.onUpdateCard)==null||i.call(this,e)}getRoomCardHTML(){const e=this.canEnterRoom(),o=this.roomType==="timed",i=!o||this._isWithinOpenWindow(),n=`${this.roomId}_enterRoom`;return window[n]=()=>this.enterRoom(),`
        <div class="practice-room ${i?"active":"in-session"}"
            ...
            ${!i&&o?`<div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;z-index:2;pointer-events:none;">${tt}</div>`:""}
        ...
        </div>`}setupEventListeners(){this._teardownDelegatedListeners(),this._actionsCache=this.getActions();const e=i=>{const n=i.target.closest("[data-action]");if(n){i.stopPropagation();const r=this._actionsCache[n.dataset.action];if(r){r(i);return}console.warn(`[${this.roomId}] Unknown data-action: "${n.dataset.action}"`);return}this._handleOutsideClick(i)},o=i=>{if(i.target.tagName!=="SELECT")return;const n=i.target.closest("[data-action]");if(!n)return;const r=this._actionsCache[n.dataset.action];r&&r(i)};document.addEventListener("click",e),document.addEventListener("change",o),this._delegatedClickHandler=e,this._delegatedChangeHandler=o,this.eventListeners.push({element:document,event:"click",handler:e},{element:document,event:"change",handler:o})}_teardownDelegatedListeners(){this._delegatedClickHandler&&(document.removeEventListener("click",this._delegatedClickHandler),document.removeEventListener("change",this._delegatedChangeHandler),this.eventListeners=this.eventListeners.filter(({handler:e})=>e!==this._delegatedClickHandler&&e!==this._delegatedChangeHandler),this._delegatedClickHandler=null,this._delegatedChangeHandler=null)}getActions(){return{gentlyLeave:()=>this.gentlyLeave(),toggleSafety:e=>this.toggleSafetyDropdown(e),showInstructions:()=>this.showInstructions(),closeInstructions:()=>this.closeInstructions(),showSchedule:()=>{var e;return(e=this.showScheduleModal)==null?void 0:e.call(this)},closeScheduleModal:()=>{var e;return(e=this.closeScheduleModal)==null?void 0:e.call(this)},toggleDimMode:()=>{var e;return(e=this.toggleDimMode)==null?void 0:e.call(this)},toggleTimer:()=>{var e;return(e=this.toggleTimer)==null?void 0:e.call(this)},adjustTime:e=>{var o;return(o=this.adjustTime)==null?void 0:o.call(this,+this._actionEl(e).dataset.minutes)},toggleSoundSettings:()=>{var e;return(e=this.toggleSoundSettings)==null?void 0:e.call(this)},toggle5minBell:()=>{var e;return(e=this.toggle5minBell)==null?void 0:e.call(this)},toggleAmbientSound:()=>{var e;return(e=this.toggleAmbientSound)==null?void 0:e.call(this)},selectBell:e=>{var o;return(o=this.selectBell)==null?void 0:o.call(this,this._actionEl(e).dataset.value)},selectCompletion:e=>{var o;return(o=this.selectCompletion)==null?void 0:o.call(this,this._actionEl(e).dataset.value)},selectAmbient:e=>{var o;return(o=this.selectAmbient)==null?void 0:o.call(this,this._actionEl(e).dataset.value)},previewSound:e=>{var o;return(o=this.previewSound)==null?void 0:o.call(this,this._actionEl(e).dataset.value,e)},previewAmbient:e=>{var o;return(o=this.previewAmbient)==null?void 0:o.call(this,this._actionEl(e).dataset.value,e)},sendMessage:e=>{var o;return(o=this.sendMessage)==null?void 0:o.call(this,this._actionEl(e).dataset.channel)},switchTab:e=>{var o;return(o=this.switchTab)==null?void 0:o.call(this,this._actionEl(e).dataset.tab)},skipBackward:()=>{var e;return(e=this.skipBackward)==null?void 0:e.call(this)},togglePlayPause:()=>{var e;return(e=this.togglePlayPause)==null?void 0:e.call(this)},skipForward:()=>{var e;return(e=this.skipForward)==null?void 0:e.call(this)}}}_actionEl(e){return e.target.closest("[data-action]")}_handleOutsideClick(e){var i;const o=document.getElementById(`${this.roomId}SafetyDropdownContainer`);if(o&&!o.contains(e.target)){const n=document.getElementById(`${this.roomId}SafetyDropdown`);n&&(n.style.display="none")}(i=this.onOutsideClick)==null||i.call(this,e)}toggleSafetyDropdown(e){e==null||e.stopPropagation();const o=document.getElementById(`${this.roomId}SafetyDropdown`),i=document.getElementById(`${this.roomId}SafetyDropdownContainer`);if(o){if(o.style.display==="block"){o.style.display="none";return}if(i){const{bottom:n,right:r}=i.getBoundingClientRect();Object.assign(o.style,{position:"fixed",top:`${n+6}px`,right:`${window.innerWidth-r}px`,left:"auto",zIndex:"2147483640",marginTop:"0"})}o.style.display="block"}}showInstructions(){var e,o;(e=document.getElementById(`${this.roomId}SafetyDropdown`))==null||e.style.setProperty("display","none"),(o=document.getElementById(`${this.roomId}InstructionsModal`))==null||o.classList.add("active")}closeInstructions(){var e;(e=document.getElementById(`${this.roomId}InstructionsModal`))==null||e.classList.remove("active")}getParticipantText(){return`${this.state.participants} present`}getHeaderGradient(){return"background:linear-gradient(135deg,rgba(139,92,246,0.1) 0%,rgba(168,85,247,0.05) 100%);"}getDevModeBadge(){return""}formatTime(e){return`${Math.floor(e/60)}:${String(e%60).padStart(2,"0")}`}registerEventListener(e,o,i){e.addEventListener(o,i),this.eventListeners.push({element:e,event:o,handler:i})}};D._hubPresenceSub=null;D._hubRooms=[];D.ROOM_ACTIVITIES={"silent-room":"🧘 Silent practice","guided-room":"🎧 Guided session","breathwork-room":"💨 Breathwork","campfire-room":"🔥 Around the fire","osho-room":"🌀 Osho space","deepwork-room":"🎯 Deep work","tarot-room":"🔮 Tarot reading","reiki-room":"✨ Reiki session"};D.startHubPresence=async function(t){t&&(D._hubRooms=t);const e=D._hubRooms;if(!e.length)return;if(!(u!=null&&u.ready)){const i=setInterval(()=>{u!=null&&u.ready&&(clearInterval(i),D.startHubPresence())},500);return}D.stopHubPresence();const o=async()=>{const i=await u.getActiveMembers(),n=i.filter(r=>r.is_phantom).length;e.forEach(r=>{const a=i.filter(s=>s.room_id===r.roomId).length;r.state.participants=a+n,r._updateRoomCardCount(a+n)})};await o(),D._hubPresenceSub=u.subscribeToPresence(o)};D.stopHubPresence=function(){if(D._hubPresenceSub){try{D._hubPresenceSub.unsubscribe()}catch{}D._hubPresenceSub=null}};window.PracticeRoom=D;window.dispatchRoomReady=function(t){document.dispatchEvent(new CustomEvent("practiceRoomReady",{detail:{roomKey:t}}))};window.openMemberProfileAboveRoom=function(t){!window.MemberProfileModal||!t||(MemberProfileModal.open(t),requestAnimationFrame(()=>{const e=openMemberProfileAboveRoom._cachedEls;(!e||e.some(o=>!o.isConnected))&&(openMemberProfileAboveRoom._cachedEls=[document.getElementById("memberProfileModal"),document.getElementById("memberProfileOverlay"),document.querySelector(".member-profile-overlay"),document.querySelector(".member-profile-modal"),document.querySelector('[class*="member"][class*="modal"]'),document.querySelector('[id*="memberProfile"]')].filter(Boolean)),openMemberProfileAboveRoom._cachedEls.forEach(o=>{o.style.zIndex="200000"})}))};const We={ENDED:0,PLAYING:1},Nt={initPlayerState(){this.state.player=null,this.state.playerReady=!1,this.state.playerInitialized=!1,this.state.sessionStarted=!1,this._progressInterval=null},preloadYouTubeAPI(){if(document.querySelector('script[src*="youtube.com/iframe_api"]'))return;const t=document.createElement("script");t.src="https://www.youtube.com/iframe_api",document.head.appendChild(t)},loadYouTubeAPI(){var e;if((e=window.YT)!=null&&e.Player){this.initPlayer();return}const t=window.onYouTubeIframeAPIReady;window.onYouTubeIframeAPIReady=()=>{t==null||t(),this.initPlayer()}},initPlayer(){if(this.state.playerInitialized)return;const t=this.getCurrentSession();if(!(t!=null&&t.videoId)){console.warn(`[${this.roomId}] No video session available`);return}this.state.player=new YT.Player(`${this.roomId}-youtube-player`,{videoId:t.videoId,playerVars:{autoplay:0,controls:1,modestbranding:1,rel:0,mute:1},events:{onReady:e=>this.onPlayerReady(e),onStateChange:e=>this.onPlayerStateChange(e)}}),this.state.playerInitialized=!0},onPlayerReady(t){var e,o,i,n;this.state.playerReady=!0,t.target.cueVideoById((e=this.getCurrentSession())==null?void 0:e.videoId),this.state.isInSession&&((i=(o=window.Core.state)==null?void 0:o.currentUser)!=null&&i.is_admin)&&this._startAtCycleOffset(t.target),(n=this.onPlayerReadyCustom)==null||n.call(this,t)},_startAtCycleOffset(t){const e=this.config.cycleDuration*1e3,o=this.config.openDuration*1e3,n=(Date.now()-this.state.cycleStartTime)%e,r=Math.max(0,(n-o)/1e3);t.seekTo(r,!0),t.unMute(),t.setVolume(100),t.playVideo(),this.state.sessionStarted=!0,this._showPlayer();const a=this.getCurrentSession();a&&window.Core.showToast(`${a.emoji} Joining session in progress…`)},onPlayerStateChange(t){t.data===We.PLAYING?this.onVideoPlaying():t.data===We.ENDED&&this.onVideoEnded()},onVideoPlaying(){this._showPlayer(),this.startProgressTracking()},onVideoEnded(){this.stopProgressTracking(),window.Core.showToast("Session complete")},startSession(){var e,o,i;if(!this.state.playerReady||this.state.sessionStarted)return;const t=this.getCurrentSession();t&&(this._showPlayer(),(e=this.state.player)==null||e.unMute(),(o=this.state.player)==null||o.setVolume(100),(i=this.state.player)==null||i.playVideo(),this.state.sessionStarted=!0,window.Core.showToast(`${t.emoji} Session starting…`))},togglePlayPause(){if(!this.state.player)return;const t=this.state.player.getPlayerState()===We.PLAYING;t?this.state.player.pauseVideo():this.state.player.playVideo();const e=document.getElementById(`${this.roomId}PlayBtn`);e&&(e.innerHTML=`<span style="font-size:24px;">${t?"▶":"⏸"}</span>`)},_seek(t){this.state.player&&this.state.player.seekTo(Math.max(0,this.state.player.getCurrentTime()+t))},skipBackward(){this._seek(-10)},skipForward(){this._seek(10)},startProgressTracking(){this._progressInterval||(this._progressInterval=setInterval(()=>this.updateTimeDisplay(),1e3))},stopProgressTracking(){this._progressInterval&&(clearInterval(this._progressInterval),this._progressInterval=null)},updateTimeDisplay(){var e;if(!((e=this.state.player)!=null&&e.getCurrentTime))return;const t=document.getElementById(`${this.roomId}TimeDisplay`);if(t){const o=Math.floor(this.state.player.getCurrentTime()),i=Math.floor(this.state.player.getDuration());t.textContent=`${this.formatTime(o)} / ${this.formatTime(i)}`}},_showPlayer(){const t=document.getElementById(`${this.roomId}PlayerOverlay`);t&&(t.style.display="none");const e=document.getElementById(`${this.roomId}Controls`);e&&(e.style.display="flex")},buildPlayerContainer(){const t=this.getCurrentSession();return`
        ...
        </div>`},cleanupPlayer(){var t;this.stopProgressTracking(),(t=this.state.player)==null||t.destroy(),this.state.player=null,this.state.playerReady=!1,this.state.playerInitialized=!1,this.state.sessionStarted=!1}},Ot={initCycleState(){this.state.isOpen=!1,this.state.isInSession=!1,this.state.cycleStartTime=null,this.state.nextOpenTime=null,this.state.nextSessionStart=null,this._cycleInterval=null},initializeCycle(){var o;const t=Date.now(),e=this.config.cycleDuration*1e3;this.state.cycleStartTime=t-t%e,(o=this.setSessions)==null||o.call(this,t),this.calculateCycleState(),this._cycleInterval&&clearInterval(this._cycleInterval),this._cycleInterval=setInterval(()=>{this.calculateCycleState(),this.updateRoomCard()},1e3)},calculateCycleState(){var a,s;const t=Date.now(),e=this.config.cycleDuration*1e3,o=this.config.openDuration*1e3,i=(t-this.state.cycleStartTime)%e,n=t-i;n!==this.state.cycleStartTime&&(this.state.cycleStartTime=n,(a=this.setSessions)==null||a.call(this,t));const r=i<o;if(this.state.isOpen=r,this.state.isInSession=!r,r){const l=o-i;this.state.nextSessionStart=t+l,this.state.nextOpenTime=t+l+this.config.sessionDuration*1e3}else this.state.nextOpenTime=t+(e-i),this.state.nextSessionStart=null;this.state.isInSession&&!this.state.sessionStarted&&this.isUserInRoom()&&((s=this.startSession)==null||s.call(this))},isUserInRoom(){var t,e;return((e=(t=window.Core)==null?void 0:t.state)==null?void 0:e.currentRoom)===this.roomId},canEnterRoom(){var t,e;return((e=(t=window.Core.state)==null?void 0:t.currentUser)==null?void 0:e.is_admin)||this.state.isOpen},_checkCycleWindow(){return this.state.isOpen},_formatCountdown(t,e){if(!t)return"";const o=Math.max(0,t-Date.now()),i=Math.floor(o/6e4),n=Math.floor(o%6e4/1e3);return`${e} ${i}:${String(n).padStart(2,"0")}`},getTimeUntilSessionStarts(){return this._formatCountdown(this.state.nextSessionStart,"Session begins in")},getCountdownToNextOpen(){return this._formatCountdown(this.state.nextOpenTime,"Opens in")},getTimerText(){var o,i;const t=((i=(o=this.getNextSession)==null?void 0:o.call(this))==null?void 0:i.title)??"Next Session",e=this.state.isOpen?this.getTimeUntilSessionStarts():this.getCountdownToNextOpen();return`<strong>Next:</strong> ${t}<br>${e}`},buildScheduleLink(){return`
        ...
        </button>`},cleanupCycle(){this._cycleInterval&&(clearInterval(this._cycleInterval),this._cycleInterval=null)}},Ee=t=>t.charAt(0).toUpperCase()+t.slice(1);function Ge(t,e,o,i){var l,d;const n=o||t.charAt(0).toUpperCase(),r=((d=(l=window.Core)==null?void 0:l.getAvatarGradient)==null?void 0:d.call(l,i||t))??"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",a=e?`<img src="${e}" width="36" height="36" style="width:36px;height:36px;object-fit:cover;border-radius:50%;display:block;flex-shrink:0;" alt="${t}" loading="lazy" decoding="async">`:`<span style="color:white;font-size:13px;font-weight:600;line-height:1;">${n}</span>`,s=e?"background:transparent;":`background:${r};`;return{inner:a,bg:s,gradient:r,initial:n}}const ot=t=>new Date(t).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});function Ft(t){return!t||typeof t!="string"?"":t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}const ze={initChatState(t=["main"]){this.chatChannels=t,this.state.messages=Object.fromEntries(t.map(e=>[e,[]]))},async initializeChat(){await Promise.all(this.chatChannels.map(t=>this.loadRoomChatFromDB(t))),setTimeout(()=>this._injectSenderAvatar(),200)},_getDbRoomId(t="main"){return t==="main"?this.roomId:`${this.roomId}-${t}`},_msgContainerId(t){return`${this.roomId}${Ee(t)}Messages`},_inputId(t){return`${this.roomId}${Ee(t)}Input`},_rowToMsgData(t,e=!1){var c,p;const o=t.profiles||{},i=((p=(c=window.Core)==null?void 0:c.state)==null?void 0:p.currentUser)||{},n=e?i.name||"You":o.name||"Member",r=e?i.avatar_url||"":o.avatar_url||"",a=e?i.emoji||"":o.emoji||"",s=o.id||null,{gradient:l,initial:d}=Ge(n,r,a,s);return{name:n,initial:d,avatarUrl:r,avatarBg:l,userId:s,time:ot(t.created_at),text:t.message,country:null}},async sendMessage(t="main",e=null){var c,p,h;const o=document.getElementById(e||this._inputId(t));if(!(o!=null&&o.value.trim()))return;const i=o.value.trim(),n=document.getElementById(this._msgContainerId(t)),r=((p=(c=window.Core)==null?void 0:c.state)==null?void 0:p.currentUser)||{},a=r.name||"You",{gradient:s,initial:l}=Ge(a,r.avatar_url||"",r.emoji||"",r.id),d={name:a,initial:l,avatarUrl:r.avatar_url||"",avatarBg:s,userId:r.id||null,time:ot(new Date),text:i,country:null,timestamp:Date.now(),...(h=this.getCustomMessageData)==null?void 0:h.call(this,t)};if(this.state.messages[t].push(d),n&&(n.insertAdjacentHTML("beforeend",this.buildMessageHTML(d)),n.scrollTop=n.scrollHeight),o.value="",window.Core.showToast("Message sent"),u!=null&&u.ready)try{await u.sendRoomMessage(this._getDbRoomId(t),i)}catch(m){console.error("[ChatMixin] sendRoomMessage error:",m)}},async loadRoomChatFromDB(t="main"){var n,r,a;if(!(u!=null&&u.ready)){this.loadMessagesFromStorage(t),this.renderSavedMessages(t);return}const e=this._getDbRoomId(t),o=document.getElementById(this._msgContainerId(t)),i=(a=(r=(n=window.Core)==null?void 0:n.state)==null?void 0:r.currentUser)==null?void 0:a.id;try{const[s,l]=await Promise.all([u.getRoomMessages(e,50),u.getBlockedUsers()]);if(o&&s.length){const d=s.filter(c=>{var p;return!l.has((p=c.profiles)==null?void 0:p.id)}).map(c=>{var h;const p=((h=c.profiles)==null?void 0:h.id)===i;return this.buildMessageHTML(this._rowToMsgData(c,p))}).join("");d&&(o.insertAdjacentHTML("beforeend",d),o.scrollTop=o.scrollHeight)}u.subscribeToRoomChat(e,async d=>{var p,h;((p=d.profiles)==null?void 0:p.id)===i||(await u.getBlockedUsers()).has((h=d.profiles)==null?void 0:h.id)||!o||(o.insertAdjacentHTML("beforeend",this.buildMessageHTML(this._rowToMsgData(d))),o.scrollTop=o.scrollHeight)})}catch(s){console.error(`[ChatMixin] loadRoomChatFromDB error (${t}):`,s)}},buildMessageHTML(t){const e=t.avatarUrl?`background-image:url('${t.avatarUrl}');background-size:cover;background-position:center;`:`background:${t.avatarBg};`,o=t.avatarUrl?"":`<span style="color:white;font-size:13px;font-weight:600;line-height:1;">${t.initial}</span>`,i=t.userId?`<span class="campfire-msg-name" role="button" tabindex="0" style="cursor:pointer;" onclick="openMemberProfileAboveRoom('${t.userId}')" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();openMemberProfileAboveRoom('${t.userId}');}" aria-label="View profile of ${t.name}">${t.name}</span>`:`<span class="campfire-msg-name">${t.name}</span>`;return`
        <div class="campfire-msg">
            <div class="campfire-msg-avatar" aria-hidden="true" style="${e}width:36px;height:36px;min-width:36px;overflow:hidden;display:flex;align-items:center;justify-content:center;flex-shrink:0;">${o}</div>
        ...
        </div>`},buildChatContainer(t="main",e="Type your message..."){const o=Ee(t),i=`${this.roomId}${o}SenderAvatar`,n=`${this.roomId}${o}SendBtn`;return`
        <div class="chat-container" id="${this.roomId}${o}ChatContainer"
             style="display:flex;flex-direction:column;">
            <div class="chat-messages" id="${this.roomId}${o}Messages"></div>
        ...
        </div>`},_injectSenderAvatar(t=null){var r,a;const e=t?[t]:this.chatChannels||["main"],o=(a=(r=window.Core)==null?void 0:r.state)==null?void 0:a.currentUser;if(!o)return;const{inner:i,bg:n}=Ge(o.name||"Me",o.avatar_url||"",o.emoji||"",o.id);e.forEach(s=>{const l=document.getElementById(`${this.roomId}${Ee(s)}SenderAvatar`);if(!l)return;const d=o.avatar_url?`width:32px;height:32px;border-radius:50%;background-image:url('${o.avatar_url}');background-size:cover;background-position:center;flex-shrink:0;`:`width:32px;height:32px;border-radius:50%;${n}display:flex;align-items:center;justify-content:center;overflow:hidden;flex-shrink:0;`,c=o.avatar_url?"":i;l.innerHTML=`<div style="${d}">${c}</div>`})},loadMessagesFromStorage(t="main"){try{const e=localStorage.getItem(`${this.roomId}_messages_${t}`);e&&(this.state.messages[t]=JSON.parse(e))}catch(e){console.error("[ChatMixin] loadMessagesFromStorage error:",e),this.state.messages[t]=[]}},saveMessagesToStorage(t="main"){try{localStorage.setItem(`${this.roomId}_messages_${t}`,JSON.stringify(this.state.messages[t]))}catch(e){console.error("[ChatMixin] saveMessagesToStorage error:",e)}},renderSavedMessages(t="main"){const e=document.getElementById(this._msgContainerId(t)),o=this.state.messages[t];!e||!o.length||(e.insertAdjacentHTML("beforeend",o.map(i=>this.buildMessageHTML(i)).join("")),e.scrollTop=e.scrollHeight)},clearMessages(t="main"){this.state.messages[t]=[],localStorage.removeItem(`${this.roomId}_messages_${t}`);const e=document.getElementById(this._msgContainerId(t));e&&(e.innerHTML=""),window.Core.showToast("Messages cleared")},capitalize:Ee,_escapeHtml:Ft},Ut=[{value:"tingsha",label:"Tingsha Bells"},{value:"bowl",label:"Singing Bowl"},{value:"chime",label:"Wind Chime"}],Wt=[{value:"tibetan",label:"Tibetan Bowl"},{value:"gong",label:"Temple Gong"},{value:"bell",label:"Temple Bell"}],Gt=[{value:"stream",label:"Gentle Stream"},{value:"rain",label:"Soft Rain"},{value:"forest",label:"Forest Birds"},{value:"ocean",label:"Ocean Waves"}],it={stream:"/Community/Ambient/Stream.mp3",rain:"/Community/Ambient/Rain.mp3",forest:"/Community/Ambient/Forrest.mp3",ocean:"/Community/Ambient/Ocean.mp3"},Vt={tingsha:{baseFreq:900,partials:[{mult:1,gain:.6,decay:2.5},{mult:2.76,gain:.3,decay:1.8},{mult:5.4,gain:.15,decay:1}]},bowl:{baseFreq:220,partials:[{mult:1,gain:.7,decay:6},{mult:2.71,gain:.35,decay:4},{mult:5.2,gain:.12,decay:2.5}]},chime:{baseFreq:1200,partials:[{mult:1,gain:.5,decay:1.5},{mult:1.86,gain:.25,decay:1},{mult:3.01,gain:.1,decay:.6}]},tibetan:{baseFreq:180,partials:[{mult:1,gain:.7,decay:8},{mult:2.68,gain:.4,decay:6},{mult:5.1,gain:.15,decay:3.5}]},gong:{baseFreq:80,partials:[{mult:1,gain:.8,decay:6},{mult:2.2,gain:.5,decay:5},{mult:3.5,gain:.25,decay:3.5},{mult:5,gain:.1,decay:2}]},bell:{baseFreq:440,partials:[{mult:1,gain:.65,decay:4},{mult:2.75,gain:.3,decay:3},{mult:5.4,gain:.12,decay:1.8}]}},yt={initSoundState(){this.state.fiveMinBellEnabled=!1,this.state.ambientEnabled=!1,this.state.selectedBell="tingsha",this.state.selectedCompletion="tibetan",this.state.selectedAmbient="stream",this._audioCtx=null,this._ambientAudio=null},_getAudioCtx(){return this._audioCtx||(this._audioCtx=new(window.AudioContext||window.webkitAudioContext)),this._audioCtx.state==="suspended"&&this._audioCtx.resume(),this._audioCtx},_playBellProfile(t,e=1){const o=Vt[t];if(!o)return;const i=this._getAudioCtx(),n=i.currentTime;o.partials.forEach(({mult:r,gain:a,decay:s})=>{const l=i.createOscillator(),d=i.createGain();l.type="sine",l.frequency.setValueAtTime(o.baseFreq*r,n),d.gain.setValueAtTime(a*e,n),d.gain.exponentialRampToValueAtTime(1e-4,n+s),l.connect(d),d.connect(i.destination),l.start(n),l.stop(n+s)})},toggleSoundSettings(){var t;(t=document.getElementById(`${this.roomId}SoundSettings`))==null||t.classList.toggle("visible")},_toggleFeature(t,e,o,i,n,r){var l,d;const a=!this.state[t];this.state[t]=a,(l=document.getElementById(e))==null||l.classList.toggle("active",a);const s=document.getElementById(o);s&&(s.style.display=a?"block":"none"),window.Core.showToast(`${i} ${a?"enabled":"disabled"}`),(d=a?n:r)==null||d.call(this)},toggle5minBell(){this._toggleFeature("fiveMinBellEnabled",`${this.roomId}Toggle5min`,`${this.roomId}5minOptions`,"5-minute bell")},toggleAmbientSound(){this._toggleFeature("ambientEnabled",`${this.roomId}ToggleAmbient`,`${this.roomId}AmbientOptions`,"Ambient sound",this.playAmbientSound,this.stopAmbientSound)},selectBell(t){this.state.selectedBell=t},selectCompletion(t){this.state.selectedCompletion=t},selectAmbient(t){this.state.selectedAmbient=t,this.state.ambientEnabled&&(this.stopAmbientSound(),this.playAmbientSound())},previewSound(t,e){e==null||e.stopPropagation(),this._playBellProfile(t),window.Core.showToast(`▶ ${t}`)},previewAmbient(t,e){e==null||e.stopPropagation();const o=it[t];if(!o)return;this._previewAudio&&(this._previewAudio.pause(),this._previewAudio=null);const i=new Audio(o);i.volume=.5,i.play().catch(()=>window.Core.showToast("Preview unavailable")),this._previewAudio=i,setTimeout(()=>{i.pause(),this._previewAudio=null},4e3),window.Core.showToast(`▶ ${t}`)},playAmbientSound(){const t=it[this.state.selectedAmbient];if(!t)return;this.stopAmbientSound();const e=new Audio(t);e.loop=!0,e.volume=.35,e.play().catch(()=>window.Core.showToast("Ambient audio unavailable")),this._ambientAudio=e},stopAmbientSound(){this._ambientAudio&&(this._ambientAudio.pause(),this._ambientAudio.src="",this._ambientAudio=null)},play5MinBell(){this.state.fiveMinBellEnabled&&(this._playBellProfile(this.state.selectedBell,.7),window.Core.showToast("5-minute bell"))},playCompletionSound(){this._playBellProfile(this.state.selectedCompletion,1),window.Core.showToast("Session complete")},cleanupSound(){this.stopAmbientSound(),this._previewAudio&&(this._previewAudio.pause(),this._previewAudio=null),this._audioCtx&&(this._audioCtx.close(),this._audioCtx=null)},_soundOption(t,e,o,i,n){const r=this.state[`selected${t}`]===e;return`
        <div class="sound-option">
            ...
            <button type="button" class="sound-preview-btn"
                    ...
                    aria-label="Preview ${o}">▶</button>
        </div>`},buildSoundSettings(){const t=this.roomId,e=Ut.map(n=>this._soundOption("Bell",n.value,n.label,"previewSound","selectBell")).join(""),o=Wt.map(n=>this._soundOption("Completion",n.value,n.label,"previewSound","selectCompletion")).join(""),i=Gt.map(n=>this._soundOption("Ambient",n.value,n.label,"previewAmbient","selectAmbient")).join("");return`
        <div class="sound-settings" id="${t}SoundSettings">
            ...
            <div class="sound-section">
                ...
                <div id="${t}AmbientOptions" style="display:none;">${i}</div>
            </div>
        ...
        <div class="timer-controls" role="group" aria-label="Timer controls">
            ...
            <button type="button" class="t-btn primary" data-action="toggleTimer" id="${this.roomId}TimerBtn" aria-live="polite">${rt.idle}</button>
            <button type="button" class="t-btn" data-action="adjustTime" data-minutes="5" aria-label="Add 5 minutes">+5m</button>
        </div>`},_setTimerGlow(t){const e=document.getElementById(`${this.roomId}TimerRingWrap`),o=document.getElementById(`${this.roomId}OuterSvg`);!e||!o||(clearTimeout(this._glowTransitionTimer),e.classList.remove("running","paused"),t==="running"&&e.classList.add("running"),t==="paused"&&e.classList.add("paused"),t==="running"?(o.style.animation="",o.style.transition="filter 1.2s ease",o.style.filter=`drop-shadow(0 0 12px ${this._glowColor}) drop-shadow(0 0 35px ${this._glowColor}) drop-shadow(0 0 70px ${this._glowColor})`,this._glowTransitionTimer=setTimeout(()=>{e.classList.add("running"),requestAnimationFrame(()=>{o.style.transition="",o.style.filter=""})},1200)):(o.style.animation="none",o.style.transition="filter 1.2s ease",o.style.filter="none"))}},ke={FLOATING_ELEMENT_COUNT:20,UPDATE_INTERVAL_MS:6e5,STORAGE_PREFIX:"solar_",STORAGE_KEY_SUFFIX:"_data",IMAGE_BASE_URL:"/Community/Solar/",MIN_REFLECTION_LENGTH:10,FLOATING_ELEMENT_DURATION_MIN:10,FLOATING_ELEMENT_DURATION_RANGE:10,FLOATING_ELEMENT_DELAY_MAX:5},C={escapeHtml(t){if(!t)return"";const e=document.createElement("div");return e.textContent=t,e.innerHTML},escapeAttr(t){return t?t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""},_closingBlock:t=>`<div class="solar-popup-highlight">
       <p><strong>Closing Line:</strong> "${t}"</p>
     </div>`,generateIntentionPracticeContent(t,e,o){const i=e.map(n=>`<button type="button" data-affirmation="${this.escapeAttr(n)}" class="solar-affirmation-btn">
         ${this.escapeHtml(n)}
       </button>`).join("");return`
      ...
      <div class="solar-popup-section">
        ...
        <div class="solar-affirmations-grid">${i}</div>
    ...
    `},generateRelationshipAuditContent(t){return`
      ...
      ${this._closingBlock(t.closingLine)}
    `}},N={generateIntentionPracticeContent(t,e,o){const{intention:i="",affirmation:n="",releaseList:r=""}=t,a=e.map(s=>`
            ...
            <div class="lunar-popup-section">
                ...
                <textarea id="intentionText" class="lunar-textarea-large"
                    ...
                    placeholder="${o.intentionPrompt}"
                >${this._escapeHtml(i)}</textarea>
                <p class="lunar-helper-text">${o.intentionHelper}</p>
            </div>

            <div class="lunar-popup-section">
                <h3>One ${o.affirmationType} Affirmation</h3>
                <p>${o.affirmationPrompt}</p>
                ...
                ${o.affirmationHelper?`<p class="lunar-helper-text">${o.affirmationHelper}</p>`:""}
            </div>

            <div class="lunar-popup-section">
                <h3>${o.listTitle}</h3>
                <p>${o.listPrompt}</p>
                ${o.listHelper?`<p class="lunar-helper-text">${o.listHelper}</p>`:""}
                <textarea id="releaseListText" class="lunar-textarea-large"
                    style="min-height:120px;" maxlength="1000"
                    aria-label="${o.listTitle}"
                    placeholder="1. &#10;2. &#10;3. "
                >${this._escapeHtml(r)}</textarea>
                ${o.listFooter?`<div class="lunar-popup-highlight"><p>${o.listFooter}</p></div>`:""}
            </div>
            ...
            </div>`},generateFutureAlignmentContent({purpose:t,steps:e,guideline:o}){return`
            <div class="lunar-popup-section">
                <h3>Purpose</h3>
                <p>${t}</p>
            </div>
            ...
            <div class="lunar-popup-highlight"><p>${o}</p></div>`},generateBodyPracticeContent({purpose:t,steps:e,guideline:o}){return`
            <div class="lunar-popup-section">
                <h3>Purpose</h3>
                <p>${t}</p>
            </div>
            ...
            </div>`},generateEnergyAwarenessContent(t){return`
            <div class="lunar-popup-section">
                <h3>Purpose</h3>
                <p>${t.purpose}</p>
            </div>
            <div class="lunar-popup-section">
                <h3>Energy Direction</h3>
                <ul>${t.energySteps.map(e=>`<li>${e}</li>`).join("")}</ul>
                <div class="lunar-popup-highlight"><p>${t.energyGuideline}</p></div>
            </div>
            <div class="lunar-popup-section">
                <h3>${t.awarenessTitle}</h3>
                <p>${t.awarenessPrompt}</p>
                ${t.awarenessExample?`<p class="lunar-helper-text"><em>${t.awarenessExample}</em></p>`:""}
            </div>
            <div class="lunar-popup-section">
                <h3>Closing</h3>
                <div class="lunar-popup-highlight"><p>"${t.closingStatement}"</p></div>
                <p>Say once, out loud or silently. End the practice.</p>
            </div>`},_escapeHtml(t){if(!t)return"";const e=document.createElement("div");return e.textContent=t,e.innerHTML},_escapeAttr(t){return t?t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}},q={CONSTANTS:{DEFAULT_STAR_COUNT:50,AVATAR_MAX_DISPLAY:5,AVATAR_COLORS:["#8B7AFF","#FF9B71","#71E8FF","#FFD371","#FF71B4"],AVATAR_INITIALS:["L","S","N","A","M"],WORD_CLOUD_COLORS:["#8B7AFF","#FF9B71","#71E8FF","#FFD371","#FF71B4","#71ffaa"],WORD_CLOUD_SIZES:[1,1.2,1.4,1.6,1.8,2,1.3,1.1,1.5,1.7]},_stylesInjected:!1,generateStarfield(t=q.CONSTANTS.DEFAULT_STAR_COUNT){const e=[];for(let o=0;o<t;o++)e.push(`<div class="lunar-star" style="left:${Math.random()*100}%;top:${Math.random()*100}%;animation-delay:${(Math.random()*3).toFixed(2)}s;opacity:${(Math.random()*.5+.3).toFixed(2)};"></div>`);return e.join("")},renderTopBar({emoji:t,name:e,daysText:o,livingPresenceCount:i,cssPrefix:n}){return`
            <div class="${n}-top-bar lunar-top-bar">
                ...
                <div class="${n}-live-count-top lunar-live-count-top">
                    ...
                    <span id="lunarLiveCountTop">${i} members practicing with you now</span>
                </div>
                <button type="button" data-action="back-to-hub" class="lunar-back-hub-btn" aria-label="Leave practice and return to hub">
                    Gently Leave
                </button>
            </div>`},renderMoonVisual({cssPrefix:t,sphereClass:e,glowClass:o}){return`
            <div class="${t}-moon-visual lunar-moon-visual">
                <div class="${o} lunar-moon-glow">
            ...
            </div>`},renderMockAvatars(t){const{AVATAR_MAX_DISPLAY:e,AVATAR_COLORS:o,AVATAR_INITIALS:i}=q.CONSTANTS,n=Math.min(t,e);return Array.from({length:n},(a,s)=>`<div class="lunar-avatar" style="background-color:${o[s]};animation-delay:${s*.1}s;"
                  aria-label="Member ${i[s]}">${i[s]}</div>`).join("")+`<div class="lunar-avatar lunar-join-avatar" role="button" tabindex="0" aria-label="Join circle" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();this.click();}"><span aria-hidden="true">+</span></div>`},renderWordCloud(t){if(!Array.isArray(t)||!t.length)return'<p style="color:rgba(224,224,255,0.6);">No words yet</p>';const{WORD_CLOUD_COLORS:e,WORD_CLOUD_SIZES:o}=q.CONSTANTS;return t.map((i,n)=>`<div class="lunar-word-cloud-item"
                  style="font-size:${o[n%o.length]}rem;color:${e[n%e.length]};animation-delay:${(n*.1).toFixed(1)}s;"
                  aria-label="Intention: ${i.word}">${i.word}</div>`).join("")},renderWisdomText(t){return`<div class="lunar-wisdom-text">"${t}"</div>`},createPopup({icon:t,title:e,subtitle:o,content:i,cssPrefix:n,hasFooter:r=!0}){const a=document.createElement("div");return a.className=`lunar-practice-popup ${n}-practice-popup`,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-labelledby","popup-title"),a.setAttribute("aria-describedby","popup-subtitle"),a.innerHTML=`
            <div class="lunar-popup-content ${n}-popup-content">
                ...
                <div class="lunar-popup-header">
                    ...
                    <div class="lunar-popup-title">
                        ...
                        <p class="lunar-popup-subtitle" id="popup-subtitle">${o}</p>
                    </div>
                </div>
                <div class="lunar-popup-body" id="collectiveIntentionContent">${i}</div>
...
@media(prefers-reduced-motion:reduce){*{animation-duration:.01ms!important;animation-iteration-count:1!important;transition-duration:.01ms!important;}}
        `}},Ve=()=>window.CommunityDB,xe={location:{latitude:31,longitude:0,name:"Default"},currentMoonData:null,currentLunarRoom:null,lunarRooms:[{phaseRanges:[[0,.068],[.932,1]],phaseName:"New Moon",icon:"🌑",roomName:"New Moon Intentions",description:"Set intentions and plant seeds for the lunar cycle",roomId:"new-moon",energy:"Beginning, Stillness, Potential",practices:["Silent meditation","Intention setting","Vision journaling","Seed planting ritual"]},{phaseRanges:[[.068,.432]],phaseName:"Waxing Moon",icon:"🌓",roomName:"Waxing Growth Practice",description:"Build momentum and cultivate expanding energy",roomId:"waxing-moon",energy:"Growth, Action, Building",practices:["Dynamic movement","Energy cultivation","Goal visualization","Action planning meditation"]},{phaseRanges:[[.432,.568]],phaseName:"Full Moon",icon:"🌕",roomName:"Full Moon Illumination",description:"Celebrate fullness and release what no longer serves",roomId:"full-moon",energy:"Culmination, Release, Clarity",practices:["Celebration ritual","Gratitude meditation","Release ceremony","Moon bathing"]},{phaseRanges:[[.568,.932]],phaseName:"Waning Moon",icon:"🌗",roomName:"Waning Release Practice",description:"Let go and reflect on the lunar journey",roomId:"waning-moon",energy:"Release, Reflection, Rest",practices:["Reflection meditation","Letting go ritual","Rest and restore","Completion ceremony"]}],init(){if(this._initialized)return;this._initialized=!0;const t=()=>this.updateAll();navigator.geolocation?navigator.geolocation.getCurrentPosition(({coords:e})=>{this.location={latitude:e.latitude,longitude:e.longitude,name:"Your Location"},t()},()=>t(),{timeout:5e3,maximumAge:36e5}):t(),setInterval(()=>this.updateAll(),6e5)},updateAll(){this.updateMoonData(),this.updateMoonVisualization(),this.updateLunarRoom(),this.renderLunarCard()},setLocation(t,e,o){this.location={latitude:t,longitude:e,name:o},this.updateAll()},updateMoonData(){const t=new Date,e=Re.getMoonIllumination(t),o=Re.getMoonTimes(t,this.location.latitude,this.location.longitude);this.currentMoonData={phase:e.phase,fraction:e.fraction,angle:e.angle,rise:o.rise,set:o.set,phaseName:this.getMoonPhaseName(e.phase),age:e.phase*29.53,nextFullMoon:this.getNextFullMoon(t)},this._renderMoonInfo()},_renderMoonInfo(){const t=this.currentMoonData;if(!t)return;const e=(i,n)=>{const r=document.getElementById(i);r&&(r.textContent=n)};e("moonPhaseName",t.phaseName),e("moonIllumination",`${Math.round(t.fraction*100)}% illuminated`),e("moonAge",`${t.age.toFixed(1)} days old`),e("moonrise",t.rise?this.formatTime(t.rise):"No rise today"),e("moonset",t.set?this.formatTime(t.set):"No set today");const o=Math.ceil((t.nextFullMoon-new Date)/864e5);e("nextPhase",`Next Full Moon: ${this.formatDate(t.nextFullMoon)} (${o} days)`)},updateMoonVisualization(){this.currentMoonData&&this.drawMoon(this.currentMoonData.phase,this.currentMoonData.angle)},drawMoon(t,e){const o=document.getElementById("moonSvg");if(!o)return;const i=50,n=60,r=60;o.innerHTML="";const a=document.createElementNS("http://www.w3.org/2000/svg","g");a.setAttribute("transform",`rotate(${(e*180/Math.PI*-1).toFixed(2)}, ${n}, ${r})`),o.appendChild(a);const s=document.createElementNS("http://www.w3.org/2000/svg","circle");s.setAttribute("cx",n),s.setAttribute("cy",r),s.setAttribute("r",i),s.setAttribute("fill","#2d3748"),a.appendChild(s);const l=Math.cos(t*2*Math.PI)*i,d=document.createElementNS("http://www.w3.org/2000/svg","path");d.setAttribute("fill","#f7fafc"),d.setAttribute("d",t<.5?`M ${n},${r-i} A ${i},${i} 0 0 1 ${n},${r+i} Q ${n+l},${r} ${n},${r-i}`:`M ${n},${r-i} Q ${n+l},${r} ${n},${r+i} A ${i},${i} 0 0 1 ${n},${r-i}`),a.appendChild(d),[{x:.3,y:-.2,r:.15},{x:-.2,y:.3,r:.1},{x:.1,y:.4,r:.08}].forEach(({x:c,y:p,r:h})=>{if(!(t<.5&&c>0||t>=.5&&c<0||t>.45&&t<.55))return;const g=document.createElementNS("http://www.w3.org/2000/svg","circle");g.setAttribute("cx",n+c*i),g.setAttribute("cy",r+p*i),g.setAttribute("r",h*i),g.setAttribute("fill","rgba(0,0,0,0.15)"),a.appendChild(g)})},getMoonPhaseName(t){return t<.03||t>.97?"New Moon":t<.22?"Waxing Crescent":t<.28?"First Quarter":t<.47?"Waxing Gibbous":t<.53?"Full Moon":t<.72?"Waning Gibbous":t<.78?"Last Quarter":"Waning Crescent"},getNextFullMoon(t){const e=Re.getMoonIllumination(t).phase,o=e<.5?(.5-e)*29.53:(1.5-e)*29.53;return new Date(t.getTime()+o*864e5)},getLunarRoomByPhase(t){return this.lunarRooms.find(e=>e.phaseRanges.some(([o,i])=>t>=o&&t<=i))??this.lunarRooms[0]},updateLunarRoom(){var e;if(!this.currentMoonData)return;const t=this.getLunarRoomByPhase(this.currentMoonData.phase);(e=this.currentLunarRoom)==null||e.roomId,t.roomId,this.currentLunarRoom=t},getCurrentRoom(){return this.currentLunarRoom},_ROOM_MODULES:{"new-moon":()=>_e(()=>Promise.resolve().then(()=>co),void 0),"waxing-moon":()=>_e(()=>Promise.resolve().then(()=>po),void 0),"full-moon":()=>_e(()=>Promise.resolve().then(()=>ho),void 0),"waning-moon":()=>_e(()=>Promise.resolve().then(()=>yo),void 0)},_roomExportName:{"new-moon":"NewMoonRoom","waxing-moon":"WaxingMoonRoom","full-moon":"FullMoonRoom","waning-moon":"WaningMoonRoom"},async _loadAndEnterRoom(t){var o,i,n;const e=this._ROOM_MODULES[t];if(!e){(o=window.Core)==null||o.showToast(`Unknown room: ${t}`);return}try{const a=(await e())[this._roomExportName[t]];a?a.enterRoom():(i=window.Core)==null||i.showToast(`${t} failed to initialise`)}catch(r){console.error(`[LunarEngine] Failed to load ${t}:`,r),(n=window.Core)==null||n.showToast(`Failed to load ${t}`)}},joinLunarRoom(){var t;if(!this.currentLunarRoom){(t=window.Core)==null||t.showToast("Lunar room not ready");return}this._loadAndEnterRoom(this.currentLunarRoom.roomId)},adminJoinRoom(t){this._loadAndEnterRoom(t)},renderLunarCard(){var n,r,a;const t=document.getElementById("lunarContainer");if(!t){console.warn("LunarEngine: #lunarContainer not found");return}if(q.injectStyles(),!this.currentMoonData||!this.currentLunarRoom){t.innerHTML='<p style="color:var(--text-muted);padding:20px;">Loading lunar data...</p>';return}const{currentMoonData:e,currentLunarRoom:o}=this,i=(a=(r=(n=window.Core)==null?void 0:n.state)==null?void 0:r.currentUser)==null?void 0:a.is_admin;t.innerHTML=`
            <div class="celestial-card-full lunar-card">
                ...
                ${this._renderRoomSection(o)}
                ${i?this._renderAdminSection():""}
            ...
            </div>`},_attachCardListeners(){const t=document.querySelector('[data-action="join-lunar-room"]');t&&!t._lunarBound&&(t.addEventListener("click",()=>this.joinLunarRoom()),t._lunarBound=!0)},_renderAdminSection(){const t="lunarAdminPanel",e="lunarAdminToggle",o=new Set,n=this.lunarRooms.filter(r=>o.has(r.roomId)?!1:o.add(r.roomId)).map(r=>`
            ...
            </div>`},_attachAdminListeners(){const t=document.querySelector(".lunar-admin-header");if(t&&!t._lunarBound){const e=()=>{const o=document.getElementById(t.dataset.panel),i=document.getElementById(t.dataset.toggle),n=o.style.display!=="none";o.style.display=n?"none":"block",i.textContent=n?"▶":"▼",t.setAttribute("aria-expanded",String(!n))};t.addEventListener("click",e),t.addEventListener("keydown",o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),e())}),t._lunarBound=!0}document.querySelectorAll(".lunar-admin-room-btn").forEach(e=>{e._lunarBound||(e.addEventListener("click",()=>this.adminJoinRoom(e.dataset.roomId)),e._lunarBound=!0)})},_refreshOuterCard(){var o,i,n;if(!((o=Ve())!=null&&o.ready)){this._outerCardRetry||(this._outerCardRetry=setTimeout(()=>{this._outerCardRetry=null,this._refreshOuterCard()},500));return}const t=(i=this.currentLunarRoom)==null?void 0:i.roomId;if(!t)return;const e=async()=>{var r;try{const a=await((r=Ve())==null?void 0:r.getRoomParticipants(t)),s=document.getElementById("lunarRoomPresence");s&&(s.textContent=`${a.length} present`)}catch(a){console.warn("[LunarEngine] _refreshOuterCard error:",a)}};if(e(),this._attachCardListeners(),this._attachAdminListeners(),this._outerCardSub)try{this._outerCardSub.unsubscribe()}catch{}this._outerCardSub=(n=Ve())==null?void 0:n.subscribeToPresence(e)},formatTime(t){return!t||isNaN(t.getTime())?"N/A":t.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})},formatDate(t){return t.toLocaleDateString("en-US",{month:"short",day:"numeric"})},getMoonData(){return this.currentMoonData},renderLunarRoom(){this.renderLunarCard()},injectAdminUI(){var o,i,n;if(!((n=(i=(o=window.Core)==null?void 0:o.state)==null?void 0:i.currentUser)==null?void 0:n.is_admin))return;const e=document.querySelector("#lunarContainer .celestial-card-full");if(e&&!document.getElementById("lunarAdminPanel")){const r=document.createElement("div");r.innerHTML=this._renderAdminSection(),e.appendChild(r.firstElementChild),this._attachAdminListeners()}}};window.LunarEngine=xe;const ee=()=>window.CommunityDB,F=class F{constructor(e){if(!e)throw new Error("LunarRoom: phaseConfig is required");this.config=e,this.isActive=!1,this.currentPractice=null,this.collectiveTimer=null,this.collectiveWords=null,this.saveDebounceTimer=null,this._retryCheckTimeout=null,this._hasLoggedWaiting=!1,this.eventListeners=[],this.userWeekData=this._getDefaultUserData(),this.weekStartDate=null,this.weekEndDate=null,this.domCache={dynamicContent:null,popup:null},this._bindMethods()}_getDefaultUserData(){return{seedAffirmation:null,practiceCount:0,journalEntries:[],emotionalEchoes:[],intentionShared:!1,privateIntention:"",collectiveWord:"",intention:"",affirmation:"",releaseList:""}}_bindMethods(){["init","enterRoom","renderRoomDashboard","switchMode","showPracticePopup","showCollectiveIntentionPopup","startCollectiveStep2","startCollectiveStep3","startCollectiveStep4","startCollectiveStep5","startMeditationTimer","startWitnessingTimer","submitWordToCollective","completeCollectivePractice","closeCollectivePopup","closePracticePopup","saveIntentionPractice","submitClosure","showLockedMessage","enterGroupCircle","leaveRoom","_handlePopupClick","_clearTimer"].forEach(e=>{typeof this[e]=="function"&&(this[e]=this[e].bind(this))})}init(){try{this.checkIfWeekActive(),q.injectStyles(this.config.cssPrefix)}catch(e){console.error(`${this.config.name} init error:`,e)}}checkIfWeekActive(){var e,o,i;try{if(!(xe!=null&&xe.currentMoonData)){this._hasLoggedWaiting||(this._hasLoggedWaiting=!0),this._retryCheckTimeout||(this._retryCheckTimeout=setTimeout(()=>{this._retryCheckTimeout=null,this.checkIfWeekActive()},500));return}if((i=(o=(e=window.Core)==null?void 0:e.state)==null?void 0:o.currentUser)==null?void 0:i.is_admin){this.isActive=!0,this.calculateWeekDates(),this.loadUserWeekData();return}const r=xe.currentMoonData.phase;this.isActive=this.config.phaseRanges.some(([a,s])=>r>=a&&r<=s),this.isActive&&(this.calculateWeekDates(),this.loadUserWeekData())}catch(n){console.error("checkIfWeekActive error:",n),this.isActive=!1}}calculateWeekDates(){var e,o,i;try{const n=xe==null?void 0:xe.currentMoonData;if(!n){console.error("No moon data");return}const{phase:r,age:a}=n,s=F.CONSTANTS,l=new Date,d=new Date(l-a*s.MS_PER_DAY);let c=this.config.phaseRanges.find(([p,h])=>r>=p&&r<=h);if(!c&&(c=((i=(o=(e=window.Core)==null?void 0:e.state)==null?void 0:o.currentUser)==null?void 0:i.is_admin)?this.config.phaseRanges[0]:null,!c)){this._calculateNextOccurrence(r,a);return}this.weekStartDate=new Date(d.getTime()+c[0]*s.LUNAR_CYCLE_DAYS*s.MS_PER_DAY),this.weekEndDate=new Date(d.getTime()+c[1]*s.LUNAR_CYCLE_DAYS*s.MS_PER_DAY)}catch(n){console.error("calculateWeekDates error:",n)}}_calculateNextOccurrence(e,o){try{const i=F.CONSTANTS,n=new Date,r=new Date(n-o*i.MS_PER_DAY),[a,s]=this.config.phaseRanges[0],l=e<a?r:new Date(r.getTime()+i.LUNAR_CYCLE_DAYS*i.MS_PER_DAY);this.weekStartDate=new Date(l.getTime()+a*i.LUNAR_CYCLE_DAYS*i.MS_PER_DAY),this.weekEndDate=new Date(l.getTime()+s*i.LUNAR_CYCLE_DAYS*i.MS_PER_DAY)}catch(i){console.error("_calculateNextOccurrence error:",i)}}getDaysRemaining(){return this.weekEndDate?Math.max(0,Math.ceil((this.weekEndDate-new Date)/F.CONSTANTS.MS_PER_DAY)):0}shouldShowClosure(){const e=this.getDaysRemaining();return e>0&&e<=2}loadUserWeekData(){try{const e=localStorage.getItem(this.config.storageKey);e&&(this.userWeekData={...this.userWeekData,...JSON.parse(e)})}catch(e){console.error("loadUserWeekData error:",e)}}saveUserWeekData(e=!1){if(e){this._performSave();return}clearTimeout(this.saveDebounceTimer),this.saveDebounceTimer=setTimeout(()=>this._performSave(),F.CONSTANTS.SAVE_DEBOUNCE_MS)}_performSave(){var e;try{localStorage.setItem(this.config.storageKey,JSON.stringify(this.userWeekData))}catch(o){console.error("_performSave error:",o),(e=window.Core)==null||e.showToast("Failed to save data")}}_sanitizeInput(e){return typeof e=="string"?e.replace(/<[^>]*>/g,"").trim():""}_validateIntention(e){const o=F.CONSTANTS;return e!=null&&e.trim()?e.length>o.MAX_INTENTION_LENGTH?{valid:!1,error:`Intention must be under ${o.MAX_INTENTION_LENGTH} characters`}:{valid:!0}:{valid:!1,error:"Intention cannot be empty"}}_validateAffirmation(e){const o=F.CONSTANTS;return e!=null&&e.trim()?e.length>o.MAX_AFFIRMATION_LENGTH?{valid:!1,error:`Affirmation must be under ${o.MAX_AFFIRMATION_LENGTH} characters`}:{valid:!0}:{valid:!1,error:"Affirmation cannot be empty"}}_validateCollectiveWord(e){return e!=null&&e.trim()?e.length>F.CONSTANTS.MAX_WORD_LENGTH?{valid:!1,error:`Word must be under ${F.CONSTANTS.MAX_WORD_LENGTH} characters`}:e.trim().includes(" ")?{valid:!1,error:"Please enter only one word"}:{valid:!0}:{valid:!1,error:"Word cannot be empty"}}enterRoom(){var e,o,i,n,r,a,s,l;try{const d=(i=(o=(e=window.Core)==null?void 0:e.state)==null?void 0:o.currentUser)==null?void 0:i.is_admin;if(!this.isActive&&!d){(n=window.Core)==null||n.showToast(`${this.config.emoji} ${this.config.name} room opens during the ${this.config.name} phase`);return}(r=window.Core)==null||r.navigateTo("practiceRoomView"),(s=(a=window.PracticeRoom)==null?void 0:a.stopHubPresence)==null||s.call(a),window.currentLunarRoom=this,this.renderRoomDashboard(),this._setPresence(),this._loadCollectiveWords(),setTimeout(()=>this._refreshLivePresence(),300)}catch(d){console.error("enterRoom error:",d),(l=window.Core)==null||l.showToast("Failed to enter room")}}leaveRoom(){var e,o,i;try{this._clearPresence(),["_presenceSub","_collectiveWordsSub"].forEach(n=>{if(this[n]){try{this[n].unsubscribe()}catch{}this[n]=null}}),this._clearTimer(),this._removeEventListeners(),window.currentLunarRoom=null,(o=(e=window.PracticeRoom)==null?void 0:e.startHubPresence)==null||o.call(e),(i=window.Core)==null||i.navigateTo("hubView")}catch(n){console.error("leaveRoom error:",n)}}renderRoomDashboard(){var e;try{const o=(e=this.domCache).dynamicContent??(e.dynamicContent=document.getElementById("dynamicRoomContent"));if(!o){console.error("dynamicRoomContent not found");return}const i=new Date,n=this.getDaysRemaining(),r=Math.ceil((this.weekStartDate-i)/F.CONSTANTS.MS_PER_DAY),a=this.getLivingPresenceCount(),s=this.isActive?`${n} ${n===1?"day":"days"} remaining`:`${r} ${r===1?"day":"days"} until ${this.config.name}`;o.innerHTML=`
                <div class="lunar-room-bg">
                    <div class="${this.config.cssPrefix}-starfield lunar-starfield">
                        ${q.generateStarfield()}
                    </div>
                    ${q.renderTopBar({emoji:this.config.emoji,name:this.config.name,daysText:s,livingPresenceCount:a,cssPrefix:this.config.cssPrefix})}
                    <div class="${this.config.cssPrefix}-content-wrapper lunar-content-wrapper">
                        ${q.renderMoonVisual({cssPrefix:this.config.cssPrefix,sphereClass:`${this.config.cssPrefix}-moon-sphere`,glowClass:`${this.config.cssPrefix}-moon-glow`})}
                        ${q.renderIntroCard({imageUrl:this.config.imageUrl,description:this.config.description})}
                        ${q.renderModeToggle({cssPrefix:this.config.cssPrefix,globalName:this.config.globalName})}
                        ...
                        <div class="lunar-wisdom-section">${q.renderWisdomText(this.config.wisdomQuote)}</div>
                    </div>
                </div>`,this._attachEventListeners(o)}catch(o){console.error("renderRoomDashboard error:",o)}}_renderSoloPracticeMode(){const e=!!(this.userWeekData.intention||this.userWeekData.affirmation);return`
            ...
            ${e?this._renderSavedInputs():""}`}_renderPracticeCards(){var n;const e=Object.entries(this.config.practices),o=(n=e[0])==null?void 0:n[0],i=!!(this.userWeekData.intention||this.userWeekData.affirmation);return e.map(([r,a])=>{const s=r===o&&i;return`
                <div class="lunar-practice-card ${this.config.cssPrefix}-practice-card${s?" locked":""}"
                     data-practice="${r}" data-locked="${s}"
                ...
                </div>`}).join("")}_renderSavedInputs(){const{intention:e,affirmation:o,releaseList:i}=this.userWeekData,n=this.config.savedInputLabels,r=a=>N._escapeHtml(a);return`
            <div class="lunar-saved-inputs">
                <h3>${n.title}</h3>
                ${e?`<div class="lunar-saved-item"><div class="lunar-saved-label">${n.intention}</div><div class="lunar-saved-text">${r(e)}</div></div>`:""}
                ${o?`<div class="lunar-saved-item"><div class="lunar-saved-label">${n.affirmation}</div><div class="lunar-saved-text">${r(o)}</div></div>`:""}
                ${i?`<div class="lunar-saved-item"><div class="lunar-saved-label">${n.releaseList}</div><div class="lunar-saved-text">${r(i).replace(/\n/g,"<br>")}</div></div>`:""}
            ...
            <div class="lunar-group-intro">
                ...
                <div class="lunar-group-avatars">${q.renderMockAvatars(e)}</div>
                <button type="button" class="lunar-join-circle-btn" data-action="enter-group-circle">Enter the Circle</button>
            </div>`}_renderClosureSection(){if(!this.shouldShowClosure())return"";const e=F.CONSTANTS;return`
            ...
            </div>`}_attachEventListeners(e){this._removeEventListeners();const o=i=>{const n=i.target.closest(".lunar-practice-card");if(n&&(i.type==="click"||i.key==="Enter"||i.key===" ")){i.preventDefault(),n.dataset.locked==="true"?this.showLockedMessage():this.showPracticePopup(n.dataset.practice);return}if(i.type!=="click")return;const r=i.target.closest("[data-action]");if(r)switch(r.dataset.action){case"switch-mode":this.switchMode(r.dataset.mode);break;case"enter-group-circle":this.enterGroupCircle();break;case"submit-closure":this.submitClosure();break;case"back-to-hub":window.Rituals?Rituals.showClosing():this.leaveRoom();break}};e.addEventListener("click",o),e.addEventListener("keydown",o),this.eventListeners.push({element:e,type:"click",handler:o},{element:e,type:"keydown",handler:o})}_removeEventListeners(){this.eventListeners.forEach(({element:e,type:o,handler:i})=>e==null?void 0:e.removeEventListener(o,i)),this.eventListeners=[]}switchMode(e){document.querySelectorAll(".lunar-practice-mode").forEach(o=>o.classList.toggle("active",o.dataset.mode===e)),document.querySelectorAll(".lunar-mode-btn").forEach(o=>{const i=o.dataset.mode===e;o.classList.toggle("active",i),o.setAttribute("aria-pressed",String(i))})}showPracticePopup(e){try{const o=this.config.practices[e];if(!o){console.error(`Practice not found: ${e}`);return}this.currentPractice=e;const i=e===Object.keys(this.config.practices)[0],n=q.createPopup({icon:o.icon,title:o.title,subtitle:o.description,content:this.getPracticeContent(e),cssPrefix:this.config.cssPrefix,hasFooter:!i,onClose:()=>this.closePracticePopup()});(document.getElementById("communityHubFullscreenContainer")??document.body).appendChild(n),this.domCache.popup=n,this._attachPopupListeners(n,e)}catch(o){console.error("showPracticePopup error:",o)}}_attachPopupListeners(e,o){var i;e.querySelectorAll('[data-action="close-popup"]').forEach(n=>n.addEventListener("click",this.closePracticePopup)),e.addEventListener("click",this._handlePopupClick),o===Object.keys(this.config.practices)[0]&&((i=e.querySelector('[data-action="save-practice"]'))==null||i.addEventListener("click",this.saveIntentionPractice),e.querySelectorAll("[data-affirmation]").forEach(n=>n.addEventListener("click",()=>{const r=e.querySelector("#affirmationText");r&&(r.value=n.dataset.affirmation)})))}_handlePopupClick(e){e.target===e.currentTarget&&this.closePracticePopup()}getPracticeContent(e){try{const o=this.config.practiceContent[e];return o?o(this.userWeekData,this.config.prebuiltAffirmations):`<div class="lunar-popup-section"><h3>Practice</h3><p>${this.config.practices[e].description}</p></div>`}catch(o){return console.error("getPracticeContent error:",o),"<p>Error loading practice content</p>"}}closePracticePopup(){const e=this.domCache.popup??document.querySelector(".lunar-practice-popup");e&&(e.remove(),this.domCache.popup=null)}saveIntentionPractice(){var e,o,i,n;try{const r=document.getElementById("intentionText"),a=document.getElementById("affirmationText"),s=document.getElementById("releaseListText");if(!r||!a||!s){console.error("Form elements not found");return}const l=this._sanitizeInput(r.value),d=this._sanitizeInput(a.value),c=this._sanitizeInput(s.value),p=this._validateIntention(l);if(!p.valid){(e=window.Core)==null||e.showToast(p.error);return}const h=this._validateAffirmation(d);if(!h.valid){(o=window.Core)==null||o.showToast(h.error);return}Object.assign(this.userWeekData,{intention:l,affirmation:d,releaseList:c}),this.userWeekData.practiceCount++,this.saveUserWeekData(!0),(i=window.Core)==null||i.showToast("Practice saved"),this.closePracticePopup(),this.renderRoomDashboard()}catch(r){console.error("saveIntentionPractice error:",r),(n=window.Core)==null||n.showToast("Failed to save practice")}}showLockedMessage(){var e;(e=window.Core)==null||e.showToast("✓ Practice completed for this cycle")}showCollectiveIntentionPopup(){var e;try{const o=q.createPopup({icon:"🌙",title:"Collective Intention Circle",subtitle:`Join others in ${this.config.collectiveFocus}`,content:this._getCollectiveStep1Content(),cssPrefix:this.config.cssPrefix,hasFooter:!1,onClose:()=>this.closeCollectivePopup()});(document.getElementById("communityHubFullscreenContainer")??document.body).appendChild(o),this.domCache.popup=o,o.querySelectorAll('[data-action="close-popup"]').forEach(i=>i.addEventListener("click",this.closeCollectivePopup)),(e=o.querySelector('[data-action="begin-collective"]'))==null||e.addEventListener("click",this.startCollectiveStep2),o.addEventListener("click",this._handlePopupClick)}catch(o){console.error("showCollectiveIntentionPopup error:",o)}}_getCollectiveStep1Content(){return`
            ...
            </div>`}startCollectiveStep2(){var o,i;const e=document.getElementById("collectiveIntentionContent");e&&(e.innerHTML=`
            <div class="lunar-popup-section" style="text-align:center;">
            ...
            </div>`,(o=e.querySelector('[data-action="start-meditation"]'))==null||o.addEventListener("click",this.startMeditationTimer),(i=e.querySelector('[data-action="skip-meditation"]'))==null||i.addEventListener("click",this.startCollectiveStep3))}startMeditationTimer(){var e;(e=document.getElementById("startMeditationBtn"))==null||e.style.setProperty("display","none"),this._runTimer("meditationTimer",F.CONSTANTS.MEDITATION_DURATION,()=>{const o=document.getElementById("skipToIntentionBtn");o&&(o.textContent="Continue to Intention",o.style.display="block")}),setTimeout(()=>{const o=document.getElementById("skipToIntentionBtn");o&&(o.style.display="block")},1e4)}startCollectiveStep3(){var o;this._clearTimer();const e=document.getElementById("collectiveIntentionContent");e&&(e.innerHTML=`
            <div class="lunar-popup-section">
                ...
                <textarea id="privateIntentionText" class="lunar-textarea-large"
                    ...
                    maxlength="${F.CONSTANTS.MAX_INTENTION_LENGTH}"
                >${N._escapeHtml(this.userWeekData.privateIntention||"")}</textarea>
                <button class="lunar-popup-btn" data-action="save-private-intention">Continue</button>
            </div>`,(o=e.querySelector('[data-action="save-private-intention"]'))==null||o.addEventListener("click",this.startCollectiveStep4))}startCollectiveStep4(){var i;const e=document.getElementById("privateIntentionText");e&&(this.userWeekData.privateIntention=this._sanitizeInput(e.value));const o=document.getElementById("collectiveIntentionContent");o&&(o.innerHTML=`
            <div class="lunar-popup-section">
                ...
                <div class="lunar-intention-preview">
                    ...
                    <p>${N._escapeHtml(this.userWeekData.privateIntention||"No intention set")}</p>
                </div>
                <input type="text" id="collectiveWordInput" class="lunar-word-input"
                    aria-label="Enter your word for this lunar phase"
                    placeholder="Your word..." maxlength="${F.CONSTANTS.MAX_WORD_LENGTH}">
                <button class="lunar-popup-btn" data-action="submit-collective-word">Plant Your Word</button>
            </div>`,(i=o.querySelector('[data-action="submit-collective-word"]'))==null||i.addEventListener("click",()=>{const n=document.getElementById("collectiveWordInput");n&&this.submitWordToCollective(n.value)}))}submitWordToCollective(e){var n,r,a;const o=this._sanitizeInput(e),i=this._validateCollectiveWord(o);if(!i.valid){(n=window.Core)==null||n.showToast(i.error);return}this.userWeekData.collectiveWord=o,this.userWeekData.intentionShared=!0,this.collectiveWords||(this.collectiveWords=this.getMockCollectiveWords()),this.collectiveWords.push({word:o,timestamp:Date.now()}),(r=ee())!=null&&r.ready&&((a=ee())==null||a.sendRoomMessage(`${this._getLunarRoomId()}-collective`,o).catch(s=>console.error("[LunarRoom] submitWordToCollective DB error:",s))),this.startCollectiveStep5()}startCollectiveStep5(){var o,i;const e=document.getElementById("collectiveIntentionContent");e&&(e.innerHTML=`
            <div class="lunar-popup-section" style="text-align:center;">
                ...
                <div id="wordCloud" class="lunar-word-cloud">
                    ${q.renderWordCloud(this.collectiveWords??this.getMockCollectiveWords())}
                </div>
            ...
            </div>`,(o=e.querySelector('[data-action="start-witnessing"]'))==null||o.addEventListener("click",this.startWitnessingTimer),(i=e.querySelector('[data-action="complete-collective"]'))==null||i.addEventListener("click",this.completeCollectivePractice))}startWitnessingTimer(){var e;(e=document.getElementById("startWitnessingBtn"))==null||e.style.setProperty("display","none"),this._runTimer("witnessingTimer",F.CONSTANTS.WITNESSING_DURATION,()=>{const o=document.getElementById("completeBtn");o&&(o.style.display="block")})}_runTimer(e,o,i){let n=o;const r=document.getElementById(e);r&&(this.collectiveTimer=setInterval(()=>{n--;const a=Math.floor(n/60),s=n%60;r.textContent=`${a}:${String(s).padStart(2,"0")}`,n<=0&&(this._clearTimer(),r.textContent="Complete",i==null||i())},F.CONSTANTS.TIMER_INTERVAL_MS))}completeCollectivePractice(){var e;this.userWeekData.practiceCount++,this.saveUserWeekData(!0),(e=window.Core)==null||e.showToast("Intention planted with the collective"),this.closeCollectivePopup(),this.renderRoomDashboard()}closeCollectivePopup(){this._clearTimer(),this.closePracticePopup()}enterGroupCircle(){this.showCollectiveIntentionPopup()}submitClosure(){var e,o,i;try{const n=document.getElementById("closureReflection");n&&(this.userWeekData.closureReflection=this._sanitizeInput(n.value),this.saveUserWeekData(!0)),(e=window.Core)==null||e.showToast(this.config.completionMessage),this.userWeekData=this._getDefaultUserData(),this.saveUserWeekData(!0),(o=window.Core)==null||o.navigateTo("hubView")}catch(n){console.error("submitClosure error:",n),(i=window.Core)==null||i.showToast("Failed to submit closure")}}_clearTimer(){this.collectiveTimer&&(clearInterval(this.collectiveTimer),this.collectiveTimer=null)}getLivingPresenceCount(){return typeof this._cachedPresenceCount=="number"?this._cachedPresenceCount:0}getMockCollectiveWords(){const e=Date.now();return[{word:"Growth",timestamp:e-864e5},{word:"Peace",timestamp:e-72e6},{word:"Courage",timestamp:e-432e5},{word:"Clarity",timestamp:e-36e6},{word:"Healing",timestamp:e-216e5},{word:"Trust",timestamp:e-18e6},{word:"Love",timestamp:e-144e5},{word:"Balance",timestamp:e-72e5},{word:"Freedom",timestamp:e-36e5},{word:"Joy",timestamp:e-18e5}]}getCollectiveWordsCount(){return(this.collectiveWords??this.getMockCollectiveWords()).length}_getLunarRoomId(){return{newmoon:"new-moon",waxingmoon:"waxing-moon",fullmoon:"full-moon",waningmoon:"waning-moon"}[this.config.cssPrefix]??this.config.cssPrefix}_setPresence(){var e,o,i;if((e=ee())!=null&&e.ready)try{const n=this._getLunarRoomId(),r=`${this.config.emoji} ${this.config.name}`;(o=ee())==null||o.setPresence("online",r,n),(i=window.Core)!=null&&i.state&&(window.Core.state.currentRoom=n,window.Core.state.currentUser&&(window.Core.state.currentUser.activity=r))}catch(n){console.error("[LunarRoom] _setPresence error:",n)}}_clearPresence(){var e,o,i;if((e=ee())!=null&&e.ready)try{(o=ee())==null||o.setPresence("online","✨ Available",null),(i=window.Core)!=null&&i.state&&(window.Core.state.currentRoom=null,window.Core.state.currentUser&&(window.Core.state.currentUser.activity="✨ Available"))}catch(n){console.error("[LunarRoom] _clearPresence error:",n)}}async _refreshLivePresence(){var i,n;if(!((i=ee())!=null&&i.ready))return;const e=this._getLunarRoomId(),o=async()=>{var r,a;try{const s=await((r=ee())==null?void 0:r.getRoomParticipants(e)),l=await((a=ee())==null?void 0:a.getBlockedUsers()),d=s.filter(m=>!l.has(m.user_id));this._cachedPresenceCount=d.length,this._cachedParticipants=d;const c=document.getElementById("lunarLiveCountTop");c&&(c.textContent=`${d.length} members practicing with you now`);const p=document.querySelector(".lunar-live-presence span");p&&(p.textContent=`${d.length} members in circle`);const h=document.querySelector(".lunar-group-avatars");h&&(h.innerHTML=this._buildRealAvatars(d))}catch(s){console.warn("[LunarRoom] _refreshLivePresence error:",s)}};if(await o(),this._presenceSub)try{this._presenceSub.unsubscribe()}catch{}this._presenceSub=(n=ee())==null?void 0:n.subscribeToPresence(o)}_buildRealAvatars(e){const i=e.slice(0,5),n=e.length-5,r=i.map(s=>{var m,g;const l=s.profiles??{},d=l.name??l.display_name??"?",c=d.charAt(0).toUpperCase(),p=((g=(m=window.Core)==null?void 0:m.getAvatarGradient)==null?void 0:g.call(m,s.user_id))??"background:#8B7AFF";let h=l.avatar_url?`<img src="${l.avatar_url}" alt="${c}" width="40" height="40" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">`:l.emoji?`<span style="font-size:18px;">${l.emoji}</span>`:`<span style="font-size:14px;font-weight:600;">${c}</span>`;return`<div class="lunar-avatar" style="${p};display:flex;align-items:center;justify-content:center;" aria-label="${d}">${h}</div>`}).join(""),a=n>0?`<div class="lunar-avatar" style="background:#333;display:flex;align-items:center;justify-content:center;font-size:12px;">+${n}</div>`:`<div class="lunar-avatar lunar-join-avatar" role="button" tabindex="0" aria-label="Join circle" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();this.click();}"><span aria-hidden="true">+</span></div>`;return r+a}async _loadCollectiveWords(){var i,n;if(!((i=ee())!=null&&i.ready))return;const e=`${this._getLunarRoomId()}-collective`,o=async()=>{var r;try{const a=await((r=ee())==null?void 0:r.getRoomMessages(e,100));if(a!=null&&a.length){this.collectiveWords=a.map(d=>({word:d.message,timestamp:new Date(d.created_at).getTime()}));const s=document.getElementById("wordCloud");s&&(s.innerHTML=q.renderWordCloud(this.collectiveWords));const l=document.querySelector(".lunar-word-count strong");l&&(l.textContent=this.collectiveWords.length)}}catch(a){console.warn("[LunarRoom] _loadCollectiveWords error:",a)}};if(await o(),this._collectiveWordsSub)try{this._collectiveWordsSub.unsubscribe()}catch{}this._collectiveWordsSub=(n=ee())==null?void 0:n.subscribeToRoomChat(e,o)}cleanup(){this._clearTimer(),this._removeEventListeners(),clearTimeout(this.saveDebounceTimer),clearTimeout(this._retryCheckTimeout),["_presenceSub","_collectiveWordsSub"].forEach(e=>{if(this[e]){try{this[e].unsubscribe()}catch{}this[e]=null}}),this.domCache={dynamicContent:null,popup:null}}};Ze(F,"CONSTANTS",{MEDITATION_DURATION:180,WITNESSING_DURATION:120,SAVE_DEBOUNCE_MS:500,MAX_INTENTION_LENGTH:500,MAX_AFFIRMATION_LENGTH:300,MAX_RELEASE_LIST_LENGTH:1e3,MAX_WORD_LENGTH:50,TIMER_INTERVAL_MS:1e3,LUNAR_CYCLE_DAYS:29.53,MS_PER_DAY:864e5});let Te=F;class Be extends D{constructor(e){super(e),this.initPlayerState(),this.initCycleState(),this.sessions=[],this.scheduleModalTitle="📅 Upcoming Sessions",this.state.currentSession=null,this.state.nextSession=null}onInit(){this.initializeCycle(),this.preloadYouTubeAPI()}onEnter(){this.loadYouTubeAPI()}onCleanup(){this.cleanupPlayer(),this.cleanupCycle()}setSessions(e){const o=Math.floor(e/(this.config.cycleDuration*1e3))%this.sessions.length;this.state.currentSession=this.sessions[o],this.state.nextSession=this.sessions[(o+1)%this.sessions.length]}getCurrentSession(){return this.state.currentSession}getNextSession(){return this.state.nextSession}buildBody(){const e=this.getCurrentSession();return`
        <div class="ps-body">
            <main class="ps-main">
        ...
        </div>`}showScheduleModal(){const e=document.getElementById(`${this.roomId}ScheduleModal`),o=document.getElementById(`${this.roomId}ScheduleContent`);if(!e||!o)return;const i=Date.now(),n=this.config.cycleDuration*1e3,r=this.config.openDuration*1e3,a=Math.floor(i/n),s=Array.from({length:6},(l,d)=>this._buildScheduleRow(i,n,r,a+d,d===0)).join("");o.innerHTML=`<div class="schedule-list">${s}</div>`,e.classList.add("active")}_buildScheduleRow(e,o,i,n,r){const a=n*o,s=a+i,l=this.sessions[n%this.sessions.length],d=e-a,c=r&&d>=0&&d<i,p=r&&d>=i,h=f=>new Date(f).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"}),m=c?'<span style="background:#22c55e;color:white;font-size:10px;font-weight:700;padding:2px 8px;border-radius:10px;margin-left:8px;">OPEN NOW</span>':p?'<span style="background:rgba(239,68,68,0.15);color:#ef4444;font-size:10px;font-weight:700;padding:2px 8px;border-radius:10px;margin-left:8px;">IN SESSION</span>':"";return`
        ...
        </div>`}closeScheduleModal(){var e;(e=document.getElementById(`${this.roomId}ScheduleModal`))==null||e.classList.remove("active")}}Object.assign(Be.prototype,Nt);Object.assign(Be.prototype,Ot);const vt={switchTab(t){const e=document.getElementById(`${this.roomId}DailyTab`),o=document.getElementById(`${this.roomId}PersonalTab`),i=document.getElementById(`${this.roomId}TabDaily`),n=document.getElementById(`${this.roomId}TabPersonal`);if(!e||!o||!i||!n)return;const r=t==="daily";e.style.display=r?"block":"none",o.style.display=r?"none":"block",i.setAttribute("aria-selected",String(r)),n.setAttribute("aria-selected",String(!r)),this._styleTab(i,r),this._styleTab(n,!r),this.state.currentTab=t,t==="personal"&&typeof this.onPersonalTabEnter=="function"&&this.onPersonalTabEnter()},_styleTab(t,e){t.style.background=e?"linear-gradient(135deg,var(--neuro-accent) 0%,var(--neuro-accent-light) 100%)":"transparent",t.style.color=e?"white":"var(--text)",t.style.borderBottom=e?"3px solid var(--neuro-accent)":"3px solid transparent"},buildTabNav(t,e){return`
        ...
        </div>`}},$={storage:{_key:t=>`${ke.STORAGE_PREFIX}${t}${ke.STORAGE_KEY_SUFFIX}`,get(t){const e=localStorage.getItem(this._key(t));if(!e)return null;try{return JSON.parse(e)}catch(o){return console.error(`[SolarUI] Error loading ${t} data:`,o),null}},set(t,e){try{return localStorage.setItem(this._key(t),JSON.stringify(e)),!0}catch(o){return console.error(`[SolarUI] Error saving ${t} data:`,o),!1}},clear(t){localStorage.removeItem(this._key(t))}},utils:{calculateDaysRemaining:t=>Math.ceil((t-new Date)/864e5),generateFloatingElements(t,e=ke.FLOATING_ELEMENT_COUNT){const{FLOATING_ELEMENT_DELAY_MAX:o,FLOATING_ELEMENT_DURATION_MIN:i,FLOATING_ELEMENT_DURATION_RANGE:n}=ke;let r="";for(let a=0;a<e;a++){const s=t[Math.floor(Math.random()*t.length)],l=(Math.random()*100).toFixed(2),d=(Math.random()*o).toFixed(2),c=(i+Math.random()*n).toFixed(2);r+=`<div class="solar-floating-element"
                      style="left:${l}%;animation-delay:${d}s;animation-duration:${c}s;">
                   ${s}
                 </div>`}return r},formatDate:t=>t.toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"})},renderers:{topBar({seasonName:t,emoji:e,daysText:o,livingPresenceCount:i}){return`
        <div class="solar-top-bar">
          ...
          <div class="solar-live-count-top">
            ...
            <span id="solarLiveCountTop">${i} members practicing with you now</span>
          </div>
        ...
        </div>`},modeToggle(){const t=o=>o==="solo"?'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle>':'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path>',e=(o,i,n)=>`<button type="button" class="solar-mode-btn${n?" active":""}" data-mode="${o}" aria-pressed="${n}">
           <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">${t(o)}</svg>
           <span>${i}</span>
        ...
        </div>`},savedInputs(t,e){const{intention:o,affirmation:i,releaseList:n}=t;if(!o&&!i&&!n)return"";const r=s=>C.escapeHtml(s),a=(s,l,d)=>`<div class="solar-input-display" style="margin-bottom:1rem;">
           <h4>${s}</h4>
        ...
        <div class="solar-saved-inputs">
          ...
          ${i?a("Gratitude Affirmation",i,!1):""}
          ${n?a("Release/Growth List",n,!0):""}
          <p>Gathered with gratitude as the season completes</p>
        </div>`},groupPractice({seasonEmoji:t,seasonName:e,presenceCount:o,itemEmoji:i,collectiveFocus:n,collectiveNoun:r}){const a=e.toLowerCase();return`
        <div class="solar-group-container">
          ...
          <ul class="solar-group-list">
            <li><span>${i}</span> Join <span id="solarGroupJoinCount">${o}</span> practitioners in live circle</li>
            <li><span>${i}</span> 3-minute guided meditation for seasonal centering</li>
            <li><span>${i}</span> Set a private intention for ${a}</li>
            <li><span>${i}</span> Share one word with the collective field</li>
            <li><span>${i}</span> Witness the circle's ${r||"intentions"}</li>
            <li><span>${i}</span> 2-minute silent integration practice</li>
          </ul>
        ...
        </div>`},closureSection({title:t,intro:e,placeholder:o,buttonText:i,closingLine:n}){return`
        ...
        </div>`},popup({title:t,content:e,hasSaveButton:o}){return`
        ...
        </div>`},inactiveRoom({seasonName:t,emoji:e,startDate:o,daysUntil:i}){return`
        <div class="solar-inactive">
          <div class="solar-inactive-container">
            ...
            <div class="solar-inactive-card">
              ...
              <p>The ${t} Solar Room opens on <strong>${o}</strong></p>
              <p class="solar-inactive-days">${i} days until the ${t.toLowerCase()} season begins</p>
              <p class="solar-inactive-note">Return when the cycle turns and the season is ready.</p>
            </div>
          </div>
        </div>`}},switchMode(t){document.querySelectorAll(".solar-mode-btn").forEach(i=>{const n=i.dataset.mode===t;i.classList.toggle("active",n),i.setAttribute("aria-pressed",String(n))});const e=document.getElementById("soloContent"),o=document.getElementById("groupContent");e&&(e.style.display=t==="solo"?"block":"none"),o&&(o.style.display=t==="group"?"block":"none")},closePracticePopup(){var t;(t=document.getElementById("practicePopup"))==null||t.remove()},handleBackToHub(){var t,e,o,i,n,r;if((t=window.currentSolarRoom)!=null&&t.leaveRoom){window.currentSolarRoom.leaveRoom();return}(o=(e=window.currentSolarRoom)==null?void 0:e._clearPresence)==null||o.call(e),document.body.classList.remove("solar-room-active"),(n=(i=window.Rituals)==null?void 0:i.showClosing)!=null&&n.call(i)||((r=x==null?void 0:x.navigateTo)==null||r.call(x,"hubView"))},showToast(t){var e,o;x!=null&&x.showToast?x.showToast(t):(o=(e=window.app)==null?void 0:e.showToast)==null||o.call(e,t)},_stylesInjected:!1,injectStyles(){if(this._stylesInjected||document.getElementById("solar-shared-styles")){this._stylesInjected=!0;return}const t=document.createElement("style");t.id="solar-shared-styles",t.textContent=this._getSharedCSS(),document.head.appendChild(t),this._stylesInjected=!0},_getSharedCSS(){return`
@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600&display=swap');
...
@media (max-width:380px) {
  ...
  .solar-inactive-card{padding:1.25rem 0.875rem !important;}
    ...
    `}};window.SolarUIManager=$;const Ae={location:{latitude:31,longitude:0,name:"Default"},currentSolarData:null,currentSolarRoom:null,solarRooms:[{season:"spring",icon:"🌱",roomName:"Spring Awakening",roomId:"spring-equinox",description:"Renewal energy and fresh beginnings",energy:"Renewal, Growth, Awakening",practices:["Dawn meditation","Renewal rituals","Energy activation","New beginning visualization"]},{season:"summer",icon:"☀️",roomName:"Summer Radiance",roomId:"summer-solstice",description:"Peak vitality and expansive energy",energy:"Vitality, Expansion, Power",practices:["Solar noon meditation","Fire ceremony","Peak energy practice","Celebration ritual"]},{season:"autumn",icon:"🍂",roomName:"Autumn Harvest",roomId:"autumn-equinox",description:"Gratitude and preparation for rest",energy:"Gratitude, Harvest, Balance",practices:["Gratitude meditation","Harvest ritual","Balance practice","Reflection ceremony"]},{season:"winter",icon:"❄️",roomName:"Winter Stillness",roomId:"winter-solstice",description:"Deep rest and inner contemplation",energy:"Rest, Stillness, Contemplation",practices:["Deep rest meditation","Inner journey","Stillness practice","Contemplative silence"]}],init(){if(this._initialized)return;this._initialized=!0;const t=()=>this.updateAll();navigator.geolocation?navigator.geolocation.getCurrentPosition(({coords:e})=>{this.location={latitude:e.latitude,longitude:e.longitude,name:"Your Location"},t()},t,{timeout:5e3,maximumAge:36e5}):t(),setInterval(t,ke.UPDATE_INTERVAL_MS)},updateAll(){this.updateSolarData(),this.updateSolarVisualization(),this.updateSolarRoom(),this.renderSolarCard()},setLocation(t,e,o){this.location={latitude:t,longitude:e,name:o},this.updateAll()},updateSolarData(){const t=new Date,{latitude:e,longitude:o}=this.location,i=Re.getTimes(t,e,o),n=this.calculateSunDeclination(t),{name:r,days:a}=this._getNextTransition(t);this.currentSolarData={sunrise:i.sunrise,sunset:i.sunset,solarNoon:i.solarNoon,declination:n,seasonInfo:this.getSeasonInfo(t),currentSeason:this.getCurrentSeason(),nextSeasonName:r,daysToNextSeason:a,position:Re.getPosition(t,e,o)},this.renderSolarInfo()},renderSolarInfo(){const t=this.currentSolarData;if(!t)return;const e=(i,n)=>{const r=document.getElementById(i);r&&(r.textContent=n)};e("sunrise",this.formatTime(t.sunrise)),e("sunset",this.formatTime(t.sunset)),e("solarNoon",this.formatTime(t.solarNoon)),e("seasonInfo",t.seasonInfo);const o=document.getElementById("solarDeclination");if(o){const i=o.querySelector(".decl-value");i&&(i.textContent=`${Math.abs(t.declination).toFixed(1)}° ${t.declination>=0?"N":"S"}`)}},calculateSunDeclination(t){const e=this.getDayOfYear(t);return 23.44*Math.sin(2*Math.PI*(e-81)/365)},getDayOfYear(t){return Math.floor((t-new Date(t.getFullYear(),0,0))/864e5)},getSeasonDates(t){if(this._seasonDatesCache||(this._seasonDatesCache={}),this._seasonDatesCache[t])return this._seasonDatesCache[t];const e=(t-2e3)/1e3,o=m=>{const g={spring:[245162380984e-5,365242.37404,.05169,-.00411,-57e-5],summer:[245171656767e-5,365241.62603,.00325,.00888,-3e-4],autumn:[245181021715e-5,365242.01767,-.11575,.00337,78e-5],winter:[245190005952e-5,365242.74049,-.06223,-.00823,32e-5]}[m];return g[0]+g[1]*e+g[2]*e**2+g[3]*e**3+g[4]*e**4},i=m=>{const g=(m-2451545)/36525,f=35999.373*g-2.47,v=1+.0334*Math.cos(f*Math.PI/180)+7e-4*Math.cos(2*f*Math.PI/180),S=[[485,324.96,1934.136],[203,337.23,32964.467],[199,342.08,20.186],[182,27.85,445267.112],[156,73.14,45036.886],[136,171.52,22518.443],[77,222.54,65928.934],[74,296.72,3034.906],[70,243.58,9037.513],[58,119.81,33718.148],[52,297.17,150.678],[50,21.02,2281.226]].reduce((L,[_,k,R])=>L+_*Math.cos((k+R*g)*Math.PI/180),0);return m+1e-5*S/v},n=m=>new Date((m-24405875e-1)*864e5),r=m=>new Date(m.getTime()-864e5),a=m=>n(i(o(m))),s=a("spring"),l=a("summer"),d=a("autumn"),c=a("winter"),p=n(i((()=>{const m=(t+1-2e3)/1e3,g=[245162380984e-5,365242.37404,.05169,-.00411,-57e-5];return g[0]+g[1]*m+g[2]*m**2+g[3]*m**3+g[4]*m**4})())),h={spring:{start:s,end:r(l)},summer:{start:l,end:r(d)},autumn:{start:d,end:r(c)},winter:{start:c,end:r(p)}};return this._seasonDatesCache[t]=h,h},getCurrentSeason(){const t=new Date,e=t.getFullYear(),o=this.location.latitude>=0,i={spring:"autumn",summer:"winter",autumn:"spring",winter:"summer"},n=this.getSeasonDates(e-1);if(t>=n.winter.start&&t<=n.winter.end)return o?"winter":"summer";const r=this.getSeasonDates(e);for(const a of["spring","summer","autumn","winter"]){const{start:s,end:l}=r[a];if(t>=s&&t<=l)return o?a:i[a]}return"winter"},_getUpcomingTransitions(t){const e=t.getFullYear(),o=this.getSeasonDates(e),i=this.getSeasonDates(e+1);return[{name:"Spring Equinox",date:o.spring.start},{name:"Summer Solstice",date:o.summer.start},{name:"Autumn Equinox",date:o.autumn.start},{name:"Winter Solstice",date:o.winter.start},{name:"Spring Equinox",date:i.spring.start}].filter(n=>n.date>t).sort((n,r)=>n.date-r.date)},getSeasonInfo(t){const e=this._getUpcomingTransitions(t)[0];return`${Math.ceil((e.date-t)/864e5)} days to ${e.name}`},_getNextTransition(t){const e=this._getUpcomingTransitions(t)[0];return{name:e.name.split(" ")[0],days:Math.ceil((e.date-t)/864e5)}},getNextSeasonInfo(t){return this._getNextTransition(t)},updateSolarVisualization(){this.currentSolarData&&this.drawWheelOfYear(this.currentSolarData)},drawWheelOfYear(t){var Q;const e=document.getElementById("solarSvg");if(!e)return;const o=280,i=140,n=140,r=110,a=52;e.setAttribute("viewBox",`0 0 ${o} ${o}`),e.setAttribute("width","100%"),e.style.height="auto",e.innerHTML="";const s="http://www.w3.org/2000/svg",l=(E,M)=>{const K=document.createElementNS(s,E);return Object.entries(M).forEach(([J,de])=>K.setAttribute(J,de)),K},d=l("defs",{}),c=l("clipPath",{id:"woyClip"});c.appendChild(l("circle",{cx:i,cy:n,r:r-1})),d.appendChild(c),e.appendChild(d);const p=[{d:`M${i},${n} L${i},${n-r} L${i+r},${n-r} L${i+r},${n} Z`,fill:"#C0DD97"},{d:`M${i},${n} L${i+r},${n} L${i+r},${n+r} L${i},${n+r} Z`,fill:"#FAC775"},{d:`M${i},${n} L${i},${n+r} L${i-r},${n+r} L${i-r},${n} Z`,fill:"#F0957B"},{d:`M${i},${n} L${i-r},${n} L${i-r},${n-r} L${i},${n-r} Z`,fill:"#B5D4F4"}],h=l("g",{"clip-path":"url(#woyClip)"});p.forEach(({d:E,fill:M})=>h.appendChild(l("path",{d:E,fill:M,opacity:"0.45",stroke:"none"}))),e.appendChild(h),e.appendChild(l("circle",{cx:i,cy:n,r,fill:"none",stroke:"var(--neuro-shadow-light)","stroke-width":"1.5"})),e.appendChild(l("circle",{cx:i,cy:n,r:a,fill:"none",stroke:"var(--neuro-shadow-light)","stroke-width":"1","stroke-dasharray":"3 3",opacity:"0.6"})),e.appendChild(l("line",{x1:i-r,y1:n,x2:i+r,y2:n,stroke:"var(--neuro-shadow-light)","stroke-width":"0.8"})),e.appendChild(l("line",{x1:i,y1:n-r,x2:i,y2:n+r,stroke:"var(--neuro-shadow-light)","stroke-width":"0.8"}));const m=(E,M,K,J,de,ce)=>{const ue=l("text",{x:E,y:M,"text-anchor":"middle",fill:de,"font-size":"9","font-weight":"600"});ue.textContent=K,e.appendChild(ue);const y=l("text",{x:E,y:M+11,"text-anchor":"middle",fill:ce,"font-size":"7.5"});y.textContent=J,e.appendChild(y)};m(i+55,n-40,"Spring","Mar · Apr · May","#3B6D11","#639922"),m(i+55,n+52,"Summer","Jun · Jul · Aug","#854F0B","#BA7517"),m(i-55,n+52,"Autumn","Sep · Oct · Nov","#993C1D","#D85A30"),m(i-55,n-40,"Winter","Dec · Jan · Feb","#185FA5","#378ADD");const g=(E,M,K)=>{const J=l("text",{x:E,y:M,"text-anchor":"middle","font-size":"11"});J.textContent=K,e.appendChild(J)};g(i,n-r+8,"🌱"),g(i+r-6,n+4,"☀️"),g(i,n+r-2,"🍂"),g(i-r+6,n+4,"❄️"),[[i,n-r,i,n-r+8],[i+r,n,i+r-8,n],[i,n+r,i,n+r-8],[i-r,n,i-r+8,n]].forEach(([E,M,K,J])=>e.appendChild(l("line",{x1:E,y1:M,x2:K,y2:J,stroke:"var(--neuro-text)","stroke-width":"1.5","stroke-linecap":"round"})));const f=79,v=new Date,S=this.getDayOfYear(v),L=-Math.PI/2+(S-f)/365*2*Math.PI,_=i+r*Math.cos(L),k=n+r*Math.sin(L);for(let E=0;E<8;E++){const M=E*Math.PI/4;e.appendChild(l("line",{x1:_+Math.cos(M)*10,y1:k+Math.sin(M)*10,x2:_+Math.cos(M)*15,y2:k+Math.sin(M)*15,stroke:"#EF9F27","stroke-width":"1.5","stroke-linecap":"round"}))}e.appendChild(l("circle",{cx:_,cy:k,r:"8",fill:"#EF9F27",stroke:"#BA7517","stroke-width":"1.2"})),e.appendChild(l("circle",{cx:_,cy:k,r:"3.5",fill:"#FCDE5A",opacity:"0.9"}));const{nextSeasonName:R,daysToNextSeason:O}=t,T=v.toLocaleDateString("en-US",{month:"short",day:"numeric"}),z=this.getCurrentSeason(),Y=z.charAt(0).toUpperCase()+z.slice(1),B=((Q=this.getSeasonDates(v.getFullYear())[z])==null?void 0:Q.start)||v,X=Math.max(1,Math.floor((v-B)/864e5)+1),G=(E,M,K,J,de)=>{const ce=l("text",{x:i,y:M,"text-anchor":"middle",fill:de,"font-size":K,"font-weight":J});ce.textContent=E,e.appendChild(ce)};G(T,n-10,"9","700","var(--neuro-text)"),G(`${X} days in ${Y}`,n+3,"7.5","400","var(--neuro-text-light)"),G(`${O} days to ${R}`,n+15,"7.5","400","#BA7517")},updateSolarRoom(){const t=this.getCurrentSeason(),e=this.solarRooms.find(o=>o.season===t);e&&e!==this.currentSolarRoom&&(this.currentSolarRoom=e,this.renderSolarRoom(e))},renderSolarRoom(t){const e=(i,n)=>{const r=document.getElementById(i);r&&(r.textContent=n)};e("solarRoomIcon",t.icon),e("solarRoomName",t.roomName),e("solarRoomDesc",t.description);const o=document.getElementById("solarPracticeRoom");o&&(o.setAttribute("data-room-id",t.roomId),o.setAttribute("data-room-energy",t.energy))},getCurrentRoom(){return this.currentSolarRoom},renderSolarCard(){var r,a,s;const t=document.getElementById("solarContainer");if(!t){console.warn("SolarEngine: solarContainer not found");return}if(!this.currentSolarData||!this.currentSolarRoom){t.innerHTML='<p style="color:var(--text-muted);padding:20px;">Loading solar data...</p>';return}const{currentSolarData:e,currentSolarRoom:o}=this,i=(s=(a=(r=window.Core)==null?void 0:r.state)==null?void 0:a.currentUser)==null?void 0:s.is_admin,n=e.currentSeason.charAt(0).toUpperCase()+e.currentSeason.slice(1);t.innerHTML=`
      <div class="celestial-card-full solar-card">
        ...
        ${i?this.renderAdminSection():""}
      </div>`,this.updateSolarVisualization(),this._refreshOuterCard(),this._attachSolarAdminListeners()},_attachSolarAdminListeners(){const t=document.querySelector(".solar-admin-header");if(t&&!t._solarBound){const e=()=>{const o=document.getElementById(t.dataset.panel),i=document.getElementById(t.dataset.toggle),n=(o==null?void 0:o.style.display)!=="none";o&&(o.style.display=n?"none":"block"),i&&(i.textContent=n?"▶":"▼"),t.setAttribute("aria-expanded",String(!n))};t.addEventListener("click",e),t.addEventListener("keydown",o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),e())}),t._solarBound=!0}document.querySelectorAll(".solar-admin-header ~ div button[data-room-id]").forEach(e=>{e._solarBound||(e.addEventListener("click",()=>this.adminJoinRoom(e.dataset.roomId)),e.addEventListener("mouseover",()=>e.style.background="var(--border)"),e.addEventListener("mouseout",()=>e.style.background="var(--season-mood)"),e._solarBound=!0)})},_refreshOuterCard(){var i;if(!(u!=null&&u.ready)){this._outerCardRetry||(this._outerCardRetry=setTimeout(()=>{this._outerCardRetry=null,this._refreshOuterCard()},500));return}const t=this.currentSolarRoom;if(!t)return;const e=`${t.season}-solar`,o=async()=>{try{const n=await u.getRoomParticipants(e),r=document.getElementById("solarRoomPresence");r&&(r.textContent=`${n.length} present`)}catch(n){console.warn("[SolarEngine] _refreshOuterCard error:",n)}};o();try{(i=this._outerCardSub)==null||i.unsubscribe()}catch{}this._outerCardSub=u.subscribeToPresence(o)},renderAdminSection(){const t="solarAdminPanel",e="solarAdminToggle";return`
      ...
      </div>`},adminJoinRoom(t){this._loadAndEnterRoom(t)},injectAdminUI(){var o,i,n;if(!((n=(i=(o=window.Core)==null?void 0:o.state)==null?void 0:i.currentUser)!=null&&n.is_admin))return;const t=document.getElementById("solarContainer");if(!t||t.querySelector("#solarAdminPanel"))return;const e=t.querySelector(".celestial-card-full");e&&e.insertAdjacentHTML("beforeend",this.renderAdminSection())},_ROOM_MODULES:{"spring-equinox":()=>_e(()=>Promise.resolve().then(()=>fo),void 0),"summer-solstice":()=>_e(()=>Promise.resolve().then(()=>vo),void 0),"autumn-equinox":()=>_e(()=>Promise.resolve().then(()=>bo),void 0),"winter-solstice":()=>_e(()=>Promise.resolve().then(()=>wo),void 0)},_roomExportName:{"spring-equinox":"SpringSolarRoom","summer-solstice":"SummerSolarRoom","autumn-equinox":"AutumnSolarRoom","winter-solstice":"WinterSolarRoom"},async _loadAndEnterRoom(t){var o,i,n,r,a,s;const e=this._ROOM_MODULES[t];if(!e){(i=(o=window.Core)==null?void 0:o.showToast)==null||i.call(o,`Unknown room: ${t}`);return}try{const d=(await e())[this._roomExportName[t]];d?d.enterRoom():(r=(n=window.Core)==null?void 0:n.showToast)==null||r.call(n,`${t} failed to initialise`)}catch(l){console.error(`[SolarEngine] _loadAndEnterRoom error for ${t}:`,l),(s=(a=window.Core)==null?void 0:a.showToast)==null||s.call(a,`Failed to load ${t}`)}},joinSolarRoom(){var t,e;if(!this.currentSolarRoom){(e=(t=window.Core)==null?void 0:t.showToast)==null||e.call(t,"Solar room not ready");return}this._loadAndEnterRoom(this.currentSolarRoom.roomId)},formatTime:t=>!t||isNaN(t.getTime())?"N/A":t.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}),formatDate:t=>t.toLocaleDateString("en-US",{month:"short",day:"numeric"}),getSolarData(){return this.currentSolarData}};window.SolarEngine=Ae;const je={config:{},practices:{},prebuiltAffirmations:[],userData:{intention:"",affirmation:"",releaseList:"",practiceCount:0,closureReflection:"",completedDate:null,privateIntention:"",collectiveWord:"",intentionShared:!1},isActive:!1,startDate:null,endDate:null,collectiveTimer:null,saveDebounceTimer:null,eventListeners:[],CONSTANTS:{MAX_INTENTION_LENGTH:500,MAX_AFFIRMATION_LENGTH:300,MAX_RELEASE_LIST_LENGTH:1e3,SAVE_DEBOUNCE_MS:500},_sanitizeInput(t){return typeof t!="string"?"":t.trim().slice(0,1e3).replace(/<script[^>]*>.*?<\/script>/gi,"").replace(/<iframe[^>]*>.*?<\/iframe>/gi,"").replace(/<object[^>]*>.*?<\/object>/gi,"")},_escapeHtml:t=>C.escapeHtml(t),_removeEventListeners(){this.eventListeners.forEach(({element:t,event:e,handler:o})=>t==null?void 0:t.removeEventListener(e,o)),this.eventListeners=[]},_clearTimer(){this.collectiveTimer&&(clearInterval(this.collectiveTimer),this.collectiveTimer=null)},cleanup(){this._clearTimer(),this._removeEventListeners(),clearTimeout(this.saveDebounceTimer),this.saveDebounceTimer=null,this._unsubPresence(),this._unsubCollectiveWords()},_unsubPresence(){var t;try{(t=this._presenceSub)==null||t.unsubscribe()}catch{}this._presenceSub=null},_unsubCollectiveWords(){var t;try{(t=this._collectiveWordsSub)==null||t.unsubscribe()}catch{}this._collectiveWordsSub=null},_startCountdownTimer(t,e,o,i){var n;try{(n=document.getElementById(e))!=null&&n.style&&(document.getElementById(e).style.display="none");const r=document.getElementById(t);if(!r)return;r.setAttribute("role","timer"),r.setAttribute("aria-live","off");let a=o;this._clearTimer(),this.collectiveTimer=setInterval(()=>{a--;const s=Math.floor(a/60),l=a%60;r.textContent=`${s}:${String(l).padStart(2,"0")}`,a<=0&&(this._clearTimer(),r.textContent="Complete",i==null||i())},1e3)}catch(r){console.error("[BaseSolarRoom] _startCountdownTimer error:",r),this._clearTimer()}},init(){try{this.checkIfActive(),this.isActive&&(this.calculateDates(),this.loadData())}catch(t){console.error(`${this.config.displayName} init error:`,t)}},checkIfActive(){var r,a,s;if((s=(a=(r=window.Core)==null?void 0:r.state)==null?void 0:a.currentUser)!=null&&s.is_admin){this.isActive=!0;return}const t=new Date,e=t.getFullYear(),o=this.config.name,i=Ae.getSeasonDates(e)[o];if(t>=i.start&&t<=i.end){this.isActive=!0;return}const n=Ae.getSeasonDates(e-1)[o];this.isActive=t>=n.start&&t<=n.end},calculateDates(){const t=new Date,e=this.config.name,o=Ae.getSeasonDates(t.getFullYear()-1)[e];if(t>=o.start&&t<=o.end){this.startDate=o.start,this.endDate=o.end;return}const i=Ae.getSeasonDates(t.getFullYear())[e];this.startDate=i.start,this.endDate=i.end},loadData(){var e;const t=$.storage.get(this.config.name);t&&new Date(t.seasonStartDate).getTime()===((e=this.startDate)==null?void 0:e.getTime())&&(this.userData=t.data)},saveData(){$.storage.set(this.config.name,{seasonStartDate:this.startDate.toISOString(),data:this.userData})||$.showToast("Could not save data. Check storage limits.")},enterRoom(){var e,o,i,n,r,a,s;const t=(i=(o=(e=window.Core)==null?void 0:e.state)==null?void 0:o.currentUser)==null?void 0:i.is_admin;if(!this.isActive&&!t){$.showToast(`${this.config.emoji} ${this.config.displayName} room opens during ${this.config.displayName.toLowerCase()} season`);return}this.startDate||this.calculateDates(),(r=(n=window.Core)==null?void 0:n.navigateTo)==null||r.call(n,"practiceRoomView"),(s=(a=window.PracticeRoom)==null?void 0:a.stopHubPresence)==null||s.call(a),document.body.classList.add("solar-room-active"),this.renderDashboard(),this._setPresence(),this._loadCollectiveWords()},leaveRoom(){var t,e,o,i;try{this._clearPresence(),this._unsubPresence(),this._unsubCollectiveWords(),this._clearTimer(),this._removeEventListeners(),document.body.classList.remove("solar-room-active"),window.currentSolarRoom=null,(e=(t=window.PracticeRoom)==null?void 0:t.startHubPresence)==null||e.call(t),(i=(o=window.Core)==null?void 0:o.navigateTo)==null||i.call(o,"hubView")}catch(n){console.error("Error leaving solar room:",n)}},renderDashboard(){$.injectStyles();const t=document.getElementById("dynamicRoomContent");if(!t){console.error("dynamicRoomContent not found");return}document.body.setAttribute("data-season",this.config.name),window.currentSolarRoom=this;const e=$.utils.calculateDaysRemaining(this.endDate),o=`${e} ${e===1?"day":"days"} remaining`,i=`${ke.IMAGE_BASE_URL}${this.config.displayName}.webp`,n=this.getLivingPresenceCount();t.innerHTML=`
      <div class="solar-room-bg">
        <div class="solar-floating-bg">
          ${$.utils.generateFloatingElements(this.config.floatingEmojis)}
        </div>

        ${$.renderers.topBar({seasonName:this.config.displayName,emoji:this.config.emoji,daysText:o,livingPresenceCount:n})}
        ...
        <div class="solar-content-wrapper">
          ...
          <div id="soloContent" class="solar-mode-content">
            ...
            <div class="solar-practices-grid" id="practicesGrid">
              ${Object.values(this.practices).map(r=>$.renderers.practiceCard(r,this.isPracticeLocked(r))).join("")}
            </div>
            ${$.renderers.savedInputs(this.userData,this.config.displayName)}
          </div>

          <div id="groupContent" class="solar-mode-content" style="display:none;">
            ${$.renderers.groupPractice({seasonEmoji:this.config.seasonEmoji,seasonName:this.config.displayName,presenceCount:n,itemEmoji:this.config.itemEmoji,sessionTimes:this.config.sessionTimes,collectiveFocus:this.config.collectiveFocus,collectiveNoun:this.config.collectiveNoun})}
          </div>

          ${e<=7?$.renderers.closureSection(this.config.closure):""}
        </div>
      </div>`,this._attachEventListeners(t),setTimeout(()=>this._refreshLivePresence(),300)},_attachEventListeners(t){try{this._removeEventListeners();const e=(r,a,s)=>{r&&(r.addEventListener(a,s),this.eventListeners.push({element:r,event:a,handler:s}))},o=t.querySelector("#practicesGrid"),i=r=>{const a=r.target.closest(".solar-practice-card");a&&(r.type==="keydown"&&r.key!=="Enter"&&r.key!==" "||(r.type==="keydown"&&r.preventDefault(),a.dataset.locked==="true"?$.showToast("Complete the first practice to unlock others"):this.showPracticePopup(a.dataset.practice)))};e(o,"click",i),e(o,"keydown",i),e(t.querySelector(".solar-mode-toggle"),"click",r=>{const a=r.target.closest(".solar-mode-btn");a!=null&&a.dataset.mode&&$.switchMode(a.dataset.mode)});const n=t.querySelector('[data-action="submit-closure"]');e(n,"click",()=>this.submitClosure())}catch(e){console.error("Error attaching event listeners:",e)}},isPracticeLocked:()=>!1,getPracticeContent(t){const e=`get${t.charAt(0).toUpperCase()}${t.slice(1)}Content`;return typeof this[e]=="function"?this[e]():(console.error(`[BaseSolarRoom] Content method ${e} not found for ${t}`),'<div class="solar-popup-section"><p>Practice content not available.</p></div>')},showPracticePopup(t){try{const e=this.practices[t];if(!e){console.error(`Practice ${t} not found`);return}const o=document.createElement("div");o.id="practicePopup",o.innerHTML=$.renderers.popup({title:e.title,content:this.getPracticeContent(t),hasSaveButton:!!e.hasSaveData}),(document.getElementById("communityHubFullscreenContainer")||document.body).appendChild(o),this._attachPopupListeners(o,t)}catch(e){console.error("Error showing practice popup:",e)}},_attachPopupListeners(t,e){var o;try{t.querySelectorAll(".solar-affirmation-btn").forEach(i=>{i.addEventListener("click",()=>{const n=document.getElementById("affirmationText");n&&(n.value=i.dataset.affirmation)})}),(o=t.querySelector('[data-action="save-practice"]'))==null||o.addEventListener("click",()=>this.savePractice(e)),t.querySelectorAll('[data-action="close-popup"]').forEach(i=>i.addEventListener("click",()=>$.closePracticePopup()))}catch(i){console.error("Error attaching popup listeners:",i)}},savePractice(t){try{const e=this.practices[t];if(!(e!=null&&e.hasSaveData))return;const o=a=>{const s=document.getElementById(a);return s?this._sanitizeInput(s.value):null},i=o("intentionText"),n=o("affirmationText"),r=o("releaseListText");i!==null&&(this.userData.intention=i),n!==null&&(this.userData.affirmation=n),r!==null&&(this.userData.releaseList=r),this.userData.practiceCount++,this.saveData(),$.showToast("Practice saved"),$.closePracticePopup(),this.renderDashboard()}catch(e){console.error("Error saving practice:",e),$.showToast("Failed to save practice")}},submitClosure(){const t=document.getElementById("closureReflection");if(!t){$.showToast("Reflection field not found");return}const e=t.value.trim();if(!e){$.showToast("Please write your closing reflection");return}if(e.length<ke.MIN_REFLECTION_LENGTH){$.showToast(`Please write at least ${ke.MIN_REFLECTION_LENGTH} characters`);return}this.userData.closureReflection=e,this.userData.completedDate=new Date().toISOString(),this.saveData(),$.showToast(`${this.config.emoji} ${this.config.displayName} season complete. Rest well until the next cycle.`),setTimeout(()=>this.init(),1e3)},showCollectiveIntentionPopup(){try{const t=document.createElement("div");t.id="collectivePopup",t.className="solar-practice-popup",t.innerHTML=`
        ...
        </div>`,t.querySelector(".solar-popup-overlay").addEventListener("click",e=>{e.target===e.currentTarget&&t.remove()}),t.querySelector("[data-close-collective]").addEventListener("click",()=>t.remove()),(document.getElementById("communityHubFullscreenContainer")||document.body).appendChild(t)}catch(t){console.error("Error showing collective popup:",t)}},_renderCollectiveStep1(){const t=this.getLivingPresenceCount(),e=this._cachedParticipants?this._buildRealAvatars(this._cachedParticipants):"";return`
      <div class="solar-popup-section" style="text-align:center;">
        <div class="solar-live-badge" style="margin-bottom:1rem;">
          <div class="solar-pulse-dot"></div>
          <span id="solarCollectivePresenceBadge">${t} practitioners in circle now</span>
        </div>
        ${e?`<div id="solarCollectiveAvatars" style="display:flex;gap:6px;justify-content:center;margin-bottom:2rem;">${e}</div>`:""}
      ...
      </div>`},startCollectiveStep2(){try{const t=document.getElementById("collectiveIntentionContent");if(!t)return;t.innerHTML=`
        <div class="solar-popup-section" style="text-align:center;">
          <h3>Step 1: Silent Meditation</h3>
        ...
        </div>`}catch(t){console.error("Error starting step 2:",t)}},startMeditationTimer(){this._startCountdownTimer("meditationTimer","startMeditationBtn",180,()=>{const t=document.getElementById("skipToIntentionBtn");t&&(t.textContent="Continue to Intention",t.style.display="block")}),setTimeout(()=>{const t=document.getElementById("skipToIntentionBtn");t&&(t.style.display="block")},1e4)},startCollectiveStep3(){try{this._clearTimer();const t=document.getElementById("collectiveIntentionContent");if(!t)return;t.innerHTML=`
        <div class="solar-popup-section">
          <h3>Step 2: Your Private Intention</h3>
        ...
        </div>`}catch(t){console.error("Error starting step 3:",t)}},startCollectiveStep4(){try{const t=document.getElementById("privateIntentionText");t&&(this.userData.privateIntention=t.value.trim());const e=document.getElementById("collectiveIntentionContent");if(!e)return;e.innerHTML=`
        <div class="solar-popup-section">
        ...
        </div>`}catch(t){console.error("Error starting step 4:",t)}},submitWordToCollective(){var t;try{const e=((t=document.getElementById("collectiveWordInput"))==null?void 0:t.value.trim())||"";if(!e){$.showToast("Please enter a word");return}if(e.length>50){$.showToast("Word is too long");return}this.userData.collectiveWord=e,this.userData.intentionShared=!0,u!=null&&u.ready&&u.sendRoomMessage(`${this._getSolarRoomId()}-collective`,e).catch(o=>console.error("[BaseSolarRoom] submitWordToCollective DB error:",o)),this.startCollectiveStep5()}catch(e){console.error("Error submitting word:",e)}},startCollectiveStep5(){var t;try{const e=document.getElementById("collectiveIntentionContent");if(!e)return;const o=(t=this._dbCollectiveWords)!=null&&t.length?this._dbCollectiveWords:this._getMockCollectiveWords(),i=this._renderWordCloud(o);e.innerHTML=`
        <div class="solar-popup-section" style="text-align:center;">
        ...
        </div>`}catch(e){console.error("Error starting step 5:",e)}},startWitnessingTimer(){this._startCountdownTimer("witnessingTimer","startWitnessingBtn",120,()=>{const t=document.getElementById("completeBtn");t&&(t.style.display="block")})},completeCollectivePractice(){var t;try{this.userData.practiceCount++,this.saveData(),$.showToast(`${this.config.seasonEmoji} ${this.config.collectiveNoun||"Intention"} planted with the collective`),(t=document.getElementById("collectivePopup"))==null||t.remove(),this.renderDashboard()}catch(e){console.error("Error completing collective practice:",e)}},_getMockCollectiveWords(){const t={spring:["Growth","Renewal","Hope","Bloom","Energy","Fresh","Vitality","Emerge","Awaken","Begin"],summer:["Radiance","Joy","Abundance","Vibrant","Expansion","Bright","Celebrate","Fullness","Alive","Shine"],autumn:["Harvest","Gratitude","Release","Balance","Gather","Wisdom","Reflection","Abundance","Thanks","Ripen"],winter:["Rest","Stillness","Peace","Wisdom","Quiet","Restore","Deep","Calm","Reflection","Inner"]},e=t[this.config.name]||t.spring,o=Date.now();return e.map((i,n)=>({word:i,timestamp:o-n*36e5}))},_getSolarRoomId:function(){return`${this.config.name}-solar`},getLivingPresenceCount(){return typeof this._cachedPresenceCount=="number"?this._cachedPresenceCount:0},async _refreshLivePresence(){if(!(u!=null&&u.ready))return;const t=this._getSolarRoomId(),e=async()=>{try{const o=await u.getRoomParticipants(t),i=await u.getBlockedUsers(),n=o.filter(l=>!i.has(l.user_id)),r=n.length;this._cachedPresenceCount=r,this._cachedParticipants=n;const a=(l,d)=>{const c=document.getElementById(l);c&&(c.textContent=d)};a("solarLiveCountTop",`${r} members practicing with you now`),a("solarGroupPresenceBadge",`${r} gathering now`),a("solarGroupJoinCount",r),a("solarCollectivePresenceBadge",`${r} practitioners in circle now`);const s=document.getElementById("solarGroupAvatars");s&&(s.innerHTML=this._buildRealAvatars(n))}catch(o){console.warn("[BaseSolarRoom] _refreshLivePresence error:",o)}};await e(),this._unsubPresence(),this._presenceSub=u.subscribeToPresence(e)},_buildRealAvatars(t){const o=t.slice(0,5),i=t.length-5,n="width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.2);",r=o.map(s=>{var m,g;const l=s.profiles||{},d=l.name||l.display_name||"?",c=d.charAt(0).toUpperCase(),p=((g=(m=window.Core)==null?void 0:m.getAvatarGradient)==null?void 0:g.call(m,s.user_id))??"background:var(--season-accent,#f59e0b)";let h;return l.avatar_url?h=`<img src="${l.avatar_url}" alt="${c}" width="40" height="40" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">`:l.emoji?h=`<span style="font-size:18px;">${l.emoji}</span>`:h=`<span style="font-size:13px;font-weight:600;">${c}</span>`,`<div class="solar-avatar" style="${p};${n}" aria-label="${d}">${h}</div>`}).join(""),a=i>0?`<div class="solar-avatar" style="background:rgba(255,255,255,0.1);${n}font-size:12px;">+${i}</div>`:"";return r+a},_setPresence(){var t;if(u!=null&&u.ready)try{const e=this._getSolarRoomId(),o=`${this.config.emoji} ${this.config.displayName}`;u.setPresence("online",o,e),(t=window.Core)!=null&&t.state&&(window.Core.state.currentRoom=e,window.Core.state.currentUser&&(window.Core.state.currentUser.activity=o))}catch(e){console.error("[BaseSolarRoom] _setPresence error:",e)}},_clearPresence(){var t;if(u!=null&&u.ready)try{u.setPresence("online","✨ Available",null),(t=window.Core)!=null&&t.state&&(window.Core.state.currentRoom=null,window.Core.state.currentUser&&(window.Core.state.currentUser.activity="✨ Available"))}catch(e){console.error("[BaseSolarRoom] _clearPresence error:",e)}},async _loadCollectiveWords(){if(u!=null&&u.ready)try{const t=`${this._getSolarRoomId()}-collective`,e=async()=>{const o=await u.getRoomMessages(t,100);if(!(o!=null&&o.length))return;this._dbCollectiveWords=o.map(r=>({word:r.message,timestamp:new Date(r.created_at).getTime()}));const i=document.getElementById("wordCloud");i&&(i.innerHTML=this._renderWordCloud(this._dbCollectiveWords));const n=document.querySelector(".solar-word-count strong");n&&(n.textContent=this._dbCollectiveWords.length)};await e(),this._unsubCollectiveWords(),this._collectiveWordsSub=u.subscribeToRoomChat(t,e)}catch(t){console.warn("[BaseSolarRoom] _loadCollectiveWords error:",t)}},_renderWordCloud(t){return t!=null&&t.length?t.map(({word:e})=>{const o=(1+Math.random()*1.5).toFixed(2),i=(.6+Math.random()*.4).toFixed(2);return`<span class="solar-word-item" style="font-size:${o}rem;opacity:${i};color:var(--season-accent,#e0e0ff);font-weight:600;display:inline-block;margin:0.5rem;transition:all 0.3s;">${e}</span>`}).join(""):'<p style="color:rgba(224,224,255,0.5);">No words yet. Be the first to share.</p>'}};class Ke extends D{constructor(){super({roomId:"silent",roomType:"always-open",name:"Silent Meditation",icon:"🧘",description:"Join others in silence. No guidance, shared energy.",energy:"Peaceful",imageUrl:"/Community/Silent.webp",participants:4}),this.initTimerState(1200),this.initSoundState(),this.affirmations=["Breathe in peace, breathe out tension","This moment is enough","I am here, I am present","Let go of what was, embrace what is","In stillness, I find clarity","My breath is my anchor","I trust the process of life","Peace begins within","I am worthy of this rest","This too shall pass"],this._affirmationInterval=null}onEnter(){this.startAffirmations()}onLeave(){this.resetTimer(),this._resetDimMode()}onCleanup(){this.cleanupTimer(),this.cleanupSound(),this._affirmationInterval&&(clearInterval(this._affirmationInterval),this._affirmationInterval=null),this._affirmationVisibilityHandler&&(document.removeEventListener("visibilitychange",this._affirmationVisibilityHandler),this._affirmationVisibilityHandler=null)}onOutsideClick(e){const o=document.getElementById(`${this.roomId}SoundSettings`);o&&!o.contains(e.target)&&!e.target.closest('[data-action="toggleSoundSettings"]')&&o.classList.remove("visible")}buildAdditionalHeaderButtons(){return`
        ...
        <div class="ps-body">
            ...
            </ul>`}}const Xt=new Jt;window.GuidedRoom=Xt;var lt;(lt=window.dispatchRoomReady)==null||lt.call(window,"guided");class Zt extends Be{constructor(){super({roomId:"osho",roomType:"timed",name:"OSHO Active",icon:"💃",description:"OSHO Active Meditations practices (with instructions). View Schedule for details.",energy:"Dynamic",imageUrl:"/Community/OSHO.webp",participants:0,cycleDuration:5400,openDuration:600,sessionDuration:4800}),this.scheduleModalTitle="📅 Upcoming OSHO Sessions",this.sessions=[{title:"OSHO Dynamic Meditation",duration:"77:00",category:"Energy",introVideoId:"Q_PFlkHH7IA",videoId:"tLUxtq3peR8",emoji:"🔥"},{title:"OSHO Kundalini Meditation",duration:"77:00",category:"Movement",introVideoId:"O3-wH2VBdN8",videoId:"vEyageQp6w8",emoji:"💃"},{title:"OSHO Nadabrahma Meditation",duration:"77:00",category:"Humming",introVideoId:"tnVsMXf88Pw",videoId:"yVGhzBVT64A",emoji:"🕉️"},{title:"OSHO Nataraj Meditation",duration:"77:00",category:"Dance",introVideoId:"pxg3FmOeQhk",videoId:"grSjP12Q4Oc",emoji:"🎭"},{title:"OSHO Whirling Meditation",duration:"77:00",category:"Spinning",introVideoId:"Jk2AaABIKTY",videoId:"EKvLFs9niXY",emoji:"🌀"}]}onEnter(){this._playingIntro=!1,super.onEnter()}initPlayer(){if(this.state.playerInitialized)return;const e=this.getCurrentSession();if(!(e!=null&&e.introVideoId)){super.initPlayer();return}this._playingIntro=!0,this.state.player=new YT.Player(`${this.roomId}-youtube-player`,{videoId:e.introVideoId,playerVars:{autoplay:0,controls:1,modestbranding:1,rel:0,mute:1},events:{onReady:o=>this.onPlayerReady(o),onStateChange:o=>this.onPlayerStateChange(o)}}),this.state.playerInitialized=!0}startSession(){var o,i,n;if(!this.state.playerReady||this.state.sessionStarted)return;const e=this.getCurrentSession();e&&(this._playingIntro=!0,this._showPlayer(),(o=this.state.player)==null||o.unMute(),(i=this.state.player)==null||i.setVolume(100),(n=this.state.player)==null||n.playVideo(),this.state.sessionStarted=!0,window.Core.showToast(`${e.emoji} Intro starting…`))}onVideoEnded(){if(this._playingIntro){this._playingIntro=!1;const e=this.getCurrentSession();e!=null&&e.videoId&&this.state.player&&(this.state.player.loadVideoById(e.videoId),this.state.player.playVideo(),window.Core.showToast(`${e.emoji} Practice starting…`))}else this.stopProgressTracking(),window.Core.showToast("Session complete")}getInstructions(){return`
            ...
            <div style="padding:0 20px 20px;">
                <div style="background:var(--surface);border:2px solid var(--border);border-radius:var(--radius-lg);overflow:hidden;">
                    ...
                    <div data-action="toggleChatPanel"
                         style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;cursor:pointer;user-select:none;opacity:${o?"1":"0.35"};">
                        ...
                        <div style="display:flex;align-items:center;gap:8px;">
                            ${o?"":'<span style="font-size:11px;opacity:0.6;font-style:italic;">☕ Opens on Break</span>'}
                            <svg id="${this.roomId}ChatChevron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:16px;height:16px;transition:transform 0.25s;transform:${o?"rotate(0deg)":"rotate(-90deg)"};">
                    ...
                    <div id="${this.roomId}ChatPanelBody"
                         style="overflow:hidden;max-height:${o?"600px":"0px"};transition:max-height 0.3s ease;opacity:${o?"1":"0"};transition:max-height 0.3s ease,opacity 0.3s ease;">
                ...
                <div class="modal-content">
                    ...
                    <div style="margin-bottom:24px;">
                        ...
                        <div id="${this.roomId}CategoryTiles" role="radiogroup" aria-labelledby="${this.roomId}CategoryLabel" style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;">
                            ${Object.entries(this.CATEGORIES).map(([e,o],i)=>`
                            <button type="button" data-action="selectCategory" data-cat="${e}"
                                ...
                                ${o.icon} ${o.label.charAt(0)+o.label.slice(1).toLowerCase()}
                            </button>`).join("")}
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom:24px;">
                        ...
                        <div id="${this.roomId}DurationTiles" role="radiogroup" aria-labelledby="${this.roomId}DurationLabel" style="display:grid;grid-template-columns:repeat(2,1fr);gap:8px;">
                            ...
                            <button type="button" data-action="selectDuration" data-dur="${e}"
                                    style="padding:12px;text-align:center;border:2px solid ${o===0?"var(--accent)":"var(--border)"};border-radius:var(--radius-md);background:${o===0?"rgba(139,92,246,0.12)":"var(--surface)"};cursor:pointer;font-size:14px;font-weight:600;transition:all 0.15s;user-select:none;width:100%;">
                                ${e} min
                            </button>`).join("")}
        ...
        ${i?`<p style="font-family:var(--serif);font-size:16px;font-weight:700;color:var(--text);text-align:center;margin:0;letter-spacing:.01em;">${i}</p>`:""}`}_getEnrichedHTML(e,o=!0){const i=`${e.suit}-${e.number}-${o}`;return this._enrichedCache[i]||(this._enrichedCache[i]=this._buildEnrichedSections(e,o)),this._enrichedCache[i]}_buildEnrichedSections(e,o=!0){const i=this.getCardData(e.number,e.suit);if(!i)return"";const n={pentacles:"Earth",swords:"Air",cups:"Water",wands:"Fire"},r={pentacles:"Physical",swords:"Mental",cups:"Emotional",wands:"Spiritual"},a={Air:"Air",Fire:"Fire",Water:"Water",Earth:"Earth"};let s=null,l=null;e.suit==="major"?s=a[i.correspondence]??null:(s=n[e.suit]??null,l=r[e.suit]??null);const d=(i.keywords||[]).map(g=>`<span style="display:inline-block;padding:4px 12px;border:1px solid var(--border);border-radius:20px;font-size:12px;color:var(--text-muted);margin:3px 4px;white-space:nowrap;">${g}</span>`).join(""),c=[];i.astrology&&i.astrology!=="-"&&c.push({label:"Astrology",value:i.astrology}),s&&c.push({label:"Element",value:s}),l&&c.push({label:"Aspect",value:l}),i.treeOfLife&&c.push({label:"Tree of Life",value:i.treeOfLife});const p=c.map(g=>`
            ...
            </div>`).join(""),h=(i.symbols||[]).map(g=>`<li style="margin:6px 0;font-size:14px;color:var(--text-muted);line-height:1.5;">${g}</li>`).join(""),m=this.roomId;return`
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-lg);padding:24px;margin-bottom:12px;">
            ...
            <div id="${m}MeaningText" style="text-align:center;font-size:15px;line-height:1.7;max-width:560px;margin:0 auto;">${i.upright||""}</div>
            <div id="${m}MeaningTextReversed" style="display:none;text-align:center;font-size:15px;line-height:1.7;max-width:560px;margin:0 auto;color:var(--text-muted);">${i.reversed||""}</div>
            ${h?`
            <details style="margin-top:20px;border-top:1px solid var(--border);padding-top:16px;">
                ...
                <ul style="margin:12px 0 0 0;padding:0 0 0 4px;list-style:none;">${h}</ul>
            </details>`:""}
        </div>
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-lg);padding:24px;margin-bottom:12px;">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px;">
                ...
                <button onclick="window.TarotRoom._toggleJournalLog()" id="${m}JournalLogBtn"
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-lg);padding:24px;margin-bottom:12px;">
            ...
            <div id="${m}InterpList" style="display:flex;flex-direction:column;gap:8px;max-height:220px;overflow-y:auto;">
        ...
        </div>`:""}`}_setMeaningTab(e){const o=document.getElementById(`${this.roomId}UprightBtn`),i=document.getElementById(`${this.roomId}ReversedBtn`),n=document.getElementById(`${this.roomId}MeaningText`),r=document.getElementById(`${this.roomId}MeaningTextReversed`);o&&(e==="upright"?(o.style.background="var(--accent)",o.style.color="#fff",o.style.borderColor="var(--accent)",i.style.background="transparent",i.style.color="var(--text-muted)",i.style.borderColor="var(--border)",n.style.display="",r.style.display="none"):(i.style.background="var(--accent)",i.style.color="#fff",i.style.borderColor="var(--accent)",o.style.background="transparent",o.style.color="var(--text-muted)",o.style.borderColor="var(--border)",n.style.display="none",r.style.display=""))}_toggleJournalLog(){const e=document.getElementById(`${this.roomId}JournalLog`),o=document.getElementById(`${this.roomId}JournalForm`),i=document.getElementById(`${this.roomId}JournalLogBtn`);if(!e)return;const n=e.style.display!=="none";e.style.display=n?"none":"",o.style.display=n?"":"none",i.textContent=n?"View Log":"Write Entry",n||this._loadJournalLog()}async _saveJournalEntry(){var a;const e=document.getElementById(`${this.roomId}JournalInput`),o=(a=e==null?void 0:e.value)==null?void 0:a.trim();if(!o){window.Core.showToast("Please write something first");return}const i=window.Core.state.currentUser,n=this.state.dailyCard,r=new Date().toISOString().slice(0,10);try{await u._sb.from("tarot_reflections").insert({user_id:i==null?void 0:i.id,card_key:`${n.suit}-${n.number}`,card_name:this.getCardName(n.number,n.suit),date:r,reflection:o}),e.value="",window.Core.showToast("Saved to your journal ✨")}catch(s){console.warn("[TarotRoom] journal save failed",s),window.Core.showToast("Could not save — please try again")}}async _loadJournalLog(){const e=window.Core.state.currentUser,o=document.getElementById(`${this.roomId}JournalLogList`);if(!(!o||!(e!=null&&e.id))){o.innerHTML='<div style="font-size:13px;color:var(--text-muted);text-align:center;padding:12px;">Loading…</div>';try{const{data:i,error:n}=await u._sb.from("tarot_reflections").select("id, card_name, date, reflection").eq("user_id",e.id).order("created_at",{ascending:!1}).limit(30);if(n)throw n;if(!i||i.length===0){o.innerHTML='<div style="font-size:13px;color:var(--text-muted);text-align:center;padding:12px;">No journal entries yet.</div>';return}o.innerHTML=i.map(r=>`
                ...
                </div>`).join("")}catch(i){console.warn("[TarotRoom] load journal failed",i),o.innerHTML='<div style="font-size:13px;color:var(--text-muted);text-align:center;padding:12px;">Could not load journal.</div>'}}}_editJournalEntry(e){var o,i;(o=document.getElementById(`jr-text-${e}`))!=null&&o.style&&(document.getElementById(`jr-text-${e}`).style.display="none"),(i=document.getElementById(`jr-edit-${e}`))!=null&&i.style&&(document.getElementById(`jr-edit-${e}`).style.display="")}_cancelEditEntry(e){var o,i;(o=document.getElementById(`jr-text-${e}`))!=null&&o.style&&(document.getElementById(`jr-text-${e}`).style.display=""),(i=document.getElementById(`jr-edit-${e}`))!=null&&i.style&&(document.getElementById(`jr-edit-${e}`).style.display="none")}async _saveEditedEntry(e){var r;const o=document.getElementById(`jr-edit-${e}`),i=o==null?void 0:o.querySelector("textarea"),n=(r=i==null?void 0:i.value)==null?void 0:r.trim();if(n)try{await u._sb.from("tarot_reflections").update({reflection:n}).eq("id",e);const a=document.getElementById(`jr-text-${e}`);a&&(a.textContent=n),this._cancelEditEntry(e),window.Core.showToast("Entry updated")}catch(a){console.warn("[TarotRoom] edit failed",a),window.Core.showToast("Could not update entry")}}async _deleteJournalEntry(e){var o;try{await u._sb.from("tarot_reflections").delete().eq("id",e),(o=document.getElementById(`jr-${e}`))==null||o.remove(),window.Core.showToast("Entry deleted")}catch(i){console.warn("[TarotRoom] delete failed",i),window.Core.showToast("Could not delete entry")}}async _submitInterpretation(){var a;const e=document.getElementById(`${this.roomId}InterpInput`),o=(a=e==null?void 0:e.value)==null?void 0:a.trim();if(!o)return;const i=window.Core.state.currentUser,n=this.state.dailyCard,r=new Date().toISOString().slice(0,10);try{await u._sb.from("tarot_interpretations").insert({user_id:i==null?void 0:i.id,display_name:(i==null?void 0:i.display_name)||(i==null?void 0:i.username)||"A seeker",card_key:`${n.suit}-${n.number}`,date:r,interpretation:o}),e.value="",await this._loadInterpretations(),window.Core.showToast("Shared 🌀")}catch(s){console.warn("[TarotRoom] interpretation save failed",s),window.Core.showToast("Could not share — please try again")}}async _loadInterpretations(){const e=this.state.dailyCard,o=new Date().toISOString().slice(0,10),i=document.getElementById(`${this.roomId}InterpList`);if(!(!i||!e)){this._interpPurgedToday||(this._interpPurgedToday=!0,u._sb.from("tarot_interpretations").delete().lt("date",o).then(()=>{}));try{const{data:n,error:r}=await u._sb.from("tarot_interpretations").select("display_name, interpretation, created_at").eq("card_key",`${e.suit}-${e.number}`).eq("date",o).order("created_at",{ascending:!1}).limit(50);if(r)throw r;if(!n||n.length===0){i.innerHTML='<div style="font-size:13px;color:var(--text-muted);text-align:center;padding:12px;">Be the first to share an interpretation.</div>';return}i.innerHTML=n.map(a=>`
                ...
                </div>`}).join(""),this._personalDataLoaded=!0}catch(r){console.warn("[TarotRoom] loadDrawHistory failed",r)}}async _loadMastery(){var r,a;const e=document.getElementById(`${this.roomId}MasteryCount`),o=document.getElementById(`${this.roomId}MasteryProgress`),i=document.getElementById(`${this.roomId}MasteryCards`);if(!e||!u._sb)return;const n=(a=(r=window.Core)==null?void 0:r.state)==null?void 0:a.currentUser;if(n!=null&&n.id)try{const{data:s}=await u._sb.from("tarot_draws").select("card_key").eq("user_id",n.id).eq("card_type","major"),l=new Set((s||[]).map(h=>h.card_key)),d=22,c=l.size,p=Math.round(c/d*100);if(e&&(e.textContent=`${c} / ${d}`),o&&(o.style.width=`${p}%`),i){const h=this.MAJOR_ARCANA_NAMES||{};i.innerHTML=Object.entries(h).map(([m,g])=>{const f=`major-${m}`,v=l.has(f);return`<span style="padding:3px 8px;border-radius:12px;font-size:12px;border:1px solid var(--border);
                        background:${v?"var(--neuro-accent)":"transparent"};
                        color:${v?"white":"var(--text-muted)"};
                        opacity:${v?"1":"0.6"};"
                        title="${g}">${v?"✓ ":""}${g}</span>`}).join("")}}catch(s){console.warn("[TarotRoom] loadMastery failed",s)}}async _clearDrawHistory(){var o,i;if(!u._sb)return;const e=(i=(o=window.Core)==null?void 0:o.state)==null?void 0:i.currentUser;if(e!=null&&e.id&&confirm("Clear your entire draw history? This cannot be undone."))try{await u._sb.from("tarot_draws").delete().eq("user_id",e.id),this._personalDataLoaded=!1,this._loadDrawHistory(),this._loadMastery(),window.Core.showToast("Draw history cleared")}catch(n){console.warn("[TarotRoom] clearDrawHistory failed",n)}}onEnter(){this.state.personalDeck.length||(this.state.personalDeck=this._buildFullDeck()),this._personalTabHydrated=!1,this._tarotDataReady?this._drawAndRenderDaily():this._pendingDailyRender=!0,this.initializeChat(),requestAnimationFrame(()=>{var e;return(e=document.querySelector(`#${this.roomId}View .tarot-main`))==null?void 0:e.scrollTo(0,0)})}getParticipantText(){return`${this.state.participants} seeking guidance`}buildCardFooter(){const e=this.state.dailyCard,o=e?this.getCardName(e.number,e.suit):null;return`
        <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:4px;">
            <span class="room-participants" style="font-size:12px;color:var(--text-muted);">${this.getParticipantText()}</span>
            ${o?`<span style="font-size:11px;color:var(--text-muted);">Daily Card: <strong style="color:var(--text);font-weight:600;">${o}</strong></span>`:""}
        ...
        </div>`}_buildPersonalTab(){const e=this.roomId,o=Object.entries(this.MAJOR_ARCANA_NAMES||{}).map(([c,p])=>`<option value="major:${c}">${p}</option>`).join(""),i=["pentacles","swords","cups","wands"],n={pentacles:"Pentacles",swords:"Swords",cups:"Cups",wands:"Wands"},r={1:"Ace",2:"Two",3:"Three",4:"Four",5:"Five",6:"Six",7:"Seven",8:"Eight",9:"Nine",10:"Ten"},a=i.map(c=>`<optgroup label="${n[c]}">${Array.from({length:10},(p,h)=>h+1).map(p=>`<option value="minor:${p}:${c}">${r[p]} of ${n[c]}</option>`).join("")}</optgroup>`).join(""),s={11:"Page",12:"Knight",13:"Queen",14:"King"},l=i.map(c=>`<optgroup label="${n[c]}">${Object.entries(s).map(([p,h])=>`<option value="court:${p}:${c}">${h} of ${n[c]}</option>`).join("")}</optgroup>`).join(""),d="width:100%;padding:10px 12px;border:2px solid var(--border);border-radius:var(--radius-md);background:var(--surface);color:var(--text);font-size:14px;cursor:pointer;";return`
        <div style="background:var(--surface);border:2px solid var(--border);border-radius:var(--radius-lg);padding:24px;margin-bottom:16px;">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-bottom:20px;">
                <div>
                    ...
                    <select id="${e}MajorSelect" style="${d}" data-action="personalSelectChange" data-source="major">
                        <option value="">— Select —</option>${o}
                    </select>
                </div>
                <div>
                    ...
                    <select id="${e}MinorSelect" style="${d}" data-action="personalSelectChange" data-source="minor">
                        <option value="">— Select —</option>${a}
                    </select>
                </div>
                <div>
                    <label style="font-weight:700;font-size:15px;margin-bottom:6px;display:flex;align-items:center;gap:6px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon" style="width:16px;height:16px;vertical-align:middle;"><path d="M2 20h20"/><path d="m4 14 4-8 4 8 4-8 4 8"/></svg> Court Cards</label>
                    <select id="${e}CourtSelect" style="${d}" data-action="personalSelectChange" data-source="court">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:4px;">
            ...
            </div>`).join(""),d=(e.commonIssues||[]).map(f=>`<li style="margin:6px 0;font-size:14px;color:var(--text-muted);line-height:1.5;">${f}</li>`).join(""),c=(e.guidedReflections||[]).map(f=>`<li style="margin:8px 0;font-size:14px;line-height:1.6;color:var(--text);">${f}</li>`).join(""),p=this.roomId,h=i?"daily":"personal",m=i?"Daily":"Personal";return`
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-lg);padding:24px;margin-bottom:12px;">
            ...
            <div style="display:flex;flex-direction:column;gap:10px;">
                ${(e.fundamentalTruths||[]).map(f=>`<p style="font-family:var(--serif);font-style:italic;font-size:15px;line-height:1.7;margin:0;text-align:center;color:var(--text);">"${f}"</p>`).join("")}
                ${e.visualization?`
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-lg);padding:24px;margin-bottom:12px;display:flex;flex-direction:column;gap:8px;">
            ...
            <details>
                ...
                <ul style="margin:12px 0 0 0;padding:0 0 0 4px;list-style:none;">${d}</ul>
            </details>`:""}
            ${c?`
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-lg);padding:24px;margin-bottom:12px;">
            ...
            <div style="display:flex;gap:8px;margin-bottom:16px;">
                ...
                />
                <button type="button" id="${p}EnergyShareBtn" data-action="submitCommunityEnergy"
                    style="padding:9px 18px;border:1px solid var(--accent);background:var(--accent);color:#fff;border-radius:var(--radius-md);font-size:14px;font-weight:600;cursor:pointer;white-space:nowrap;flex-shrink:0;">
                    Share
                </button>
            </div>
        ...
        <div style="border:2px solid var(--border);border-radius:var(--radius-lg);padding:20px;background:var(--surface);margin-top:16px;">
            ...
            <div id="${this.roomId}MasteryChakras" style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center;">
        ...
        </div>`}_toggleChakraJournalLog(e){const o=this.roomId,i=document.getElementById(`${o}${e}JournalLog`),n=document.getElementById(`${o}${e}JournalForm`),r=document.getElementById(`${o}${e}JournalLogBtn`);if(!i)return;const a=i.style.display!=="none";i.style.display=a?"none":"",n.style.display=a?"":"none",r.textContent=a?"View Log":"Write Entry",a||this._loadChakraJournalLog(e)}async _saveChakraJournalEntry(e,o){var c,p;const i=this.roomId,n=document.getElementById(`${i}${e}JournalInput`),r=(c=n==null?void 0:n.value)==null?void 0:c.trim();if(!r){window.Core.showToast("Please write something first");return}const a=window.Core.state.currentUser,s=new Date().toISOString().slice(0,10),d=((p=Object.values(this.CHAKRA_SCHEDULE||{}).find(h=>h.key===o))==null?void 0:p.name)||o;try{await u._sb.from("reiki_sessions").insert({user_id:a==null?void 0:a.id,chakra_key:o,chakra_name:d,date:s,entry:r}),n.value="",window.Core.showToast("Saved to your chakra journal ✨"),this._masteryLoaded=!1,e==="Personal"&&this._loadChakraMastery()}catch(h){console.warn("[ReikiRoom] journal save failed",h),window.Core.showToast("Could not save — please try again")}}async _loadChakraJournalLog(e){const o=this.roomId,i=window.Core.state.currentUser,n=document.getElementById(`${o}${e}JournalLogList`);if(!(!n||!(i!=null&&i.id))){n.innerHTML='<div style="font-size:13px;color:var(--text-muted);text-align:center;padding:12px;">Loading…</div>';try{const{data:r,error:a}=await u._sb.from("reiki_sessions").select("id, chakra_name, date, entry").eq("user_id",i.id).order("created_at",{ascending:!1}).limit(30);if(a)throw a;if(!r||r.length===0){n.innerHTML='<div style="font-size:13px;color:var(--text-muted);text-align:center;padding:12px;">No journal entries yet.</div>';return}n.innerHTML=r.map(s=>`
                ...
                </div>`).join("")}catch(r){console.warn("[ReikiRoom] load journal failed",r),n.innerHTML='<div style="font-size:13px;color:var(--text-muted);text-align:center;padding:12px;">Could not load journal.</div>'}}}_editSessionEntry(e){var o,i;(o=document.getElementById(`rj-text-${e}`))!=null&&o.style&&(document.getElementById(`rj-text-${e}`).style.display="none"),(i=document.getElementById(`rj-edit-${e}`))!=null&&i.style&&(document.getElementById(`rj-edit-${e}`).style.display="")}_cancelEditEntry(e){var o,i;(o=document.getElementById(`rj-text-${e}`))!=null&&o.style&&(document.getElementById(`rj-text-${e}`).style.display=""),(i=document.getElementById(`rj-edit-${e}`))!=null&&i.style&&(document.getElementById(`rj-edit-${e}`).style.display="none")}async _saveEditedEntry(e){var r;const o=document.getElementById(`rj-edit-${e}`),i=o==null?void 0:o.querySelector("textarea"),n=(r=i==null?void 0:i.value)==null?void 0:r.trim();if(n)try{await u._sb.from("reiki_sessions").update({entry:n}).eq("id",e);const a=document.getElementById(`rj-text-${e}`);a&&(a.textContent=n),this._cancelEditEntry(e),window.Core.showToast("Entry updated")}catch(a){console.warn("[ReikiRoom] edit failed",a),window.Core.showToast("Could not update entry")}}async _deleteSessionEntry(e){var o;try{await u._sb.from("reiki_sessions").delete().eq("id",e),(o=document.getElementById(`rj-${e}`))==null||o.remove(),window.Core.showToast("Entry deleted")}catch(i){console.warn("[ReikiRoom] delete failed",i),window.Core.showToast("Could not delete entry")}}async _submitCommunityEnergy(){var a;const e=document.getElementById(`${this.roomId}EnergyInput`),o=(a=e==null?void 0:e.value)==null?void 0:a.trim();if(!o)return;const i=window.Core.state.currentUser,n=this.CHAKRA_SCHEDULE[this.state.currentDay],r=new Date().toISOString().slice(0,10);try{await u._sb.from("reiki_shares").insert({user_id:i==null?void 0:i.id,display_name:(i==null?void 0:i.display_name)||(i==null?void 0:i.username)||(i==null?void 0:i.name)||"A seeker",chakra_key:n==null?void 0:n.key,date:r,share:o}),e.value="",await this._loadCommunityEnergy(),window.Core.showToast("Shared 🌀")}catch(s){console.warn("[ReikiRoom] community energy save failed",s),window.Core.showToast("Could not share — please try again")}}async _loadCommunityEnergy(){const e=this.CHAKRA_SCHEDULE[this.state.currentDay],o=new Date().toISOString().slice(0,10),i=document.getElementById(`${this.roomId}EnergyList`);if(!(!i||!e)){this._energyPurgedToday||(this._energyPurgedToday=!0,u._sb.from("reiki_shares").delete().lt("date",o).then(()=>{}));try{const{data:n,error:r}=await u._sb.from("reiki_shares").select("display_name, share, created_at").eq("chakra_key",e.key).eq("date",o).order("created_at",{ascending:!1}).limit(50);if(r)throw r;if(!n||n.length===0){i.innerHTML=`<div style="font-size:13px;color:var(--text-muted);text-align:center;padding:12px;">Be the first to share today's energy.</div>`;return}i.innerHTML=n.map(a=>`
                <div style="display:flex;gap:10px;align-items:baseline;padding:8px 10px;background:var(--background);border-radius:var(--radius-md);border:1px solid var(--border);">
                    <span style="font-size:12px;font-weight:600;color:var(--accent);white-space:nowrap;flex-shrink:0;">${this._escapeHtml(a.display_name)}</span>
                    <span style="font-size:14px;line-height:1.5;color:var(--text);">${this._escapeHtml(a.share)}</span>
                </div>`).join("")}catch(n){console.warn("[ReikiRoom] load community energy failed",n),i.innerHTML='<div style="font-size:13px;color:var(--text-muted);text-align:center;padding:12px;">Could not load.</div>'}}}async _loadChakraMastery(){const e=window.Core.state.currentUser,o=document.getElementById(`${this.roomId}MasteryCount`),i=document.getElementById(`${this.roomId}MasteryProgress`),n=document.getElementById(`${this.roomId}MasteryChakras`);if(!n)return;const r=[{key:"root",label:"Root",color:"#ef4444"},{key:"sacral",label:"Sacral",color:"#f97316"},{key:"solar",label:"Solar Plexus",color:"#eab308"},{key:"heart",label:"Heart",color:"#22c55e"},{key:"throat",label:"Throat",color:"#3b82f6"},{key:"third-eye",label:"Third Eye",color:"#6366f1"},{key:"crown",label:"Crown",color:"#a855f7"}];if(!(e!=null&&e.id)){n.innerHTML=r.map(a=>`<span style="padding:5px 14px;border-radius:20px;font-size:13px;font-weight:600;background:var(--border);color:var(--text-muted);">${a.label}</span>`).join(""),o&&(o.textContent="0 / 7");return}try{const{data:a,error:s}=await u._sb.from("reiki_sessions").select("chakra_key").eq("user_id",e.id);if(s)throw s;const l=new Set((a||[]).map(p=>p.chakra_key)),d=r.filter(p=>l.has(p.key)).length,c=Math.round(d/7*100);o&&(o.textContent=`${d} / 7`),i&&(i.style.width=`${c}%`),n.innerHTML=r.map(p=>{const h=l.has(p.key);return`<span style="padding:5px 14px;border-radius:20px;font-size:13px;font-weight:600;
                    background:${h?p.color:"var(--border)"};
                    color:${h?"#fff":"var(--text-muted)"};
                    opacity:${h?"1":"0.5"};
                    transition:all 0.3s ease;">${p.label}</span>`}).join(""),this._masteryLoaded=!0}catch(a){console.warn("[ReikiRoom] load mastery failed",a),o&&(o.textContent="— / 7")}}onEnter(){this._personalTabHydrated=!1,this._masteryLoaded=!1,this.initializeChat(),requestAnimationFrame(()=>{var i;const e=document.getElementById(`${this.roomId}DailyTabContent`),o=document.getElementById(`${this.roomId}DailyChatSection`);if(e&&this._chakraDataReady&&this.state.currentDay){const n=this.CHAKRA_SCHEDULE[this.state.currentDay];e.innerHTML=`
                ...
                ${this._getChakraDisplayHTML(n,this.state.dailyImageIndex,!0,!0)}`,o&&(o.style.display=""),this._loadCommunityEnergy()}(i=document.querySelector(`#${this.roomId}View .tarot-main`))==null||i.scrollTo(0,0)})}getActions(){return{...super.getActions(),startPersonalSession:()=>this.startPersonalSession(),prevChakraImage:e=>{this._actionEl(e).dataset.scope==="daily"?this.previousDailyImage():this.previousPersonalImage()},nextChakraImage:e=>{this._actionEl(e).dataset.scope==="daily"?this.nextDailyImage():this.nextPersonalImage()},toggleChakraJournal:e=>this._toggleChakraJournalLog(this._actionEl(e).dataset.prefix),saveChakraJournal:e=>{const o=this._actionEl(e);this._saveChakraJournalEntry(o.dataset.prefix,o.dataset.key)},submitCommunityEnergy:()=>this._submitCommunityEnergy()}}getInstructions(){return`
            ...
            </ul>`}}Object.assign(Xe.prototype,ze);Object.assign(Xe.prototype,vt);const ro=new Xe;window.ReikiRoom=ro;var ht;(ht=window.dispatchRoomReady)==null||ht.call(window,"reiki");const ao={state:{isEnabled:!1,isRendered:!1},config:{FEATURE_ENABLED:!1},getHTML(){return this.config.FEATURE_ENABLED?`
        ...
        </section>`},_getCardHTML(t){const e=this.config.CARDS[t],o=this[t][0];return`
        <div class="event-card ${t}-card" style="position:relative;overflow:hidden;">
            ${this._getFlyerHTML(o,e.imageId,this[t].length)}
            ${this._getContentHTML(o,e.contentId,e.ctaText)}
        </div>`},_getFlyerHTML(t,e,o){const i=Array.from({length:o},(n,r)=>`<span class="dot${r===0?" active":""}" data-index="${r}"
        ...
        </div>`},_getContentHTML(t,e,o){return`
        <div class="event-content" id="${e}" style="padding:20px;">
            ...
            <button type="button" class="btn btn-primary" style="display:inline-flex;align-items:center;justify-content:center;gap:0.5rem;width:100%;" onclick="UpcomingEvents.openWhatsApp('${this.escapeHtml(t.whatsapp)}')"
                    aria-label="${this.escapeHtml(o)} for ${this.escapeHtml(t.title)}">
                ${this.escapeHtml(o)}
            </button>
            ...
            <button type="button" onclick="UpcomingEvents.closeLightbox()"
                    ...
                    style="position:absolute;top:18px;right:22px;background:none;border:none;
                           cursor:pointer;font-size:28px;color:#fff;opacity:0.7;line-height:1;">✕</button>`,document.body.appendChild(e),document.body.style.overflow="hidden",requestAnimationFrame(()=>{e.style.opacity="1",e.querySelector("img").style.transform="scale(1)"}),e.addEventListener("click",o=>{o.target===e&&this.closeLightbox()}),this._lightboxEsc=o=>{o.key==="Escape"&&this.closeLightbox()},document.addEventListener("keydown",this._lightboxEsc)},closeLightbox(){const t=document.getElementById("flyerLightbox");t&&(t.style.opacity="0",setTimeout(()=>{t.remove(),document.body.style.overflow=""},250),this._lightboxEsc&&(document.removeEventListener("keydown",this._lightboxEsc),this._lightboxEsc=null))},initRotation(){this.destroy();const t=(e,o=0)=>{const i=this.config.CARDS[e],n=()=>{this.state[i.stateKey]=(this.state[i.stateKey]+1)%this[e].length,this.updateCard(e,this.state[i.stateKey])};o?this._staggerTimeout=setTimeout(()=>{this.state[i.intervalKey]=setInterval(n,this.config.ROTATION_INTERVAL)},o):this.state[i.intervalKey]=setInterval(n,this.config.ROTATION_INTERVAL)};t("classes"),t("sessions",this.config.ROTATION_INTERVAL/2)},updateCard(t,e){const o=this.config.CARDS[t],i=this[t][e],n=document.getElementById(o.imageId),r=document.getElementById(o.contentId);if(!n||!r){console.warn(`[UpcomingEvents] Elements not found: ${o.imageId} or ${o.contentId}`);return}n.style.opacity="0",setTimeout(()=>{n.src=i.image,n.alt=i.title,r.innerHTML=this._getContentHTML(i,o.contentId,o.ctaText),this._updateDots(o.cardSelector,e),n.style.opacity="1"},this.config.FADE_DURATION)},_updateDots(t,e){var o;(o=document.querySelector(t))==null||o.querySelectorAll(".dot").forEach((i,n)=>{const r=n===e;i.style.opacity=r?"1":"0.5",i.classList.toggle("active",r)})},async render(){if(this.state.isInitialized){console.warn("UpcomingEvents already initialized");return}const t=document.getElementById("upcomingEventsContainer");if(!t){console.warn("upcomingEventsContainer not found - skipping render");return}try{if(u!=null&&u.ready){const e=await u.getAppSettings("upcoming_events");e&&(["classes0","classes1","sessions0","sessions1"].forEach(o=>{if(e[o]){const[i,n]=[o.slice(0,-1),+o.slice(-1)];this[i][n]={...this[i][n],...e[o]}}}),!e.classes0&&e.classes&&(this.classes[0]={...this.classes[0],...e.classes}),!e.sessions0&&e.sessions&&(this.sessions[0]={...this.sessions[0],...e.sessions}))}t.innerHTML=this.getHTML(),setTimeout(()=>this.initRotation(),100),this.state.isInitialized=!0,this.injectAdminUI()}catch(e){console.error("UpcomingEvents render error:",e)}},injectAdminUI(){var n,r,a;const t=(a=(r=(n=window.Core)==null?void 0:n.state)==null?void 0:r.currentUser)==null?void 0:a.is_admin,e=document.getElementById("upcomingAdminBtn");if(e){e.style.display=t?"inline-block":"none";return}if(!t)return;const o=document.querySelector("#upcomingEventsContainer .section-header");if(!o)return;const i=document.createElement("button");i.id="upcomingAdminBtn",i.className="btn btn-primary upcoming-admin-btn",i.type="button",i.setAttribute("aria-label","Update event flyers"),i.onclick=()=>wt.openAdminModal(),i.style.cssText="display:inline-flex;align-items:center;justify-content:center;gap:0.5rem;",i.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> Update Flyers',o.appendChild(i)},destroy(){clearTimeout(this._staggerTimeout),clearInterval(this.state.classInterval),clearInterval(this.state.sessionInterval),this._staggerTimeout=null,this.state.classInterval=null,this.state.sessionInterval=null,this.state.isInitialized=!1},openAdminModal(){if(document.getElementById("eventsAdminModal"))return;this._adminDraft={classes0:{...this.classes[0]},classes1:{...this.classes[1]},sessions0:{...this.sessions[0]},sessions1:{...this.sessions[1]}},this._adminActiveTab="classes0";const t=document.createElement("div");t.id="eventsAdminModal",t.style.cssText=`position:fixed;inset:0;z-index:10000;background:rgba(0,0,0,0.6);
        ...
        <div style="background:var(--neuro-bg,#f0f0f3);border-radius:20px;padding:24px;
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:20px;">
                ${this.config.ADMIN_TABS.map((e,o)=>`
                <button type="button" id="adminTab_${e.id}" onclick="UpcomingEvents._switchAdminTab('${e.id}')" aria-pressed="${o===0}"
                        style="padding:9px;border-radius:10px;border:none;cursor:pointer;font-size:0.82rem;font-weight:600;
                               ${o===0?"background:var(--neuro-accent);color:#fff;":"background:var(--neuro-accent-a10);color:var(--neuro-accent);"}">
                    ${e.label}
                </button>`).join("")}
            </div>
        ...
        </div>`},_switchAdminTab(t){this._readAdminFields(this._adminActiveTab),this._adminActiveTab=t,this.config.ADMIN_TABS.forEach(({id:e})=>{const o=document.getElementById(`adminTab_${e}`);if(!o)return;const i=e===t;o.style.background=i?"var(--neuro-accent)":"var(--neuro-accent-a10)",o.style.color=i?"#fff":"var(--neuro-accent)"}),this._renderAdminTab(t)},_renderAdminTab(t){const e=document.getElementById("adminTabContent");if(!e)return;const o=this._adminDraft[t],{Sessions:i,Workshops:n}=this.config.FLYER_FILES,r=(l,d)=>d.map(c=>{const p=this._flyerBase+l+"/"+c,h=o.image===p;return`<button type="button" onclick="UpcomingEvents._selectFlyer('${t}','${p}','${c}')"
            ...
            <div style="margin-bottom:14px;">
                ...
                <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;">${r("Sessions",i)}</div>
            ...
            <div style="display:flex;flex-direction:column;gap:10px;">
                <input id="adminField_title"    placeholder="Title"    value="${this.escapeHtml(o.title||"")}"    style="${s}">
                <input id="adminField_subtitle" placeholder="Subtitle" value="${this.escapeHtml(o.subtitle||"")}" style="${s}">
                <textarea id="adminField_info"  placeholder="Description" rows="3" style="${s}resize:vertical;">${this.escapeHtml(o.info||"")}</textarea>
                <input id="adminField_type"     placeholder="Type (e.g. 🎴 Online Zoom Class)"         value="${this.escapeHtml(o.type||"")}"     style="${s}">
                <input id="adminField_datetime" placeholder="Date & Time (e.g. Monday, 10:00 AM GMT+2)" value="${this.escapeHtml(o.datetime||"")}" style="${s}">
            </div>`},_selectFlyer(t,e,o){const i=this.flyerCatalog[o]||{},n=this._adminDraft[t];this._adminDraft[t]={...n,image:e,title:i.title||n.title,subtitle:i.subtitle||n.subtitle,info:i.info||n.info,type:i.type||n.type},this._renderAdminTab(t)},_readAdminFields(t){if(!document.getElementById("adminField_title"))return;const e=o=>{var i,n;return((n=(i=document.getElementById(o))==null?void 0:i.value)==null?void 0:n.trim())||""};this._adminDraft[t]={...this._adminDraft[t],title:e("adminField_title"),subtitle:e("adminField_subtitle"),info:e("adminField_info"),type:e("adminField_type"),datetime:e("adminField_datetime")}},async _adminSave(){const t=document.querySelector('#eventsAdminModal button[onclick*="_adminSave"]');t&&(t.disabled=!0,t.textContent="Saving..."),this._readAdminFields(this._adminActiveTab);try{const e={classes0:this._adminDraft.classes0,classes1:this._adminDraft.classes1,sessions0:this._adminDraft.sessions0,sessions1:this._adminDraft.sessions1};if(!await u.saveAppSettings("upcoming_events",e))throw new Error("saveAppSettings returned false");["classes0","classes1","sessions0","sessions1"].forEach(i=>{const[n,r]=[i.slice(0,-1),+i.slice(-1)];Object.assign(this[n][r],this._adminDraft[i])}),this.updateCard("classes",this.state.classIndex),this.updateCard("sessions",this.state.sessionIndex),window.Core.showToast("Flyers updated for all users"),this.closeAdminModal()}catch(e){console.error("_adminSave error:",e),window.Core.showToast("Could not save - please try again"),t&&(t.disabled=!1,t.textContent="Save & Publish")}},openWhatsApp(t){t&&window.open(t,"_blank","noopener,noreferrer")},escapeHtml(t){if(!t)return"";const e=document.createElement("div");return e.textContent=t,e.innerHTML}};window.UpcomingEvents=wt;const at=["Enter with intention, leave with gratitude","This space holds you. Enter with presence.","Breathe in. You are welcome here.","Leave the noise behind. Step into stillness.","You are exactly where you need to be.","Enter gently. This moment is yours.","Set down what you carry. Enter with an open heart.","The space is ready. So are you.","Come as you are. This is a place of welcome.","Arrive fully. Begin with intention."];class so{constructor(e){this.app=e,this.initialized=!1,this._activeMembersWidget=null}async render(){const e=document.getElementById("community-hub-tab");if(!e){console.error("[CommunityHub] Tab element not found");return}if(this.createFullscreenRoomContainer(),this.initialized||(e.innerHTML=this._buildTabHTML()),requestAnimationFrame(()=>requestAnimationFrame(()=>this._showRitualImmediately())),this.initialized?this._refreshHubPresence():(await this.initializeCommunityHub(),this.initialized=!0),this._attachHubVisibility(),window._pendingHubScrollTarget){const o=window._pendingHubScrollTarget;window._pendingHubScrollTarget=null,requestAnimationFrame(()=>requestAnimationFrame(()=>{const i=document.getElementById(o);i&&i.scrollIntoView({behavior:"smooth",block:"start"})}))}if(window._pendingRoomOpen){const o=window._pendingRoomOpen;window._pendingRoomOpen=null;const i=window[`${o}_enterRoom`];if(typeof i=="function")i();else{const n=r=>{var a,s;((a=r.detail)==null?void 0:a.roomKey)===o&&(document.removeEventListener("practiceRoomReady",n),(s=window[`${o}_enterRoom`])==null||s.call(window))};document.addEventListener("practiceRoomReady",n),setTimeout(()=>document.removeEventListener("practiceRoomReady",n),8e3)}}}_buildTabHTML(){return`
    ...
    `}_buildCandleSVG(e){return`
      ...
      </svg>`}_buildRitualCard({id:e,textId:o,type:i,action:n,label:r,buttonText:a}){return`
      <div class="ritual-overlay ${i}" id="${e}" role="dialog" aria-modal="true" aria-labelledby="${o}">
        <div class="ritual-card">
          <div class="ritual-candle" aria-hidden="true">${this._buildCandleSVG(i[0])}</div>
          <div class="ritual-text" id="${o}"></div>
    ...
    `,document.body.appendChild(e),!document.getElementById("openingOverlay")){const o=document.createElement("div");o.innerHTML=this._buildRitualCard({id:"openingOverlay",textId:"openingRitualText",type:"opening",action:"ritual-opening",label:"Enter the space",buttonText:"Enter the Space"}),(document.getElementById("app-container")||document.body).appendChild(o.firstElementChild)}}_showRitualImmediately(){var i,n;if((n=(i=window.Rituals)==null?void 0:i.state)!=null&&n.hasSeenOpening)return;const e=document.getElementById("openingOverlay");if(!e)return;const o=document.getElementById("openingRitualText");o&&(o.textContent=`"${at[Math.floor(Math.random()*at.length)]}"`),document.body.classList.add("ritual-active"),e.classList.add("active"),setTimeout(()=>{window.Rituals?window.Rituals.completeOpening():(e.classList.remove("active"),document.body.classList.remove("ritual-active"))},5e3)}_refreshHubPresence(){var e,o,i,n;try{(e=this._activeMembersWidget)==null||e.refresh(),(i=(o=window.PracticeRoom)==null?void 0:o._hubRooms)!=null&&i.length&&PracticeRoom.startHubPresence(),(n=window.CollectiveFieldDB)!=null&&n.refreshCount&&window.CollectiveFieldDB.refreshCount()}catch(r){console.warn("[CommunityHub] _refreshHubPresence fallback to Core.init",r),x.state.initialized=!1,x.init()}}_preloadYouTubeAPI(){var o;if((o=window.YT)!=null&&o.Player||document.querySelector('script[src*="youtube.com/iframe_api"]'))return;const e=document.createElement("script");e.src="https://www.youtube.com/iframe_api",e.async=!0,document.head.appendChild(e)}_attachHubVisibility(){this._hubVisibilityHandler||(this._hubVisibilityHandler=()=>{var e,o;if(document.hidden)(e=this._hubChatRooms)==null||e.forEach(i=>{try{u.unsubscribeFromRoomChat(i)}catch{}});else{const i=(o=x==null?void 0:x.state)==null?void 0:o.currentRoom;i&&this._hubChatResubscribe&&this._hubChatResubscribe(i)}},document.addEventListener("visibilitychange",this._hubVisibilityHandler))}registerHubChatRooms(e,o){this._hubChatRooms=e,this._hubChatResubscribe=o}loadStylesheet(e,{critical:o=!1}={}){if(document.querySelector(`link[href="${e}"]`))return;const i=document.createElement("link");i.rel="stylesheet",i.href=e,o||(i.rel="preload",i.as="style",i.onload=function(){this.rel="stylesheet"}),document.head.appendChild(i)}loadScript(e){return new Promise((o,i)=>{if(document.querySelector(`script[src="${e}"]`))return o();const n=Object.assign(document.createElement("script"),{src:e,async:!0});n.onload=o,n.onerror=()=>i(new Error(`Failed to load: ${e}`)),document.body.appendChild(n)})}async initializeCommunityHub(){var e,o,i,n,r;try{if(this._preloadYouTubeAPI(),(o=(e=window.LunarEngine)==null?void 0:e.init)==null||o.call(e),!(x!=null&&x.init))throw new Error("Core module not found");await u.init(),window.CommunityDB=u,await x.init(),window.Core=x;const a=document.getElementById("activeMembersContainer");if(a&&(this._activeMembersWidget&&this._activeMembersWidget.destroy(),this._activeMembersWidget=new It(a),this._activeMembersWidget.render()),(i=window.CollectiveField)==null||i.render(),(n=window.Resonance)==null||n.render(),(r=window.UpcomingEvents)==null||r.render(),window.ProfileModule){window.ProfileModule.state.isInitialized=!1;try{window.ProfileModule.init()}catch(s){console.warn("[CommunityHub] ProfileModule re-init:",s)}}if(window.CommunityModule){window.CommunityModule.state.isInitialized=!1;try{window.CommunityModule.init()}catch(s){console.warn("[CommunityHub] CommunityModule re-init:",s)}}if(window.Rituals&&(window.Rituals.state.hasSeenOpening=!1),window.CollectiveFieldDB&&await window.CollectiveFieldDB.init(),window._pendingHubScrollTarget){const s=window._pendingHubScrollTarget;window._pendingHubScrollTarget=null,requestAnimationFrame(()=>requestAnimationFrame(()=>{const l=document.getElementById(s);l&&l.scrollIntoView({behavior:"smooth",block:"start"})}))}}catch(a){console.error("❌ Failed to load Community Hub:",a);const s=document.getElementById("community-hub-main-content");s&&(s.innerHTML=`
