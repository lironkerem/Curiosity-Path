const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/newmoon-room-Dv9cok12.js","assets/lunar-core-rfkUXe8n.js","assets/waxingmoon-room-DvZzZmds.js","assets/fullmoon-room-CEdERuw0.js","assets/waningmoon-room-KCQ2tIZg.js","assets/spring-solar-room-BE9hUPAo.js","assets/solar-base-room-BWw7Gkfz.js","assets/summer-solar-room-6hrVBg2T.js","assets/autumn-solar-room-BJYNMtF5.js","assets/winter-solar-room-BYVnj8x3.js"])))=>i.map(i=>d[i]);
    ...
    <div class="modal-overlay" id="guidelinesModal" onclick="SafetyBar.handleOverlayClick(event,'guidelines')">
        ...
        <div style="position:relative;" id="${this.roomId}SafetyDropdownContainer">
            ...
            <div id="${this.roomId}SafetyDropdown"
                ...
                ${e.map(([i,o,n])=>`<button type="button" class="safety-dropdown-item" onclick="${i}"><span aria-hidden="true">${o}</span> ${n}</button>`).join("")}
            </div>
