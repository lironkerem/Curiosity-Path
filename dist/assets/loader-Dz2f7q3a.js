...
`,this.initializeComponents().then(()=>l(()=>import("./app-BuB1g-jc.js"),__vite__mapDeps([0,1,2])))}).then(e=>{if(typeof e.bootSelfAnalysis=="function")this.instance=e.bootSelfAnalysis(t),this.isInitialized=!0;else throw new Error("bootSelfAnalysis function not found")}).catch(e=>{console.error("❌ Self-Analysis loader failed:",e),t.innerHTML=`
