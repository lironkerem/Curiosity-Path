import{b as G,_ as z,C as h}from"./community-hub-CJhlSKys.js";import{S as H}from"./vendor-suncalc-BBoG6fSx.js";const A={PRESENCE_RANGE:{min:8,max:23},FLOATING_ELEMENT_COUNT:20,UPDATE_INTERVAL_MS:6e5,STORAGE_PREFIX:"solar_",STORAGE_KEY_SUFFIX:"_data",IMAGE_BASE_URL:"/Community/Solar/",SEASONS:{SPRING:"spring",SUMMER:"summer",AUTUMN:"autumn",WINTER:"winter"},MIN_REFLECTION_LENGTH:10,FLOATING_ELEMENT_DURATION_MIN:10,FLOATING_ELEMENT_DURATION_RANGE:10,FLOATING_ELEMENT_DELAY_MAX:5},l={escapeHtml(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML},escapeAttr(e){return e?e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""},_closingBlock:e=>`<div class="solar-popup-highlight">
    ...
    `},generateRelationshipAuditContent(e){return`
      ...
      ${this._closingBlock(e.closingLine)}
    `}},oe=Object.freeze(Object.defineProperty({__proto__:null,SOLAR_CONSTANTS:A,SolarConfig:l},Symbol.toStringTag,{value:"Module"})),c={storage:{_key:e=>`${A.STORAGE_PREFIX}${e}${A.STORAGE_KEY_SUFFIX}`,get(e){const t=localStorage.getItem(this._key(e));if(!t)return null;try{return JSON.parse(t)}catch(o){return console.error(`[SolarUI] Error loading ${e} data:`,o),null}},set(e,t){try{return localStorage.setItem(this._key(e),JSON.stringify(t)),!0}catch(o){return console.error(`[SolarUI] Error saving ${e} data:`,o),!1}},clear(e){localStorage.removeItem(this._key(e))}},utils:{calculateDaysRemaining:e=>Math.ceil((e-new Date)/864e5),generateFloatingElements(e,t=A.FLOATING_ELEMENT_COUNT){const{FLOATING_ELEMENT_DELAY_MAX:o,FLOATING_ELEMENT_DURATION_MIN:r,FLOATING_ELEMENT_DURATION_RANGE:n}=A;let i="";for(let a=0;a<t;a++){const d=e[Math.floor(Math.random()*e.length)],s=(Math.random()*100).toFixed(2),v=(Math.random()*o).toFixed(2),f=(r+Math.random()*n).toFixed(2);i+=`<div class="solar-floating-element"
                      style="left:${s}%;animation-delay:${v}s;animation-duration:${f}s;">
                   ${d}
        ...
        </div>`},savedInputs(e,t){const{intention:o,affirmation:r,releaseList:n}=e;if(!o&&!r&&!n)return"";const i=d=>l.escapeHtml(d),a=(d,s,v)=>`<div class="solar-input-display" style="margin-bottom:1rem;">
           <h4>${d}</h4>
           <p${v?' style="white-space:pre-line;"':""}>${i(s)}</p>
         </div>`;return`
        ...
        </div>`}},switchMode(e){document.querySelectorAll(".solar-mode-btn").forEach(r=>{const n=r.dataset.mode===e;r.classList.toggle("active",n),r.setAttribute("aria-pressed",String(n))});const t=document.getElementById("soloContent"),o=document.getElementById("groupContent");t&&(t.style.display=e==="solo"?"block":"none"),o&&(o.style.display=e==="group"?"block":"none")},closePracticePopup(){document.getElementById("practicePopup")?.remove()},handleBackToHub(){if(window.currentSolarRoom?.leaveRoom){window.currentSolarRoom.leaveRoom();return}window.currentSolarRoom?._clearPresence?.(),document.body.classList.remove("solar-room-active"),window.Rituals?.showClosing?.()||G?.navigateTo?.("hubView")},showToast(e){G?.showToast?G.showToast(e):window.app?.showToast?.(e)},_stylesInjected:!1,injectStyles(){if(this._stylesInjected||document.getElementById("solar-shared-styles")){this._stylesInjected=!0;return}const e=document.createElement("style");e.id="solar-shared-styles",e.textContent=this._getSharedCSS(),document.head.appendChild(e),this._stylesInjected=!0},_getSharedCSS(){return`
...
@media (max-width:380px) {
  ...
  .solar-inactive-card{padding:1.25rem 0.875rem !important;}
    ...
    `}};window.SolarUIManager=c;const re=Object.freeze(Object.defineProperty({__proto__:null,SolarUIManager:c},Symbol.toStringTag,{value:"Module"})),$={location:{latitude:31,longitude:0,name:"Default"},currentSolarData:null,currentSolarRoom:null,solarRooms:[{season:"spring",icon:"🌱",roomName:"Spring Awakening",roomId:"spring-equinox",description:"Renewal energy and fresh beginnings",energy:"Renewal, Growth, Awakening",practices:["Dawn meditation","Renewal rituals","Energy activation","New beginning visualization"]},{season:"summer",icon:"☀️",roomName:"Summer Radiance",roomId:"summer-solstice",description:"Peak vitality and expansive energy",energy:"Vitality, Expansion, Power",practices:["Solar noon meditation","Fire ceremony","Peak energy practice","Celebration ritual"]},{season:"autumn",icon:"🍂",roomName:"Autumn Harvest",roomId:"autumn-equinox",description:"Gratitude and preparation for rest",energy:"Gratitude, Harvest, Balance",practices:["Gratitude meditation","Harvest ritual","Balance practice","Reflection ceremony"]},{season:"winter",icon:"❄️",roomName:"Winter Stillness",roomId:"winter-solstice",description:"Deep rest and inner contemplation",energy:"Rest, Stillness, Contemplation",practices:["Deep rest meditation","Inner journey","Stillness practice","Contemplative silence"]}],init(){if(this._initialized)return;this._initialized=!0;const e=()=>this.updateAll();navigator.geolocation?navigator.geolocation.getCurrentPosition(({coords:t})=>{this.location={latitude:t.latitude,longitude:t.longitude,name:"Your Location"},e()},e,{timeout:5e3,maximumAge:36e5}):e(),setInterval(e,A.UPDATE_INTERVAL_MS)},updateAll(){this.updateSolarData(),this.updateSolarVisualization(),this.updateSolarRoom(),this.renderSolarCard()},setLocation(e,t,o){this.location={latitude:e,longitude:t,name:o},this.updateAll()},updateSolarData(){const e=new Date,{latitude:t,longitude:o}=this.location,r=H.getTimes(e,t,o),n=this.calculateSunDeclination(e),{name:i,days:a}=this._getNextTransition(e);this.currentSolarData={sunrise:r.sunrise,sunset:r.sunset,solarNoon:r.solarNoon,declination:n,seasonInfo:this.getSeasonInfo(e),currentSeason:this.getCurrentSeason(),nextSeasonName:i,daysToNextSeason:a,position:H.getPosition(e,t,o)},this.renderSolarInfo()},renderSolarInfo(){const e=this.currentSolarData;if(!e)return;const t=(r,n)=>{const i=document.getElementById(r);i&&(i.textContent=n)};t("sunrise",this.formatTime(e.sunrise)),t("sunset",this.formatTime(e.sunset)),t("solarNoon",this.formatTime(e.solarNoon)),t("seasonInfo",e.seasonInfo);const o=document.getElementById("solarDeclination");if(o){const r=o.querySelector(".decl-value");r&&(r.textContent=`${Math.abs(e.declination).toFixed(1)}° ${e.declination>=0?"N":"S"}`)}},calculateSunDeclination(e){const t=this.getDayOfYear(e);return 23.44*Math.sin(2*Math.PI*(t-81)/365)},getDayOfYear(e){return Math.floor((e-new Date(e.getFullYear(),0,0))/864e5)},getSeasonDates(e){if(this._seasonDatesCache||(this._seasonDatesCache={}),this._seasonDatesCache[e])return this._seasonDatesCache[e];const t=(e-2e3)/1e3,o=p=>{const m={spring:[245162380984e-5,365242.37404,.05169,-.00411,-57e-5],summer:[245171656767e-5,365241.62603,.00325,.00888,-3e-4],autumn:[245181021715e-5,365242.01767,-.11575,.00337,78e-5],winter:[245190005952e-5,365242.74049,-.06223,-.00823,32e-5]}[p];return m[0]+m[1]*t+m[2]*t**2+m[3]*t**3+m[4]*t**4},r=p=>{const m=(p-2451545)/36525,M=35999.373*m-2.47,E=1+.0334*Math.cos(M*Math.PI/180)+7e-4*Math.cos(2*M*Math.PI/180),B=[[485,324.96,1934.136],[203,337.23,32964.467],[199,342.08,20.186],[182,27.85,445267.112],[156,73.14,45036.886],[136,171.52,22518.443],[77,222.54,65928.934],[74,296.72,3034.906],[70,243.58,9037.513],[58,119.81,33718.148],[52,297.17,150.678],[50,21.02,2281.226]].reduce((L,[_,k,N])=>L+_*Math.cos((k+N*m)*Math.PI/180),0);return p+1e-5*B/E},n=p=>new Date((p-24405875e-1)*864e5),i=p=>new Date(p.getTime()-864e5),a=p=>n(r(o(p))),d=a("spring"),s=a("summer"),v=a("autumn"),f=a("winter"),P=n(r((()=>{const p=(e+1-2e3)/1e3,m=[245162380984e-5,365242.37404,.05169,-.00411,-57e-5];return m[0]+m[1]*p+m[2]*p**2+m[3]*p**3+m[4]*p**4})())),C={spring:{start:d,end:i(s)},summer:{start:s,end:i(v)},autumn:{start:v,end:i(f)},winter:{start:f,end:i(P)}};return this._seasonDatesCache[e]=C,C},getCurrentSeason(){const e=new Date,t=e.getFullYear(),o=this.location.latitude>=0,r={spring:"autumn",summer:"winter",autumn:"spring",winter:"summer"},n=this.getSeasonDates(t-1);if(e>=n.winter.start&&e<=n.winter.end)return o?"winter":"summer";const i=this.getSeasonDates(t);for(const a of["spring","summer","autumn","winter"]){const{start:d,end:s}=i[a];if(e>=d&&e<=s)return o?a:r[a]}return"winter"},_getUpcomingTransitions(e){const t=e.getFullYear(),o=this.getSeasonDates(t),r=this.getSeasonDates(t+1);return[{name:"Spring Equinox",date:o.spring.start},{name:"Summer Solstice",date:o.summer.start},{name:"Autumn Equinox",date:o.autumn.start},{name:"Winter Solstice",date:o.winter.start},{name:"Spring Equinox",date:r.spring.start}].filter(n=>n.date>e).sort((n,i)=>n.date-i.date)},getSeasonInfo(e){const t=this._getUpcomingTransitions(e)[0];return`${Math.ceil((t.date-e)/864e5)} days to ${t.name}`},_getNextTransition(e){const t=this._getUpcomingTransitions(e)[0];return{name:t.name.split(" ")[0],days:Math.ceil((t.date-e)/864e5)}},getNextSeasonInfo(e){return this._getNextTransition(e)},updateSolarVisualization(){this.currentSolarData&&this.drawWheelOfYear(this.currentSolarData)},drawWheelOfYear(e){const t=document.getElementById("solarSvg");if(!t)return;const o=280,r=140,n=140,i=110,a=52;t.setAttribute("viewBox",`0 0 ${o} ${o}`),t.setAttribute("width","100%"),t.style.height="auto",t.innerHTML="";const d="http://www.w3.org/2000/svg",s=(g,u)=>{const S=document.createElementNS(d,g);return Object.entries(u).forEach(([I,T])=>S.setAttribute(I,T)),S},v=s("defs",{}),f=s("clipPath",{id:"woyClip"});f.appendChild(s("circle",{cx:r,cy:n,r:i-1})),v.appendChild(f),t.appendChild(v);const P=[{d:`M${r},${n} L${r},${n-i} L${r+i},${n-i} L${r+i},${n} Z`,fill:"#C0DD97"},{d:`M${r},${n} L${r+i},${n} L${r+i},${n+i} L${r},${n+i} Z`,fill:"#FAC775"},{d:`M${r},${n} L${r},${n+i} L${r-i},${n+i} L${r-i},${n} Z`,fill:"#F0957B"},{d:`M${r},${n} L${r-i},${n} L${r-i},${n-i} L${r},${n-i} Z`,fill:"#B5D4F4"}],C=s("g",{"clip-path":"url(#woyClip)"});P.forEach(({d:g,fill:u})=>C.appendChild(s("path",{d:g,fill:u,opacity:"0.45",stroke:"none"}))),t.appendChild(C),t.appendChild(s("circle",{cx:r,cy:n,r:i,fill:"none",stroke:"var(--neuro-shadow-light)","stroke-width":"1.5"})),t.appendChild(s("circle",{cx:r,cy:n,r:a,fill:"none",stroke:"var(--neuro-shadow-light)","stroke-width":"1","stroke-dasharray":"3 3",opacity:"0.6"})),t.appendChild(s("line",{x1:r-i,y1:n,x2:r+i,y2:n,stroke:"var(--neuro-shadow-light)","stroke-width":"0.8"})),t.appendChild(s("line",{x1:r,y1:n-i,x2:r,y2:n+i,stroke:"var(--neuro-shadow-light)","stroke-width":"0.8"}));const p=(g,u,S,I,T,D)=>{const W=s("text",{x:g,y:u,"text-anchor":"middle",fill:T,"font-size":"9","font-weight":"600"});W.textContent=S,t.appendChild(W);const F=s("text",{x:g,y:u+11,"text-anchor":"middle",fill:D,"font-size":"7.5"});F.textContent=I,t.appendChild(F)};p(r+55,n-40,"Spring","Mar · Apr · May","#3B6D11","#639922"),p(r+55,n+52,"Summer","Jun · Jul · Aug","#854F0B","#BA7517"),p(r-55,n+52,"Autumn","Sep · Oct · Nov","#993C1D","#D85A30"),p(r-55,n-40,"Winter","Dec · Jan · Feb","#185FA5","#378ADD");const m=(g,u,S)=>{const I=s("text",{x:g,y:u,"text-anchor":"middle","font-size":"11"});I.textContent=S,t.appendChild(I)};m(r,n-i+8,"🌱"),m(r+i-6,n+4,"☀️"),m(r,n+i-2,"🍂"),m(r-i+6,n+4,"❄️"),[[r,n-i,r,n-i+8],[r+i,n,r+i-8,n],[r,n+i,r,n+i-8],[r-i,n,r-i+8,n]].forEach(([g,u,S,I])=>t.appendChild(s("line",{x1:g,y1:u,x2:S,y2:I,stroke:"var(--neuro-text)","stroke-width":"1.5","stroke-linecap":"round"})));const M=79,E=new Date,B=this.getDayOfYear(E),L=-Math.PI/2+(B-M)/365*2*Math.PI,_=r+i*Math.cos(L),k=n+i*Math.sin(L);for(let g=0;g<8;g++){const u=g*Math.PI/4;t.appendChild(s("line",{x1:_+Math.cos(u)*10,y1:k+Math.sin(u)*10,x2:_+Math.cos(u)*15,y2:k+Math.sin(u)*15,stroke:"#EF9F27","stroke-width":"1.5","stroke-linecap":"round"}))}t.appendChild(s("circle",{cx:_,cy:k,r:"8",fill:"#EF9F27",stroke:"#BA7517","stroke-width":"1.2"})),t.appendChild(s("circle",{cx:_,cy:k,r:"3.5",fill:"#FCDE5A",opacity:"0.9"}));const{nextSeasonName:N,daysToNextSeason:U}=e,Y=E.toLocaleDateString("en-US",{month:"short",day:"numeric"}),j=this.getCurrentSeason(),V=j.charAt(0).toUpperCase()+j.slice(1),q=this.getSeasonDates(E.getFullYear())[j]?.start||E,J=Math.max(1,Math.floor((E-q)/864e5)+1),O=(g,u,S,I,T)=>{const D=s("text",{x:r,y:u,"text-anchor":"middle",fill:T,"font-size":S,"font-weight":I});D.textContent=g,t.appendChild(D)};O(Y,n-10,"9","700","var(--neuro-text)"),O(`${J} days in ${V}`,n+3,"7.5","400","var(--neuro-text-light)"),O(`${U} days to ${N}`,n+15,"7.5","400","#BA7517")},updateSolarRoom(){const e=this.getCurrentSeason(),t=this.solarRooms.find(o=>o.season===e);t&&t!==this.currentSolarRoom&&(this.currentSolarRoom=t,this.renderSolarRoom(t))},renderSolarRoom(e){const t=(r,n)=>{const i=document.getElementById(r);i&&(i.textContent=n)};t("solarRoomIcon",e.icon),t("solarRoomName",e.roomName),t("solarRoomDesc",e.description);const o=document.getElementById("solarPracticeRoom");o&&(o.setAttribute("data-room-id",e.roomId),o.setAttribute("data-room-energy",e.energy))},getCurrentRoom(){return this.currentSolarRoom},renderSolarCard(){const e=document.getElementById("solarContainer");if(!e){console.warn("SolarEngine: solarContainer not found");return}if(!this.currentSolarData||!this.currentSolarRoom){e.innerHTML='<p style="color:var(--text-muted);padding:20px;">Loading solar data...</p>';return}const{currentSolarData:t,currentSolarRoom:o}=this,r=window.Core?.state?.currentUser?.is_admin,n=t.currentSeason.charAt(0).toUpperCase()+t.currentSeason.slice(1);e.innerHTML=`
      ...
      </div>`,this.updateSolarVisualization(),this._refreshOuterCard(),this._attachSolarAdminListeners()},_attachSolarAdminListeners(){const e=document.querySelector(".solar-admin-header");if(e&&!e._solarBound){const t=()=>{const o=document.getElementById(e.dataset.panel),r=document.getElementById(e.dataset.toggle),n=o?.style.display!=="none";o&&(o.style.display=n?"none":"block"),r&&(r.textContent=n?"▶":"▼"),e.setAttribute("aria-expanded",String(!n))};e.addEventListener("click",t),e.addEventListener("keydown",o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),t())}),e._solarBound=!0}document.querySelectorAll(".solar-admin-header ~ div button[data-room-id]").forEach(t=>{t._solarBound||(t.addEventListener("click",()=>this.adminJoinRoom(t.dataset.roomId)),t.addEventListener("mouseover",()=>t.style.background="var(--border)"),t.addEventListener("mouseout",()=>t.style.background="var(--season-mood)"),t._solarBound=!0)})},_refreshOuterCard(){if(!h?.ready){this._outerCardRetry||(this._outerCardRetry=setTimeout(()=>{this._outerCardRetry=null,this._refreshOuterCard()},500));return}const e=this.currentSolarRoom;if(!e)return;const t=`${e.season}-solar`,o=async()=>{try{const r=await h.getRoomParticipants(t),n=document.getElementById("solarRoomPresence");n&&(n.textContent=`${r.length} present`)}catch(r){console.warn("[SolarEngine] _refreshOuterCard error:",r)}};o();try{this._outerCardSub?.unsubscribe()}catch{}this._outerCardSub=h.subscribeToPresence(o)},renderAdminSection(){const e="solarAdminPanel",t="solarAdminToggle";return`
      ...
      </div>`},adminJoinRoom(e){this._loadAndEnterRoom(e)},injectAdminUI(){if(!window.Core?.state?.currentUser?.is_admin)return;const e=document.getElementById("solarContainer");if(!e||e.querySelector("#solarAdminPanel"))return;const t=e.querySelector(".celestial-card-full");t&&t.insertAdjacentHTML("beforeend",this.renderAdminSection())},_ROOM_MODULES:{"spring-equinox":()=>z(()=>Promise.resolve().then(()=>X),void 0),"summer-solstice":()=>z(()=>Promise.resolve().then(()=>Q),void 0),"autumn-equinox":()=>z(()=>Promise.resolve().then(()=>Z),void 0),"winter-solstice":()=>z(()=>Promise.resolve().then(()=>K),void 0)},_roomExportName:{"spring-equinox":"SpringSolarRoom","summer-solstice":"SummerSolarRoom","autumn-equinox":"AutumnSolarRoom","winter-solstice":"WinterSolarRoom"},async _loadAndEnterRoom(e){const t=this._ROOM_MODULES[e];if(!t){window.Core?.showToast?.(`Unknown room: ${e}`);return}try{const r=(await t())[this._roomExportName[e]];r?r.enterRoom():window.Core?.showToast?.(`${e} failed to initialise`)}catch(o){console.error(`[SolarEngine] _loadAndEnterRoom error for ${e}:`,o),window.Core?.showToast?.(`Failed to load ${e}`)}},joinSolarRoom(){if(!this.currentSolarRoom){window.Core?.showToast?.("Solar room not ready");return}this._loadAndEnterRoom(this.currentSolarRoom.roomId)},formatTime:e=>!e||isNaN(e.getTime())?"N/A":e.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}),formatDate:e=>e.toLocaleDateString("en-US",{month:"short",day:"numeric"}),getSolarData(){return this.currentSolarData}};window.SolarEngine=$;const ne=Object.freeze(Object.defineProperty({__proto__:null,SolarEngine:$},Symbol.toStringTag,{value:"Module"})),R={config:{},practices:{},prebuiltAffirmations:[],userData:{intention:"",affirmation:"",releaseList:"",practiceCount:0,closureReflection:"",completedDate:null,privateIntention:"",collectiveWord:"",intentionShared:!1},isActive:!1,startDate:null,endDate:null,collectiveTimer:null,saveDebounceTimer:null,eventListeners:[],CONSTANTS:{MAX_INTENTION_LENGTH:500,MAX_AFFIRMATION_LENGTH:300,MAX_RELEASE_LIST_LENGTH:1e3,SAVE_DEBOUNCE_MS:500},_sanitizeInput(e){return typeof e!="string"?"":e.trim().slice(0,1e3).replace(/<script[^>]*>.*?<\/script>/gi,"").replace(/<iframe[^>]*>.*?<\/iframe>/gi,"").replace(/<object[^>]*>.*?<\/object>/gi,"")},_escapeHtml:e=>l.escapeHtml(e),_removeEventListeners(){this.eventListeners.forEach(({element:e,event:t,handler:o})=>e?.removeEventListener(t,o)),this.eventListeners=[]},_clearTimer(){this.collectiveTimer&&(clearInterval(this.collectiveTimer),this.collectiveTimer=null)},cleanup(){this._clearTimer(),this._removeEventListeners(),clearTimeout(this.saveDebounceTimer),this.saveDebounceTimer=null,this._unsubPresence(),this._unsubCollectiveWords()},_unsubPresence(){try{this._presenceSub?.unsubscribe()}catch{}this._presenceSub=null},_unsubCollectiveWords(){try{this._collectiveWordsSub?.unsubscribe()}catch{}this._collectiveWordsSub=null},_startCountdownTimer(e,t,o,r){try{document.getElementById(t)?.style&&(document.getElementById(t).style.display="none");const n=document.getElementById(e);if(!n)return;n.setAttribute("role","timer"),n.setAttribute("aria-live","off");let i=o;this._clearTimer(),this.collectiveTimer=setInterval(()=>{i--;const a=Math.floor(i/60),d=i%60;n.textContent=`${a}:${String(d).padStart(2,"0")}`,i<=0&&(this._clearTimer(),n.textContent="Complete",r?.())},1e3)}catch(n){console.error("[BaseSolarRoom] _startCountdownTimer error:",n),this._clearTimer()}},init(){try{this.checkIfActive(),this.isActive&&(this.calculateDates(),this.loadData())}catch(e){console.error(`${this.config.displayName} init error:`,e)}},checkIfActive(){if(window.Core?.state?.currentUser?.is_admin){this.isActive=!0;return}const e=new Date,t=e.getFullYear(),o=this.config.name,r=$.getSeasonDates(t)[o];if(e>=r.start&&e<=r.end){this.isActive=!0;return}const n=$.getSeasonDates(t-1)[o];this.isActive=e>=n.start&&e<=n.end},calculateDates(){const e=new Date,t=this.config.name,o=$.getSeasonDates(e.getFullYear()-1)[t];if(e>=o.start&&e<=o.end){this.startDate=o.start,this.endDate=o.end;return}const r=$.getSeasonDates(e.getFullYear())[t];this.startDate=r.start,this.endDate=r.end},loadData(){const e=c.storage.get(this.config.name);e&&new Date(e.seasonStartDate).getTime()===this.startDate?.getTime()&&(this.userData=e.data)},saveData(){c.storage.set(this.config.name,{seasonStartDate:this.startDate.toISOString(),data:this.userData})||c.showToast("Could not save data. Check storage limits.")},enterRoom(){const e=window.Core?.state?.currentUser?.is_admin;if(!this.isActive&&!e){c.showToast(`${this.config.emoji} ${this.config.displayName} room opens during ${this.config.displayName.toLowerCase()} season`);return}this.startDate||this.calculateDates(),window.Core?.navigateTo?.("practiceRoomView"),window.PracticeRoom?.stopHubPresence?.(),document.body.classList.add("solar-room-active"),this.renderDashboard(),this._setPresence(),this._loadCollectiveWords()},leaveRoom(){try{this._clearPresence(),this._unsubPresence(),this._unsubCollectiveWords(),this._clearTimer(),this._removeEventListeners(),document.body.classList.remove("solar-room-active"),window.currentSolarRoom=null,window.PracticeRoom?.startHubPresence?.(),window.Core?.navigateTo?.("hubView")}catch(e){console.error("Error leaving solar room:",e)}},renderDashboard(){c.injectStyles();const e=document.getElementById("dynamicRoomContent");if(!e){console.error("dynamicRoomContent not found");return}document.body.setAttribute("data-season",this.config.name),window.currentSolarRoom=this;const t=c.utils.calculateDaysRemaining(this.endDate),o=`${t} ${t===1?"day":"days"} remaining`,r=`${A.IMAGE_BASE_URL}${this.config.displayName}.webp`,n=this.getLivingPresenceCount();e.innerHTML=`
      <div class="solar-room-bg">
        <div class="solar-floating-bg">
          ${c.utils.generateFloatingElements(this.config.floatingEmojis)}
        </div>

        ${c.renderers.topBar({seasonName:this.config.displayName,emoji:this.config.emoji,daysText:o,livingPresenceCount:n})}
        ...
        <div class="solar-content-wrapper">
          ...
          <div id="soloContent" class="solar-mode-content">
            ...
            <div class="solar-practices-grid" id="practicesGrid">
              ${Object.values(this.practices).map(i=>c.renderers.practiceCard(i,this.isPracticeLocked(i))).join("")}
            </div>
            ${c.renderers.savedInputs(this.userData,this.config.displayName)}
          </div>

          <div id="groupContent" class="solar-mode-content" style="display:none;">
            ${c.renderers.groupPractice({seasonEmoji:this.config.seasonEmoji,seasonName:this.config.displayName,presenceCount:n,itemEmoji:this.config.itemEmoji,sessionTimes:this.config.sessionTimes,collectiveFocus:this.config.collectiveFocus,collectiveNoun:this.config.collectiveNoun})}
          </div>

          ${t<=7?c.renderers.closureSection(this.config.closure):""}
        </div>
      </div>`,this._attachEventListeners(e),setTimeout(()=>this._refreshLivePresence(),300)},_attachEventListeners(e){try{this._removeEventListeners();const t=(i,a,d)=>{i&&(i.addEventListener(a,d),this.eventListeners.push({element:i,event:a,handler:d}))},o=e.querySelector("#practicesGrid"),r=i=>{const a=i.target.closest(".solar-practice-card");a&&(i.type==="keydown"&&i.key!=="Enter"&&i.key!==" "||(i.type==="keydown"&&i.preventDefault(),a.dataset.locked==="true"?c.showToast("Complete the first practice to unlock others"):this.showPracticePopup(a.dataset.practice)))};t(o,"click",r),t(o,"keydown",r),t(e.querySelector(".solar-mode-toggle"),"click",i=>{const a=i.target.closest(".solar-mode-btn");a?.dataset.mode&&c.switchMode(a.dataset.mode)});const n=e.querySelector('[data-action="submit-closure"]');t(n,"click",()=>this.submitClosure())}catch(t){console.error("Error attaching event listeners:",t)}},isPracticeLocked:()=>!1,getPracticeContent(e){const t=`get${e.charAt(0).toUpperCase()}${e.slice(1)}Content`;return typeof this[t]=="function"?this[t]():(console.error(`[BaseSolarRoom] Content method ${t} not found for ${e}`),'<div class="solar-popup-section"><p>Practice content not available.</p></div>')},showPracticePopup(e){try{const t=this.practices[e];if(!t){console.error(`Practice ${e} not found`);return}const o=document.createElement("div");o.id="practicePopup",o.innerHTML=c.renderers.popup({title:t.title,content:this.getPracticeContent(e),hasSaveButton:!!t.hasSaveData}),(document.getElementById("communityHubFullscreenContainer")||document.body).appendChild(o),this._attachPopupListeners(o,e)}catch(t){console.error("Error showing practice popup:",t)}},_attachPopupListeners(e,t){try{e.querySelectorAll(".solar-affirmation-btn").forEach(o=>{o.addEventListener("click",()=>{const r=document.getElementById("affirmationText");r&&(r.value=o.dataset.affirmation)})}),e.querySelector('[data-action="save-practice"]')?.addEventListener("click",()=>this.savePractice(t)),e.querySelectorAll('[data-action="close-popup"]').forEach(o=>o.addEventListener("click",()=>c.closePracticePopup()))}catch(o){console.error("Error attaching popup listeners:",o)}},savePractice(e){try{if(!this.practices[e]?.hasSaveData)return;const o=a=>{const d=document.getElementById(a);return d?this._sanitizeInput(d.value):null},r=o("intentionText"),n=o("affirmationText"),i=o("releaseListText");r!==null&&(this.userData.intention=r),n!==null&&(this.userData.affirmation=n),i!==null&&(this.userData.releaseList=i),this.userData.practiceCount++,this.saveData(),c.showToast("Practice saved"),c.closePracticePopup(),this.renderDashboard()}catch(t){console.error("Error saving practice:",t),c.showToast("Failed to save practice")}},submitClosure(){const e=document.getElementById("closureReflection");if(!e){c.showToast("Reflection field not found");return}const t=e.value.trim();if(!t){c.showToast("Please write your closing reflection");return}if(t.length<A.MIN_REFLECTION_LENGTH){c.showToast(`Please write at least ${A.MIN_REFLECTION_LENGTH} characters`);return}this.userData.closureReflection=t,this.userData.completedDate=new Date().toISOString(),this.saveData(),c.showToast(`${this.config.emoji} ${this.config.displayName} season complete. Rest well until the next cycle.`),setTimeout(()=>this.init(),1e3)},showCollectiveIntentionPopup(){try{const e=document.createElement("div");e.id="collectivePopup",e.className="solar-practice-popup",e.innerHTML=`
      ...
      <div class="solar-popup-section" style="text-align:center;">
        ...
        </div>`}catch(e){console.error("Error starting step 4:",e)}},submitWordToCollective(){try{const e=document.getElementById("collectiveWordInput")?.value.trim()||"";if(!e){c.showToast("Please enter a word");return}if(e.length>50){c.showToast("Word is too long");return}this.userData.collectiveWord=e,this.userData.intentionShared=!0,h?.ready&&h.sendRoomMessage(`${this._getSolarRoomId()}-collective`,e).catch(t=>console.error("[BaseSolarRoom] submitWordToCollective DB error:",t)),this.startCollectiveStep5()}catch(e){console.error("Error submitting word:",e)}},startCollectiveStep5(){try{const e=document.getElementById("collectiveIntentionContent");if(!e)return;const t=this._dbCollectiveWords?.length?this._dbCollectiveWords:this._getMockCollectiveWords(),o=this._renderWordCloud(t);e.innerHTML=`
        <div class="solar-popup-section" style="text-align:center;">
        ...
        <p style="text-align:center;font-size:0.9rem;color:rgba(224,224,255,0.7);margin-bottom:2rem;">
          <span class="solar-word-count"><strong>${t.length}</strong></span> ${this.config.collectiveNoun||"intentions"} in this ${this.config.displayName} cycle
        </p>
        ...
        </div>`}catch(e){console.error("Error starting step 5:",e)}},startWitnessingTimer(){this._startCountdownTimer("witnessingTimer","startWitnessingBtn",120,()=>{const e=document.getElementById("completeBtn");e&&(e.style.display="block")})},completeCollectivePractice(){try{this.userData.practiceCount++,this.saveData(),c.showToast(`${this.config.seasonEmoji} ${this.config.collectiveNoun||"Intention"} planted with the collective`),document.getElementById("collectivePopup")?.remove(),this.renderDashboard()}catch(e){console.error("Error completing collective practice:",e)}},_getMockCollectiveWords(){const e={spring:["Growth","Renewal","Hope","Bloom","Energy","Fresh","Vitality","Emerge","Awaken","Begin"],summer:["Radiance","Joy","Abundance","Vibrant","Expansion","Bright","Celebrate","Fullness","Alive","Shine"],autumn:["Harvest","Gratitude","Release","Balance","Gather","Wisdom","Reflection","Abundance","Thanks","Ripen"],winter:["Rest","Stillness","Peace","Wisdom","Quiet","Restore","Deep","Calm","Reflection","Inner"]},t=e[this.config.name]||e.spring,o=Date.now();return t.map((r,n)=>({word:r,timestamp:o-n*36e5}))},_getSolarRoomId:function(){return`${this.config.name}-solar`},getLivingPresenceCount(){return typeof this._cachedPresenceCount=="number"?this._cachedPresenceCount:0},async _refreshLivePresence(){if(!h?.ready)return;const e=this._getSolarRoomId(),t=async()=>{try{const o=await h.getRoomParticipants(e),r=await h.getBlockedUsers(),n=o.filter(s=>!r.has(s.user_id)),i=n.length;this._cachedPresenceCount=i,this._cachedParticipants=n;const a=(s,v)=>{const f=document.getElementById(s);f&&(f.textContent=v)};a("solarLiveCountTop",`${i} members practicing with you now`),a("solarGroupPresenceBadge",`${i} gathering now`),a("solarGroupJoinCount",i),a("solarCollectivePresenceBadge",`${i} practitioners in circle now`);const d=document.getElementById("solarGroupAvatars");d&&(d.innerHTML=this._buildRealAvatars(n))}catch(o){console.warn("[BaseSolarRoom] _refreshLivePresence error:",o)}};await t(),this._unsubPresence(),this._presenceSub=h.subscribeToPresence(t)},_buildRealAvatars(e){const o=e.slice(0,5),r=e.length-5,n="width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.2);",i=o.map(d=>{const s=d.profiles||{},v=s.name||s.display_name||"?",f=v.charAt(0).toUpperCase(),P=window.Core?.getAvatarGradient?.(d.user_id)??"background:var(--season-accent,#f59e0b)";let C;return s.avatar_url?C=`<img src="${s.avatar_url}" alt="${f}" width="40" height="40" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">`:s.emoji?C=`<span style="font-size:18px;">${s.emoji}</span>`:C=`<span style="font-size:13px;font-weight:600;">${f}</span>`,`<div class="solar-avatar" style="${P};${n}" aria-label="${v}">${C}</div>`}).join(""),a=r>0?`<div class="solar-avatar" style="background:rgba(255,255,255,0.1);${n}font-size:12px;">+${r}</div>`:"";return i+a},_setPresence(){if(h?.ready)try{const e=this._getSolarRoomId(),t=`${this.config.emoji} ${this.config.displayName}`;h.setPresence("online",t,e),window.Core?.state&&(window.Core.state.currentRoom=e,window.Core.state.currentUser&&(window.Core.state.currentUser.activity=t))}catch(e){console.error("[BaseSolarRoom] _setPresence error:",e)}},_clearPresence(){if(h?.ready)try{h.setPresence("online","✨ Available",null),window.Core?.state&&(window.Core.state.currentRoom=null,window.Core.state.currentUser&&(window.Core.state.currentUser.activity="✨ Available"))}catch(e){console.error("[BaseSolarRoom] _clearPresence error:",e)}},async _loadCollectiveWords(){if(h?.ready)try{const e=`${this._getSolarRoomId()}-collective`,t=async()=>{const o=await h.getRoomMessages(e,100);if(!o?.length)return;this._dbCollectiveWords=o.map(i=>({word:i.message,timestamp:new Date(i.created_at).getTime()}));const r=document.getElementById("wordCloud");r&&(r.innerHTML=this._renderWordCloud(this._dbCollectiveWords));const n=document.querySelector(".solar-word-count strong");n&&(n.textContent=this._dbCollectiveWords.length)};await t(),this._unsubCollectiveWords(),this._collectiveWordsSub=h.subscribeToRoomChat(e,t)}catch(e){console.warn("[BaseSolarRoom] _loadCollectiveWords error:",e)}},_renderWordCloud(e){return e?.length?e.map(({word:t})=>{const o=(1+Math.random()*1.5).toFixed(2),r=(.6+Math.random()*.4).toFixed(2);return`<span class="solar-word-item" style="font-size:${o}rem;opacity:${r};color:var(--season-accent,#e0e0ff);font-weight:600;display:inline-block;margin:0.5rem;transition:all 0.3s;">${t}</span>`}).join(""):'<p style="color:rgba(224,224,255,0.5);">No words yet. Be the first to share.</p>'}},ie=Object.freeze(Object.defineProperty({__proto__:null,BaseSolarRoom:R},Symbol.toStringTag,{value:"Module"})),y=Object.create(R);y.config={name:"spring",displayName:"Spring",emoji:"🌸",seasonEmoji:"🌸",itemEmoji:"🌱",sessionTimes:"sunrise and sunset",startMonth:2,startDay:20,endMonth:5,endDay:20,floatingEmojis:["🌸","🌱","🌿"],wisdom:"As the spring sun awakens the earth, we plant our intentions and embrace the season of growth and renewal.",closure:{title:"Spring Completion",intro:"As spring comes to fullness, reflect on the seeds you have planted and the growth you have nurtured through this season of renewal.",placeholder:"What intentions took root? What grew beyond your expectations? What are you ready to bring into the fullness of summer?",buttonText:"Complete Spring",closingLine:"I celebrate the growth of this season and step forward into summer with an open heart."},modeDescription:"Individual practices for renewal, growth, and planting intentions",collectiveFocus:"planting collective intentions for growth",collectiveNoun:"seeds of intention"};y.prebuiltAffirmations=["I welcome new beginnings with open arms","I am ready to grow and expand","I plant seeds of intention for my future","I embrace the fresh energy of spring","I trust in the cycle of renewal","I awaken to new possibilities","I am vibrant and full of life","I celebrate growth in all its forms","I honor my journey of transformation","I bloom with grace and vitality"];y.practices={intentionPlanting:{id:"intentionPlanting",title:"Intention and Planting",hasSaveData:!0,description:"Set clear priorities for growth",color:"var(--ring-silent)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>'},futureAlignment:{id:"futureAlignment",title:"Future Alignment Visualization",description:"Integrate vision and direction",color:"var(--ring-available)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6M4.22 4.22l4.24 4.24m5.08 5.08l4.24 4.24M1 12h6m6 0h6M4.22 19.78l4.24-4.24m5.08-5.08l4.24-4.24"/></svg>'},bodyAwakening:{id:"bodyAwakening",title:"Body Awakening and Breath",description:"Energize and activate the body",color:"var(--ring-deep)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="3"/><path d="M12 11v10M8 15l4-4 4 4M8 21h8"/></svg>'},energyAwareness:{id:"energyAwareness",title:"Energy and Awareness",description:"Activate energy for growth",color:"var(--ring-resonant)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>'},environmentalClearing:{id:"environmentalClearing",title:"Environmental Clearing",description:"Create space for fresh energy",color:"var(--ring-silent)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>'},roleExpansion:{id:"roleExpansion",title:"Role Expansion Practice",description:"Embrace roles that support growth",color:"var(--ring-available)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v8m-4-4h8"/></svg>'},paceActivation:{id:"paceActivation",title:"Pace Activation Practice",description:"Align with forward momentum",color:"var(--ring-deep)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>'},relationshipSpringAudit:{id:"relationshipSpringAudit",title:"Relationship Spring Audit",description:"Energize or refresh connections",color:"var(--ring-resonant)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>'}};y.getIntentionPlantingContent=function(){return l.generateIntentionPracticeContent(this.userData,this.prebuiltAffirmations,{purpose:"Plant clear intentions for growth this season",intentionPrompt:"What do you want to cultivate this Spring season?",intentionPlaceholder:"This Spring, I choose to focus on...",affirmationTitle:"Choose Growth Affirmation",listTitle:"Seeds to Plant",listPrompt:"Write 3 new projects, habits, or intentions you want to begin:",readAloudText:"Say your intention and seeds out loud once.",closingLine:"I honor what I plant this season and nurture it with care."})};y.getFutureAlignmentContent=function(){return l.generateFutureAlignmentContent({purpose:"Integrate vision and direction for the season",visualizationPrompt:"Visualize yourself at the end of Spring feeling aligned, energized, and inspired.",feelingTitle:"Feel Expansion",feelingPrompt:"Do not visualize outcomes-simply feel the state of readiness and growth.",closingLine:"I move through this season aligned with my true potential."})};y.getBodyAwakeningContent=function(){return l.generateBodyPracticeContent({purpose:"Energize and activate the body for new beginnings",steps:["Stand or sit comfortably, feet hip-width apart, knees soft","Inhale slowly through the nose, exhale gently through the mouth","Repeat 5 times"],subtleMovement:"Optionally, stretch arms overhead or roll shoulders to awaken energy.",closingLine:"My body is energized and ready to grow this season."})};y.getEnergyAwarenessContent=function(){return l.generateEnergyAwarenessContent({purpose:"Activate and direct internal energy for growth",energySteps:["Place hands on solar plexus","Imagine energy radiating upward and outward, like new shoots emerging"],energyQuality:"Expansion",energyGuideline:"Spring energy is about activation and outward growth.",closingLine:"I open my energy to growth and new possibilities."})};y.getEnvironmentalClearingContent=function(){return l.generateEnvironmentalClearingContent({purpose:"Create space for fresh energy and opportunities",removePrompt:"Take 3 things that no longer serve you and remove or delete them. Make room for new energy.",closingLine:"I create space for fresh growth and inspiration."})};y.getRoleExpansionContent=function(){return l.generateRolePracticeContent({purpose:"Consciously embrace roles that support growth",roleExamples:["Learner","Creator","Leader","Supporter","Explorer","Innovator"],actionTitle:"Expand One Role",actionPrompt:"Choose one role to consciously step into more fully this season.",closingLine:"I step into my roles with openness and energy this season."})};y.getPaceActivationContent=function(){return l.generatePacePracticeContent({purpose:"Align personal tempo with the season's forward momentum",paceOptions:["Slower than optimal","Appropriate","Already active"],adjustmentPrompt:"Select one action to increase forward momentum:",adjustmentExamples:["Start the day with energy","Add a new activity","Step into action sooner"],closingLine:"I allow my pace to rise with the season's energy."})};y.getRelationshipSpringAuditContent=function(){return l.generateRelationshipAuditContent({purpose:"Identify relationships to energize or refresh",identifyPrompt:"List 2–3 key people in your life: one that feels alive and inspiring, one that feels stagnant or uninspiring.",actionExamples:["Engage actively","Show appreciation","Energize connection","Set fresh boundaries"],integrationPrompt:"Notice your energy as you consider these relationships. Observe how your choices create room for renewal.",closingLine:"I nurture my connections with openness and clarity."})};y.init();console.log("🌸 Spring Solar Room loaded");const X=Object.freeze(Object.defineProperty({__proto__:null,SpringSolarRoom:y},Symbol.toStringTag,{value:"Module"})),b=Object.create(R);b.config={name:"summer",displayName:"Summer",emoji:"☀️",seasonEmoji:"☀️",itemEmoji:"🌻",sessionTimes:"midday and golden hour",startMonth:5,startDay:21,endMonth:7,endDay:20,floatingEmojis:["☀️","🌻","🌺"],wisdom:"As the summer sun shines at its brightest, we celebrate the fullness of life and embrace our radiant potential.",closure:{title:"Summer Completion",intro:"As the peak of summer begins to soften, reflect on the vitality, joy, and radiance you have expressed and embodied this season.",placeholder:"What did you celebrate? Where did you shine most brightly? What abundance are you grateful for as the light begins to turn?",buttonText:"Complete Summer",closingLine:"I honor the fullness of this season and release it with gratitude as the light gently turns."},modeDescription:"Individual practices for vitality, expansion, and celebration",collectiveFocus:"celebrating collective vitality and abundance",collectiveNoun:"expressions of joy"};b.prebuiltAffirmations=["I shine brightly with confidence and joy","I embrace the fullness of life","I am abundant and overflowing with energy","I celebrate my vitality and strength","I trust in the power of expansion","I radiate warmth and positivity","I am vibrant and alive","I honor the peak of my potential","I bask in the light of abundance","I embody the energy of summer"];b.practices={intentionRadiance:{id:"intentionRadiance",title:"Intention and Radiance",hasSaveData:!0,description:"Set intentions for expressing energy",color:"var(--ring-silent)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>'},futureAlignment:{id:"futureAlignment",title:"Future Alignment Visualization",description:"Integrate clarity for joyful expression",color:"var(--ring-available)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6M4.22 4.22l4.24 4.24m5.08 5.08l4.24 4.24M1 12h6m6 0h6M4.22 19.78l4.24-4.24m5.08-5.08l4.24-4.24"/></svg>'},bodyActivation:{id:"bodyActivation",title:"Body Activation and Breath",description:"Energize and enliven presence",color:"var(--ring-deep)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="3"/><path d="M12 11v10M8 15l4-4 4 4M8 21h8"/></svg>'},energyAwareness:{id:"energyAwareness",title:"Energy and Awareness",description:"Amplify energy for expansion",color:"var(--ring-resonant)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>'},environmentalClearing:{id:"environmentalClearing",title:"Environmental Clearing",description:"Create space for abundance",color:"var(--ring-silent)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>'},roleExpansion:{id:"roleExpansion",title:"Role Expansion Practice",description:"Express roles with creativity",color:"var(--ring-available)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v8m-4-4h8"/></svg>'},paceAlignment:{id:"paceAlignment",title:"Pace Alignment Practice",description:"Harmonize with vibrant energy",color:"var(--ring-deep)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>'},relationshipSummerAudit:{id:"relationshipSummerAudit",title:"Relationship Summer Audit",description:"Energize or celebrate connections",color:"var(--ring-resonant)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>'}};b.getIntentionRadianceContent=function(){return l.generateIntentionPracticeContent(this.userData,this.prebuiltAffirmations,{purpose:"Set intentions for full self-expression this season",intentionPrompt:"What do you want to radiate this Summer season?",intentionPlaceholder:"This Summer, I choose to focus on...",affirmationTitle:"Choose Radiance Affirmation",listTitle:"Celebration List",listPrompt:"Write 3 ways you want to express your energy and joy:",readAloudText:"Say your intention and celebrations out loud once.",closingLine:"I honor my light and allow it to shine brightly this season."})};b.getFutureAlignmentContent=function(){return l.generateFutureAlignmentContent({purpose:"Integrate clarity and direction for joyful expression",visualizationPrompt:"Visualize yourself at the height of Summer feeling vibrant, energized, and fully present.",feelingTitle:"Feel Radiance",feelingPrompt:"Do not visualize outcomes-simply feel the fullness of presence and joy.",closingLine:"I move through this season in alignment with my true radiance."})};b.getBodyActivationContent=function(){return l.generateBodyPracticeContent({purpose:"Energize the body and enliven presence",steps:["Stand or sit comfortably, feet hip-width apart, knees soft","Inhale fully through the nose, exhale gently through the mouth","Repeat 5 times"],subtleMovement:"Optionally, stretch arms outward or sway gently to open the body.",closingLine:"My body is vibrant, energized, and ready to express joy."})};b.getEnergyAwarenessContent=function(){return l.generateEnergyAwarenessContent({purpose:"Amplify and circulate energy for expansion",energySteps:["Place hands on heart and crown","Imagine energy radiating outward from the heart and upward from the crown"],energyQuality:"Expansion",energyGuideline:"Summer energy is about full expression, openness, and circulation.",closingLine:"I let my energy flow freely, fully embracing this season."})};b.getEnvironmentalClearingContent=function(){return l.generateEnvironmentalClearingContent({purpose:"Create space for abundance and creative energy",removePrompt:"Take 3 things that no longer serve you and remove or delete them. Make room for joy and inspiration.",closingLine:"I create space for abundance and new possibilities."})};b.getRoleExpansionContent=function(){return l.generateRolePracticeContent({purpose:"Consciously express roles that reflect energy and creativity",roleExamples:["Creator","Leader","Supporter","Explorer","Teacher","Artist"],actionTitle:"Amplify One Role",actionPrompt:"Choose one role to step into fully this season, expressing energy and joy.",closingLine:"I step into my roles with confidence and radiance this season."})};b.getPaceAlignmentContent=function(){return l.generatePacePracticeContent({purpose:"Harmonize your tempo with Summer's vibrant energy",paceOptions:["Slower than desired","Appropriate","Already energized"],adjustmentPrompt:"Select one action to increase flow and presence:",adjustmentExamples:["Start the day energetically","Add movement","Fully engage in an activity"],closingLine:"I allow my pace to align with the energy of this season."})};b.getRelationshipSummerAuditContent=function(){return l.generateRelationshipAuditContent({purpose:"Identify relationships to energize or celebrate",identifyPrompt:"List 2–3 key people in your life: one that feels inspiring and alive, one that feels neutral or stagnant.",actionExamples:["Engage fully","Express appreciation","Energize connection","Set playful boundaries"],integrationPrompt:"Notice how your energy shifts as you consider these relationships. Observe the expansion or contraction of joy.",closingLine:"I nurture my connections with vibrancy and clarity."})};b.init();console.log("☀️ Summer Solar Room loaded");const Q=Object.freeze(Object.defineProperty({__proto__:null,SummerSolarRoom:b},Symbol.toStringTag,{value:"Module"})),w=Object.create(R);w.config={name:"autumn",displayName:"Autumn",emoji:"🍂",seasonEmoji:"🍂",itemEmoji:"🍁",sessionTimes:"sunrise and sunset",startMonth:8,startDay:21,endMonth:10,endDay:20,floatingEmojis:["🍂","🍁","🌾"],wisdom:"As the autumn sun sets earlier each day, we gather our harvest and give thanks for the abundance we have received.",closure:{title:"Autumn Completion",intro:"As the autumn season draws to its close, gather your harvest and give thanks for all that has ripened and been received.",placeholder:"What have you harvested this season? What are you grateful for? What are you ready to release before the stillness of winter?",buttonText:"Complete Autumn",closingLine:"I gather my harvest with gratitude and release what is complete, ready to rest."},modeDescription:"Individual practices for gratitude, harvest, and preparation",collectiveFocus:"sharing collective gratitude and harvest",collectiveNoun:"harvests of gratitude"};w.prebuiltAffirmations=["I celebrate the harvest of my efforts","I am grateful for the abundance in my life","I honor the cycle of growth and rest","I release what no longer serves me with grace","I trust the wisdom of seasonal change","I gather strength for the quieter months ahead","I embrace transformation and letting go","I am rooted in gratitude and presence","I honor my growth and prepare for renewal","I welcome the wisdom of autumn"];w.practices={intentionHarvest:{id:"intentionHarvest",title:"Intention and Harvest",hasSaveData:!0,description:"Consolidate seasonal priorities",color:"var(--ring-silent)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>'},futureAlignment:{id:"futureAlignment",title:"Future Alignment Visualization",description:"Integrate clarity and direction",color:"var(--ring-available)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6M4.22 4.22l4.24 4.24m5.08 5.08l4.24 4.24M1 12h6m6 0h6M4.22 19.78l4.24-4.24m5.08-5.08l4.24-4.24"/></svg>'},bodyGrounding:{id:"bodyGrounding",title:"Body Grounding and Breath",description:"Signal safety and stability",color:"var(--ring-deep)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="3"/><path d="M12 11v10M8 15l4-4 4 4M8 21h8"/></svg>'},energyAwareness:{id:"energyAwareness",title:"Energy and Awareness",description:"Consolidate and protect energy",color:"var(--ring-resonant)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>'},environmentalClearing:{id:"environmentalClearing",title:"Environmental Clearing",description:"Create external order",color:"var(--ring-silent)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>'},roleShedding:{id:"roleShedding",title:"Role Shedding Practice",description:"Consciously prune roles",color:"var(--ring-available)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/></svg>'},paceRecalibration:{id:"paceRecalibration",title:"Pace Recalibration",description:"Align tempo with seasonal slowing",color:"var(--ring-deep)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>'},relationshipAudit:{id:"relationshipAudit",title:"Seasonal Relationship Audit",description:"Prune or nurture connections",color:"var(--ring-resonant)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>'}};w.getIntentionHarvestContent=function(){return l.generateIntentionPracticeContent(this.userData,this.prebuiltAffirmations,{purpose:"Consolidate seasonal priorities and harvest learnings",intentionPrompt:"What do you want to focus on this Autumn season?",intentionPlaceholder:"This Autumn, I choose to focus on...",affirmationTitle:"Choose Gratitude Affirmation",listTitle:"Harvest List",listPrompt:"Write 3 achievements, learnings, or resources you want to carry forward:",readAloudText:"Say your intention and harvest list out loud once.",closingLine:"I honor what I have gathered and carry it with care."})};w.getFutureAlignmentContent=function(){return l.generateFutureAlignmentContent({purpose:"Integrate clarity and direction for the season",visualizationPrompt:"Visualize yourself at the end of Autumn feeling aligned, grounded, and at ease.",feelingTitle:"Feel Alignment",feelingPrompt:"Do not visualize outcomes-simply feel the state of integration.",closingLine:"I move through this season in harmony with my true path."})};w.getBodyGroundingContent=function(){return l.generateBodyPracticeContent({purpose:"Signal safety and stability before seasonal change",steps:["Stand or sit comfortably, feet hip-width apart, knees soft","Inhale slowly through the nose, exhale gently through the mouth","Repeat 5 times"],subtleMovement:"Optionally, gently roll shoulders or stretch arms to release tension.",closingLine:"My body is grounded and ready to receive this season."})};w.getEnergyAwarenessContent=function(){return l.generateEnergyAwarenessContent({purpose:"Consolidate internal energy and protect what is harvested",energySteps:["Place hands on lower belly","Imagine energy collecting inward rather than radiating outward"],energyQuality:"Containment",energyGuideline:"Autumn energy is about holding and integrating, not expanding.",closingLine:"I contain my energy with care, honoring what I have gathered."})};w.getEnvironmentalClearingContent=function(){return l.generateEnvironmentalClearingContent({purpose:"Create external order to support internal consolidation",removePrompt:"Take 3 things that no longer serve you and remove or delete them. Do not reorganize-only subtraction.",closingLine:"I create space by letting go."})};w.getRoleSheddingContent=function(){return l.generateRolePracticeContent({purpose:"Consciously prune seasonal roles",roleExamples:["Parent","Leader","Fixer","Supporter","Creator","Learner"],actionTitle:"Soften One Role",actionPrompt:"Choose one role to consciously step back from or soften this season.",closingLine:"I allow my roles to rest and breathe this season."})};w.getPaceRecalibrationContent=function(){return l.generatePacePracticeContent({purpose:"Align personal tempo with seasonal slowing",paceOptions:["Faster than sustainable","Appropriate","Already slowed"],adjustmentPrompt:"Select one action to recalibrate your pace today:",adjustmentExamples:["Start the day slower","Reduce transitions","Leave earlier","Do fewer things per day"],closingLine:"I allow my pace to change with the season."})};w.getRelationshipAuditContent=function(){return l.generateRelationshipAuditContent({purpose:"Identify relationships to prune or nurture",identifyPrompt:"List 2–3 key people in your life: one that feels alive, inspiring, or supportive, and one that feels heavy, draining, or unresolved.",actionExamples:["Show gratitude","Limit interaction","Step back","Simply observe"],integrationPrompt:"Notice your energy and tension as you consider these relationships. Observe how your choices affect internal space.",closingLine:"I tend my connections with care and clarity."})};w.init();console.log("🍂 Autumn Solar Room loaded");const Z=Object.freeze(Object.defineProperty({__proto__:null,AutumnSolarRoom:w},Symbol.toStringTag,{value:"Module"})),x=Object.create(R);x.config={name:"winter",displayName:"Winter",emoji:"❄️",seasonEmoji:"❄️",itemEmoji:"⛄",sessionTimes:"twilight hours",startMonth:11,startDay:21,endMonth:1,endDay:19,floatingEmojis:["❄️","⛄","🌨️"],wisdom:"In the quiet stillness of winter, we rest deeply and listen to the wisdom that emerges from silence.",closure:{title:"Winter Completion",intro:"As the winter season draws to a close, take a moment to honor the stillness and wisdom you have gathered in the quiet.",placeholder:"What did you discover in the silence? What wisdom emerged from this period of rest? What are you ready to carry forward into spring?",buttonText:"Complete Winter",closingLine:"I honor the wisdom gathered in stillness and carry it gently into the light."},modeDescription:"Individual practices for rest, contemplation, and inner wisdom",collectiveFocus:"honoring collective rest and inner wisdom",collectiveNoun:"whispers of wisdom"};x.prebuiltAffirmations=["I embrace the stillness within","I rest deeply and restore fully","I trust the wisdom of quiet contemplation","I honor my need for pause and reflection","I find peace in the darkness","I am held in the gentle silence of winter","I surrender to the cycle of rest","I listen to the whispers of my inner wisdom","I am complete in this moment of stillness","I trust the regenerative power of winter"];x.practices={intentionReflection:{id:"intentionReflection",title:"Intention and Reflection",hasSaveData:!0,description:"Consolidate insights and prepare for renewal",color:"var(--ring-silent)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>'},futureAlignment:{id:"futureAlignment",title:"Future Alignment Visualization",description:"Integrate insight and prepare for future growth",color:"var(--ring-available)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6M4.22 4.22l4.24 4.24m5.08 5.08l4.24 4.24M1 12h6m6 0h6M4.22 19.78l4.24-4.24m5.08-5.08l4.24-4.24"/></svg>'},bodyGrounding:{id:"bodyGrounding",title:"Body Grounding and Breath",description:"Signal safety, stability, and rejuvenation",color:"var(--ring-deep)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="3"/><path d="M12 11v10M8 15l4-4 4 4M8 21h8"/></svg>'},energyAwareness:{id:"energyAwareness",title:"Energy and Awareness",description:"Consolidate internal energy and protect vital reserves",color:"var(--ring-resonant)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>'},environmentalClearing:{id:"environmentalClearing",title:"Environmental Clearing",description:"Create supportive external space for inner calm",color:"var(--ring-silent)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>'},roleShedding:{id:"roleShedding",title:"Role Shedding Practice",description:"Consciously release or soften roles that drain energy",color:"var(--ring-available)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v8m-4-4h8"/></svg>'},paceRecalibration:{id:"paceRecalibration",title:"Pace Recalibration Practice",description:"Align personal tempo with Winter's stillness",color:"var(--ring-deep)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>'},relationshipWinterAudit:{id:"relationshipWinterAudit",title:"Relationship Winter Audit",description:"Identify connections to rest, nurture, or let go",color:"var(--ring-resonant)",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>'}};x.getIntentionReflectionContent=function(){return l.generateIntentionPracticeContent(this.userData,this.prebuiltAffirmations,{purpose:"Consolidate insights and prepare for renewal",intentionPrompt:"What do you want to focus on this Winter season?",intentionPlaceholder:"This Winter, I choose to focus on...",affirmationTitle:"Choose Stillness Affirmation",listTitle:"Reflection List",listPrompt:"Write 3 insights or lessons you wish to integrate:",readAloudText:"Say your intention and reflections out loud once.",closingLine:"I honor my inner wisdom and hold it with care this season."})};x.getFutureAlignmentContent=function(){return l.generateFutureAlignmentContent({purpose:"Integrate insight and prepare for future growth",visualizationPrompt:"Visualize yourself at the end of Winter feeling restored, aligned, and centered.",feelingTitle:"Feel Integration",feelingPrompt:"Do not visualize outcomes-simply feel inner stability and readiness.",closingLine:"I move through this season in harmony with my inner truth."})};x.getBodyGroundingContent=function(){return l.generateBodyPracticeContent({purpose:"Signal safety, stability, and rejuvenation",steps:["Stand or sit comfortably, feet hip-width apart, knees soft","Inhale deeply through the nose, exhale slowly through the mouth","Repeat 5 times"],subtleMovement:"Optionally, gently stretch or roll shoulders to release tension and encourage circulation.",closingLine:"My body is grounded, calm, and ready to rest this season."})};x.getEnergyAwarenessContent=function(){return l.generateEnergyAwarenessContent({purpose:"Consolidate internal energy and protect vital reserves",energySteps:["Place hands on heart and lower belly","Imagine energy gathering inward and settling into the center"],energyQuality:"Containment",energyGuideline:"Winter energy is about inward focus, replenishment, and stillness.",closingLine:"I hold my energy with care, honoring my need for restoration."})};x.getEnvironmentalClearingContent=function(){return l.generateEnvironmentalClearingContent({purpose:"Create supportive external space for inner calm",removePrompt:"Take 3 things that no longer serve you and remove or delete them. Do not reorganize-simply create space.",closingLine:"I create stillness in my environment to support inner clarity."})};x.getRoleSheddingContent=function(){return l.generateRolePracticeContent({purpose:"Consciously release or soften roles that drain energy",roleExamples:["Leader","Caregiver","Worker","Supporter","Creator","Learner"],actionTitle:"Soften One Role",actionPrompt:"Choose one role to consciously step back from or pause this season.",closingLine:"I allow my roles to rest and restore my energy this season."})};x.getPaceRecalibrationContent=function(){return l.generatePacePracticeContent({purpose:"Align personal tempo with Winter's stillness",paceOptions:["Faster than sustainable","Appropriate","Already slowed"],adjustmentPrompt:"Select one action to slow or restore balance:",adjustmentExamples:["Pause before starting tasks","Reduce transitions","Allow more rest periods"],closingLine:"I allow my pace to align with the natural rhythm of this season."})};x.getRelationshipWinterAuditContent=function(){return l.generateRelationshipAuditContent({purpose:"Identify connections to rest, nurture, or let go",identifyPrompt:"List 2–3 key people in your life: one that feels supportive and nourishing, one that feels heavy or draining.",actionExamples:["Express gratitude","Limit interaction","Step back","Simply observe"],integrationPrompt:"Notice how your energy shifts as you consider these relationships. Observe the space created for calm and restoration.",closingLine:"I tend my connections with care and preserve my energy this season."})};x.init();console.log("❄️ Winter Solar Room loaded");const K=Object.freeze(Object.defineProperty({__proto__:null,WinterSolarRoom:x},Symbol.toStringTag,{value:"Module"}));export{re as a,ne as b,ie as c,oe as s};
