const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/controller-ka5L-GHE.js","assets/main-BKUOhH6B.js","assets/main-Ch1Nciyc.css","assets/subShadowJourney-CaSQoSvd.js","assets/modal-1yjDmyAf.js"])))=>i.map(i=>d[i]);
import{_ as l}from"./main-BKUOhH6B.js";import{c}from"./modal-1yjDmyAf.js";import{g as h}from"./controller-ka5L-GHE.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2.39.0/+esm";const p=[{id:"hero",title:"Hero",color:"#ef4444"},{id:"lover",title:"Lover",color:"#ec4899"},{id:"warrior",title:"Warrior",color:"#f59e0b"},{id:"sage",title:"Sage",color:"#3b82f6"},{id:"healer",title:"Healer",color:"#22c55e"},{id:"shadow",title:"Shadow",color:"#8b5cf6"}];function w(){const o=`<div class="archetype-grid">
    ${p.map(e=>{const a=h(e.id);return`
    ...
    </div>`,{modal:d,closeModal:n}=c({id:"filteredShadowListModal",title:`${h(o)} ${p.find(t=>t.id===o).title} Sub-Shadows`,subtitle:"Pick a shadow to begin its 15-25 min journey",content:a,actions:'<button class="btn" id="close-filtered-btn">Close</button>'});d.querySelectorAll(".shadow-library-item").forEach(t=>{t.addEventListener("click",()=>{const r=t.dataset.shadowId;n(),l(()=>import("./subShadowJourney-CaSQoSvd.js"),__vite__mapDeps([3,1,2,4,0])).then(u=>u.openSubShadowJourneyModal(r))})}),d.querySelector("#close-filtered-btn").addEventListener("click",n)}export{w as openSubShadowsLabGrid};
