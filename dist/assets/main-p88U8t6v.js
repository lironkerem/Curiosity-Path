...
`,this.initializeComponents().then(()=>R(()=>import("./app-DzFmKYRc.js"),__vite__mapDeps([2,1])))}).then(t=>{if(typeof t.bootSelfAnalysis=="function")this.instance=t.bootSelfAnalysis(e),this.isInitialized=!0;else throw new Error("bootSelfAnalysis function not found")}).catch(t=>{console.error("❌ Self-Analysis loader failed:",t),e.innerHTML=`
