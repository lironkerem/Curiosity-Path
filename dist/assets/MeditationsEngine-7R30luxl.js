class b{constructor(e){this.app=e,this.ytPlayer=null,this.isPlaying=!1,this.currentMeditation=null,this.sessionStartTime=null,this.progressInterval=null,this.eventCleanup=[],this.pdfGuideUrl="/Source_PDF/Meditation_Demo.pdf",this.SKIP_SECONDS=15,this.MIN_PLAYER_WIDTH=380,this.PROGRESS_UPDATE_MS=1e3,this.loadYouTubeAPI(),this.meditations=this.getMeditationsData()}loadYouTubeAPI(){if(window.YT&&window.YT.Player){window.ytReady=!0;return}if(window.onYouTubeIframeAPIReady=()=>{window.ytReady=!0},!document.querySelector('script[src*="youtube.com/iframe_api"]')){const e=document.createElement("script");e.src="https://www.youtube.com/iframe_api",document.head.appendChild(e)}}getMeditationsData(){return[{id:1,title:"Grounding to the Center of Earth",duration:"29:56",category:"Grounding",description:"Connect deeply with Earth energy and find your center",embedUrl:"https://www.youtube.com/embed/_KedpeSYwgA?enablejsapi=1&rel=0&playsinline=1",emoji:"🌍",type:"guided",premium:!1},{id:2,title:"Aura Adjustment and Cleaning",duration:"29:56",category:"Energy",description:"Cleanse and strengthen your energetic field",embedUrl:"https://www.youtube.com/embed/gIMfdNkAC4g?enablejsapi=1&rel=0&playsinline=1",emoji:"✨",type:"guided",premium:!1},{id:3,title:"Chakra Cleaning",duration:"39:58",category:"Chakras",description:"Balance and clear all seven energy centers",embedUrl:"https://www.youtube.com/embed/BFvmLeYg7cE?enablejsapi=1&rel=0&playsinline=1",emoji:"🌈",type:"guided",premium:!1},{id:4,title:"The Center of the Universe",duration:"29:56",category:"Spiritual",description:"Expand your consciousness to cosmic awareness",embedUrl:"https://www.youtube.com/embed/1T2dNQ4M7Ko?enablejsapi=1&rel=0&playsinline=1",emoji:"🌌",type:"guided",premium:!1},{id:5,title:"Blowing Roses Healing Technique",duration:"29:56",category:"Healing",description:"Release emotional blockages with visualization",embedUrl:"https://www.youtube.com/embed/3yQrtsHbSBo?enablejsapi=1&rel=0&playsinline=1",emoji:"🌹",type:"guided",premium:!1},{id:6,title:"3 Wishes Manifestation",duration:"29:52",category:"Manifestation",description:"Align your intentions with universal flow",embedUrl:"https://www.youtube.com/embed/EvRa_qwgJao?enablejsapi=1&rel=0&playsinline=1",emoji:"⭐",type:"guided",premium:!1},{id:7,title:"Meeting your Higher Self",duration:"29:56",category:"Premium",description:"Connect with your highest consciousness",embedUrl:"https://www.youtube.com/embed/34mla-PnpeU?enablejsapi=1&rel=0&playsinline=1",emoji:"💎",type:"guided",premium:!0},{id:8,title:"Inner Temple",duration:"29:46",category:"Premium",description:"Create your sacred inner sanctuary",embedUrl:"https://www.youtube.com/embed/t6o6lpftZBA?enablejsapi=1&rel=0&playsinline=1",emoji:"🔮",type:"guided",premium:!0},{id:9,title:"Gratitude Practice",duration:"29:56",category:"Premium",description:"Cultivate deep appreciation and abundance",embedUrl:"https://www.youtube.com/embed/JyTwWAhsiq8?enablejsapi=1&rel=0&playsinline=1",emoji:"👑",type:"guided",premium:!0}]}showMeditationSchedule(e){const i={guided:{title:"Today's Meditation Schedule",cycleSec:3600,openSec:900,sessions:[{title:"Grounding to the Center of Earth",duration:"29:56",category:"Grounding",emoji:"🌍"},{title:"Aura Adjustment and Cleaning",duration:"29:56",category:"Energy",emoji:"✨"},{title:"Chakra Cleaning",duration:"39:58",category:"Chakras",emoji:"🌈"},{title:"The Center of the Universe",duration:"29:56",category:"Spiritual",emoji:"🌌"},{title:"Blowing Roses Healing Technique",duration:"29:56",category:"Healing",emoji:"🌹"},{title:"3 Wishes Manifestation",duration:"29:52",category:"Manifestation",emoji:"⭐"},{title:"Meeting your Higher Self",duration:"29:56",category:"Premium",emoji:"💎"},{title:"Inner Temple",duration:"29:46",category:"Premium",emoji:"🔮"},{title:"Gratitude Practice",duration:"29:56",category:"Premium",emoji:"👑"}]},osho:{title:"Upcoming OSHO Sessions",cycleSec:5400,openSec:600,sessions:[{title:"OSHO Dynamic Meditation",duration:"77:00",category:"Energy",emoji:"🔥"},{title:"OSHO Kundalini Meditation",duration:"77:00",category:"Movement",emoji:"💃"},{title:"OSHO Nadabrahma Meditation",duration:"77:00",category:"Humming",emoji:"🕉️"},{title:"OSHO Nataraj Meditation",duration:"77:00",category:"Dance",emoji:"🎭"},{title:"OSHO Whirling Meditation",duration:"77:00",category:"Spinning",emoji:"🌀"}]}}[e];if(!i)return;const o=Date.now(),a=i.cycleSec*1e3,r=i.openSec*1e3,l=Math.floor(o/a),d=s=>new Date(s).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"}),c=Array.from({length:6},(s,p)=>{const h=(l+p)%i.sessions.length,u=i.sessions[h],m=(l+p)*a,w=m+r,y=o-m,g=p===0&&y>=0&&y<r,v=p===0&&y>=r,f=g?'<span style="background:#22c55e;color:white;font-size:10px;font-weight:700;padding:2px 8px;border-radius:10px;margin-left:8px;">OPEN NOW</span>':v?'<span style="background:rgba(239,68,68,0.15);color:#ef4444;font-size:10px;font-weight:700;padding:2px 8px;border-radius:10px;margin-left:8px;">IN SESSION</span>':"";return`
      ...
      <div style="background:var(--neuro-bg);border-radius:16px;padding:1.5rem;max-width:520px;width:100%;max-height:80vh;overflow-y:auto;box-shadow:12px 12px 24px var(--neuro-shadow-dark),-12px -12px 24px var(--neuro-shadow-light);">
        ...
        <div>${c}</div>
      </div>`,n.addEventListener("click",s=>{s.target===n&&n.remove()}),document.body.appendChild(n)}buildMeditationCTA(){const e=(r,l)=>{const d=Date.now(),c=r*1e3,n=l*1e3,s=d%c;if(s<n)return null;const p=c-s,h=Math.floor(p/6e4),u=Math.floor(p%6e4/1e3);return`Opens in ${h}:${String(u).padStart(2,"0")}`},t=e(3600,900),i=e(5400,600),o="width:100%;padding:0.75rem 1rem;border-radius:999px;border:none;background:var(--neuro-bg);color:var(--neuro-text-light);font-size:0.9rem;font-weight:600;cursor:not-allowed;opacity:0.55;box-shadow:inset 4px 4px 8px var(--neuro-shadow-dark),inset -4px -4px 8px var(--neuro-shadow-light);",a=r=>`<button type="button" onclick="event.stopPropagation();window.featuresManager.engines.meditations.showMeditationSchedule('${r}')"
      ...
      <div class="community-link-card" style="padding-top:0;">
        ...
        <p style="margin:0 0 1.5rem;font-size:0.92rem;line-height:1.6;">Practice in real time with others. Choose silence, guided visualization, or active OSHO techniques - all in shared, live spaces.</p>
        <div class="meditation-cta-grid" style="display:grid;grid-template-columns:repeat(2,1fr);gap:0.75rem;">
          ...
          <button onclick="document.activeElement?.blur();window.app.nav.switchTab('community-hub')"
                  class="btn btn-primary" style="display:inline-flex;align-items:center;justify-content:center;gap:0.5rem;white-space:nowrap;">
          ...
          <button onclick="document.activeElement?.blur();window._pendingRoomOpen='silent';window.app.nav.switchTab('community-hub')"
                  class="btn btn-primary" style="display:inline-flex;align-items:center;justify-content:center;gap:0.5rem;white-space:nowrap;">
          ...
          <div style="display:flex;flex-direction:column;gap:0.35rem;">
            <button type="button" disabled style="${o}">
          ...
          <div style="display:flex;flex-direction:column;gap:0.35rem;">
            <button onclick="document.activeElement?.blur();window._pendingRoomOpen='guided';window.app.nav.switchTab('community-hub')"
                    class="btn btn-primary" style="display:inline-flex;align-items:center;justify-content:center;gap:0.5rem;white-space:nowrap;">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 18 0v7a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3"/></svg>
          ...
          <div style="display:flex;flex-direction:column;gap:0.35rem;">
            <button onclick="document.activeElement?.blur();window._pendingRoomOpen='osho';window.app.nav.switchTab('community-hub')"
                    class="btn btn-primary" style="display:inline-flex;align-items:center;justify-content:center;gap:0.5rem;white-space:nowrap;">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M12 22V12"/><path d="M12 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" fill="currentColor"/><path d="M9 22v-4l3-2 3 2v4"/><path d="M7 15l5-3 5 3"/></svg>
      ...
      </div>`}render(){const e=document.getElementById("meditations-tab");e.innerHTML=`
      <div style="padding:1.5rem;min-height:100vh;">
        <div class="universal-content">

          <header class="main-header project-curiosity"
                  style="--header-img:url('/Tabs/NavMeditations.webp');--header-title:'';
          ...
          <div class="text-center" style="margin-bottom:2rem;">
            <button onclick="window.featuresManager.engines.meditations.openPDFGuide()"
                    class="btn btn-primary" style="padding:12px 32px;display:inline-flex;align-items:center;gap:8px;">
          ...
          <div class="card dashboard-wellness-toolkit" style="margin-bottom:2rem;">
            ...
            <div class="wellness-buttons-grid">
              <button class="wellness-tool-btn wellness-tool-active" onclick="window.openSelfReset()" aria-label="Open 60-Second Self Reset">
                ...
                <div class="wellness-tool-content"><h4 class="wellness-tool-name">Self Reset</h4><p class="wellness-tool-description">Short Breathing practice</p><div class="wellness-tool-stats"><span class="wellness-stat-xp">+10 XP</span><span class="wellness-stat-karma">+1 Karma</span></div></div>
              </button>
              <button class="wellness-tool-btn wellness-tool-active" onclick="window.openFullBodyScan()" aria-label="Full Body Scan">
                ...
                <div class="wellness-tool-content"><h4 class="wellness-tool-name">Full Body Scan</h4><p class="wellness-tool-description">Progressive relaxation</p><div class="wellness-tool-stats"><span class="wellness-stat-xp">+10 XP</span><span class="wellness-stat-karma">+1 Karma</span></div></div>
              </button>
              <button class="wellness-tool-btn wellness-tool-active" onclick="window.openNervousReset()" aria-label="Nervous System Reset">
                ...
                <div class="wellness-tool-content"><h4 class="wellness-tool-name">Nervous System</h4><p class="wellness-tool-description">Balance &amp; regulation</p><div class="wellness-tool-stats"><span class="wellness-stat-xp">+10 XP</span><span class="wellness-stat-karma">+1 Karma</span></div></div>
              </button>
              <button class="wellness-tool-btn wellness-tool-active" onclick="window.openTensionSweep()" aria-label="Tension Sweep">
                ...
                <div class="wellness-tool-content"><h4 class="wellness-tool-name">Tension Sweep</h4><p class="wellness-tool-description">Release stored tension</p><div class="wellness-tool-stats"><span class="wellness-stat-xp">+10 XP</span><span class="wellness-stat-karma">+1 Karma</span></div></div>
              </button>
            </div>
          </div>
      ...
      ${this.renderStyles()}
    `,this.attachEventListeners()}renderMeditationCards(){return this.meditations.map(e=>{const t=this.app.state?.currentUser?.isAdmin||this.app.state?.currentUser?.isVip,i=e.premium&&!t&&!this.app.gamification?.state?.unlockedFeatures?.includes("advanced_meditations");return`
        <div class="meditation-card ${i?"locked":""}"
             title="${i?"Purchase Advanced Meditations in Karma Shop to unlock":""}">
          ${e.premium?'<span class="premium-badge">PREMIUM</span>':""}
          ${i?'<div class="lock-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div>':""}
      ...
      <div id="meditation-player-wrapper" class="player-wrapper">
        <div id="meditation-audio-player" class="compact-player hidden">
          ...
          <div class="player-controls">
            <button onclick="window.featuresManager.engines.meditations.skipBackward()" class="icon-btn" aria-label="Skip backward">⏪</button>
            ...
            <button onclick="window.featuresManager.engines.meditations.skipForward()" class="icon-btn" aria-label="Skip forward">⏩</button>
          </div>
        </div>
      </div>`}renderStyles(){return document.getElementById("meditations-engine-styles")?"":`
      <style id="meditations-engine-styles">
        ...
        .player-wrapper{position:fixed;bottom:20px;right:20px;z-index:1000;}
        ...
        .video-pane #yt-player-container,.video-pane #yt-player-container iframe{position:absolute;top:0;left:0;width:100%;height:100%;}
      ...
      </style>`}attachEventListeners(){}playAudio(e){const t=this.meditations.find(o=>o.id===e);if(!t)return;const i=this.app.state?.currentUser?.isAdmin||this.app.state?.currentUser?.isVip;if(t.premium&&!i&&!this.app.gamification?.state?.unlockedFeatures?.includes("advanced_meditations")){this.app.showToast("Unlock Advanced Meditations in the Karma Shop!","info");return}this._play(t,!1)}playVideo(e){const t=this.meditations.find(o=>o.id===e);if(!t)return;const i=this.app.state?.currentUser?.isAdmin||this.app.state?.currentUser?.isVip;if(t.premium&&!i&&!this.app.gamification?.state?.unlockedFeatures?.includes("advanced_meditations")){this.app.showToast("Unlock Advanced Meditations in the Karma Shop!","info");return}this._play(t,!0)}_play(e,t){try{if(this.currentMeditation=e,this.sessionStartTime=Date.now(),this.ytPlayer&&!document.getElementById("yt-player-container")){try{this.ytPlayer.destroy()}catch{}this.ytPlayer=null}document.getElementById("player-emoji").innerHTML=e.emoji,document.getElementById("player-title").textContent=e.title,document.getElementById("meditation-audio-player").classList.remove("hidden"),e.embedUrl&&this._startYouTubePlayer(e,t)}catch(i){console.error("Error starting meditation:",i),this.app.showToast("Error starting meditation","error")}}_startYouTubePlayer(e,t){if(!window.ytReady||!window.YT||!window.YT.Player){this.app.showToast("Initializing player… please tap again.","info");const i=window.onYouTubeIframeAPIReady;window.onYouTubeIframeAPIReady=()=>{window.ytReady=!0,typeof i=="function"&&i(),this._startYouTubePlayer(e,t)};return}try{const i=e.embedUrl.match(/embed\/([a-zA-Z0-9_-]{11})/)[1],o=window.location.origin&&window.location.origin!=="null"?window.location.origin:void 0;if(t?this._showVideoPane():this._hideVideoPane(),document.getElementById("play-pause-btn").disabled=!0,!this.ytPlayer||typeof this.ytPlayer.playVideo!="function"){if(this.ytPlayer&&typeof this.ytPlayer.destroy=="function"){try{this.ytPlayer.destroy()}catch{}this.ytPlayer=null}const a={enablejsapi:1,rel:0,playsinline:1};o&&(a.origin=o),this.ytPlayer=new YT.Player("yt-player-container",{videoId:i,playerVars:a,events:{onReady:()=>{document.getElementById("play-pause-btn").disabled=!1,this.ytPlayer.playVideo(),this.app.showToast(t?"Playing – tap pause to stop":"Audio playing","success")},onStateChange:r=>this._handleYouTubeStateChange(r),onError:r=>{console.error("YouTube player error:",r),this.app.showToast("Video error – check connection or video availability","error")}}})}else this.ytPlayer.loadVideoById(i);this._startProgressUpdates()}catch(i){console.error("Error initializing YouTube player:",i),this.app.showToast("Error loading video","error")}}_handleYouTubeStateChange(e){e.data===YT.PlayerState.ENDED&&this.currentMeditation&&this.onMeditationComplete(),e.data===YT.PlayerState.PLAYING&&(this.isPlaying=!0,document.getElementById("play-pause-btn").textContent="⏸️"),e.data===YT.PlayerState.PAUSED&&(this.isPlaying=!1,document.getElementById("play-pause-btn").textContent="▶️")}_startProgressUpdates(){this.progressInterval&&clearInterval(this.progressInterval),this.progressInterval=setInterval(()=>{this.isPlaying&&this.updateProgress()},this.PROGRESS_UPDATE_MS)}_showVideoPane(){document.getElementById("video-pane").classList.remove("hidden"),document.getElementById("meditation-audio-player").classList.add("video-mode"),this.initDrag()}_hideVideoPane(){document.getElementById("video-pane").classList.add("hidden"),document.getElementById("meditation-audio-player").classList.remove("video-mode")}initDrag(){const e=document.querySelector(".player-info"),t=document.getElementById("meditation-player-wrapper");if(!e||!t)return;let i,o,a,r;const l=n=>{i=n.touches?n.touches[0].clientX:n.clientX,o=n.touches?n.touches[0].clientY:n.clientY;const s=t.getBoundingClientRect();a=i-s.left,r=o-s.top,document.addEventListener("mousemove",d),document.addEventListener("mouseup",c),document.addEventListener("touchmove",d,{passive:!1}),document.addEventListener("touchend",c,{passive:!0}),n.preventDefault()},d=n=>{const s=(n.touches?n.touches[0].clientX:n.clientX)-a,p=(n.touches?n.touches[0].clientY:n.clientY)-r;t.style.left=s+"px",t.style.top=p+"px",t.style.bottom="auto",t.style.right="auto"},c=()=>{document.removeEventListener("mousemove",d),document.removeEventListener("mouseup",c),document.removeEventListener("touchmove",d),document.removeEventListener("touchend",c)};e.addEventListener("mousedown",l),e.addEventListener("touchstart",l,{passive:!1}),this.eventCleanup.push(()=>{e.removeEventListener("mousedown",l),e.removeEventListener("touchstart",l)})}togglePlay(){if(this.currentMeditation&&this.ytPlayer&&typeof this.ytPlayer.playVideo=="function")try{this.isPlaying?this.ytPlayer.pauseVideo():this.ytPlayer.playVideo()}catch(e){console.error("Error toggling playback:",e),this.app.showToast("Player not ready","info")}}stopMeditation(){try{if(this.isPlaying=!1,this.currentMeditation=null,this.sessionStartTime=null,this.progressInterval&&(clearInterval(this.progressInterval),this.progressInterval=null),this.ytPlayer&&typeof this.ytPlayer.destroy=="function"){try{this.ytPlayer.destroy()}catch{}this.ytPlayer=null}const e=document.getElementById("yt-player-container");e&&(e.innerHTML="");const t=document.getElementById("play-pause-btn");t&&(t.textContent="▶️"),document.getElementById("meditation-audio-player")?.classList.add("hidden"),this._hideVideoPane()}catch(e){console.error("Error stopping meditation:",e)}}skipForward(){if(!(!this.ytPlayer||typeof this.ytPlayer.getCurrentTime!="function"))try{const e=this.ytPlayer.getCurrentTime()||0,t=this.ytPlayer.getDuration()||0;this.ytPlayer.seekTo(Math.min(e+this.SKIP_SECONDS,t),!0)}catch(e){console.error("Error skipping forward:",e)}}skipBackward(){if(!(!this.ytPlayer||typeof this.ytPlayer.getCurrentTime!="function"))try{const e=this.ytPlayer.getCurrentTime()||0;this.ytPlayer.seekTo(Math.max(e-this.SKIP_SECONDS,0),!0)}catch(e){console.error("Error skipping backward:",e)}}updateProgress(){if(!(!this.ytPlayer||typeof this.ytPlayer.getCurrentTime!="function"))try{const e=this.ytPlayer.getCurrentTime()||0,t=this.ytPlayer.getDuration()||0;t>0&&(document.getElementById("player-time").textContent=`${this.formatTime(e)} / ${this.formatTime(t)}`,this.updateRing(e,t))}catch(e){console.error("Error updating progress:",e)}}updateRing(e,t){const i=document.getElementById("player-progress-ring");if(!(!i||!t))try{const o=i.r.baseVal.value,a=2*Math.PI*o;i.style.strokeDasharray=`${a} ${a}`;const r=a-e/t*a;i.style.strokeDashoffset=isNaN(r)?a:r}catch(o){console.error("Error updating ring:",o)}}onMeditationComplete(){try{if(this.isPlaying=!1,document.getElementById("play-pause-btn").textContent="▶️",this.app.showToast("Meditation complete! Well done.","success"),!this.currentMeditation)return;const e=this.ytPlayer?Math.floor((this.ytPlayer.getDuration()||0)/60):0,t=Math.max(e,1),i={type:this.currentMeditation.type||"guided",meditationId:this.currentMeditation.id,title:this.currentMeditation.title,category:this.currentMeditation.category,duration:t,chakra:this.getChakraFromMeditation(this.currentMeditation.category),timestamp:new Date().toISOString(),sessionStartTime:this.sessionStartTime,completedAt:Date.now()};this.app.state&&this.app.state.addEntry("meditation",i),this.checkAchievements(),this.sessionStartTime=null}catch(e){console.error("Error completing meditation:",e)}}checkAchievements(){try{const e=(this.app.state?.data?.meditationHistory||[]).length,t=this.app.gamification;if(!t)return;const i=t.getBadgeDefinitions();e>=1&&t.checkAndGrantBadge("first_meditation",i),e>=20&&t.checkAndGrantBadge("meditation_devotee",i),e>=60&&t.checkAndGrantBadge("meditation_master",i),e>=100&&t.checkAndGrantBadge("meditation_100",i),e>=200&&t.checkAndGrantBadge("meditation_200",i)}catch(e){console.error("Error checking achievements:",e)}}getChakraFromMeditation(e){return{Grounding:"root",Energy:"sacral",Chakras:"heart",Spiritual:"crown",Healing:"heart",Manifestation:"solar",Premium:"crown"}[e]||null}formatTime(e){return!e||isNaN(e)||e<0?"0:00":`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,"0")}`}openPDFGuide(){this.pdfGuideUrl&&this.pdfGuideUrl!=="YOUR_PDF_URL_HERE"?window.open(this.pdfGuideUrl,"_blank"):this.app.showToast("PDF Guide is not yet available.","info")}destroy(){this.cleanup()}cleanup(){try{if(this.progressInterval&&(clearInterval(this.progressInterval),this.progressInterval=null),this.eventCleanup.forEach(t=>t()),this.eventCleanup=[],this.ytPlayer&&typeof this.ytPlayer.destroy=="function"){try{this.ytPlayer.destroy()}catch{}this.ytPlayer=null}const e=document.getElementById("yt-player-container");e&&(e.innerHTML=""),this.isPlaying=!1,this.currentMeditation=null,this.sessionStartTime=null}catch(e){console.error("Error during cleanup:",e)}}}typeof window<"u"&&(window.MeditationsEngine=b);export{b as default};
