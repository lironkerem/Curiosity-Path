import{N as c}from"./Index-DT2GP4of.js";import"./User-Tab-B_tDP8HX.js";import"./community-hub-Dyy_kFsr.js";import"./features-lazy-DBLChGA-.js";import"./vendor-suncalc-BBoG6fSx.js";import"./supabase-DmJIYYE5.js";import"./gamification-C4jQodZo.js";const u=[{id:"happy",emoji:"😊",title:"Happy"},{id:"joyful",emoji:"😄",title:"Joyful"},{id:"excited",emoji:"🤩",title:"Excited"},{id:"loved",emoji:"🥰",title:"Loved"},{id:"grateful",emoji:"🙏",title:"Grateful"},{id:"peaceful",emoji:"😌",title:"Peaceful"},{id:"calm",emoji:"🧘",title:"Calm"},{id:"relaxed",emoji:"😎",title:"Relaxed"},{id:"proud",emoji:"😤",title:"Proud"},{id:"confident",emoji:"💪",title:"Confident"},{id:"hopeful",emoji:"🌟",title:"Hopeful"},{id:"inspired",emoji:"✨",title:"Inspired"},{id:"sad",emoji:"😢",title:"Sad"},{id:"crying",emoji:"😭",title:"Crying"},{id:"lonely",emoji:"😔",title:"Lonely"},{id:"disappointed",emoji:"😞",title:"Disappointed"},{id:"anxious",emoji:"😰",title:"Anxious"},{id:"worried",emoji:"😟",title:"Worried"},{id:"stressed",emoji:"😫",title:"Stressed"},{id:"overwhelmed",emoji:"🤯",title:"Overwhelmed"},{id:"angry",emoji:"😠",title:"Angry"},{id:"frustrated",emoji:"😤",title:"Frustrated"},{id:"annoyed",emoji:"😒",title:"Annoyed"},{id:"tired",emoji:"😴",title:"Tired"},{id:"sick",emoji:"🤒",title:"Sick"},{id:"confused",emoji:"😕",title:"Confused"},{id:"surprised",emoji:"😲",title:"Surprised"},{id:"shocked",emoji:"😱",title:"Shocked"},{id:"nervous",emoji:"😬",title:"Nervous"},{id:"embarrassed",emoji:"😳",title:"Embarrassed"}],p=["What made you smile today?","What are you grateful for right now?","What's on your mind?","How are you really feeling?","What would you like to remember about today?","What challenged you today?","What did you learn about yourself?","What are you looking forward to?"],d=400;class M{constructor(e){this.app=e,this.currentPage=0,this.viewMode="write",this.isOpen=!1,this.isLocked=!1,this.activeModals=[]}render(){let e=document.getElementById("journal-tab");if(!e){const t=document.getElementById("main-content");if(!t)return;e=document.createElement("div"),e.id="journal-tab",e.className="tab-content",t.appendChild(e)}e.innerHTML=`
    ...
    `,this.initializeLockState(),this.renderJournal()}renderJournal(){const e=document.getElementById("journal-wrapper");if(!e)return;const t=!!this.app.state.data.journalPin;this.isOpen?this.renderOpenBook(e,t):this.renderClosedBook(e,t)}renderClosedBook(e,t){const o=this.app.state.currentUser?.name||"My",n=t&&this.isLocked?'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>':"";e.innerHTML=`
      ...
      </div>`;const i=e.querySelector(".journal-closed");requestAnimationFrame(()=>{i.style.transition="opacity 0.5s ease-out, transform 0.5s ease-out",i.style.opacity="1",i.style.transform="scale(1)"}),i.addEventListener("click",()=>{t&&this.isLocked?this.promptUnlock():this.openBook()})}renderOpenBook(e,t){e.innerHTML=`
      ...
      </div>`,this.attachMoodListeners(e),this.updateNavigation()}renderReadMode(e="none"){const t=document.getElementById("journal-pages"),o=document.getElementById("save-entry");o&&(o.style.display="none");const n=this.app.state.data.journalEntries||[];if(n.length===0){this.renderEmptyJournal(t);return}const s=[...n].sort((m,v)=>new Date(v.timestamp)-new Date(m.timestamp))[this.currentPage],a=n.indexOf(s),l=s.mood?this.getMoodEmoji(s.mood):"",r=s.date||this.formatDate(new Date(s.timestamp)),h=e==="left"?"page-flip-left":e==="right"?"page-flip-right":"";t.innerHTML=`
      <div class="journal-page read-mode ${h}">
        ...
        <div class="entry-content">${this.escapeHtml(s.situation||s.feelings||"")}</div>
      ...
      `,onConfirm:t=>{const o=t.querySelector("#pin-input"),n=t.querySelector("#pin-confirm"),i=o.value,s=n.value;return i.length!==4||!/^\d{4}$/.test(i)?(this.app.showToast("PIN must be 4 digits","warning"),!1):i!==s?(this.app.showToast("PINs do not match","warning"),!1):(this.app.state.data.journalPin=btoa(i),this.app.state.saveAppData(),this.isLocked=!0,this.app.showToast("PIN set successfully!","success"),this.renderJournal(),!0)}});setTimeout(()=>e.querySelector("#pin-input")?.focus(),100)}promptUnlock(){const e=this.createModal({icon:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/></svg>',title:"Unlock Journal",content:`
        <div class="modal-input-wrapper">
      ...
      `,onConfirm:o=>{const n=o.querySelector("#unlock-pin"),i=n.value,s=atob(this.app.state.data.journalPin||"");return i===s?(this.isLocked=!1,this.isOpen=!0,this.app.showToast("Journal unlocked!","success"),this.openBook(),!0):(this.app.showToast("Incorrect PIN","error"),n.value="",n.focus(),!1)}});e.querySelector("#forgot-pin")?.addEventListener("click",()=>{this.closeModal(e),this.resetPinWithAuth()});const t=e.querySelector("#unlock-pin");t?.addEventListener("keydown",o=>{o.key==="Enter"&&e.querySelector(".modal-confirm")?.click()}),setTimeout(()=>t?.focus(),100)}async resetPinWithAuth(){const e=this.createModal({icon:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg>',title:"Reset PIN",content:`
        <div class="modal-input-wrapper">
      ...
      `,cancelOnly:!0});e.querySelector("#change-pin")?.addEventListener("click",()=>{this.closeModal(e),this.promptSetPin()}),e.querySelector("#remove-pin")?.addEventListener("click",()=>{this.closeModal(e),c.showConfirm("Remove PIN lock from your journal? Your journal will remain accessible without a PIN.",()=>{delete this.app.state.data.journalPin,this.app.state.saveAppData(),this.isLocked=!1,this.app.showToast("PIN removed","success"),this.renderJournal()},{title:"Remove PIN?",icon:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/></svg>',confirmText:"Remove PIN"})})}saveEntry(){const e=document.getElementById("journal-entry-text"),t=e?.value.trim();if(!t){this.app.showToast("Please write something in your journal","warning");return}const n=document.querySelector(".mood-btn.active")?.dataset.mood||null,i={situation:t,feelings:"",mood:n,timestamp:new Date().toISOString(),date:this.formatDate(new Date)};this.app.state.addEntry("journal",i),this.app.gamification&&this.app.gamification.incrementJournalEntries(),this.app.showToast("Journal entry saved!","success"),e.value="",document.querySelectorAll(".mood-btn").forEach(s=>s.classList.remove("active")),this.checkAchievements(),this.switchMode("read")}editEntry(e){const t=this.app.state.data.journalEntries||[],o=t[e];if(!o)return;const n=this.createModal({icon:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/></svg>',title:"Edit Journal Entry",content:`
        <div class="modal-input-wrapper">
      ...
      `,onConfirm:i=>{const a=i.querySelector("#edit-entry").value.trim();if(!a)return this.app.showToast("Please write something","warning"),!1;const r=i.querySelector(".mood-btn.active")?.dataset.mood||null;return t[e].situation=a,t[e].feelings="",t[e].mood=r,this.app.state.data.journalEntries=t,this.app.state.saveAppData(),this.app.showToast("Journal entry updated!","success"),this.renderCurrentView(),!0}});this.attachMoodListeners(n),setTimeout(()=>n.querySelector("#edit-entry")?.focus(),100)}deleteEntry(e){c.showConfirm("Are you sure you want to delete this journal entry? This action cannot be undone.",()=>{const t=this.app.state.data.journalEntries||[];t.splice(e,1),this.app.state.data.journalEntries=t,this.app.state.saveAppData(),this.app.showToast("Journal entry deleted","info"),this.currentPage>=t.length&&(this.currentPage=Math.max(0,t.length-1)),this.renderCurrentView()},{title:"Delete Journal Entry",icon:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',confirmText:"Delete",isDanger:!0})}openBook(){const e=document.querySelector(".journal-closed");if(!e){this.isOpen=!0,this.renderJournal();return}e.style.transition=`opacity ${d}ms ease-in, transform ${d}ms ease-in`,e.style.opacity="0",e.style.transform="scale(0.9)",setTimeout(()=>{this.isOpen=!0,this.renderJournal()},d)}closeBook(){const e=document.querySelector(".journal-book");if(!e){this.isOpen=!1,this.renderJournal();return}e.style.transition=`opacity ${d}ms ease-in, transform ${d}ms ease-in`,e.style.opacity="0",e.style.transform="scale(0.9)",setTimeout(()=>{this.isOpen=!1,this.app.state.data.journalPin&&(this.isLocked=!0,this.app.state.data.journalLocked=!0,this.app.state.saveAppData()),this.renderJournal()},d)}switchMode(e){this.viewMode=e,this.currentPage=0,document.querySelectorAll(".mode-btn").forEach(t=>t.classList.remove("active")),document.querySelector(`[data-mode="${e}"]`)?.classList.add("active"),this.renderCurrentView()}navigatePage(e){const o=(this.app.state.data.journalEntries||[]).length-1,n=this.currentPage+e;n<0||n>o||(this.currentPage=n,this.renderReadMode(e>0?"right":"left"))}updateNavigation(){const e=this.app.state.data.journalEntries||[],t=document.getElementById("prev-page"),o=document.getElementById("next-page"),n=document.getElementById("page-indicator");this.viewMode==="write"?(t&&(t.style.display="none"),o&&(o.style.display="none"),n&&(n.textContent="")):(t&&(t.style.display="block",t.disabled=this.currentPage===0),o&&(o.style.display="block",o.disabled=this.currentPage>=e.length-1),n&&(n.textContent=e.length?`Entry ${this.currentPage+1} of ${e.length}`:""))}renderCurrentView(){this.viewMode==="write"?this.renderWriteMode():this.renderReadMode()}attachOpenEventListeners(){document.getElementById("close-journal")?.addEventListener("click",()=>this.closeBook()),document.getElementById("lock-toggle")?.addEventListener("click",()=>this.handleLockToggle()),document.getElementById("pin-settings")?.addEventListener("click",()=>this.showPinSettings()),document.querySelectorAll(".mode-btn").forEach(a=>{a.addEventListener("click",l=>{const r=l.target.dataset.mode;this.switchMode(r)})});const n=document.getElementById("prev-page"),i=document.getElementById("next-page");n?.addEventListener("click",()=>this.navigatePage(-1)),i?.addEventListener("click",()=>this.navigatePage(1)),document.getElementById("save-entry")?.addEventListener("click",()=>this.saveEntry())}handleLockToggle(){!!this.app.state.data.journalPin?this.isLocked?this.promptUnlock():(this.isLocked=!0,this.app.state.data.journalLocked=!0,this.app.state.saveAppData(),this.app.showToast("Journal locked","info"),this.renderJournal()):this.promptSetPin()}attachMoodListeners(e){e.querySelectorAll(".mood-btn").forEach(t=>{t.addEventListener("click",o=>{e.querySelectorAll(".mood-btn").forEach(n=>n.classList.remove("active")),o.currentTarget.classList.add("active")})})}checkAchievements(){const e=this.app.gamification?.state?.totalJournalEntries||0,t=this.app.gamification;if(!t)return;const o=t.getBadgeDefinitions();e>=1&&t.checkAndGrantBadge("first_journal",o),e>=20&&t.checkAndGrantBadge("journal_keeper",o),e>=75&&t.checkAndGrantBadge("journal_master",o),e>=150&&t.checkAndGrantBadge("journal_150",o),e>=400&&t.checkAndGrantBadge("journal_400",o)}createModal({icon:e,title:t,content:o,onConfirm:n,cancelOnly:i=!1}){const s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
      <div class="neuro-modal">
        ...
        <div class="modal-actions">
          <button class="btn modal-cancel">${i?"Close":"Cancel"}</button>
          ${i?"":'<button class="btn btn-primary modal-confirm">Confirm</button>'}
        </div>
      </div>`,document.body.appendChild(s),this.activeModals.push(s);const a=()=>this.closeModal(s);s.querySelector(".modal-cancel").onclick=a,!i&&n&&(s.querySelector(".modal-confirm").onclick=()=>{n(s)!==!1&&this.closeModal(s)}),s.onclick=r=>{r.target===s&&a()};const l=r=>{r.key==="Escape"&&(a(),document.removeEventListener("keydown",l))};return document.addEventListener("keydown",l),s}closeModal(e){e.style.opacity="0",setTimeout(()=>{e.remove(),this.activeModals=this.activeModals.filter(t=>t!==e)},200)}cleanup(){this.activeModals.forEach(e=>e.remove()),this.activeModals=[]}getRandomPrompt(){return p[Math.floor(Math.random()*p.length)]}formatDate(e){return e.toLocaleDateString("en-US",{weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})}renderMoodButtons(e=null){return u.map(t=>`<button class="mood-btn ${e===t.id?"active":""}" 
              data-mood="${t.id}" 
              title="${t.title}">${t.emoji}</button>`).join("")}getMoodEmoji(e){const t=u.find(o=>o.id===e);return t?t.emoji:""}escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}}export{M as default};
