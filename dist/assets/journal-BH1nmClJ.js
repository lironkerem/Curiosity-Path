      ...
      <div class="neuro-modal">
        ...
        <div class="modal-actions">
          ...
          ${s?"":'<button class="btn btn-primary modal-confirm">Confirm</button>'}
              ...
              data-mood="${t.id}" 
              title="${t.title}">${t.emoji}</button>`).join("")}getMoodEmoji(e){const t=u.find(o=>o.id===e);return t?t.emoji:""}escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}}export{w as default};
