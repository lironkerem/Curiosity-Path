...
AutumnSolarRoom.config = {
  ...
  startMonth: 8, startDay: 21, endMonth: 10, endDay: 20,
  floatingEmojis:  ['🍂', '🍁', '🌾'],
...
AutumnSolarRoom.practices = {
  intentionHarvest: {
    id: 'intentionHarvest', title: 'Intention and Harvest', hasSaveData: true,
    description: 'Consolidate seasonal priorities', color: 'var(--ring-silent)',
  ...
  futureAlignment: {
    ...
    description: 'Integrate clarity and direction', color: 'var(--ring-available)',
  ...
  bodyGrounding: {
    ...
    description: 'Signal safety and stability', color: 'var(--ring-deep)',
  ...
  energyAwareness: {
    ...
    description: 'Consolidate and protect energy', color: 'var(--ring-resonant)',
  ...
  environmentalClearing: {
    ...
    description: 'Create external order', color: 'var(--ring-silent)',
  ...
  roleShedding: {
    ...
    description: 'Consciously prune roles', color: 'var(--ring-available)',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/></svg>`,
  },
  paceRecalibration: {
    id: 'paceRecalibration', title: 'Pace Recalibration',
    description: 'Align tempo with seasonal slowing', color: 'var(--ring-deep)',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`,
  },
  relationshipAudit: {
    id: 'relationshipAudit', title: 'Seasonal Relationship Audit',
    description: 'Prune or nurture connections', color: 'var(--ring-resonant)',
...
AutumnSolarRoom.getBodyGroundingContent = function() {
  return SolarConfig.generateBodyPracticeContent({
    ...
    steps:          ['Stand or sit comfortably, feet hip-width apart, knees soft', 'Inhale slowly through the nose, exhale gently through the mouth', 'Repeat 5 times'],
...
AutumnSolarRoom.getEnergyAwarenessContent = function() {
  return SolarConfig.generateEnergyAwarenessContent({
    ...
    energySteps:     ['Place hands on lower belly', 'Imagine energy collecting inward rather than radiating outward'],
...
AutumnSolarRoom.getPaceRecalibrationContent = function() {
  return SolarConfig.generatePacePracticeContent({
    ...
    adjustmentExamples: ['Start the day slower', 'Reduce transitions', 'Leave earlier', 'Do fewer things per day'],
...
AutumnSolarRoom.getRelationshipAuditContent = function() {
  return SolarConfig.generateRelationshipAuditContent({
    ...
    actionExamples:    ['Show gratitude', 'Limit interaction', 'Step back', 'Simply observe'],
