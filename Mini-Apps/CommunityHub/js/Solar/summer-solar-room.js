...
SummerSolarRoom.config = {
  ...
  startMonth: 5, startDay: 21, endMonth: 7, endDay: 20,
  floatingEmojis:  ['☀️', '🌻', '🌺'],
...
SummerSolarRoom.practices = {
  intentionRadiance: {
    id: 'intentionRadiance', title: 'Intention and Radiance', hasSaveData: true,
    description: 'Set intentions for expressing energy', color: 'var(--ring-silent)',
  ...
  futureAlignment: {
    ...
    description: 'Integrate clarity for joyful expression', color: 'var(--ring-available)',
  ...
  bodyActivation: {
    id: 'bodyActivation', title: 'Body Activation and Breath',
    description: 'Energize and enliven presence', color: 'var(--ring-deep)',
  ...
  energyAwareness: {
    ...
    description: 'Amplify energy for expansion', color: 'var(--ring-resonant)',
  ...
  environmentalClearing: {
    ...
    description: 'Create space for abundance', color: 'var(--ring-silent)',
  ...
  roleExpansion: {
    id: 'roleExpansion', title: 'Role Expansion Practice',
    description: 'Express roles with creativity', color: 'var(--ring-available)',
  ...
  paceAlignment: {
    id: 'paceAlignment', title: 'Pace Alignment Practice',
    description: 'Harmonize with vibrant energy', color: 'var(--ring-deep)',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`,
  },
  relationshipSummerAudit: {
    id: 'relationshipSummerAudit', title: 'Relationship Summer Audit',
    description: 'Energize or celebrate connections', color: 'var(--ring-resonant)',
...
SummerSolarRoom.getBodyActivationContent = function() {
  return SolarConfig.generateBodyPracticeContent({
    ...
    steps:          ['Stand or sit comfortably, feet hip-width apart, knees soft', 'Inhale fully through the nose, exhale gently through the mouth', 'Repeat 5 times'],
...
SummerSolarRoom.getEnergyAwarenessContent = function() {
  return SolarConfig.generateEnergyAwarenessContent({
    ...
    energySteps:     ['Place hands on heart and crown', 'Imagine energy radiating outward from the heart and upward from the crown'],
...
SummerSolarRoom.getPaceAlignmentContent = function() {
  return SolarConfig.generatePacePracticeContent({
    ...
    adjustmentExamples: ['Start the day energetically', 'Add movement', 'Fully engage in an activity'],
...
SummerSolarRoom.getRelationshipSummerAuditContent = function() {
  return SolarConfig.generateRelationshipAuditContent({
    ...
    actionExamples:    ['Engage fully', 'Express appreciation', 'Energize connection', 'Set playful boundaries'],
...
console.log('☀️ Summer Solar Room loaded');

export { SummerSolarRoom };
