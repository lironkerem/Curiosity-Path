...
SpringSolarRoom.practices = {
  intentionPlanting: {
    id: 'intentionPlanting', title: 'Intention and Planting', hasSaveData: true,
    description: 'Set clear priorities for growth', color: 'var(--ring-silent)',
  ...
  futureAlignment: {
    ...
    description: 'Integrate vision and direction', color: 'var(--ring-available)',
  ...
  bodyAwakening: {
    id: 'bodyAwakening', title: 'Body Awakening and Breath',
    description: 'Energize and activate the body', color: 'var(--ring-deep)',
  ...
  energyAwareness: {
    ...
    description: 'Activate energy for growth', color: 'var(--ring-resonant)',
  ...
  environmentalClearing: {
    ...
    description: 'Create space for fresh energy', color: 'var(--ring-silent)',
  ...
  roleExpansion: {
    ...
    description: 'Embrace roles that support growth', color: 'var(--ring-available)',
  ...
  paceActivation: {
    id: 'paceActivation', title: 'Pace Activation Practice',
    description: 'Align with forward momentum', color: 'var(--ring-deep)',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`,
  },
  relationshipSpringAudit: {
    id: 'relationshipSpringAudit', title: 'Relationship Spring Audit',
    description: 'Energize or refresh connections', color: 'var(--ring-resonant)',
...
SpringSolarRoom.getEnergyAwarenessContent = function() {
  return SolarConfig.generateEnergyAwarenessContent({
    ...
    energySteps:     ['Place hands on solar plexus', 'Imagine energy radiating upward and outward, like new shoots emerging'],
...
SpringSolarRoom.getPaceActivationContent = function() {
  return SolarConfig.generatePacePracticeContent({
    ...
    adjustmentExamples: ['Start the day with energy', 'Add a new activity', 'Step into action sooner'],
...
SpringSolarRoom.getRelationshipSpringAuditContent = function() {
  return SolarConfig.generateRelationshipAuditContent({
    ...
    actionExamples:   ['Engage actively', 'Show appreciation', 'Energize connection', 'Set fresh boundaries'],
