...
.lunar-admin-header span:first-child{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:rgba(139,92,246,.9);}
.lunar-admin-body{padding:16px 20px;background:var(--surface);border-top:1px solid rgba(139,92,246,.2);}
